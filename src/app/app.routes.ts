...
export const routes: Routes = [
...

    {
        ...
        children: [
            ...
            {
                path: 'adminrh',
                loadComponent: () => import('./features/adminrh/adminrh.component').then(m => m.AdminrhComponent),
                canActivate: [authGuard],
                children: [
            ...
            {
                path: 'student',
                loadComponent: () => import('./features/student/student.component').then(m => m.StudentComponent),
                children: [
                    ...
                    // ✅ Écart de compétences — chemin relatif, pas de canActivate (hérité du parent student)
