...
import { apiResultFormat, instructorAssignment } from '../../../shared/models/model';
...
@Component({
    ...
    imports:[CommonModule,MatTableModule,MatSortModule,MatPaginatorModule,MatSelectModule,BsDatepickerModule,FormsModule]
})
export class AdminrhAssignmentComponent {
 public routes = routes;
  
    // pagination variables
    public pageSize = 10;
    public tableData: instructorAssignment[] = [];
    public tableDataCopy: instructorAssignment[] = [];
    public actualData: instructorAssignment[] = [];
    ...
    constructor(
      ...
      this.data.getInstructorAssignment().subscribe((apiRes: apiResultFormat) => {
