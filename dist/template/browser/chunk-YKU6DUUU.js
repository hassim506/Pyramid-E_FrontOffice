...
function AdminrhQuizComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 9);
    \u0275\u0275text(1);
    \u0275\u0275elementStart(2, "button", 10);
    \u0275\u0275listener("click", function AdminrhQuizComponent_div_10_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r1);
...
function AdminrhQuizComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhQuizComponent_div_12_div_4_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhQuizComponent_div_12_div_5_tr_21_span_11_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhQuizComponent_div_12_div_5_tr_21_span_12_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhQuizComponent_div_12_div_5_tr_21_span_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AdminrhQuizComponent_div_12_div_5_tr_21_span_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 3);
...
function AdminrhQuizComponent_div_12_div_5_tr_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(11, AdminrhQuizComponent_div_12_div_5_tr_21_span_11_Template, 2, 1, "span", 29)(12, AdminrhQuizComponent_div_12_div_5_tr_21_span_12_Template, 2, 0, "span", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "td");
    \u0275\u0275template(14, AdminrhQuizComponent_div_12_div_5_tr_21_span_14_Template, 2, 1, "span", 29)(15, AdminrhQuizComponent_div_12_div_5_tr_21_span_15_Template, 2, 0, "span", 30);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function AdminrhQuizComponent_div_12_div_5_tr_21_Template_button_click_28_listener() {
...
function AdminrhQuizComponent_div_12_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(21, AdminrhQuizComponent_div_12_div_5_tr_21_Template, 30, 20, "tr", 26);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function AdminrhQuizComponent_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "div", 15)(2, "h5", 16);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, AdminrhQuizComponent_div_12_div_4_Template, 9, 2, "div", 17)(5, AdminrhQuizComponent_div_12_div_5_Template, 22, 1, "div", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var AdminrhQuizComponent = class _AdminrhQuizComponent {
  ...
  static \u0275fac = function AdminrhQuizComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminrhQuizComponent)(\u0275\u0275directiveInject(QuizService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminrhQuizComponent, selectors: [["app-adminrh-quiz"]], decls: 13, vars: 5, consts: [[1, "container-fluid", "px-4"], [1, "d-flex", "justify-content-between", "align-items-center", "mb-4"], [1, "h3", "mb-0"], [1, "text-muted"], ["type", "button", 1, "btn", "btn-primary", 3, "routerLink"], [1, "fas", "fa-plus", "me-2"], ["class", "alert alert-danger alert-dismissible fade show", "role", "alert", 4, "ngIf"], ["class", "text-center py-5", 4, "ngIf"], ["class", "card", 4, "ngIf"], ["role", "alert", 1, "alert", "alert-danger", "alert-dismissible", "fade", "show"], ["type", "button", 1, "btn-close", 3, "click"], [1, "text-center", "py-5"], ["role", "status", 1, "spinner-border", "text-primary"], [1, "visually-hidden"], [1, "card"], [1, "card-header"], [1, "card-title", "mb-0"], ["class", "card-body text-center py-5", 4, "ngIf"], ["class", "table-responsive", 4, "ngIf"], [1, "card-body", "text-center", "py-5"], [1, "fas", "fa-question-circle", "fa-3x", "text-muted", "mb-3"], [1, "btn", "btn-primary", 3, "routerLink"], [1, "table-responsive"], [1, "table", "table-hover", "mb-0"], [1, "table-light"], ["width", "150"], [4, "ngFor", "ngForOf"], [1, "text-truncate", 2, "max-width", "200px", "display", "inline-block"], [1, "badge", "bg-light", "text-dark"], [4, "ngIf"], ["class", "text-muted", 4, "ngIf"], [1, "btn-group", "btn-group-sm"], ["type", "button", "title", "Voir le quiz", 1, "btn", "btn-outline-primary", 3, "routerLink"], [1, "fas", "fa-eye"], ["type", "button", "title", "Modifier", 1, "btn", "btn-outline-warning", 3, "routerLink"], [1, "fas", "fa-edit"], ["type", "button", "title", "Supprimer", 1, "btn", "btn-outline-danger", 3, "click"], [1, "fas", "fa-trash"]], template: function AdminrhQuizComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(10, AdminrhQuizComponent_div_10_Template, 3, 1, "div", 6)(11, AdminrhQuizComponent_div_11_Template, 4, 0, "div", 7)(12, AdminrhQuizComponent_div_12_Template, 6, 3, "div", 8);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
            ...
            <td>\r
              <div class="btn-group btn-group-sm">\r
                <button \r
                  ...
                  [routerLink]="['/quiz', quiz.id]"\r
                  title="Voir le quiz">\r
                  <i class="fas fa-eye"></i>\r
                </button>\r
                <button \r
                  type="button" \r
                  class="btn btn-outline-warning"\r
                  [routerLink]="['/quiz', quiz.id, 'edit']"\r
                  title="Modifier">\r
...
</div>`, styles: ["/* src/app/features/adminrh/adminrh-quiz/adminrh-quiz.component.scss */\n.badge-success {\n  background-color: #198754 !important;\n}\n.badge-secondary {\n  background-color: #6c757d !important;\n}\n.table th {\n  border-top: none;\n  font-weight: 600;\n  font-size: 0.875rem;\n  color: #6c757d;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n}\n.btn-group-sm .btn {\n  padding: 0.25rem 0.5rem;\n}\n.card-header {\n  background-color: #f8f9fa;\n  border-bottom: 1px solid #dee2e6;\n}\n.text-truncate {\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n.spinner-border {\n  width: 3rem;\n  height: 3rem;\n}\n/*# sourceMappingURL=adminrh-quiz.component.css.map */\n"] }]
  }], () => [{ type: QuizService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhQuizComponent, { className: "AdminrhQuizComponent", filePath: "src/app/features/adminrh/adminrh-quiz/adminrh-quiz.component.ts", lineNumber: 28 });
})();
export {
  AdminrhQuizComponent
};
//# sourceMappingURL=chunk-YKU6DUUU.js.map
