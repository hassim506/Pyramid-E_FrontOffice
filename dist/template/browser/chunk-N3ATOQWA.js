...
function InstructorDashboardComponent_Conditional_10_Conditional_121_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6, "Score satisfaction apprenant");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
var InstructorDashboardComponent = class _InstructorDashboardComponent {
  ...
  ngOnInit() {
    ...
    forkJoin({
      dash: this.http.get(`${environment.apiUrl}/formateur/dashboard/stats`, { headers: this.headers }).pipe(catchError(() => of(null))),
      formations: this.http.get(`${environment.apiUrl}/formateur/formations`, { headers: this.headers }).pipe(catchError(() => of({ formations: [] }))),
      sessions: this.http.get(`${environment.apiUrl}/sessions-formation?formateur_id=${uid}`, { headers: this.headers }).pipe(catchError(() => of({ sessions: [] }))),
      quiz: this.http.get(`${environment.apiUrl}/quiz-results`, { headers: this.headers }).pipe(catchError(() => of([]))),
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorDashboardComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-dashboard", imports: [CommonModule, RouterLink, NgApexchartsModule], template: `<!-- \u2500\u2500 HEADER \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
<div class="db-header">
  <div class="db-header__info">
    <div class="db-header__title">Tableau de bord \u2014 {{ displayName }}</div>
    <div class="db-header__sub">Vos indicateurs p\xE9dagogiques en temps r\xE9el</div>
  </div>
...
@if (loading) {
  ...
  <div class="db-charts-row">
    ...
    <!-- Compl\xE9tion par formation -->
    <div class="db-card db-card--chart">
      <div class="db-card__head">
        <i class="isax isax-book-1"></i>
        <span class="db-card__title">Compl\xE9tion par formation</span>
      ...
      @if (completionChart) {
        ...
        <div class="db-empty">Aucune donn\xE9e formation</div>
      }
    </div>

    <!-- Quiz r\xE9ussite vs abandon -->
    <div class="db-card db-card--chart db-card--narrow">
      <div class="db-card__head">
        <i class="isax isax-award"></i>
        <span class="db-card__title">R\xE9sultats quiz</span>
      </div>
      @if (quizChart) {
        <apx-chart
        ...
        <div class="db-empty">Aucun r\xE9sultat quiz</div>
      }
    </div>

  </div>

  <!-- \u2500\u2500 M\xC9TRIQUES D\xC9TAILL\xC9ES \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
  <div class="db-metrics-row">

    <!-- Indicateurs p\xE9dagogiques -->
    <div class="db-card">
      <div class="db-card__head">
        <i class="isax isax-chart-square"></i>
        <span class="db-card__title">Indicateurs p\xE9dagogiques</span>
      </div>
      <div class="db-metric-list">
        ...
        <div class="db-metric-item">
          <span class="db-metric-lbl">Taux compl\xE9tion cours</span>
          <div class="db-metric-bar-wrap">
            <div class="db-metric-bar">
        ...
        <div class="db-metric-item">
          <span class="db-metric-lbl">Score moyen \xE9valuations</span>
          <div class="db-metric-bar-wrap">
            <div class="db-metric-bar">
        ...
        <div class="db-metric-item">
          <span class="db-metric-lbl">Taux de r\xE9ussite</span>
          <div class="db-metric-bar-wrap">
            <div class="db-metric-bar">
              <div class="db-metric-fill"
    ...
    <!-- R\xE9sum\xE9 consultant -->
    <div class="db-card">
      <div class="db-card__head">
        <i class="isax isax-profile-circle"></i>
        <span class="db-card__title">R\xE9sum\xE9 consultant</span>
      </div>
  ...
  <!-- \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 -->
  <!--  NOUVEAUX INDICATEURS \u2014 donn\xE9es API centralis\xE9es              -->
  <!-- \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 -->

  <!-- \u2500\u2500 Qualit\xE9 & Satisfaction \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
  <div class="db-section-title">
    <i class="isax isax-star"></i> Qualit\xE9 & Satisfaction
  </div>
  ...
  <div class="db-kpi-grid db-kpi-grid--4">
    ...
    <div class="db-card db-card--metric">
      ...
      @if (statsLoading) {
        ...
        <div class="db-empty db-empty--sm">Non encore \xE9valu\xE9</div>
      }
    </div>
    ...
    <div class="db-card db-card--metric">
      ...
      @if (statsLoading) {
        ...
        <small class="text-muted">Score satisfaction apprenant</small>
      } @else {
        <div class="db-empty db-empty--sm">Pas de donn\xE9es</div>
      }
    </div>
    ...
    <!-- Progression avant / apr\xE8s -->
    <div class="db-card db-card--metric">
      <div class="db-card__head">
        <i class="isax isax-chart-2 text-primary"></i>
        <span class="db-card__title">Progression avant / apr\xE8s</span>
      </div>
      @if (statsLoading) {
        <div class="db-kpi-card--skeleton" style="height:48px;border-radius:8px;"></div>
      } @else {
        <div class="db-progress-compare">
          ...
          <div class="db-progress-compare__item">
            <span class="db-progress-compare__lbl">Apr\xE8s</span>
            <div class="db-metric-bar" style="flex:1; margin:0 8px;">
  ...
  <!-- \u2500\u2500 D\xE9lais & Performance op\xE9rationnelle \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
  <div class="db-section-title" style="margin-top:24px;">
    <i class="isax isax-clock"></i> D\xE9lais & Performance op\xE9rationnelle
  </div>
  ...
  <div class="db-kpi-grid db-kpi-grid--3">
    ...
    <div class="db-card db-card--metric">
      ...
      @if (statsLoading) {
        ...
        <small class="text-muted">D\xE9lai moyen apr\xE8s fin de session</small>
      } @else {
        <div class="db-empty db-empty--sm">Pas encore de donn\xE9es</div>
      }
    </div>

    <!-- D\xE9lai publication r\xE9sultats -->
    <div class="db-card db-card--metric">
      <div class="db-card__head">
        <i class="isax isax-send-2 text-success"></i>
        <span class="db-card__title">D\xE9lai de publication r\xE9sultats</span>
      </div>
      @if (statsLoading) {
        <div class="db-kpi-card--skeleton" style="height:48px;border-radius:8px;"></div>
    ...
    <!-- Nombre de sessions anim\xE9es (d\xE9tail) -->
    <div class="db-card db-card--metric">
      <div class="db-card__head">
        <i class="isax isax-calendar-tick text-blue"></i>
        <span class="db-card__title">Sessions anim\xE9es</span>
      </div>
      @if (statsLoading) {
        <div class="db-kpi-card--skeleton" style="height:48px;border-radius:8px;"></div>
      } @else {
        ...
        <div class="db-metric-list" style="margin-top:8px;">
          <div class="db-metric-item" style="margin-bottom:4px;">
            <span class="db-metric-lbl" style="font-size:11px;">Termin\xE9es</span>
            <span class="db-metric-val" style="font-size:11px; color:#22c55e;">
              {{ dashStats?.nb_sessions_terminees ?? 0 }}
            </span>
          </div>
          <div class="db-metric-item">
            <span class="db-metric-lbl" style="font-size:11px;">Apprenants (sessions)</span>
      ...
      <table class="db-table">
        ...
        <tbody>
          @if (!formations.length) {
            <tr><td colspan="4" class="db-empty-row">Aucune formation trouv\xE9e</td></tr>
          }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorDashboardComponent, { className: "InstructorDashboardComponent", filePath: "src/app/features/instructor/instructor-dashboard/instructor-dashboard.component.ts", lineNumber: 60 });
})();
export {
  InstructorDashboardComponent
};
//# sourceMappingURL=chunk-N3ATOQWA.js.map
