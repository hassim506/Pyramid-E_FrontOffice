...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhProfileComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-profile", imports: [CommonModule, ReactiveFormsModule, RouterModule], template: `<div class="content container-fluid">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhProfileComponent, { className: "AdminrhProfileComponent", filePath: "src/app/features/adminrh/adminrh-profile/adminrh-profile.component.ts", lineNumber: 19 });
})();
export {
  AdminrhProfileComponent
};
//# sourceMappingURL=chunk-PO2RTU43.js.map
