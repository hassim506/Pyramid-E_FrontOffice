...
function AdminrhSidebarComponent_div_39_span_14_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhSidebarComponent_div_39_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(13, "Sessions");
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, AdminrhSidebarComponent_div_39_span_14_Template, 2, 1, "span", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "a", 39);
    \u0275\u0275element(16, "i", 46);
...
function AdminrhSidebarComponent_span_45_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhSidebarComponent_div_47_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 48);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AdminrhSidebarComponent_div_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38)(1, "a", 39);
    \u0275\u0275element(2, "i", 49);
    ...
    \u0275\u0275text(4, "Formations");
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, AdminrhSidebarComponent_div_47_span_5_Template, 2, 1, "span", 23);
    \u0275\u0275elementEnd();
...
function AdminrhSidebarComponent_div_66_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38)(1, "a", 39);
    \u0275\u0275element(2, "i", 35);
    \u0275\u0275text(3, " Personnaliser le mod\xE8le ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "a", 39);
    \u0275\u0275element(5, "i", 25);
    \u0275\u0275text(6, " Certificats obtenus ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AdminrhSidebarComponent_div_77_a_4_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhSidebarComponent_div_77_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AdminrhSidebarComponent_div_77_a_4_Template, 3, 1, "a", 51);
    \u0275\u0275elementStart(5, "a", 39);
    \u0275\u0275element(6, "i", 52);
    \u0275\u0275text(7, " R\xF4les ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "a", 39);
    \u0275\u0275element(9, "i", 53);
...
var AdminrhSidebarComponent = class _AdminrhSidebarComponent {
  ...
  constructor(common, authService, demandeService, sessionService, router) {
    this.common = common;
  ...
  loadBadgeCounts() {
    ...
    this.sessionService.getAllSessionsRH().subscribe({
      next: (res) => {
        ...
        this.sessionsAVenirCount = (res.sessions || []).filter((s) => s.date_debut != null && new Date(s.date_debut) > today).length;
      },
      error: () => {
      }
    });
  ...
  static \u0275fac = function AdminrhSidebarComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminrhSidebarComponent)(\u0275\u0275directiveInject(CommonService), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(DemandeFormationService), \u0275\u0275directiveInject(SessionFormationService), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminrhSidebarComponent, selectors: [["app-adminrh-sidebar"]], decls: 108, vars: 27, consts: [[1, "sb-shell"], [1, "sb-logo"], [1, "sb-logo-mark"], [1, "sb-logo-text"], [1, "sb-logo-sub"], [1, "sb-user"], [1, "sb-av"], [1, "sb-uname"], [1, "sb-urole"], [1, "sb-scroll"], [1, "sb-section"], [1, "sb-section-label"], ["routerLinkActive", "active", 1, "sb-item", 3, "routerLink"], [1, "isax", "isax-grid-3"], [1, "sb-item-label"], [1, "isax", "isax-volume-high"], [1, "sb-divider"], [1, "sb-group"], [1, "sb-group-header", 3, "click"], [1, "isax", "isax-play-circle", "icon"], [1, "isax", "isax-arrow-right-3", "arr"], ["class", "sb-sub", 4, "ngIf"], [1, "isax", "isax-document-text", "icon"], ["class", "sb-badge sb-badge--red", 4, "ngIf"], [1, "isax", "isax-clipboard-text"], [1, "isax", "isax-award"], [1, "isax", "isax-medal-star"], [1, "isax", "isax-note-21", "icon"], [1, "isax", "isax-profile-2user", "icon"], [1, "isax", "isax-building"], [1, "isax", "isax-receipt-item"], [1, "isax", "isax-ticket"], [1, "sb-bottom"], ["routerLinkActive", "active", 1, "sb-bottom-item", 3, "routerLink"], [1, "isax", "isax-user-square"], [1, "isax", "isax-setting-2"], [1, "sb-bottom-item", "logout", 3, "routerLink"], [1, "isax", "isax-logout"], [1, "sb-sub"], ["routerLinkActive", "active", 1, "sb-sub-item", 3, "routerLink"], [1, "isax", "isax-book-1"], [1, "isax", "isax-category"], [1, "isax", "isax-route-square"], [1, "isax", "isax-calendar-1"], [1, "sb-sub-label"], ["class", "sb-badge sb-badge--amber", 4, "ngIf"], [1, "isax", "isax-tag"], [1, "sb-badge", "sb-badge--amber"], [1, "sb-badge", "sb-badge--red"], [1, "isax", "isax-document-text"], [1, "isax", "isax-people"], ["routerLinkActive", "active", "class", "sb-sub-item", 3, "routerLink", 4, "ngIf"], [1, "isax", "isax-shield-tick"], [1, "isax", "isax-lock"], [1, "isax", "isax-profile-2user"]], template: function AdminrhSidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(38, "i", 20);
      \u0275\u0275elementEnd();
      \u0275\u0275template(39, AdminrhSidebarComponent_div_39_Template, 18, 6, "div", 21);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(45, AdminrhSidebarComponent_span_45_Template, 2, 1, "span", 23);
      \u0275\u0275element(46, "i", 20);
      \u0275\u0275elementEnd();
      \u0275\u0275template(47, AdminrhSidebarComponent_div_47_Template, 16, 5, "div", 21);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(48, "a", 12);
      \u0275\u0275element(49, "i", 24);
      \u0275\u0275elementStart(50, "span", 14);
      \u0275\u0275text(51, "Assignments");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(52, "a", 12);
      \u0275\u0275element(53, "i", 25);
      \u0275\u0275elementStart(54, "span", 14);
      \u0275\u0275text(55, "Quiz");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(56, "a", 12);
      \u0275\u0275element(57, "i", 26);
      \u0275\u0275elementStart(58, "span", 14);
      \u0275\u0275text(59, "R\xE9sultats Quiz");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(60, "div", 17)(61, "div", 18);
      \u0275\u0275listener("click", function AdminrhSidebarComponent_Template_div_click_61_listener() {
        return ctx.toggleGroup("certificats");
      });
      \u0275\u0275element(62, "i", 27);
      \u0275\u0275elementStart(63, "span");
      \u0275\u0275text(64, "Certificats");
      \u0275\u0275elementEnd();
      \u0275\u0275element(65, "i", 20);
      \u0275\u0275elementEnd();
      \u0275\u0275template(66, AdminrhSidebarComponent_div_66_Template, 7, 2, "div", 21);
      \u0275\u0275elementEnd()();
      \u0275\u0275element(67, "div", 16);
      \u0275\u0275elementStart(68, "div", 10)(69, "div", 11);
      \u0275\u0275text(70, "Utilisateurs & acc\xE8s");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(71, "div", 17)(72, "div", 18);
      \u0275\u0275listener("click", function AdminrhSidebarComponent_Template_div_click_72_listener() {
        return ctx.toggleGroup("utilisateurs");
      });
      \u0275\u0275element(73, "i", 28);
      \u0275\u0275elementStart(74, "span");
      \u0275\u0275text(75, "Gestion utilisateurs");
      \u0275\u0275elementEnd();
      \u0275\u0275element(76, "i", 20);
      \u0275\u0275elementEnd();
      \u0275\u0275template(77, AdminrhSidebarComponent_div_77_Template, 11, 4, "div", 21);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(78, "a", 12);
      \u0275\u0275element(79, "i", 29);
      \u0275\u0275elementStart(80, "span", 14);
      \u0275\u0275text(81, "Entreprises");
      \u0275\u0275elementEnd()()();
      \u0275\u0275element(82, "div", 16);
      ...
      \u0275\u0275text(97, "Tickets support");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(98, "div", 32)(99, "a", 33);
      \u0275\u0275element(100, "i", 34);
      \u0275\u0275text(101, " Mon profil ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(102, "a", 33);
      \u0275\u0275element(103, "i", 35);
      \u0275\u0275text(104, " Param\xE8tres ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(105, "a", 36);
      \u0275\u0275element(106, "i", 37);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(5);
      \u0275\u0275classProp("open", ctx.openGroups["certificats"]);
      \u0275\u0275advance(5);
      \u0275\u0275property("ngIf", ctx.openGroups["certificats"]);
      \u0275\u0275advance(6);
...
(() => {
  ...
  <div class="sb-scroll">
    ...
    <div class="sb-section">
      ...
      <div class="sb-group">
        ...
        <div class="sb-sub" *ngIf="openGroups['formations']">
          ...
          <a [routerLink]="routes.adminrhSession" routerLinkActive="active" class="sb-sub-item">
            ...
            <span class="sb-sub-label">Sessions</span>
      ...
      <!-- Certificats -->
      <div class="sb-group">
        <div class="sb-group-header" [class.open]="openGroups['certificats']"
             (click)="toggleGroup('certificats')">
          <i class="isax isax-note-21 icon"></i>
          <span>Certificats</span>
          <i class="isax isax-arrow-right-3 arr"></i>
        </div>
        <div class="sb-sub" *ngIf="openGroups['certificats']">
          <a [routerLink]="routes.adminrhCertificateModele" routerLinkActive="active" class="sb-sub-item">
            <i class="isax isax-setting-2"></i> Personnaliser le mod\xE8le
          </a>
          <a [routerLink]="routes.adminrhCertificate" routerLinkActive="active" class="sb-sub-item">
            <i class="isax isax-award"></i> Certificats obtenus
          </a>
        </div>
      </div>
    </div>
...
`, styles: ["/* src/app/features/adminrh/common/adminrh-sidebar/adminrh-sidebar.component.scss */\n:host {\n  display: block;\n  padding: 0 !important;\n}\n.sb-shell {\n  background: #0F172A;\n  display: flex;\n  flex-direction: column;\n  min-height: calc(100vh - 80px);\n  overflow: hidden;\n  border-radius: 12px;\n  margin-bottom: 24px;\n}\n.sb-logo {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 18px 16px 14px;\n  border-bottom: 0.5px solid rgba(255, 255, 255, 0.08);\n  flex-shrink: 0;\n}\n.sb-logo-mark {\n  width: 32px;\n  height: 32px;\n  border-radius: 8px;\n  background: #1D9E75;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 14px;\n  font-weight: 500;\n  color: #fff;\n  flex-shrink: 0;\n}\n.sb-logo-text {\n  font-size: 14px;\n  font-weight: 500;\n  color: #fff;\n}\n.sb-logo-sub {\n  font-size: 10px;\n  color: rgba(255, 255, 255, 0.3);\n  margin-top: 1px;\n}\n.sb-user {\n  display: flex;\n  align-items: center;\n  gap: 9px;\n  padding: 10px;\n  margin: 10px 10px 4px;\n  border-radius: 8px;\n  background: rgba(255, 255, 255, 0.06);\n  flex-shrink: 0;\n}\n.sb-av {\n  width: 30px;\n  height: 30px;\n  border-radius: 50%;\n  background: #534AB7;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 11px;\n  font-weight: 500;\n  color: #CECBF6;\n  flex-shrink: 0;\n}\n.sb-uname {\n  font-size: 12px;\n  font-weight: 500;\n  color: #fff;\n}\n.sb-urole {\n  font-size: 10px;\n  color: rgba(255, 255, 255, 0.3);\n}\n.sb-scroll {\n  flex: 1;\n  overflow-y: auto;\n  overflow-x: hidden;\n  padding: 6px 0 10px;\n}\n.sb-scroll::-webkit-scrollbar {\n  width: 3px;\n}\n.sb-scroll::-webkit-scrollbar-track {\n  background: transparent;\n}\n.sb-scroll::-webkit-scrollbar-thumb {\n  background: rgba(255, 255, 255, 0.15);\n  border-radius: 3px;\n}\n.sb-section {\n  margin-bottom: 4px;\n}\n.sb-section-label {\n  font-size: 10px;\n  font-weight: 500;\n  color: rgba(255, 255, 255, 0.3);\n  text-transform: uppercase;\n  letter-spacing: 0.07em;\n  padding: 10px 18px 4px;\n}\n.sb-divider {\n  height: 0.5px;\n  background: rgba(255, 255, 255, 0.08);\n  margin: 6px 14px;\n}\n.sb-item {\n  display: flex;\n  align-items: center;\n  gap: 9px;\n  padding: 7px 14px;\n  margin: 1px 8px;\n  border-radius: 8px;\n  cursor: pointer;\n  color: rgba(255, 255, 255, 0.6);\n  font-size: 13px;\n  text-decoration: none;\n  transition: background 0.12s, color 0.12s;\n}\n.sb-item i {\n  font-size: 16px;\n  flex-shrink: 0;\n}\n.sb-item:hover {\n  background: rgba(255, 255, 255, 0.07);\n  color: rgba(255, 255, 255, 0.9);\n}\n.sb-item.active {\n  background: #1D4ED8;\n  color: #fff;\n}\n.sb-item.active i {\n  color: #fff;\n}\n.sb-item-label {\n  flex: 1;\n}\n.sb-badge {\n  font-size: 10px;\n  padding: 2px 7px;\n  border-radius: 20px;\n  background: rgba(255, 255, 255, 0.12);\n  color: rgba(255, 255, 255, 0.7);\n  font-weight: 500;\n  flex: none;\n  width: fit-content;\n  line-height: 1.4;\n}\n.sb-badge.notif {\n  background: #DC2626;\n  color: #fff;\n}\n.sb-badge--red {\n  background: #DC2626;\n  color: #fff;\n}\n.sb-badge--amber {\n  background: #D97706;\n  color: #fff;\n}\n.sb-sub-label {\n  flex: 1;\n}\n.sb-group {\n  margin: 1px 8px;\n}\n.sb-group-header {\n  display: flex;\n  align-items: center;\n  gap: 9px;\n  padding: 7px 6px;\n  border-radius: 8px;\n  cursor: pointer;\n  color: rgba(255, 255, 255, 0.6);\n  font-size: 13px;\n  transition: color 0.12s;\n}\n.sb-group-header:hover {\n  color: rgba(255, 255, 255, 0.9);\n}\n.sb-group-header.open {\n  color: rgba(255, 255, 255, 0.9);\n}\n.sb-group-header i.icon {\n  font-size: 16px;\n  flex-shrink: 0;\n}\n.sb-group-header span:not(.sb-badge) {\n  flex: 1;\n}\n.sb-group-header i.arr {\n  font-size: 12px;\n  transition: transform 0.15s;\n}\n.sb-group-header.open i.arr {\n  transform: rotate(90deg);\n}\n.sb-sub {\n  padding-left: 10px;\n  border-left: 0.5px solid rgba(255, 255, 255, 0.1);\n  margin: 2px 0 4px 22px;\n}\n.sb-sub-item {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  padding: 5px 8px;\n  border-radius: 8px;\n  cursor: pointer;\n  color: rgba(255, 255, 255, 0.5);\n  font-size: 12px;\n  text-decoration: none;\n  transition: background 0.1s, color 0.1s;\n}\n.sb-sub-item i {\n  font-size: 14px;\n}\n.sb-sub-item:hover {\n  color: rgba(255, 255, 255, 0.85);\n  background: rgba(255, 255, 255, 0.05);\n}\n.sb-sub-item.active {\n  color: #93C5FD;\n}\n.sb-bottom {\n  padding: 10px 10px 14px;\n  border-top: 0.5px solid rgba(255, 255, 255, 0.08);\n  flex-shrink: 0;\n}\n.sb-bottom-item {\n  display: flex;\n  align-items: center;\n  gap: 9px;\n  padding: 7px 8px;\n  border-radius: 8px;\n  cursor: pointer;\n  color: rgba(255, 255, 255, 0.5);\n  font-size: 12px;\n  text-decoration: none;\n  transition: background 0.12s, color 0.12s;\n}\n.sb-bottom-item i {\n  font-size: 15px;\n}\n.sb-bottom-item:hover {\n  background: rgba(255, 255, 255, 0.07);\n  color: rgba(255, 255, 255, 0.8);\n}\n.sb-bottom-item.active {\n  color: rgba(255, 255, 255, 0.85);\n}\n.sb-bottom-item.logout {\n  color: rgba(220, 38, 38, 0.7);\n}\n.sb-bottom-item.logout:hover {\n  background: rgba(220, 38, 38, 0.1);\n  color: #FCA5A5;\n}\n/*# sourceMappingURL=adminrh-sidebar.component.css.map */\n"] }]
  }], () => [{ type: CommonService }, { type: AuthService }, { type: DemandeFormationService }, { type: SessionFormationService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhSidebarComponent, { className: "AdminrhSidebarComponent", filePath: "src/app/features/adminrh/common/adminrh-sidebar/adminrh-sidebar.component.ts", lineNumber: 16 });
})();
...
//# sourceMappingURL=chunk-O7OGKO3O.js.map
