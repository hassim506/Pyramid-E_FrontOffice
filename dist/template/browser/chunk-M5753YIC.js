...
import {
  FooterComponent
} from "./chunk-TO2JIKAN.js";
import "./chunk-NVY3W4TG.js";
import {
  require_aos
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HomeComponent, [{
    type: Component,
    args: [{ selector: "app-home", imports: [CommonModule, FooterComponent, RouterLink, SlickCarouselModule, LightgalleryModule], encapsulation: ViewEncapsulation.None, template: `<!-- banner -->
  ...
  <div class="container" style="margin-left: 50px;margin-top:10px;">
    <div class="row align-items-center justify-content-between">
      <div class="col-xl-7 col-lg-7">
        <div class="banner-content pe-xxl-5" style="margin-left: -15px !important;">
          <span class="hero-title">avec Pyramide</span>
          <h1 class="mb-4 text-white"> Formez vos talents
             <span>Transformez</span> votre 
            <span>entreprise</span> 
          </h1>
          <p class="fs-lg text-center text-md-start pb-2 pb-md-3 mb-4">
           D\xE9veloppez les comp\xE9tences qui font avancer votre entreprise
          </p>
          <form class="banner-search" (ngSubmit)="onSubmit()">
            <div class="dropdown">
              <a class="hero-dropdown" href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false">
                S\xE9lectionner une Cat\xE9gorie <i class="isax isax-arrow-down5 fs-12"></i>
              </a>
              <ul class="dropdown-menu p-1">
                <li><a class="dropdown-item" href="javascript:void(0);">Management</a></li>
                <li><a class="dropdown-item" href="javascript:void(0);">D\xE9veloppement</a></li>
                <li><a class="dropdown-item" href="javascript:void(0);">Marketing Digital</a></li>
                <li><a class="dropdown-item" href="javascript:void(0);">Finance</a></li>
                <li><a class="dropdown-item" href="javascript:void(0);">Ressources Humaines</a></li>
              </ul>
            </div>
            <input type="text" name="search" class="border-0 form-control p-0"
              placeholder="Rechercher des formations, des formateurs..." />
            ...
            <div class="counter-item">
              ...
              <div class="count-content">
                <h5 class="text-skyblue">
                  <span class="count-digit">200</span>+
                </h5>
            ...
            <div class="counter-item">
              ...
              <div class="count-content">
                <h5 class="text-success">
                  <span class="count-digit">150</span>+
                </h5>
                <p>Formateurs Certifi\xE9s</p>
              </div>
            </div>
          </div> -->
        </div>
          ...
          <div class="swiper swiper-slider-banner w-auto">
            <div class="swiper-wrapper">
              <div class="swiper swiper-cards swiper-3d swiper-initialized swiper-horizontal swiper-pointer-events swiper-watch-progress" >
                <div class="swiper-wrapper">
                  <div class="swiper-slide ng-star-inserted swiper-slide-visible swiper-slide-active" style="z-index: 3; transform: translate3d(0px, 0px, 0px) rotateZ(0deg) scale(1);">
                      ...
                      <div class="course-item-two course-item mb-0">
                        <div class="course-img">
                          ...
                          <div class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                            <a href="javascript:void(0);" class="fav-icon" [ngClass]="{'selected':isSelected[1]}" (click)="iconSelect(1)">
                        ...
                        <div class="course-content">
                          <div class="d-flex justify-content-between mb-2">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="ms-2">
                                <a href="javascript:void(0);" class="link-default fs-14">Amadou Diallo</a>
                              </div>
                            </div>
                            <span
                          ...
                          <h6 class="mb-2">
                            <a [routerLink]="routes.courseDetails">Formation Compl\xE8te en Gestion d'Entreprise</a>
                          </h6>
                          ...
                          <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a [routerLink]="routes.cart" class="btn btn-dark btn-sm d-inline-flex align-items-center">Ajouter<i
                  ...
                  <div class="swiper-slide ng-star-inserted swiper-slide-visible swiper-slide-next" style="z-index: 2; transform: translate3d(calc(7.25032% - 321px), 0px, -100.005px) rotateZ(2.0001deg) scale(1);">
                    <div class="swiper-slide">
                      <div class="course-item-two course-item mb-0">
                        <div class="course-img">
                        ...
                        <div class="course-content">
                          <div class="d-flex justify-content-between mb-2">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="ms-2">
                                <a href="javascript:void(0);" class="link-default fs-14">Fatou Ndiaye</a>
                              </div>
                            </div>
                            <span
                              class="badge badge-light rounded-pill bg-light d-inline-flex align-items-center fs-13 fw-medium">
                          ...
                          <h6 class="mb-2">
                            <a [routerLink]="routes.courseDetails">Marketing Digital pour Entreprises Africaines</a>
                          </h6>
                          <p class="d-flex align-items-center mb-3">
                            <i class="ti ti-star-filled text-warning me-2"></i>
                            4.9
                  ...
                  <div class="swiper-slide " style="z-index: 1; transform: translate3d(calc(13.0005% - 642px), 0px, -200.01px) rotateZ(4.0002deg) scale(1); transition-duration: 0ms;">
                    <div class="swiper-slide">
                      <div class="course-item-two course-item mb-0">
                        <div class="course-img">
                        ...
                        <div class="course-content">
                          <div class="d-flex justify-content-between mb-2">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="ms-2">
                                <a href="javascript:void(0);" class="link-default fs-14">Koffi Mensah</a>
                              </div>
                            </div>
                            <span
                              class="badge badge-light rounded-pill bg-light d-inline-flex align-items-center fs-13 fw-medium">
                          ...
                          <h6 class="mb-2">
                            <a [routerLink]="routes.courseDetails">Gestion Financi\xE8re pour PME</a>
                          </h6>
                          <p class="d-flex align-items-center mb-3">
                            <i class="ti ti-star-filled text-warning me-2"></i>
                            4.7
...
<section class="benefit-section">
  <div class="container">
    <div class="section-header text-center">
      <span class="fw-medium text-secondary text-decoration-underline mb-2 d-inline-block">Nos Avantages</span>
      <h2>Suivez la progression et les performances par employ\xE9, service ou entreprise</h2>
      <p>
        La bonne formation, guid\xE9e par un expert, peut vous fournir des connaissances inestimables 
        et des comp\xE9tences pratiques pour r\xE9ussir.
      </p>
    </div>
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="card shadow-sm">
          <div class="card-body p-4">
            ...
            <h5 class="mt-3 mb-1">\u{1F7E2} Flexibilit\xE9 & Organisation</h5>
            <p>
              Cr\xE9ez des sessions adapt\xE9es \xE0 vos besoins m\xE9tier
              Formations en pr\xE9sentiel, e-learning ou hybrides
              Affectation simple des employ\xE9s aux session
              Un syst\xE8me flexible qui s\u2019adapte \xE0 votre organisation
            </p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6">
        <div class="card shadow-sm">
          <div class="card-body p-4">
            ...
            <h5 class="mt-3 mb-1">\u{1F7E0} Formateurs & Consultants</h5>
            <p>
                Collaborez facilement avec des formateurs internes ou externes
                Un m\xEAme formateur peut intervenir dans plusieurs entreprises
                Gestion claire des sessions, participants et \xE9valuations
                Un espace d\xE9di\xE9 pour les formateurs
            </p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6">
        <div class="card shadow-sm">
          <div class="card-body p-4">
            ...
            <h5 class="mt-3 mb-1">\u{1F7E3} Exp\xE9rience Employ\xE9</h5>
            <p>
              Une interface simple et intuitive pour vos collaborateurs
              Acc\xE8s rapide aux formations et aux certificats
              Inscription facile et suivi personnalis\xE9
              Valorisez les comp\xE9tences acquises
            </p>
          </div>
        </div>
      </div>
       <div class="col-lg-4 col-md-6">
        <div class="card shadow-sm">
          <div class="card-body p-4">
            ...
            <h5 class="mt-3 mb-1">\u{1F534} Certification & Tra\xE7abilit\xE9</h5>
            <p>
              Certificats s\xE9curis\xE9s et v\xE9rifiables
              Historique complet des formations suivies
              Tra\xE7abilit\xE9 conforme aux exigences r\xE9glementaires
              Gestion des certificats avec dates d\u2019expiration
            </p>
          </div>
        </div>
      </div>
       <div class="col-lg-4 col-md-6">
        <div class="card shadow-sm">
          <div class="card-body p-4">
            ...
            <h5 class="mt-3 mb-1">\u{1F7E1} S\xE9curit\xE9 & Fiabilit\xE9</h5>
            <p>
              Donn\xE9es s\xE9curis\xE9es et cloisonn\xE9es par entreprise
              Gestion fine des r\xF4les et des permissions
              Respect des bonnes pratiques de s\xE9curit\xE9
              Plateforme fiable et \xE9volutive
            </p>
          </div>
        </div>
      </div>
       <div class="col-lg-4 col-md-6">
        <div class="card shadow-sm">
          <div class="card-body p-4">
            ...
            <div class="p-4 rounded-pill bg-skyblue-transparent d-inline-flex">
              <i class="isax isax-clock-1 fs-24"></i>
            </div>
            <h5 class="mt-3 mb-1">\u26A1 Gain de temps & Performance</h5>
            <p>
              R\xE9duisez la charge administrative des RH
              Automatisez les inscriptions et la g\xE9n\xE9ration des certificats
              Acc\xE9l\xE9rez la mont\xE9e en comp\xE9tences de vos \xE9quipes
              Concentrez-vous sur l\u2019essentiel : la performance
            </p>
          </div>
        </div>
      </div>
...
<section class="client-section">
  <div class="container">
    <h6 class="fw-medium text-center mb-4">
      Approuv\xE9 par
      <span class="text-decoration-underline text-secondary">200+</span>
      Entreprises \xE0 Travers l'Afrique
    </h6>
...
<section class="top-courses-sec">
  ...
  <div class="container">
    <div class="section-header text-center">
      <span class="fw-medium text-secondary text-decoration-underline mb-2 d-inline-block">Nos Cat\xE9gories</span>
      <h2>Formations & Cat\xE9gories </h2>
      <p>
       Cat\xE9goriser vos formations pour une navigation facile et une meilleure organisation.
      </p>
    </div>
      ...
      <ngx-slick-carousel #slickModal="slick-carousel" [config]="topCourseSlider">
        <div ngxSlickItem>
          <div class="categories-item categories-item-three mb-0">
            ...
            <h6 class="title">
              <a [routerLink]="routes.courseCategory">Management</a>
            </h6>
          </div>
        </div>
        <div ngxSlickItem>
          <div class="categories-item categories-item-three mb-0">
            ...
            <h6 class="title">
              <a [routerLink]="routes.courseCategory">Ressources Humaines</a>
            </h6>
          </div>
        </div>
        <div ngxSlickItem>
          <div class="categories-item categories-item-three mb-0">
            ...
            <h6 class="title">
              <a [routerLink]="routes.courseCategory">Marketing Digital</a>
            </h6>
          </div>
        </div>
        <div ngxSlickItem>
          <div class="categories-item categories-item-three mb-0">
            ...
            <h6 class="title">
              <a [routerLink]="routes.courseCategory">Finance & Comptabilit\xE9</a>
            </h6>
          </div>
        </div>
        <div ngxSlickItem>
          <div class="categories-item categories-item-three mb-0">
            ...
            <h6 class="title">
              <a [routerLink]="routes.courseCategory">Leadership</a>
            </h6>
          </div>
        </div>
        <div ngxSlickItem>
          <div class="categories-item categories-item-three mb-0">
            ...
            <h6 class="title">
              <a [routerLink]="routes.courseCategory">D\xE9veloppement Web</a>
            </h6>
          </div>
        </div>
      </ngx-slick-carousel>
    </div>
    <a [routerLink]="routes.courseCategory" class="btn btn-primary btn-md">Voir Toutes les Cat\xE9gories</a>
  </div>
</section>
<!-- /top courses -->
  ...
  <div class="container">
    ...
    <div class="trust-content">
      ...
      <div class="row justify-content-between">
        <div class="col-md-4">
          <h4>
            Approuv\xE9 par 5.000+ entreprises et apprenants satisfaits depuis 2020
          </h4>
          <div class="d-flex align-items-center flex-wrap mt-5 gap-2">
            <a [routerLink]="routes.login" class="btn btn-secondary">S'inscrire comme Apprenant</a>
            <a [routerLink]="routes.becomeAnExpert" class="btn btn-dark">Devenir Formateur</a>
          </div>
        </div>
        <div class="col-md-7">
          <div class="row">
            <div class="col-md-6">
              <h4 class="text-white mb-2">4.9/5</h4>
              <h5 class="text-white mb-2">Note de Satisfaction</h5>
              <p class="text-white mb-5">
                Un taux de satisfaction exceptionnel qui t\xE9moigne de la qualit\xE9 de nos formations.
              </p>
            </div>
            <div class="col-md-6">
              <h4 class="text-white mb-2">5000+</h4>
              <h5 class="text-white mb-2">Apprenants Satisfaits en Afrique</h5>
              <p class="text-white mb-5">
                Des milliers de professionnels africains ont transform\xE9 leur carri\xE8re gr\xE2ce \xE0 Pyramide.
              </p>
            </div>
          </div>
          <div class="d-flex align-items-center bg-white user-goal p-2">
            ...
            <p class="text-gray-9 mb-0">
              "Toutes les formations sont incroyablement utiles pour atteindre vos objectifs professionnels"
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="me-5" data-aos="fade-up">
          <img src="assets/img/feature/how-it-work.jpg" class="img-fluid rounded-5" alt="img" />
        </div>
      </div>
      <div class="col-lg-6">
        <div class="how-it-works-content aos" data-aos="fade-up">
          <div class="section-header">
            <span class="fw-medium text-secondary text-decoration-underline mb-2 d-inline-block">Comment \xE7a marche</span>
            <h2 class="mb-1">Comment \xE7a marche ?</h2>
            <p>
              D\xE9ployez la formation en entreprise en toute simplicit\xE9
            </p>
          </div>
          <div class="d-flex align-items-center works-items">
            <span class="count">01</span>
            <div>
              <h5 class="mb-1">Cr\xE9ez vos sessions de formation</h5>
              <p>
                Une fois sur la page d'accueil du site, recherchez le bouton S'inscrire, Enregistrer ou Cr\xE9er un compte.
          ...
          <div class="d-flex align-items-center works-items">
            ...
            <div>
              <h5 class="mb-1">Affectez vos collaborateurs</h5>
              <p>
          ...
          <div class="d-flex align-items-center works-items">
            ...
            <div>
              <h5 class="mb-1">Suivez la progression et certifiez les comp\xE9tences</h5>
              <p>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="ps-0 ps-lg-2 pt-4 pt-lg-0 ps-xl-5">
                    <div class="section-header">
                        <span class="fw-medium text-secondary text-decoration-underline mb-2 d-inline-block">A propos</span>
                        <h2>A propos de nous</h2>
                        <p>Nous accompagnons les entreprises dans la structuration, le suivi et la certification des formations professionnelles gr\xE2ce \xE0 une plateforme digitale pens\xE9e pour les enjeux RH.</p>
                    </div>
                    <div class="d-flex align-items-center about-us-banner">
                        ...
                        <div class="ps-3">
                            <h6 class="mb-2">Apprenez de n'importe o\xF9</h6>
                            <p>L'apprentissage de n'importe o\xF9 est devenu un aspect transformateur de l'\xE9ducation moderne, permettant aux individus.</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center about-us-banner">
                        <div>
                        ...
                        <div class="ps-3">
                            <h6 class="mb-2">Mentors Experts</h6>
                            <p>Les mentors experts sont des atouts inestimables dans tout domaine, fournissant des conseils et des connaissances exp\xE9riment\xE9es.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Les autres sections continuent avec la m\xEAme traduction... -->
<!-- Je continue si vous le souhaitez -->

  <app-footer></app-footer>`, styles: ['/* src/app/features/home-list/home/home.component.scss */\n.banner-section {\n  background: url("./media/home-bg-white.png") no-repeat center center fixed;\n  padding: auto;\n  background-size: cover;\n  width: 100%;\n  height: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.banner-section {\n  position: relative;\n  background-color: #006F78 !important;\n  padding: 323px 0 80px;\n  z-index: 0;\n  overflow: hidden;\n}\n/*# sourceMappingURL=home.component.css.map */\n'] }]
  }], () => [{ type: DataService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HomeComponent, { className: "HomeComponent", filePath: "src/app/features/home-list/home/home.component.ts", lineNumber: 33 });
})();
export {
  HomeComponent
};
...
lightgallery/plugins/video/lg-video.es5.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-M5753YIC.js.map
