...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(StudentSondageComponent, [{
    type: Component,
    args: [{ selector: "app-student-sondage", standalone: true, imports: [CommonModule, FormsModule], template: `<!-- Loading -->
...
<div *ngIf="!loading && submitted" class="ss-submitted-wrap">
  <div class="ss-submitted-card">
    ...
    <h2 class="ss-submitted-title">Merci pour vos r\xE9ponses !</h2>
    <p class="ss-submitted-sub" *ngIf="sondage?.message_fin">{{ sondage?.message_fin }}</p>
    <p class="ss-submitted-sub" *ngIf="!sondage?.message_fin">
      Votre sondage a bien \xE9t\xE9 envoy\xE9. Vos r\xE9ponses nous aideront \xE0 am\xE9liorer nos formations.
    </p>
...
<div *ngIf="!loading && !error && !submitted && sondage" class="ss-wrap">
  ...
  <div class="ss-nav">
    <button class="ss-btn ss-btn--ghost" (click)="goPrev()" [disabled]="currentStep === 0">
      <i class="isax isax-arrow-left-2 me-2"></i> Pr\xE9c\xE9dent
    </button>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StudentSondageComponent, { className: "StudentSondageComponent", filePath: "src/app/features/student/student-sondage/student-sondage.component.ts", lineNumber: 15 });
})();
export {
  StudentSondageComponent
};
//# sourceMappingURL=chunk-424H5MVZ.js.map
