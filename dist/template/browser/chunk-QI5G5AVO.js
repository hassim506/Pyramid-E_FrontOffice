...
function AdminrhDemandeComponent_div_94_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(30, AdminrhDemandeComponent_div_94_div_1_button_30_Template, 4, 3, "button", 67)(31, AdminrhDemandeComponent_div_94_div_1_button_31_Template, 4, 3, "button", 68)(32, AdminrhDemandeComponent_div_94_div_1_button_32_Template, 4, 0, "button", 69);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhDemandeComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-demande", standalone: true, imports: [RouterLink, FormsModule, CommonModule, MatSortModule, CustomPaginationComponent], template: `<div class="page">\r
\r
  <!-- Page Header -->\r
  <div class="page-header">\r
    <div class="page-header__left">\r
      <h1>Demandes de formation</h1>\r
      <p>G\xE9rez et traitez toutes les demandes de formation de votre entreprise</p>\r
    </div>\r
...
\r
  ...
  <div class="kpi-row">\r
    ...
    <div class="kpi">\r
      <div class="kpi__icon ki-blue"><i class="isax isax-document"></i></div>\r
      <div class="kpi__body">\r
        <div class="kpi__label">Total</div>\r
        <div class="kpi__val">{{ totalDemandes }}</div>\r
        <div class="kpi__delta">demandes</div>\r
      </div>\r
    </div>\r
  </div>\r
\r
...
\r
    <!-- Tab bar -->\r
    <div class="tab-bar">\r
      <button type="button" class="tab" [class.active]="activeTab === 'tous'" (click)="setTab('tous')">\r
        Toutes <span class="tab-count">{{ tabCounts.tous }}</span>\r
      </button>\r
      <button type="button" class="tab" [class.active]="activeTab === 'formation'" (click)="setTab('formation')">\r
        Formations <span class="tab-count">{{ tabCounts.formation }}</span>\r
      </button>\r
      <button type="button" class="tab" [class.active]="activeTab === 'parcours'" (click)="setTab('parcours')">\r
        Parcours <span class="tab-count">{{ tabCounts.parcours }}</span>\r
      </button>\r
      <button type="button" class="tab" [class.active]="activeTab === 'catalogue'" (click)="setTab('catalogue')">\r
        Catalogues <span class="tab-count">{{ tabCounts.catalogue }}</span>\r
      </button>\r
    </div>\r
\r
    <!-- Toolbar -->\r
...
\r
    ...
    <div *ngIf="!loading && !hasData" class="empty-state">\r
      ...
      <p>Aucune demande de formation</p>\r
    </div>\r
\r
    <!-- Demande list -->\r
...
\r
        ...
        <div class="d-left">\r
          ...
          <div class="d-type-line"\r
               [class.tl-form]="d.type_demande === 'formation'"\r
               [class.tl-parc]="d.type_demande === 'parcours'"\r
               [class.tl-cat]="d.type_demande === 'catalogue'">\r
          </div>\r
        </div>\r
\r
        <!-- Body -->\r
...
\r
          <div class="d-title">\r
            <ng-container *ngIf="d.type_demande === 'formation'">{{ d.formation?.titre || 'Formation non d\xE9finie' }}</ng-container>\r
            <ng-container *ngIf="d.type_demande === 'parcours'">{{ d.parcours?.titre || d.parcours?.nom || 'Parcours non d\xE9fini' }}</ng-container>\r
            <ng-container *ngIf="d.type_demande === 'catalogue'">{{ d.catalogue?.titre || 'Catalogue non d\xE9fini' }}</ng-container>\r
            <ng-container *ngIf="!d.type_demande">Demande #{{ d.id }}</ng-container>\r
          </div>\r
\r
          <div class="d-meta">\r
            <span *ngIf="d.date_souhaitee_debut"><i class="isax isax-calendar-1"></i> {{ formatDate(d.date_souhaitee_debut) }}</span>\r
            <span *ngIf="d.formation?.duree_totale"><i class="isax isax-clock"></i> {{ d.formation?.duree_totale }}h</span>\r
...
\r
        ...
        <div class="d-right">\r
          <div class="d-badges">\r
            ...
            <span class="tb"\r
              [class.tb-form]="d.type_demande === 'formation'"\r
              [class.tb-parc]="d.type_demande === 'parcours'"\r
              [class.tb-cat]="d.type_demande === 'catalogue'">\r
              {{ d.type_demande === 'formation' ? 'Formation' : d.type_demande === 'parcours' ? 'Parcours' : 'Catalogue' }}\r
            </span>\r
          </div>\r
          <div class="action-row">\r
            ...
            <button *ngIf="canCancel(d)" type="button" class="act-btn act-cancel" title="Annuler" (click)="annulerDemande(d)" aria-label="Annuler">\r
...
\r
      ...
      <div *ngIf="!tableData.length" class="empty-state">\r
        <i class="isax isax-search-normal-1"></i>\r
        <p>Aucun r\xE9sultat pour "{{ searchDataValue }}"</p>\r
      </div>\r
    </div>\r
\r
    <!-- Pagination -->\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhDemandeComponent, { className: "AdminrhDemandeComponent", filePath: "app/features/adminrh/adminrh-demande/adminrh-demande.component.ts", lineNumber: 30 });
})();
export {
  AdminrhDemandeComponent
};
//# sourceMappingURL=chunk-QI5G5AVO.js.map
