...
function InstructorSidebarComponent_div_102_div_6_Template(rf, ctx) {
  if (rf & 1) {
...
function InstructorSidebarComponent_div_102_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, InstructorSidebarComponent_div_102_div_6_Template, 7, 5, "div", 57);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function InstructorSidebarComponent_a_110_Template(rf, ctx) {
  if (rf & 1) {
...
var InstructorSidebarComponent = class _InstructorSidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InstructorSidebarComponent, selectors: [["app-instructor-sidebar"]], decls: 114, vars: 29, consts: [[1, "sb-shell"], [1, "sb-logo"], [1, "sb-logo-mark"], [1, "isax", "isax-teacher"], [1, "sb-logo-text"], [1, "sb-logo-sub"], [1, "sb-profile"], [1, "prof-row"], [1, "prof-av"], [1, "prof-name"], [1, "prof-role"], [1, "prof-stats"], [1, "pstat"], [1, "pstat-v"], [1, "pstat-l"], [1, "pstat-sep"], [1, "sb-scroll"], [1, "sb-section-label"], ["routerLinkActive", "active", 1, "sb-item", 3, "routerLink"], [1, "isax", "isax-grid-3", "icon"], [1, "sb-item-label"], [1, "sb-divider"], [1, "sb-group"], [1, "sb-group-header", 3, "click"], [1, "isax", "isax-book", "icon"], ["class", "sb-badge sb-badge--caramel", 4, "ngIf"], [1, "isax", "isax-arrow-right-3", "arr"], ["class", "sb-sub", 4, "ngIf"], [1, "isax", "isax-element-4", "icon"], [1, "isax", "isax-award", "icon"], [1, "isax", "isax-profile-2user", "icon"], ["class", "sb-badge sb-badge--gray", 4, "ngIf"], [1, "isax", "isax-note-21", "icon"], [1, "isax", "isax-calendar-1", "icon"], [1, "isax", "isax-receipt-item", "icon"], [1, "isax", "isax-ticket", "icon"], ["class", "sb-progress-card", 4, "ngIf"], [1, "sb-bottom"], ["routerLinkActive", "active", 1, "sb-bottom-item", 3, "routerLink"], [1, "isax", "isax-user-square"], [1, "isax", "isax-setting-2"], ["class", "sb-bottom-item sb-rh-return", 3, "routerLink", 4, "ngIf"], [1, "sb-bottom-item", "logout", 3, "routerLink"], [1, "isax", "isax-logout"], [1, "sb-badge", "sb-badge--caramel"], [1, "sb-sub"], ["routerLinkActive", "active", 1, "sb-sub-item", 3, "routerLink"], [1, "isax", "isax-task-square"], ["href", "/courses/instructor-course-add", "target", "_blank", 1, "sb-sub-item"], [1, "isax", "isax-add-circle"], [1, "isax", "isax-video-circle"], [1, "isax", "isax-chart-2"], [1, "sb-badge", "sb-badge--gray"], [1, "sb-progress-card"], [1, "pc-header"], [1, "pc-title"], [1, "pc-period"], ["class", "pc-row", 4, "ngFor", "ngForOf"], [1, "pc-row"], [1, "pc-name", 3, "title"], [1, "pc-bar-wrap"], [1, "pc-fill"], [1, "pc-pct"], [1, "sb-bottom-item", "sb-rh-return", 3, "routerLink"], [1, "isax", "isax-arrow-left-2"]], template: function InstructorSidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(101, "Tickets support");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(102, InstructorSidebarComponent_div_102_Template, 7, 1, "div", 36);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(103, "div", 37)(104, "a", 38);
      \u0275\u0275element(105, "i", 39);
      \u0275\u0275text(106, " Mon profil formateur ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(107, "a", 38);
      \u0275\u0275element(108, "i", 40);
      \u0275\u0275text(109, " Pr\xE9f\xE9rences ");
      \u0275\u0275elementEnd();
      \u0275\u0275template(110, InstructorSidebarComponent_a_110_Template, 3, 1, "a", 41);
      \u0275\u0275elementStart(111, "a", 42);
      \u0275\u0275element(112, "i", 43);
      \u0275\u0275text(113, " D\xE9connexion ");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(12);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorSidebarComponent, { className: "InstructorSidebarComponent", filePath: "app/features/instructor/common/instructor-sidebar/instructor-sidebar.component.ts", lineNumber: 18 });
})();
...
//# sourceMappingURL=chunk-EJ5LLV4G.js.map
