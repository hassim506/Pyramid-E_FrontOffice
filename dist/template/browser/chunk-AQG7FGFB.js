import {
  CompanyAddComponent
} from "./chunk-IM623WBY.js";
import "./chunk-OE6AEQ26.js";
import {
...
function CompanyManagementComponent_div_8_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "div", 31);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "small", 28);
    \u0275\u0275text(4, "Inactives");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function CompanyManagementComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "small", 28);
    \u0275\u0275text(5, "Total");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 26)(7, "div", 29);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "small", 28);
    \u0275\u0275text(10, "Actives");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, CompanyManagementComponent_div_8_div_11_Template, 5, 1, "div", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function CompanyManagementComponent_button_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 32);
    \u0275\u0275listener("click", function CompanyManagementComponent_button_13_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
...
function CompanyManagementComponent_small_25_Template(rf, ctx) {
  if (rf & 1) {
...
function CompanyManagementComponent_div_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39)(1, "div", 26)(2, "div", 40)(3, "span", 41);
    \u0275\u0275text(4, "Chargement...");
    \u0275\u0275elementEnd()();
...
function CompanyManagementComponent_div_27_button_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 49);
    \u0275\u0275listener("click", function CompanyManagementComponent_div_27_button_8_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openNew());
    });
    \u0275\u0275element(1, "i", 50);
    \u0275\u0275text(2, " Ajouter une entreprise ");
    \u0275\u0275elementEnd();
  }
}
function CompanyManagementComponent_div_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "i", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "h5", 46);
    \u0275\u0275text(5, "Aucune entreprise trouv\xE9e");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 47);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, CompanyManagementComponent_div_27_button_8_Template, 3, 0, "button", 48);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.canAddCompany());
  }
}
function CompanyManagementComponent_div_28_div_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 72)(1, "button", 73);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "ul", 74)(4, "li")(5, "a", 75);
    \u0275\u0275listener("click", function CompanyManagementComponent_div_28_div_8_Template_a_click_5_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(6, "5 par page");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "li")(8, "a", 75);
    \u0275\u0275listener("click", function CompanyManagementComponent_div_28_div_8_Template_a_click_8_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "li")(11, "a", 75);
    \u0275\u0275listener("click", function CompanyManagementComponent_div_28_div_8_Template_a_click_11_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "li")(14, "a", 75);
    \u0275\u0275listener("click", function CompanyManagementComponent_div_28_div_8_Template_a_click_14_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function CompanyManagementComponent_div_28_tr_34_small_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 28);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "titlecase");
  ...
  if (rf & 2) {
    const company_r9 = \u0275\u0275nextContext().$implicit;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, ctx_r0.getClientType(company_r9.client)), " ");
  }
}
function CompanyManagementComponent_div_28_tr_34_button_53_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 95);
    \u0275\u0275listener("click", function CompanyManagementComponent_div_28_tr_34_button_53_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const company_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.archiveCompany(company_r9));
    });
    \u0275\u0275element(1, "i", 96);
    \u0275\u0275elementEnd();
  }
}
function CompanyManagementComponent_div_28_tr_34_button_54_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 97);
    \u0275\u0275listener("click", function CompanyManagementComponent_div_28_tr_34_button_54_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r11);
      const company_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.reactivateCompany(company_r9));
    });
    \u0275\u0275element(1, "i", 7);
    \u0275\u0275elementEnd();
  }
}
function CompanyManagementComponent_div_28_tr_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 76)(1, "td")(2, "div", 77)(3, "span", 78);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(5, "td")(6, "div", 77)(7, "div", 79)(8, "span", 80);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div")(11, "a", 81);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 82);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(15, "td")(16, "div")(17, "div", 83);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275template(19, CompanyManagementComponent_div_28_tr_34_small_19_Template, 3, 3, "small", 21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "td")(21, "div", 77);
    \u0275\u0275element(22, "i", 84);
    \u0275\u0275elementStart(23, "span");
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(25, "td")(26, "div", 77);
    \u0275\u0275element(27, "i", 85);
    \u0275\u0275elementStart(28, "span");
    \u0275\u0275text(29);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(30, "td")(31, "span", 54);
    \u0275\u0275text(32);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "td")(34, "div", 77);
    \u0275\u0275element(35, "i", 86);
    \u0275\u0275elementStart(36, "span", 83);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(38, "td")(39, "div", 77)(40, "span", 87);
    \u0275\u0275text(41);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(46);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "td", 68)(48, "div", 88)(49, "button", 89);
    \u0275\u0275listener("click", function CompanyManagementComponent_div_28_tr_34_Template_button_click_49_listener() {
      const company_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.editCompany(company_r9));
    });
    \u0275\u0275element(50, "i", 90);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "a", 91);
    \u0275\u0275element(52, "i", 92);
    \u0275\u0275elementEnd();
    \u0275\u0275template(53, CompanyManagementComponent_div_28_tr_34_button_53_Template, 2, 0, "button", 93)(54, CompanyManagementComponent_div_28_tr_34_button_54_Template, 2, 0, "button", 94);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r0.getCompanyField(company_r9, "ninea"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.getCompanyInitials(company_r9.nom || ""));
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(20, _c1, company_r9.id));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", company_r9.nom || "Nom non renseign\xE9", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ID: ", company_r9.id, " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r0.getClientName(company_r9.client));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getClientType(company_r9.client));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.getCompanyField(company_r9, "email"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.getCompanyField(company_r9, "telephone"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r0.getCompanyField(company_r9, "secteur_activite"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.getCompanyField(company_r9, "taille_effectif"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r0.getCountryFlag(company_r9.pays || ""));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.getCountryName(company_r9.pays || ""));
    \u0275\u0275advance(2);
    \u0275\u0275classMap(ctx_r0.getStatusClass(company_r9.statut));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.getStatusLabel(company_r9.statut), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", !ctx_r0.canEditCompany(company_r9));
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(22, _c1, company_r9.id));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", company_r9.statut === "active");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", company_r9.statut === "inactive");
  }
}
function CompanyManagementComponent_div_28_tr_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 98)(2, "div", 28);
    \u0275\u0275element(3, "i", 99);
    \u0275\u0275elementStart(4, "h6");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 100);
...
function CompanyManagementComponent_div_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 42)(1, "div", 51)(2, "div", 52)(3, "h6", 53);
    \u0275\u0275text(4, "Liste des Entreprises");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 4)(6, "span", 54);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, CompanyManagementComponent_div_28_div_8_Template, 16, 1, "div", 55);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(9, "div", 56)(10, "table", 57);
    \u0275\u0275listener("matSortChange", function CompanyManagementComponent_div_28_Template_table_matSortChange_10_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.sortData($event));
    });
    \u0275\u0275elementStart(11, "thead", 58)(12, "tr")(13, "th", 59);
    \u0275\u0275text(14, "NINEA");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "th", 62);
    \u0275\u0275text(20, "Email");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "th", 63);
    ...
    \u0275\u0275text(28, "Pays");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "th", 67);
    \u0275\u0275text(30, "Statut");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "th", 68);
    \u0275\u0275text(32, "Actions");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(33, "tbody");
    \u0275\u0275template(34, CompanyManagementComponent_div_28_tr_34_Template, 55, 24, "tr", 69)(35, CompanyManagementComponent_div_28_tr_35_Template, 8, 1, "tr", 70);
    \u0275\u0275elementEnd()()();
...
- Toutes les donn\xE9es associ\xE9es`;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CompanyManagementComponent, selectors: [["app-companymanagement"]], decls: 30, vars: 19, consts: [[1, "page-content"], [1, "page-title", "d-flex", "align-items-center", "justify-content-between", "mb-4"], [1, "fw-bold", "mb-1"], [1, "text-muted", "mb-0"], [1, "d-flex", "align-items-center", "gap-2"], ["class", "d-flex align-items-center gap-3 me-3", 4, "ngIf"], [1, "btn", "btn-outline-primary", 3, "click", "disabled"], [1, "isax", "isax-refresh"], [1, "ms-1"], ["class", "btn btn-primary", 3, "disabled", "click", 4, "ngIf"], ["class", "alert alert-success alert-dismissible fade show", "role", "alert", 4, "ngIf"], ["class", "alert alert-danger alert-dismissible fade show", "role", "alert", 4, "ngIf"], [1, "card", "mb-4"], [1, "card-body"], [1, "row", "align-items-center"], [1, "col-md-6"], [1, "input-group"], [1, "input-group-text"], [1, "isax", "isax-search-normal-1"], ["type", "search", "placeholder", "Rechercher par nom, email, t\xE9l\xE9phone, secteur...", 1, "form-control", 3, "ngModelChange", "ngModel", "ngModelOptions", "disabled"], [1, "col-md-6", "text-end"], ["class", "text-muted", 4, "ngIf"], ["class", "d-flex justify-content-center p-5", 4, "ngIf"], ["class", "card", 4, "ngIf"], [3, "onClose", "onSave", "visible", "isEditMode", "companyData"], [1, "d-flex", "align-items-center", "gap-3", "me-3"], [1, "text-center"], [1, "fw-bold", "text-primary"], [1, "text-muted"], [1, "fw-bold", "text-success"], ["class", "text-center", 4, "ngIf"], [1, "fw-bold", "text-warning"], [1, "btn", "btn-primary", 3, "click", "disabled"], [1, "isax", "isax-add"], ["role", "alert", 1, "alert", "alert-success", "alert-dismissible", "fade", "show"], [1, "isax", "isax-tick-circle", "me-2"], ["type", "button", 1, "btn-close", 3, "click"], ["role", "alert", 1, "alert", "alert-danger", "alert-dismissible", "fade", "show"], [1, "isax", "isax-warning-2", "me-2"], [1, "d-flex", "justify-content-center", "p-5"], ["role", "status", 1, "spinner-border", "text-primary", "mb-3"], [1, "visually-hidden"], [1, "card"], [1, "card-body", "text-center", "py-5"], [1, "mb-4"], [1, "isax", "isax-building", "display-1", "text-muted"], [1, "fw-bold", "mb-3"], [1, "text-muted", "mb-4"], ["class", "btn btn-primary", 3, "click", 4, "ngIf"], [1, "btn", "btn-primary", 3, "click"], [1, "isax", "isax-add", "me-2"], [1, "card-header", "bg-white", "border-bottom"], [1, "d-flex", "align-items-center", "justify-content-between"], [1, "mb-0", "fw-bold"], [1, "badge", "bg-light", "text-dark"], ["class", "dropdown", 4, "ngIf"], [1, "table-responsive"], ["matSort", "", 1, "table", "table-hover", "mb-0", 3, "matSortChange"], [1, "table-light"], ["mat-sort-header", "ninea"], ["mat-sort-header", "nom"], ["mat-sort-header", "client"], ["mat-sort-header", "email"], ["mat-sort-header", "telephone"], ["mat-sort-header", "secteur_activite"], ["mat-sort-header", "taille_effectif"], ["mat-sort-header", "pays"], ["mat-sort-header", "statut"], [1, "text-end"], ["class", "align-middle", 4, "ngFor", "ngForOf", "ngForTrackBy"], [4, "ngIf"], [1, "card-footer", "bg-white", "border-top"], [1, "dropdown"], ["type", "button", "data-bs-toggle", "dropdown", 1, "btn", "btn-sm", "btn-outline-secondary", "dropdown-toggle"], [1, "dropdown-menu"], ["href", "javascript:void(0)", 1, "dropdown-item", 3, "click"], [1, "align-middle"], [1, "d-flex", "align-items-center"], [1, "badge", "bg-light", "text-dark", "font-monospace"], [1, "avatar", "avatar-md", "bg-primary", "text-white", "rounded", "me-3", "d-flex", "align-items-center", "justify-content-center"], [1, "fw-bold"], [1, "fw-semibold", "text-decoration-none", "text-dark", 3, "routerLink"], [1, "text-muted", "small"], [1, "fw-medium"], [1, "isax", "isax-sms", "text-muted", "me-2"], [1, "isax", "isax-call", "text-muted", "me-2"], [1, "isax", "isax-profile-2user", "text-muted", "me-2"], [1, "me-2"], ["role", "group", 1, "btn-group", "btn-group-sm"], ["title", "Modifier", 1, "btn", "btn-outline-primary", 3, "click", "disabled"], [1, "isax", "isax-edit"], ["title", "Voir d\xE9tails", 1, "btn", "btn-outline-info", 3, "routerLink"], [1, "isax", "isax-eye"], ["class", "btn btn-outline-warning", "title", "Archiver l'entreprise", 3, "click", 4, "ngIf"], ["class", "btn btn-outline-success", "title", "R\xE9activer l'entreprise", 3, "click", 4, "ngIf"], ["title", "Archiver l'entreprise", 1, "btn", "btn-outline-warning", 3, "click"], [1, "isax", "isax-archive"], ["title", "R\xE9activer l'entreprise", 1, "btn", "btn-outline-success", 3, "click"], ["colspan", "10", 1, "text-center", "py-4"], [1, "isax", "isax-search-normal-1", "display-6", "mb-3", "d-block"], [1, "mb-0"]], template: function CompanyManagementComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(13, CompanyManagementComponent_button_13_Template, 4, 1, "button", 9);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(14, CompanyManagementComponent_div_14_Template, 4, 1, "div", 10)(15, CompanyManagementComponent_div_15_Template, 4, 1, "div", 11);
      \u0275\u0275elementStart(16, "div", 12)(17, "div", 13)(18, "div", 14)(19, "div", 15)(20, "div", 16)(21, "span", 17);
      \u0275\u0275element(22, "i", 18);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(23, "input", 19);
      \u0275\u0275twoWayListener("ngModelChange", function CompanyManagementComponent_Template_input_ngModelChange_23_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.searchDataValue, $event) || (ctx.searchDataValue = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function CompanyManagementComponent_Template_input_ngModelChange_23_listener() {
        return ctx.searchData(ctx.searchDataValue);
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(24, "div", 20);
      \u0275\u0275template(25, CompanyManagementComponent_small_25_Template, 2, 2, "small", 21);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(26, CompanyManagementComponent_div_26_Template, 7, 0, "div", 22)(27, CompanyManagementComponent_div_27_Template, 9, 2, "div", 23)(28, CompanyManagementComponent_div_28_Template, 38, 5, "div", 23);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(29, "app-company-add", 24);
      \u0275\u0275listener("onClose", function CompanyManagementComponent_Template_app_company_add_onClose_29_listener() {
        return ctx.hideDialog();
      })("onSave", function CompanyManagementComponent_Template_app_company_add_onSave_29_listener() {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275property("ngIf", ctx.canAddCompany());
      \u0275\u0275advance();
