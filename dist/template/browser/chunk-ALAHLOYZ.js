...
<ng-container *ngIf="vue === 'repondre' && selected">
  ...
  <div *ngIf="submitSuccess" class="ms-success-screen">
    ...
    <button class="ms-btn-back" (click)="retour()">
      <i class="isax isax-arrow-left-2"></i> Retour aux enqu\xEAtes
    </button>
  </div>
  ...
  <ng-container *ngIf="!submitSuccess">
    ...
    <div class="ms-rep-header">
      <button class="ms-back-btn" (click)="retour()">
        <i class="isax isax-arrow-left-2"></i>
      </button>
      <div class="ms-rep-title-wrap">
      ...
      <ng-container *ngIf="currentQuestion.type === 'radio'">
        <div class="ms-options">
          <label *ngFor="let opt of currentQuestion.options" class="ms-option"
            ...
            <input type="radio" class="ms-option-input"
                   [name]="'q' + currentQuestion.id"
                   [value]="opt"
                   [(ngModel)]="reponses[currentQuestion.id!]">
            <span class="ms-option-dot"></span>
            <span>{{ opt }}</span>
          </label>
        </div>
      </ng-container>
...
//# sourceMappingURL=chunk-ALAHLOYZ.js.map
