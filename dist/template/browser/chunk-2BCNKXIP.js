...
function InstructorCertificateComponent_ng_container_2_tr_72_span_14_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275styleProp("color", ctx_r1.getScoreColor(cert_r5.score_final))("background", ctx_r1.parseFloat(cert_r5.score_final) >= 80 ? "#ECFDF5" : ctx_r1.parseFloat(cert_r5.score_final) >= 60 ? "#FFFBEB" : "#FFF5F5");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", cert_r5.score_final, "% ");
  }
}
function InstructorCertificateComponent_ng_container_2_tr_72_span_15_Template(rf, ctx) {
  if (rf & 1) {
...
function InstructorCertificateComponent_ng_container_2_tr_72_span_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 49);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function InstructorCertificateComponent_ng_container_2_tr_72_span_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 49);
    \u0275\u0275text(1, "\u2014");
    \u0275\u0275elementEnd();
...
function InstructorCertificateComponent_ng_container_2_tr_72_span_24_Template(rf, ctx) {
  if (rf & 1) {
...
function InstructorCertificateComponent_ng_container_2_tr_72_span_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 49);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function InstructorCertificateComponent_ng_container_2_tr_72_span_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 49);
...
function InstructorCertificateComponent_ng_container_2_tr_72_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(14, InstructorCertificateComponent_ng_container_2_tr_72_span_14_Template, 2, 5, "span", 47)(15, InstructorCertificateComponent_ng_container_2_tr_72_span_15_Template, 2, 0, "span", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "td");
    \u0275\u0275template(17, InstructorCertificateComponent_ng_container_2_tr_72_span_17_Template, 2, 2, "span", 48)(18, InstructorCertificateComponent_ng_container_2_tr_72_span_18_Template, 2, 0, "span", 48);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(24, InstructorCertificateComponent_ng_container_2_tr_72_span_24_Template, 4, 4, "span", 50)(25, InstructorCertificateComponent_ng_container_2_tr_72_span_25_Template, 3, 4, "span", 48)(26, InstructorCertificateComponent_ng_container_2_tr_72_span_26_Template, 2, 0, "span", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "td")(28, "span", 51);
    \u0275\u0275element(29, "i", 52);
    \u0275\u0275text(30);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "td")(32, "div", 53)(33, "button", 54);
    \u0275\u0275listener("click", function InstructorCertificateComponent_ng_container_2_tr_72_Template_button_click_33_listener() {
    ...
    \u0275\u0275listener("click", function InstructorCertificateComponent_ng_container_2_tr_72_Template_button_click_35_listener() {
      const cert_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", cert_r5.score_final);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !cert_r5.score_final);
    \u0275\u0275advance(2);
    ...
    \u0275\u0275property("ngIf", !cert_r5.formateur);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(22, 24, cert_r5.date_delivrance, "dd/MM/yyyy"));
    \u0275\u0275advance(3);
...
function InstructorCertificateComponent_ng_container_2_tr_73_Template(rf, ctx) {
  if (rf & 1) {
...
function InstructorCertificateComponent_ng_container_2_div_74_ng_container_3_span_1_Template(rf, ctx) {
  if (rf & 1) {
...
function InstructorCertificateComponent_ng_container_2_div_74_ng_container_3_button_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 69);
    \u0275\u0275listener("click", function InstructorCertificateComponent_ng_container_2_div_74_ng_container_3_button_2_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
...
function InstructorCertificateComponent_ng_container_2_div_74_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, InstructorCertificateComponent_ng_container_2_div_74_ng_container_3_span_1_Template, 2, 0, "span", 66)(2, InstructorCertificateComponent_ng_container_2_div_74_ng_container_3_button_2_Template, 2, 3, "button", 67);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function InstructorCertificateComponent_ng_container_2_div_74_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 62)(1, "button", 63);
    \u0275\u0275listener("click", function InstructorCertificateComponent_ng_container_2_div_74_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275element(2, "i", 64);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, InstructorCertificateComponent_ng_container_2_div_74_ng_container_3_Template, 3, 2, "ng-container", 40);
    \u0275\u0275elementStart(4, "button", 63);
    \u0275\u0275listener("click", function InstructorCertificateComponent_ng_container_2_div_74_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.goToPage(ctx_r1.currentPage + 1));
    });
...
function InstructorCertificateComponent_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(64, "D\xE9livr\xE9 le");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "th");
    \u0275\u0275text(66, "Expiration");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(72, InstructorCertificateComponent_ng_container_2_tr_72_Template, 37, 27, "tr", 40)(73, InstructorCertificateComponent_ng_container_2_tr_73_Template, 5, 0, "tr", 2);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(74, InstructorCertificateComponent_ng_container_2_div_74_Template, 6, 3, "div", 41);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function InstructorCertificateComponent_div_5_ng_container_52_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function InstructorCertificateComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(4, "i", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div")(6, "h5", 74);
    \u0275\u0275text(7, "Certificat de r\xE9ussite");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "p", 75);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(10, "button", 76);
    \u0275\u0275elementEnd();
    \u0275\u0275element(11, "div", 77);
    \u0275\u0275elementStart(12, "div", 78)(13, "div", 79)(14, "div", 80)(15, "div", 81);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div")(18, "div", 82);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 83);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "div", 84);
    \u0275\u0275text(23, "Certificat de r\xE9ussite");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 85);
    \u0275\u0275text(25, "a compl\xE9t\xE9 avec succ\xE8s la formation");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "div", 86);
    \u0275\u0275text(27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "div", 87)(29, "div", 88)(30, "div", 89);
    \u0275\u0275text(31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "div", 90);
    \u0275\u0275text(33, "Score obtenu");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(34, "div", 91);
    \u0275\u0275elementStart(35, "div", 88)(36, "div", 89);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div", 90);
    \u0275\u0275text(39, "Dur\xE9e totale");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(40, "div", 92)(41, "div", 93);
    \u0275\u0275element(42, "div", 94);
    \u0275\u0275elementStart(43, "div", 95);
    \u0275\u0275text(44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "div", 96);
    \u0275\u0275text(46);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "div", 97);
    \u0275\u0275element(48, "i", 98);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(49, "div", 99);
    \u0275\u0275text(50);
    \u0275\u0275pipe(51, "date");
    \u0275\u0275template(52, InstructorCertificateComponent_div_5_ng_container_52_Template, 3, 6, "ng-container", 2);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(53, "div", 100)(54, "div", 101)(55, "div", 102);
    \u0275\u0275element(56, "i", 103);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "div")(58, "div", 104);
    \u0275\u0275text(59, "Code unique");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "div", 105);
    \u0275\u0275text(61);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(62, "div", 101)(63, "div", 102);
    \u0275\u0275element(64, "i", 106);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "div")(66, "div", 104);
    \u0275\u0275text(67, "Statut");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "div")(69, "span", 51);
    \u0275\u0275element(70, "i", 52);
    \u0275\u0275text(71);
    \u0275\u0275elementEnd()()()()()();
    \u0275\u0275element(72, "div", 77);
    \u0275\u0275elementStart(73, "div", 107)(74, "button", 108);
    \u0275\u0275text(75, "Fermer");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(76, "button", 109);
    \u0275\u0275listener("click", function InstructorCertificateComponent_div_5_Template_button_click_76_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.downloadPdf(ctx_r1.selectedCertificate));
    });
    \u0275\u0275element(77, "i", 57);
    \u0275\u0275text(78, " T\xE9l\xE9charger PDF ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" D\xE9livr\xE9 le ", \u0275\u0275pipeBind4(51, 29, ctx_r1.selectedCertificate.date_delivrance, "dd MMMM yyyy", "", "fr-FR"), " ");
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorCertificateComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-certificate", imports: [CommonModule, FormsModule], template: `<!-- Loading -->
...
<ng-container *ngIf="!loading">
  ...
  <div class="ip-page-head">
    <div>
      <h5 class="ip-page-head__title">
        Certificats <span class="ip-count">{{ filteredCertificates.length }}</span>
      </h5>
      <p class="ip-page-head__sub">Certificats d\xE9livr\xE9s pour vos formations</p>
    </div>
  </div>
  ...
  <div class="ip-kpi-row">
    <div class="ip-kpi-card">
      ...
      <div>
        <div class="ip-kpi-label">Total</div>
        <div class="ip-kpi-value">{{ certificates.length }}</div>
      </div>
    </div>
    <div class="ip-kpi-card">
  ...
  <div class="ip-card ip-filter-card">
    <div class="ip-filter-row">
      ...
      <div class="ip-filter-group">
        <select class="ip-input" [(ngModel)]="selectedStatus" (ngModelChange)="applyFilters()">
  ...
  <div class="ip-card">
    <div class="table-responsive">
      <table class="table ip-table">
        ...
        <tbody>
          <tr *ngFor="let cert of getPaginatedCertificates()">
            <td>
            ...
            <td><div class="ip-formation-name">{{ cert.formation?.titre }}</div></td>
            <td>
    ...
    <div *ngIf="totalPages > 1" class="ip-pagination">
      <button type="button" class="ip-page-btn" [disabled]="currentPage === 1" (click)="goToPage(currentPage - 1)">
        <i class="isax isax-arrow-left-2"></i>
      </button>
      <ng-container *ngFor="let p of pages">
        <span *ngIf="p === -1" class="ip-page-ellipsis">\u2026</span>
        <button *ngIf="p !== -1" type="button" class="ip-page-btn"
                [class.ip-page-btn--active]="p === currentPage"
                (click)="goToPage(p)">{{ p }}</button>
      </ng-container>
      <button type="button" class="ip-page-btn" [disabled]="currentPage === totalPages" (click)="goToPage(currentPage + 1)">
...
<!-- \u2500\u2500 MODAL D\xC9TAILS \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
<div class="modal fade" id="inst_cert_details_modal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered ip-modal-dialog">
    <div class="modal-content ip-modal-content" *ngIf="selectedCertificate">

      <div class="ip-cert-accent" [style.background]="getScoreColor(selectedCertificate.score_final)"></div>

      <div class="ip-modal-header">
        <div class="ip-modal-icon"><i class="isax isax-award"></i></div>
        <div>
          <h5 class="ip-modal-title">Certificat de r\xE9ussite</h5>
          <p class="ip-modal-sub">N\xB0 {{ selectedCertificate.code_unique }}</p>
        </div>
      ...
      <div class="ip-modal-body">
        ...
        <div class="ip-cert-preview">
          <div class="ip-cert-logo">
            <div class="ip-cert-logo-mark" [style.background]="getScoreColor(selectedCertificate.score_final)">
              {{ getInitials(selectedCertificate.employe?.name || '') }}
            </div>
            <div>
              <div class="ip-cert-logo-text">{{ selectedCertificate.employe?.prenom }} {{ selectedCertificate.employe?.nom }}</div>
              <div class="ip-cert-logo-sub">{{ selectedCertificate.employe?.fonction }}</div>
            </div>
          </div>
          <div class="ip-cert-label">Certificat de r\xE9ussite</div>
          <div class="ip-cert-action-text">a compl\xE9t\xE9 avec succ\xE8s la formation</div>
          <div class="ip-cert-formation-title" [style.color]="getScoreColor(selectedCertificate.score_final)">
            {{ selectedCertificate.formation?.titre }}
          </div>
          <div class="ip-cert-score-row">
            <div class="ip-cert-score-item">
              <div class="ip-cert-score-val" [style.color]="getScoreColor(selectedCertificate.score_final)">
                {{ selectedCertificate.score_final }}%
              </div>
              <div class="ip-cert-score-label">Score obtenu</div>
            </div>
            <div class="ip-cert-divider-v"></div>
            <div class="ip-cert-score-item">
              <div class="ip-cert-score-val">{{ selectedCertificate.formation?.duree_totale || '\u2014' }}h</div>
          ...
          <div class="ip-cert-sig-row">
            <div class="ip-cert-sig">
              ...
              <div class="ip-cert-sig-name">{{ selectedCertificate.formateur?.prenom }} {{ selectedCertificate.formateur?.nom }}</div>
              <div class="ip-cert-sig-role">Formateur \xB7 {{ selectedCertificate.formation?.titre }}</div>
            </div>
            <div class="ip-cert-qr"><i class="isax isax-scan-barcode"></i></div>
          </div>
          <div class="ip-cert-validity">
            D\xE9livr\xE9 le {{ selectedCertificate.date_delivrance | date:'dd MMMM yyyy' : '' : 'fr-FR' }}
            <ng-container *ngIf="selectedCertificate.date_expiration">
              \xB7 Valide jusqu'au {{ selectedCertificate.date_expiration | date:'dd MMMM yyyy' : '' : 'fr-FR' }}
            </ng-container>
          </div>
        </div>
        ...
        <div class="ip-detail-row ip-detail-row--mt">
          <div class="ip-detail-block ip-detail-block--half">
            ...
            <div>
              ...
              <div class="ip-detail-value ip-detail-value--mono">{{ selectedCertificate.code_unique }}</div>
            </div>
          </div>
          <div class="ip-detail-block ip-detail-block--half">
            ...
            <div>
              ...
              <div>
                <span class="ip-cert-badge"
                      [class.ip-cert-badge--valide]="selectedCertificate.statut === 'valide'"
                      [class.ip-cert-badge--expire]="selectedCertificate.statut === 'expir\xE9'"
                      [class.ip-cert-badge--revoque]="selectedCertificate.statut === 'r\xE9voqu\xE9'">
                  <i class="fa-solid fa-circle"></i>
                  {{ selectedCertificate.statut === 'valide' ? 'Valide' : selectedCertificate.statut === 'expir\xE9' ? 'Expir\xE9' : 'R\xE9voqu\xE9' }}
                </span>
              </div>
            </div>
          </div>
      ...
      <div class="ip-modal-footer">
        ...
        <button type="button" class="ip-btn ip-btn--primary"
                (click)="downloadPdf(selectedCertificate)">
          <i class="isax isax-document-download"></i> T\xE9l\xE9charger PDF
        </button>
      </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorCertificateComponent, { className: "InstructorCertificateComponent", filePath: "src/app/features/instructor/instructor-certificate/instructor-certificate.component.ts", lineNumber: 13 });
})();
export {
  InstructorCertificateComponent
};
//# sourceMappingURL=chunk-2BCNKXIP.js.map
