...
var _c0 = ["*"];
var _LightgalleryService = class _LightgalleryService {
  constructor() {
  }
};
_LightgalleryService.\u0275fac = function LightgalleryService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _LightgalleryService)();
};
_LightgalleryService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
  token: _LightgalleryService,
  factory: _LightgalleryService.\u0275fac,
  providedIn: "root"
});
var LightgalleryService = _LightgalleryService;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LightgalleryService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
var _LightgalleryComponent = class _LightgalleryComponent {
  ...
  ngAfterViewChecked() {
    if (!this.lgInitialized) {
      this.registerEvents();
      this.LG = lightgallery_es5_default(this._elementRef.nativeElement, this.settings);
...
_LightgalleryComponent.\u0275fac = function LightgalleryComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _LightgalleryComponent)(\u0275\u0275directiveInject(ElementRef));
};
_LightgalleryComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  type: _LightgalleryComponent,
...
var LightgalleryComponent = _LightgalleryComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LightgalleryComponent, [{
    type: Component,
    args: [{
...
var _LightgalleryModule = class _LightgalleryModule {
};
_LightgalleryModule.\u0275fac = function LightgalleryModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _LightgalleryModule)();
};
_LightgalleryModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _LightgalleryModule,
  declarations: [LightgalleryComponent],
  exports: [LightgalleryComponent]
});
_LightgalleryModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({});
var LightgalleryModule = _LightgalleryModule;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LightgalleryModule, [{
    type: NgModule,
    args: [{
      declarations: [LightgalleryComponent],
      imports: [],
...
lightgallery/lightgallery.es5.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-EKBW3B5U.js.map
