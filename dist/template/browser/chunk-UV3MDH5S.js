...
function InstructorQuizComponent_ng_container_2_tr_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, InstructorQuizComponent_ng_container_2_tr_32_div_8_Template, 2, 1, "div", 40);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275template(14, InstructorQuizComponent_ng_container_2_tr_32_span_14_Template, 3, 1, "span", 43)(15, InstructorQuizComponent_ng_container_2_tr_32_span_15_Template, 2, 0, "span", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "td");
    \u0275\u0275template(17, InstructorQuizComponent_ng_container_2_tr_32_span_17_Template, 2, 1, "span", 45)(18, InstructorQuizComponent_ng_container_2_tr_32_span_18_Template, 2, 0, "span", 44);
    \u0275\u0275elementEnd();
...
function InstructorQuizComponent_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(32, InstructorQuizComponent_ng_container_2_tr_32_Template, 35, 16, "tr", 35)(33, InstructorQuizComponent_ng_container_2_tr_33_Template, 5, 0, "tr", 2);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function InstructorQuizComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(19);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(20, InstructorQuizComponent_div_5_div_20_Template, 8, 1, "div", 64);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(16, _c1, ctx_r1.selectedQuiz.id));
  }
}
...
function InstructorQuizComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 59)(1, "form", 73)(2, "div", 74)(3, "label", 75);
    \u0275\u0275text(4, "Titre ");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 74)(9, "label", 75);
    \u0275\u0275text(10, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275element(11, "textarea", 78);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 79)(13, "div", 80)(14, "label", 75);
    \u0275\u0275text(15, "Dur\xE9e (minutes)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 81);
    \u0275\u0275element(17, "i", 82)(18, "input", 83);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 80)(20, "label", 75);
    \u0275\u0275text(21, "Score minimum (%)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "div", 81);
    \u0275\u0275element(23, "i", 84)(24, "input", 85);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(25, "div", 79)(26, "div", 80)(27, "label", 75);
    \u0275\u0275text(28, "Tentatives maximum");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "div", 81);
    \u0275\u0275element(30, "i", 86)(31, "input", 87);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "div", 80)(33, "label", 75);
    \u0275\u0275text(34, "Statut");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "div", 88)(36, "span", 89);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "label", 90);
    \u0275\u0275element(39, "input", 91)(40, "span", 92);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(41, InstructorQuizComponent_div_19_div_41_Template, 2, 1, "div", 93);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_2_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorQuizComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-quiz", standalone: true, imports: [CommonModule, RouterLink, FormsModule, ReactiveFormsModule, DatePickerModule, CustomPaginationComponent], template: `<!-- Loading -->
...
<ng-container *ngIf="!loading || quizzes.length > 0">
  ...
  <div class="ip-page-head">
    <div>
      ...
      <p class="ip-page-head__sub">G\xE9rez vos quiz et consultez les r\xE9sultats</p>
    </div>
      ...
      <table class="table ip-table">
        ...
        <tbody>
          <tr *ngFor="let quiz of quizzes">
            ...
            <td>
              <span class="ip-status-badge" [class.ip-status-active]="quiz.is_active" [class.ip-status-inactive]="!quiz.is_active">
            ...
            <td>
              <div class="ip-actions">
                ...
                <button type="button" class="ip-action-btn ip-action-btn--arch" title="Archiver"
...
<!-- \u2500\u2500 MODAL D\xC9TAILS \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
<div class="modal fade" id="quiz_details_modal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content ip-modal-content" *ngIf="selectedQuiz">
      ...
      <div class="ip-modal-body">
        ...
        <div class="ip-detail-row">
          <div class="ip-detail-block ip-detail-block--half">
            <div class="ip-detail-icon-wrap">
              <i class="isax isax-status"></i>
            </div>
            <div>
              <div class="ip-detail-label">Statut</div>
              <div>
                <span class="ip-status-badge" [class.ip-status-active]="selectedQuiz.is_active" [class.ip-status-inactive]="!selectedQuiz.is_active">
                  <i class="fa-solid fa-circle"></i>
      ...
      <div class="ip-modal-footer">
        ...
        <a [routerLink]="['/instructor/instructor-quiz-questions', selectedQuiz.id]"
           class="ip-btn ip-btn--primary" data-bs-dismiss="modal">
          <i class="isax isax-eye"></i> Voir les questions
        </a>
      </div>
...
<!-- \u2500\u2500 MODAL MODIFICATION \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
<div class="modal fade" id="quiz_edit_modal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered ip-modal-dialog">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorQuizComponent, { className: "InstructorQuizComponent", filePath: "src/app/features/instructor/instructor-quiz/instructor-quiz.component.ts", lineNumber: 20 });
})();
export {
  InstructorQuizComponent
};
//# sourceMappingURL=chunk-UV3MDH5S.js.map
