...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhPlansComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-plans", imports: [CommonModule, MatTableModule, MatSortModule, MatPaginatorModule, MatSelectModule, CustomPaginationComponent, BsDatepickerModule], template: `<div class="row">
    <div class="col-xl-5">
      <div class="card mb-3">
      <div class="card-body">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhPlansComponent, { className: "AdminrhPlansComponent", filePath: "src/app/features/adminrh/settings/adminrh-plans/adminrh-plans.component.ts", lineNumber: 21 });
})();
export {
  AdminrhPlansComponent
};
//# sourceMappingURL=chunk-TG55APFN.js.map
