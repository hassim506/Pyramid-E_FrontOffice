...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SondagePublicComponent, [{
    type: Component,
    args: [{ selector: "app-sondage-public", standalone: true, imports: [CommonModule, FormsModule], template: `<div class="sondage-public-page">
  ...
  <!-- \u2500\u2500 D\xC9J\xC0 R\xC9PONDU \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
  <div *ngIf="etat === 'deja_repondu'" class="sp-card sp-state">
    <div class="sp-icon sp-icon--warn">\u2713</div>
    <h2>D\xE9j\xE0 r\xE9pondu</h2>
    <p>Vous avez d\xE9j\xE0 r\xE9pondu \xE0 ce sondage. Votre avis a bien \xE9t\xE9 enregistr\xE9.</p>
    <p class="sp-muted">Merci pour votre participation !</p>
  </div>

  <!-- \u2500\u2500 INACTIF / EXPIR\xC9 \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
  <div *ngIf="etat === 'inactif'" class="sp-card sp-state">
    <div class="sp-icon sp-icon--muted">\u{1F512}</div>
    <h2>Sondage ferm\xE9</h2>
  ...
  <div *ngIf="etat === 'erreur'" class="sp-card sp-state">
    ...
    <h2>Lien invalide</h2>
    <p>{{ erreurMessage || 'Ce lien est invalide ou a expir\xE9.' }}</p>
  </div>
  ...
  <div *ngIf="etat === 'formulaire'" class="sp-wrap">
      ...
      <div *ngFor="let q of questions; let i = index" class="sp-question">
        ...
        <div *ngIf="q.type === 'notation'" class="sp-notation">
          <button *ngFor="let star of getEtoiles(+(q.valeur_max ?? 5))"
            ...
            [attr.aria-label]="star + ' \xE9toile(s)'">
            \u2605
          </button>
    ...
    <div class="sp-footer">
      <button class="sp-btn-submit" (click)="soumettre()" [disabled]="soumettre_loading">
        <span *ngIf="!soumettre_loading">Envoyer mes r\xE9ponses</span>
...
//# sourceMappingURL=chunk-Y25K5IUW.js.map
