...
var SuperadminSidebarComponent = class _SuperadminSidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SuperadminSidebarComponent, selectors: [["app-superadmin-sidebar"]], decls: 116, vars: 27, consts: [[1, "sb-shell"], [1, "sb-logo"], [1, "sb-logo-mark"], [1, "sb-logo-text"], [1, "sb-logo-sub"], [1, "sb-user"], [1, "sb-av"], [1, "sb-uname"], [1, "sb-urole"], [1, "sb-scroll"], [1, "sb-section"], [1, "sb-section-label"], ["routerLinkActive", "active", 1, "sb-item", 3, "routerLink"], [1, "isax", "isax-grid-3"], [1, "sb-item-label"], [1, "sb-divider"], ["routerLinkActive", "active", "class", "sb-item", 3, "routerLink", 4, "appHasPermission"], [1, "sb-group"], [1, "sb-group-header", 3, "click"], [1, "isax", "isax-profile-2user", "icon"], [1, "isax", "isax-arrow-right-3", "arr"], ["class", "sb-sub", 4, "ngIf"], [1, "isax", "isax-book-1"], [1, "isax", "isax-clipboard-text"], [1, "isax", "isax-award"], [1, "isax", "isax-medal-star"], [1, "isax", "isax-note-21"], [1, "isax", "isax-calendar-1"], [1, "isax", "isax-routing-2"], [1, "isax", "isax-coin-1"], [1, "isax", "isax-receipt-item"], [1, "isax", "isax-ticket"], [1, "sb-bottom"], ["routerLinkActive", "active", 1, "sb-bottom-item", 3, "routerLink"], [1, "isax", "isax-user-square"], [1, "isax", "isax-setting-2"], [1, "sb-bottom-item", "logout", 3, "click"], [1, "isax", "isax-logout"], [1, "isax", "isax-building"], [1, "sb-sub"], ["routerLinkActive", "active", "class", "sb-sub-item", 3, "routerLink", 4, "appHasPermission"], ["routerLinkActive", "active", 1, "sb-sub-item", 3, "routerLink"], [1, "isax", "isax-people"], [1, "isax", "isax-shield-tick"], [1, "isax", "isax-lock"]], template: function SuperadminSidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275element(70, "div", 15);
      \u0275\u0275elementStart(71, "div", 10)(72, "div", 11);
      \u0275\u0275text(73, "Rapport");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(106, "div", 32)(107, "a", 33);
      \u0275\u0275element(108, "i", 34);
      \u0275\u0275text(109, " Mon profil ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(110, "a", 33);
      \u0275\u0275element(111, "i", 35);
      \u0275\u0275text(112, " Param\xE8tres ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(113, "div", 36);
      \u0275\u0275listener("click", function SuperadminSidebarComponent_Template_div_click_113_listener() {
        return ctx.logout();
      });
      \u0275\u0275element(114, "i", 37);
      \u0275\u0275text(115, " D\xE9connexion ");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(11);
...
(() => {
  ...
  <div class="sb-scroll">
    ...
    <div class="sb-section">
      ...
      <a [routerLink]="routes.superadminSession" routerLinkActive="active" class="sb-item">
        <i class="isax isax-calendar-1"></i><span class="sb-item-label">Sessions</span>
      </a>
      <a [routerLink]="routes.superadminParcours" routerLinkActive="active" class="sb-item">
        <i class="isax isax-routing-2"></i><span class="sb-item-label">Parcours</span>
      </a>
    </div>
    ...
    <!-- FINANCE -->
    <div class="sb-section">
      <div class="sb-section-label">Rapport</div>
      ...
      <a [routerLink]="routes.superadminStatements" routerLinkActive="active" class="sb-item">
        <i class="isax isax-receipt-item"></i><span class="sb-item-label">Rapports</span>
      </a>
    </div>
    ...
    <div class="sb-section">
      ...
      <a [routerLink]="routes.superadminSondage" routerLinkActive="active" class="sb-item">
        <i class="isax isax-note-21"></i><span class="sb-item-label">Sondages &amp; enqu\xEAtes</span>
      </a>
    </div>
    ...
    <!-- S\xC9CURIT\xC9 -->
    <div class="sb-section">
      <div class="sb-section-label">S\xE9curit\xE9</div>
      <a [routerLink]="routes.superadminAuditLogs" routerLinkActive="active" class="sb-item">
        <i class="isax isax-clipboard-text"></i><span class="sb-item-label">Logs d'audit</span>
      </a>
    </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminComponent, { className: "SuperadminComponent", filePath: "src/app/features/superadmin/superadmin.component.ts", lineNumber: 24 });
})();
export {
  SuperadminComponent
};
//# sourceMappingURL=chunk-BZA2WYS4.js.map
