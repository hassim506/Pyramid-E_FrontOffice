...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SuperadminPayoutsComponent, [{
    type: Component,
    args: [{ selector: "app-superadmin-payouts", imports: [CommonModule, MatTableModule, MatSortModule, FormsModule, MatPaginatorModule, MatSelectModule, BsDatepickerModule, CustomPaginationComponent], template: `
    <div class="payouts">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminPayoutsComponent, { className: "SuperadminPayoutsComponent", filePath: "src/app/features/superadmin/superadmin-payouts/superadmin-payouts.component.ts", lineNumber: 23 });
})();
export {
  SuperadminPayoutsComponent
};
//# sourceMappingURL=chunk-4JHPUOCW.js.map
