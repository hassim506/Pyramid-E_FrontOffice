...
function AdminrhRoleComponent_table_17_tr_18_span_17_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhRoleComponent_table_17_tr_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(11, "td")(12, "span", 101);
    \u0275\u0275element(13, "i");
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "td");
    \u0275\u0275template(16, AdminrhRoleComponent_table_17_tr_18_span_16_Template, 2, 1, "span", 102)(17, AdminrhRoleComponent_table_17_tr_18_span_17_Template, 2, 0, "span", 103);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "td")(19, "button", 104);
    \u0275\u0275listener("click", function AdminrhRoleComponent_table_17_tr_18_Template_button_click_19_listener() {
    ...
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "td")(23, "span", 106);
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "td", 107);
    \u0275\u0275text(26);
    \u0275\u0275pipe(27, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "td")(29, "div", 108)(30, "button", 109);
    \u0275\u0275listener("click", function AdminrhRoleComponent_table_17_tr_18_Template_button_click_30_listener() {
      const role_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.viewRolePermissions(role_r3));
    });
    \u0275\u0275element(31, "i", 110);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "button", 111);
    \u0275\u0275listener("click", function AdminrhRoleComponent_table_17_tr_18_Template_button_click_32_listener() {
      const role_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(role_r3.description || "ID: " + role_r3.id);
    \u0275\u0275advance(2);
    \u0275\u0275attribute("data-role", ctx_r0.getRoleTypeKey(role_r3));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(27, 15, role_r3.created_at, "dd/MM/yyyy"));
  }
}
...
function AdminrhRoleComponent_table_17_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275element(4, "br");
    \u0275\u0275template(5, AdminrhRoleComponent_table_17_tr_19_button_5_Template, 3, 0, "button", 117);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminrhRoleComponent_table_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(18, AdminrhRoleComponent_table_17_tr_18_Template, 34, 18, "tr", 95)(19, AdminrhRoleComponent_table_17_tr_19_Template, 6, 2, "tr", 74);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
        ...
        <td>\r
          <div class="ul-user">\r
            ...
            <div>\r
              ...
              <div class="ul-user__email">{{ role.description || ('ID: ' + role.id) }}</div>\r
            </div>\r
          </div>\r
        </td>\r
        <td>\r
...
//# sourceMappingURL=chunk-IJCIRH2Y.js.map
