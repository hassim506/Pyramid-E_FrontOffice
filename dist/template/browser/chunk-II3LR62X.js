...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorQuizResultsComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-quiz-results", imports: [CommonModule, MatTableModule, MatSortModule, MatPaginatorModule, MatSelectModule, CustomPaginationComponent, RouterLink, FormsModule], template: `<!-- Loading -->\r
  ...
  <div class="ip-card ip-filter-card">\r
    <div class="ip-filter-row">\r
      <div class="ip-filter-group">\r
        <label class="ip-label">Quiz ID</label>\r
        <div class="ip-input-icon-wrap">\r
          <i class="isax isax-award ip-input-icon"></i>\r
          <input type="number" class="ip-input ip-input--icon"\r
                 [(ngModel)]="filterQuizId" (ngModelChange)="applyFilters()"\r
                 placeholder="ID du quiz">\r
        </div>\r
      </div>\r
      <div class="ip-filter-group">\r
        <label class="ip-label">Utilisateur ID</label>\r
        <div class="ip-input-icon-wrap">\r
          <i class="isax isax-user ip-input-icon"></i>\r
          <input type="number" class="ip-input ip-input--icon"\r
                 [(ngModel)]="filterUserId" (ngModelChange)="applyFilters()"\r
          ...
          <tr *ngFor="let result of getPaginatedResults()">\r
            ...
            <td>\r
              <span class="ip-pill">\r
                <i class="isax isax-award"></i> Quiz #{{ result.quiz_id }}\r
              </span>\r
            </td>\r
            <td>\r
              <div class="ip-user-cell">\r
                <div class="ip-user-avatar"><i class="isax isax-user"></i></div>\r
                <span>User #{{ result.user_id }}</span>\r
              </div>\r
            </td>\r
            <td>\r
...
\r
  ...
  <app-custom-pagination\r
    *ngIf="filteredResults.length > 0"\r
...
//# sourceMappingURL=chunk-II3LR62X.js.map
