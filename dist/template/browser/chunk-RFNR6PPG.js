...
function AdminrhSidebarComponent_a_47_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AdminrhSidebarComponent_a_47_span_4_Template, 2, 1, "span", 29);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AdminrhSidebarComponent_div_48_div_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "a", 59)(2, "span", 60);
    \u0275\u0275text(3, "Formations");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AdminrhSidebarComponent_div_48_div_7_span_4_Template, 2, 1, "span", 61);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "a", 59)(6, "span", 60);
    \u0275\u0275text(7, "Parcours");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "a", 59)(9, "span", 60);
    \u0275\u0275text(10, "Catalogue");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function AdminrhSidebarComponent_div_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "Demandes");
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, AdminrhSidebarComponent_div_48_span_5_Template, 2, 1, "span", 54);
    \u0275\u0275element(6, "i", 55);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, AdminrhSidebarComponent_div_48_div_7_Template, 11, 4, "div", 56);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AdminrhSidebarComponent_div_53_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "Formations");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "a", 59)(5, "span", 60);
    \u0275\u0275text(6, "Catalogue");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "a", 59)(8, "span", 60);
    \u0275\u0275text(9, "Parcours");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function AdminrhSidebarComponent_div_53_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(5, "i", 55);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, AdminrhSidebarComponent_div_53_div_6_Template, 10, 3, "div", 56);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AdminrhSidebarComponent_a_54_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "Sessions");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AdminrhSidebarComponent_a_54_span_4_Template, 2, 1, "span", 65);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AdminrhSidebarComponent_div_60_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(5, "i", 55);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, AdminrhSidebarComponent_div_60_div_6_Template, 7, 2, "div", 56);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AdminrhSidebarComponent_a_61_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AdminrhSidebarComponent_a_61_span_4_Template, 2, 1, "span", 70);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AdminrhSidebarComponent_div_77_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhSidebarComponent_a_89_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhSidebarComponent_a_90_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 78);
    \u0275\u0275element(1, "i", 80);
...
var AdminrhSidebarComponent = class _AdminrhSidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminrhSidebarComponent, selectors: [["app-adminrh-sidebar"]], decls: 103, vars: 32, consts: [[1, "sb-shell"], [1, "sb-logo"], [1, "sb-logo-mark"], [1, "sb-logo-text"], [1, "sb-logo-badge"], [1, "sb-profile"], [1, "sb-av"], [1, "sb-profile-info"], [1, "sb-pname"], [1, "sb-prole"], [1, "sb-pcompany"], [1, "isax", "isax-buildings-2"], [1, "sb-ministats"], [1, "sb-ministat"], [1, "sb-ministat-val"], [1, "sb-ministat-lbl"], [1, "sb-ministat-div"], ["class", "sb-ministat sb-ministat--warn", 4, "ngIf"], ["class", "sb-ministat", 4, "ngIf"], [1, "sb-scroll"], [1, "sb-section"], [1, "sb-section-label"], ["routerLinkActive", "active", 1, "sb-item", 3, "routerLink"], [1, "isax", "isax-grid-3"], [1, "sb-item-label"], [1, "sb-divider"], ["routerLinkActive", "active", "class", "sb-item", 3, "routerLink", 4, "appHasPermission"], ["class", "sb-group", 4, "appHasPermission"], [1, "isax", "isax-ticket"], ["class", "sb-badge", 4, "ngIf"], ["class", "sb-widget-alert", 4, "ngIf"], [1, "sb-widget-quota"], [1, "sb-quota-header"], [1, "sb-quota-lbl"], [1, "sb-quota-val"], [1, "sb-quota-bar"], [1, "sb-quota-fill"], [1, "sb-quota-sub"], [1, "sb-bottom"], ["routerLinkActive", "active", "class", "sb-bottom-item sb-item", 3, "routerLink", 4, "appHasPermission"], ["routerLinkActive", "active", 1, "sb-bottom-item", 3, "routerLink"], [1, "isax", "isax-user-square"], [1, "sb-bottom-item", "sb-learner-switch", 3, "routerLink"], [1, "isax", "isax-user-octagon"], [1, "sb-bottom-item", "sb-trainer-switch", 3, "routerLink"], [1, "isax", "isax-teacher"], [1, "sb-bottom-item", "logout", 3, "routerLink"], [1, "isax", "isax-logout"], [1, "sb-ministat", "sb-ministat--warn"], [1, "isax", "isax-people"], [1, "sb-badge"], [1, "sb-group"], [1, "sb-group-header", 3, "click"], [1, "isax", "isax-document-text", "icon"], ["class", "sb-badge sb-badge--red", 4, "ngIf"], [1, "isax", "isax-arrow-right-3", "arr"], ["class", "sb-sub", 4, "ngIf"], [1, "sb-badge", "sb-badge--red"], [1, "sb-sub"], ["routerLinkActive", "active", 1, "sb-sub-item", 3, "routerLink"], [1, "sb-sub-label"], ["class", "sb-badge sb-badge--red sb-badge--sm", 4, "ngIf"], [1, "sb-badge", "sb-badge--red", "sb-badge--sm"], [1, "isax", "isax-book-1", "icon"], [1, "isax", "isax-calendar-1"], ["class", "sb-badge sb-badge--amber", 4, "ngIf"], [1, "sb-badge", "sb-badge--amber"], [1, "isax", "isax-chart-2"], [1, "isax", "isax-award", "icon"], [1, "isax", "isax-note-21"], ["class", "sb-badge sb-badge--teal", 4, "ngIf"], [1, "sb-badge", "sb-badge--teal"], [1, "isax", "isax-receipt-item"], [1, "sb-widget-alert"], [1, "sb-widget-alert-title"], [1, "isax", "isax-warning-2"], [1, "sb-widget-alert-sub"], [1, "sb-widget-alert-link", 3, "routerLink"], ["routerLinkActive", "active", 1, "sb-bottom-item", "sb-item", 3, "routerLink"], [1, "isax", "isax-setting-2"], [1, "isax", "isax-award"]], template: function AdminrhSidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(71, "Communication");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(72, "a", 22);
      \u0275\u0275element(73, "i", 28);
      \u0275\u0275elementStart(74, "span", 24);
      \u0275\u0275text(75, "Tickets support");
      \u0275\u0275elementEnd();
      \u0275\u0275template(76, AdminrhSidebarComponent_span_76_Template, 2, 1, "span", 29);
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(77, AdminrhSidebarComponent_div_77_Template, 8, 2, "div", 30);
      \u0275\u0275elementStart(78, "div", 31)(79, "div", 32)(80, "span", 33);
      \u0275\u0275text(81, "QUOTA FORMATIONS");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275element(85, "div", 36);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(86, "div", 37);
      \u0275\u0275text(87);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(88, "div", 38);
      \u0275\u0275template(89, AdminrhSidebarComponent_a_89_Template, 3, 1, "a", 39)(90, AdminrhSidebarComponent_a_90_Template, 3, 1, "a", 39);
      \u0275\u0275elementStart(91, "a", 40);
      \u0275\u0275element(92, "i", 41);
      \u0275\u0275text(93, " Mon profil ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(94, "a", 42);
      \u0275\u0275element(95, "i", 43);
      \u0275\u0275text(96, " Mode apprenant ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(97, "a", 44);
      \u0275\u0275element(98, "i", 45);
      \u0275\u0275text(99, " Mode formateur ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(100, "a", 46);
      \u0275\u0275element(101, "i", 47);
      \u0275\u0275text(102, " D\xE9connexion ");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(11);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhSidebarComponent, { className: "AdminrhSidebarComponent", filePath: "app/features/adminrh/common/adminrh-sidebar/adminrh-sidebar.component.ts", lineNumber: 21 });
})();
...
//# sourceMappingURL=chunk-RFNR6PPG.js.map
