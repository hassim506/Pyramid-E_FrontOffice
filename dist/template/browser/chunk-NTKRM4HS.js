...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhAnnouncementsComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-announcements", imports: [CommonModule, MatTableModule, MatSortModule, MatPaginatorModule, MatSelectModule, FormsModule], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhAnnouncementsComponent, { className: "AdminrhAnnouncementsComponent", filePath: "src/app/features/adminrh/adminrh-announcements/adminrh-announcements.component.ts", lineNumber: 20 });
})();
export {
  AdminrhAnnouncementsComponent
};
//# sourceMappingURL=chunk-NTKRM4HS.js.map
