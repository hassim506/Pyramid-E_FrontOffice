...
function LectureFormationComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7, "Chargement de la formation...");
    \u0275\u0275elementEnd()();
  }
}
...
function LectureFormationComponent_div_5_div_26_div_6_span_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ~", ctx_r0.sondageAChaud.duree_estimee, " min ");
  }
}
function LectureFormationComponent_div_5_div_26_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 219)(1, "span");
    \u0275\u0275element(2, "i", 225);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, LectureFormationComponent_div_5_div_26_div_6_span_4_Template, 3, 1, "span", 35);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", ctx_r0.sondageAChaud.nombre_questions, " question", ctx_r0.sondageAChaud.nombre_questions !== 1 ? "s" : "", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.sondageAChaud.duree_estimee);
  }
}
function LectureFormationComponent_div_5_div_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 216)(1, "div", 217);
    \u0275\u0275element(2, "i", 223);
    \u0275\u0275text(3, "Sondage de satisfaction ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 218);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, LectureFormationComponent_div_5_div_26_div_6_Template, 5, 3, "div", 224);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.sondageAChaud.titre);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.sondageAChaud.nombre_questions);
  }
}
function LectureFormationComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r24 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 198);
    \u0275\u0275listener("click", function LectureFormationComponent_div_5_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r24);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.ignorerSondage());
    });
    \u0275\u0275elementStart(1, "div", 199);
    \u0275\u0275listener("click", function LectureFormationComponent_div_5_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r24);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "div", 200)(3, "span");
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "h2", 204);
    \u0275\u0275text(18, "Formation termin\xE9e ! \u{1F389}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "p", 205);
    \u0275\u0275text(20, " Vous avez termin\xE9 ");
    \u0275\u0275elementStart(21, "strong");
    \u0275\u0275text(22);
    \u0275\u0275elementEnd();
    \u0275\u0275text(23, ".");
    \u0275\u0275element(24, "br");
    \u0275\u0275text(25, " Donnez-nous votre avis en r\xE9pondant au sondage. ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(26, LectureFormationComponent_div_5_div_26_Template, 7, 2, "div", 206);
    \u0275\u0275elementStart(27, "div", 207)(28, "button", 208);
    \u0275\u0275listener("click", function LectureFormationComponent_div_5_Template_button_click_28_listener() {
      \u0275\u0275restoreView(_r24);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.allerAuSondage());
    });
    \u0275\u0275element(29, "i", 209);
    \u0275\u0275text(30, " R\xE9pondre maintenant ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "button", 210);
    \u0275\u0275listener("click", function LectureFormationComponent_div_5_Template_button_click_31_listener() {
      \u0275\u0275restoreView(_r24);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.ignorerSondage());
    });
    \u0275\u0275element(32, "i", 211);
    \u0275\u0275text(33, " Je le ferai plus tard ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "button", 212);
    \u0275\u0275listener("click", function LectureFormationComponent_div_5_Template_button_click_34_listener() {
      \u0275\u0275restoreView(_r24);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.fermerModalSondage());
    });
    \u0275\u0275element(35, "i", 213);
    \u0275\u0275text(36, " Retour au tableau de bord ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "p", 214);
    \u0275\u0275element(38, "i", 215);
    \u0275\u0275text(39, " Le sondage restera disponible dans ");
    \u0275\u0275elementStart(40, "strong");
    \u0275\u0275text(41, "Mes Sondages");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275textInterpolate(ctx_r0.formation == null ? null : ctx_r0.formation.titre);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", ctx_r0.sondageAChaud);
  }
}
var LectureFormationComponent = class _LectureFormationComponent {
  ...
  embeddedParcoursId = null;
  embeddedCatalogueId = null;
  ...
  ngOnInit() {
    if (this.embeddedFormationId) {
      ...
      console.log(`\u{1F680} [LectureFormation] Mode EMBARQU\xC9 \u2192 formationId=${this.formationId} | parcoursId=${this.parcoursId} | catalogueId=${this.catalogueId}`);
      this.loadStructure();
    } else {
      ...
      if (idFromRoute) {
        ...
        console.log(`\u{1F680} [LectureFormation] Mode ROUTE \u2192 formationId=${this.formationId}`);
        console.log(`\u{1F4CB} [LectureFormation] history.state complet:`, state);
        console.log(`\u{1F511} [LectureFormation] Contexte \u2192 parcoursId=${this.parcoursId} | catalogueId=${this.catalogueId} | fromPage=${state?.fromPage}`);
        this.loadStructure();
      } else {
  ...
  ngOnChanges(changes) {
    if (changes["embeddedFormationId"]?.currentValue) {
      ...
      this.parcoursId = this.embeddedParcoursId ?? null;
      this.catalogueId = this.embeddedCatalogueId ?? null;
      console.log(`\u{1F504} [LectureFormation] ngOnChanges \u2192 nouveau formationId=${this.formationId} | parcoursId=${this.parcoursId} | catalogueId=${this.catalogueId}`);
      this.resetState();
      this.loadStructure();
    }
  }
  ngOnDestroy() {
    ...
    console.log(`\u{1F5D1}\uFE0F [LectureFormation] Destruction \u2192 formationId=${this.formationId} | parcoursId=${this.parcoursId} | catalogueId=${this.catalogueId}`);
  }
  resetState() {
    this.loading = true;
    this.error = "";
    ...
    this.sondageAChaud = null;
  }
  loadStructure() {
    this.loading = true;
    this.error = "";
    console.log(`\u{1F4E1} [LectureFormation] loadStructure() \u2192 formationId=${this.formationId} | parcoursId=${this.parcoursId} | catalogueId=${this.catalogueId}`);
    this.progressionService.loadFromApi(this.formationId, this.parcoursId, this.catalogueId).subscribe({
      next: (res) => {
        ...
        console.log(`\u{1F4CA} [LectureFormation] Sections d\xE9j\xE0 compl\xE9t\xE9es: [${res?.completed_section_ids ?? []}] | %=${res?.progression ?? 0}`);
      },
      error: (err) => {
    ...
    this.formationsService.getFormationStructure(this.formationId).subscribe({
      next: (res) => {
        ...
        if (!Array.isArray(this.modules))
          this.modules = [];
        console.log(`\u2705 [LectureFormation] Structure charg\xE9e \u2192 formation:`, this.formation?.titre);
        ...
        this.progressionService.init(this.formationId, this.flatSections.length, [], this.parcoursId, this.catalogueId);
  ...
  selectSection(section) {
    console.log(`\u{1F4D6} [LectureFormation] selectSection \u2192 id=${section.id} | titre="${section.titre}" | type=${section.type}`);
  ...
  markCompleted(sectionId) {
    ...
    this.progressionService.markCompleted(this.formationId, sectionId, this.parcoursId, this.catalogueId).subscribe((res) => {
      console.log(`\u2705 [LectureFormation] markCompleted r\xE9ponse:`, {
      ...
      if (this.hasQuiz(this.selectedSection) && !this.quizResults[sectionId]) {
        console.log(`\u{1F3AF} [LectureFormation] Section a un quiz \u2192 d\xE9marrage automatique dans 400ms`);
        setTimeout(() => this.startQuiz(), 400);
      }
      if (res?.est_termine && res?.quiz_final) {
        console.log(`\u{1F3C6} [LectureFormation] Formation TERMIN\xC9E \u2014 quiz final disponible:`, res.quiz_final);
        setTimeout(() => this._ouvrirModalQuizFinal(res.quiz_final), 600);
      }
      if (res?.est_termine && !res?.quiz_final) {
        console.log(`\u{1F389} [LectureFormation] Formation TERMIN\xC9E \u2014 pas de quiz final`);
      }
    });
  }
  // ✅ isCompleted — passe parcoursId + catalogueId au service
  isCompleted(id) {
    return this.progressionService.isCompleted(this.formationId, id, this.parcoursId, this.catalogueId);
  }
  hasQuiz(s) {
    return s?.quiz?.questions?.length > 0;
  }
  startQuiz() {
    console.log(`\u{1F3AF} [LectureFormation] startQuiz \u2192 sectionId=${this.selectedSection?.id}`);
    this.quizMode = true;
    this.quizSubmitted = false;
    this.currentAnswers = {};
  }
  ...
  submitQuiz() {
    ...
    console.log(`\u{1F4DD} [LectureFormation] submitQuiz \u2192 score=${score}/${questions.length} | passed=${passed} | sectionId=${this.selectedSection.id}`);
    ...
    if (passed) {
      console.log(`\u2705 [LectureFormation] Quiz r\xE9ussi \u2192 markCompleted sectionId=${this.selectedSection.id}`);
      this.progressionService.markCompleted(this.formationId, this.selectedSection.id, this.parcoursId, this.catalogueId).subscribe((res) => {
        console.log(`\u2705 [LectureFormation] markCompleted apr\xE8s quiz r\xE9ussi:`, {
          progression: res?.progression,
          est_termine: res?.est_termine,
          quiz_final: res?.quiz_final
        });
        if (res?.est_termine && res?.quiz_final) {
          console.log(`\u{1F3C6} [LectureFormation] Formation TERMIN\xC9E via quiz \u2014 quiz final:`, res.quiz_final);
          setTimeout(() => this._ouvrirModalQuizFinal(res.quiz_final), 600);
        }
      });
    } else {
      console.log(`\u274C [LectureFormation] Quiz \xE9chou\xE9 \u2192 section NON marqu\xE9e compl\xE9t\xE9e`);
    }
  }
  retryQuiz() {
    console.log(`\u{1F501} [LectureFormation] retryQuiz \u2192 sectionId=${this.selectedSection?.id}`);
    this.quizSubmitted = false;
    this.currentAnswers = {};
    if (this.selectedSection?.id) {
      delete this.quizResults[this.selectedSection.id];
      this.progressionService.markUncompleted(this.formationId, this.selectedSection.id, this.parcoursId, this.catalogueId);
    }
  }
  // ── Modal Quiz Final ─────────────────────────────────────
  _ouvrirModalQuizFinal(quiz) {
    console.log(`\u{1F3C6} [LectureFormation] _ouvrirModalQuizFinal:`, quiz);
  ...
  allerAuQuizFinal() {
    if (!this.quizFinalData)
      return;
    console.log(`\u{1F3AF} [LectureFormation] allerAuQuizFinal \u2192 quizId=${this.quizFinalData.id}`);
    this.showQuizFinalModal = false;
  ...
  resterEtFairePlusTard() {
    console.log(`\u23F3 [LectureFormation] resterEtFairePlusTard \u2014 modal ferm\xE9e, quiz ignor\xE9 pour l'instant`);
    this.showQuizFinalModal = false;
  }
  // ── Modal Sondage à chaud ─────────────────────────
  _ouvrirModalSondage(sondage) {
    this.sondageAChaud = sondage;
    this.showSondageModal = true;
  }
  allerAuSondage() {
    if (!this.sondageAChaud)
      return;
    this.showSondageModal = false;
  ...
  goBack() {
    if (this.isEmbedded) {
      console.log(`\u21A9\uFE0F [LectureFormation] goBack \u2192 mode embarqu\xE9 \u2192 closePlayer.emit()`);
  ...
  getModuleProgress(module) {
    ...
    if (!s.length)
      return 0;
    const done = s.filter((x) => this.progressionService.isCompleted(this.formationId, x.id, this.parcoursId, this.catalogueId)).length;
    const percent = Math.round(done / s.length * 100);
    console.log(`\u{1F4CA} [LectureFormation] getModuleProgress "${module.titre}" \u2192 ${done}/${s.length} = ${percent}%`);
    return percent;
  }
  getSectionIcon(s) {
    return {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LectureFormationComponent, selectors: [["app-lecture-formation"]], inputs: { embeddedFormationId: "embeddedFormationId", embeddedParcoursId: "embeddedParcoursId", embeddedCatalogueId: "embeddedCatalogueId" }, outputs: { closePlayer: "closePlayer" }, features: [\u0275\u0275NgOnChangesFeature], decls: 6, vars: 6, consts: [["class", "lp-loader", 4, "ngIf"], ["class", "lp-error", 4, "ngIf"], ["class", "lp-empty", 4, "ngIf"], ["class", "lp-shell", 4, "ngIf"], ["class", "lp-modal-overlay", 3, "click", 4, "ngIf"], [1, "lp-loader"], [1, "qq-loading__ring"], [1, "lp-loader__text"], [1, "lp-error"], [1, "lp-error__icon"], [1, "isax", "isax-warning-2"], [1, "lp-empty"], [1, "lp-empty__icon"], [1, "isax", "isax-book-1"], [1, "lp-empty__title"], [1, "lp-empty__sub"], [1, "lp-empty__hint"], [1, "isax", "isax-notification", "me-2"], [1, "lp-shell"], [1, "lp-topbar"], [1, "lp-topbar__left"], [1, "lp-topbar__back", 3, "click"], [1, "isax", "isax-arrow-left-2"], [1, "lp-topbar__info"], [1, "lp-topbar__label"], [1, "lp-topbar__title"], [1, "lp-topbar__right"], [1, "lp-topbar__progress"], [1, "lp-topbar__progress-track"], [1, "lp-topbar__progress-fill"], [1, "lp-topbar__progress-label"], [1, "lp-topbar__menu-btn", 3, "click"], [1, "isax", "isax-sidebar-right"], [1, "lp-body"], [1, "lp-main"], [4, "ngIf"], [1, "lp-sidebar"], [1, "lp-sidebar__progress"], [1, "lp-sidebar__progress-info"], [1, "lp-sidebar__progress-bar"], [1, "lp-sidebar__progress-fill"], [1, "lp-sidebar__content"], ["class", "lp-sidebar__module", 4, "ngFor", "ngForOf"], [1, "lp-breadcrumb"], [1, "lp-breadcrumb__back", 3, "click"], [1, "isax", "isax-arrow-left-2", "me-1"], [1, "isax", "isax-arrow-right-3", "lp-breadcrumb__sep"], [1, "lp-breadcrumb__module"], [1, "lp-breadcrumb__current"], [1, "lp-section-header"], [1, "lp-section-header__type-badge"], [1, "lp-section-header__title"], [1, "lp-section-header__meta"], ["class", "lp-meta-tag", 4, "ngIf"], ["class", "lp-meta-tag lp-meta-tag--done", 4, "ngIf"], ["class", "lp-meta-tag lp-meta-tag--quiz", 4, "ngIf"], [1, "lp-actions-bar"], ["class", "lp-btn lp-btn--complete", 3, "click", 4, "ngIf"], ["class", "lp-done-badge", 4, "ngIf"], ["class", "lp-btn lp-btn--quiz", 3, "click", 4, "ngIf"], [1, "lp-nav-btns"], [1, "lp-btn", "lp-btn--prev", 3, "click", "disabled"], [1, "lp-btn", "lp-btn--next", 3, "click", "disabled"], [1, "isax", "isax-arrow-right-2", "ms-1"], ["class", "lp-congrats", 4, "ngIf"], [1, "lp-meta-tag"], [1, "isax", "isax-clock", "me-1"], [1, "lp-meta-tag", "lp-meta-tag--done"], [1, "isax", "isax-tick-circle", "me-1"], [1, "lp-meta-tag", "lp-meta-tag--quiz"], [1, "isax", "isax-task-square", "me-1"], ["class", "lp-media-wrap lp-media-wrap--video", 4, "ngIf"], ["class", "lp-video-description", 4, "ngIf"], [1, "lp-media-wrap", "lp-media-wrap--video"], [1, "lp-embed-wrap"], ["frameborder", "0", "allowfullscreen", "", "allow", "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", 3, "src"], ["frameborder", "0", "allowfullscreen", "", 3, "src"], ["controls", "", "preload", "metadata", 1, "lp-video-native", 3, "ended", "error", "src"], ["class", "lp-video-error", 4, "ngIf"], [1, "lp-video-error"], [1, "isax", "isax-video-slash"], ["target", "_blank", 1, "lp-btn-link", 3, "href"], [1, "isax", "isax-export", "me-1"], [1, "lp-video-description"], [1, "lp-media-wrap", "lp-media-wrap--image"], [1, "lp-image-content", 3, "src", "alt"], ["class", "lp-image-caption", 4, "ngIf"], [1, "lp-image-caption"], [1, "isax", "isax-gallery", "me-2"], ["class", "lp-content-hero", 4, "ngIf"], [1, "lp-text-card"], ["class", "lp-text-intro", 4, "ngIf"], [1, "lp-text-body", 3, "innerHTML"], ["class", "lp-resources", 4, "ngIf"], [1, "lp-content-hero"], [1, "lp-content-hero__img", 3, "src", "alt"], [1, "lp-text-intro"], [1, "isax", "isax-info-circle", "lp-text-intro__icon"], [1, "lp-resources"], [1, "lp-resources__title"], [1, "isax", "isax-folder-2", "me-2"], [1, "lp-resources__list"], ["target", "_blank", "class", "lp-resource-item", 3, "href", 4, "ngFor", "ngForOf"], ["target", "_blank", 1, "lp-resource-item", 3, "href"], [1, "lp-resource-item__icon"], [1, "isax"], [1, "lp-resource-item__body"], [1, "lp-resource-item__name"], [1, "lp-resource-item__type"], [1, "isax", "isax-export", "lp-resource-item__arrow"], [1, "lp-audio-wrap"], [1, "lp-audio-cover"], [1, "lp-audio-cover__img", 3, "src", "alt"], [1, "lp-audio-cover__overlay"], [1, "isax", "isax-voice-cricle"], [1, "lp-audio-player"], [1, "lp-audio-player__title"], ["controls", "", 1, "lp-audio-native", 3, "ended", "src"], ["class", "lp-text-card", 4, "ngIf"], [1, "lp-pdf-wrap"], [1, "lp-pdf-header"], [1, "lp-pdf-header__icon"], [1, "isax", "isax-document-text"], [1, "lp-pdf-header__name"], [1, "lp-pdf-header__hint"], ["target", "_blank", "download", "", 1, "lp-btn", "lp-btn--outline", 3, "href"], [1, "isax", "isax-import", "me-1"], [1, "lp-pdf-viewer"], [1, "lp-pdf-frame", 3, "src"], [1, "lp-btn", "lp-btn--complete", 3, "click"], [1, "isax", "isax-tick-circle", "me-2"], [1, "lp-done-badge"], [1, "lp-btn", "lp-btn--quiz", 3, "click"], [1, "isax", "isax-task-square", "me-2"], [1, "lp-congrats"], [1, "lp-congrats__sparkles"], [1, "lp-congrats__icon"], [1, "isax", "isax-award"], [1, "lp-congrats__title"], [1, "lp-congrats__sub"], [1, "lp-quiz-shell"], [1, "lp-quiz-header"], [1, "lp-quiz-header__back", 3, "click"], [1, "lp-quiz-header__info"], [1, "lp-quiz-header__badge"], [1, "lp-quiz-header__title"], [1, "lp-quiz-header__count"], ["class", "lp-quiz-result", 4, "ngIf"], [1, "lp-quiz-questions"], ["class", "lp-quiz-question", 4, "ngFor", "ngForOf"], ["class", "lp-quiz-footer", 4, "ngIf"], [1, "lp-quiz-result"], [1, "lp-quiz-result__card"], [1, "lp-quiz-result__icon"], [1, "lp-quiz-result__score"], [1, "lp-quiz-result__label"], [1, "lp-quiz-result__sub"], [1, "lp-quiz-result__actions"], [1, "lp-btn", "lp-btn--outline", 3, "click"], [1, "isax", "isax-refresh", "me-1"], ["class", "lp-btn lp-btn--next", 3, "click", 4, "ngIf"], [1, "lp-btn", "lp-btn--next", 3, "click"], [1, "lp-quiz-question"], [1, "lp-quiz-question__header"], [1, "lp-quiz-question__num"], [1, "lp-quiz-question__text"], ["class", "lp-quiz-opts", 4, "ngIf"], ["class", "lp-quiz-explication", 4, "ngIf"], [1, "lp-quiz-opts"], ["class", "lp-quiz-opt", 3, "class", "disabled", "click", 4, "ngFor", "ngForOf"], [1, "lp-quiz-opt", 3, "click", "disabled"], [1, "lp-quiz-opt__indicator"], [1, "lp-quiz-opt__text"], [1, "lp-quiz-explication"], [1, "isax", "isax-info-circle", "me-2"], [1, "lp-quiz-footer"], [1, "lp-btn", "lp-btn--complete", 3, "click", "disabled"], [1, "isax", "isax-send-2", "me-2"], [1, "lp-quiz-footer__hint"], [1, "lp-sidebar__module"], [1, "lp-module-header", 3, "click"], [1, "lp-module-header__left"], [1, "lp-module-header__num"], [1, "lp-module-header__title"], [1, "lp-module-header__right"], [1, "lp-module-header__mini-bar"], ["class", "lp-section-list", 4, "ngIf"], [1, "lp-section-list"], ["class", "lp-section-item", 3, "lp-section-item--active", "lp-section-item--done", "click", 4, "ngFor", "ngForOf"], [1, "lp-section-item", 3, "click"], [1, "lp-section-item__status"], [1, "lp-section-item__body"], [1, "lp-section-item__title"], [1, "lp-section-item__footer"], ["class", "lp-section-item__duration", 4, "ngIf"], ["class", "lp-section-item__quiz-badge", 4, "ngIf"], [1, "lp-section-item__duration"], [1, "lp-section-item__quiz-badge"], [1, "lp-modal-overlay", 3, "click"], [1, "lp-modal", 3, "click"], [1, "lp-modal__confetti"], [1, "lp-modal__icon-wrap"], [1, "lp-modal__icon-ring"], [1, "lp-modal__icon"], [1, "lp-modal__title"], [1, "lp-modal__sub"], ["class", "lp-modal__quiz-info", 4, "ngIf"], [1, "lp-modal__actions"], [1, "lp-modal__btn", "lp-modal__btn--primary", 3, "click"], [1, "isax", "isax-play-circle", "me-2"], [1, "lp-modal__btn", "lp-modal__btn--secondary", 3, "click"], [1, "isax", "isax-clock", "me-2"], [1, "lp-modal__btn", "lp-modal__btn--ghost", 3, "click"], [1, "isax", "isax-arrow-left-2", "me-2"], [1, "lp-modal__note"], [1, "isax", "isax-info-circle", "me-1"], [1, "lp-modal__quiz-info"], [1, "lp-modal__quiz-badge"], [1, "lp-modal__quiz-name"], [1, "lp-modal__quiz-meta"], [1, "isax", "isax-medal-star", "me-1"], [1, "isax", "isax-repeat", "me-1"], [1, "isax", "isax-clipboard-text"], [1, "isax", "isax-clipboard-text", "me-2"], ["class", "lp-modal__quiz-meta", 4, "ngIf"], [1, "isax", "isax-note-21", "me-1"]], template: function LectureFormationComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.showSondageModal);
    }
...
\r
<!-- \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\r
     MODAL SONDAGE \xC0 CHAUD\r
\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 -->\r
<div class="lp-modal-overlay" *ngIf="showSondageModal" (click)="ignorerSondage()">\r
  <div class="lp-modal" (click)="$event.stopPropagation()">\r
\r
    <div class="lp-modal__confetti">\r
      <span>\u{1F389}</span><span>\u{1F4CB}</span><span>\u2705</span><span>\u{1F4AC}</span><span>\u2B50</span>\r
    </div>\r
\r
    <div class="lp-modal__icon-wrap">\r
      <div class="lp-modal__icon-ring"></div>\r
...
\r
    <h2 class="lp-modal__title">Formation termin\xE9e ! \u{1F389}</h2>\r
    <p class="lp-modal__sub">\r
      Vous avez termin\xE9 <strong>{{ formation?.titre }}</strong>.<br>\r
      Donnez-nous votre avis en r\xE9pondant au sondage.\r
    </p>\r
\r
    <div class="lp-modal__quiz-info" *ngIf="sondageAChaud">\r
      <div class="lp-modal__quiz-badge">\r
        <i class="isax isax-clipboard-text me-2"></i>Sondage de satisfaction\r
      </div>\r
      <p class="lp-modal__quiz-name">{{ sondageAChaud.titre }}</p>\r
      <div class="lp-modal__quiz-meta" *ngIf="sondageAChaud.nombre_questions">\r
        <span>\r
          <i class="isax isax-note-21 me-1"></i>\r
          {{ sondageAChaud.nombre_questions }} question{{ sondageAChaud.nombre_questions !== 1 ? 's' : '' }}\r
        </span>\r
        <span *ngIf="sondageAChaud.duree_estimee">\r
          <i class="isax isax-clock me-1"></i>\r
          ~{{ sondageAChaud.duree_estimee }} min\r
        </span>\r
      </div>\r
    </div>\r
\r
    <div class="lp-modal__actions">\r
      <button class="lp-modal__btn lp-modal__btn--primary" (click)="allerAuSondage()">\r
        <i class="isax isax-play-circle me-2"></i>\r
        R\xE9pondre maintenant\r
      </button>\r
      <button class="lp-modal__btn lp-modal__btn--secondary" (click)="ignorerSondage()">\r
        <i class="isax isax-clock me-2"></i>\r
        Je le ferai plus tard\r
      </button>\r
      <button class="lp-modal__btn lp-modal__btn--ghost" (click)="fermerModalSondage()">\r
        <i class="isax isax-arrow-left-2 me-2"></i>\r
        Retour au tableau de bord\r
      </button>\r
    </div>\r
\r
    <p class="lp-modal__note">\r
      <i class="isax isax-info-circle me-1"></i>\r
      Le sondage restera disponible dans <strong>Mes Sondages</strong>\r
    </p>\r
\r
  </div>\r
  ...
  }], () => [{ type: ActivatedRoute }, { type: Router }, { type: FormationService }, { type: DomSanitizer }, { type: ProgressionService }], { embeddedFormationId: [{
    type: Input
  }], embeddedParcoursId: [{
    type: Input
  }], embeddedCatalogueId: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LectureFormationComponent, { className: "LectureFormationComponent", filePath: "app/features/student/lecture-formation/lecture-formation.component.ts", lineNumber: 27 });
})();
export {
  LectureFormationComponent
};
//# sourceMappingURL=chunk-PDTWE4UT.js.map
