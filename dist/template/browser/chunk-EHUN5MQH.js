...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BlogDetailsLeftSidebarComponent, [{
    type: Component,
    args: [{ selector: "app-blog-details-left-sidebar", imports: [CommonModule, RouterLink], template: `<div class="blog-sec blog-details">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BlogDetailsLeftSidebarComponent, { className: "BlogDetailsLeftSidebarComponent", filePath: "app/features/blog/blog-details-left-sidebar/blog-details-left-sidebar.component.ts", lineNumber: 12 });
})();
export {
  BlogDetailsLeftSidebarComponent
};
//# sourceMappingURL=chunk-EHUN5MQH.js.map
