...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorDetailsComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-details", imports: [CommonModule, RouterLink, SlickCarouselModule], template: `<div class="instructor-detail-content">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                        ...
                        <div class="flex-fill">
                            <div class="pb-3 border-bottom mb-3">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <h6 class="fw-bold"><a href="javascript:void(0);">Rolands Granger</a></h6>
                                </div>
                                        ...
                                        <div class="course-item course-item-three mx-2 mb-0">
                                            <div class="course-carousal-img position-relative overflow-hidden rounded-3 mb-3">
                                                ...
                                                <div class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                                                    <a class="like" href="javascript:void(0);"><i class="isax isax-heart color-active"></i></a>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-sm rounded-circle">
                                                        <img class="img-fluid rounded-circle object-fit-cover" src="./assets/img/avatar/avatar2.jpg" alt="img">
                                                    </div>
                                                    <p class="ms-2"><a [routerLink]="routes.instructorDetails">Ana Reyes</a></p>
                                                </div>
                                                <span class="tag-btn">Wordpress</span>
                                            </div>
                                            <h5 class="mt-3 mb-2 text-truncate line-clamb-2"><a [routerLink]="routes.courseDetails">Wordpress for Beginners - Master Wordpress Quickly</a></h5>
                                            ...
                                            <div class="d-flex justify-content-between mt-3 align-items-center">
                                                ...
                                                <a [routerLink]="routes.courseGrid" class="btn view-course-btn">View Course<i class="fs-8 fas fa-angle-right ms-2"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <div class="course-item course-item-three mx-2 mb-0">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-sm rounded-circle">
                                                        <img class="img-fluid rounded-circle object-fit-cover" src="./assets/img/avatar/avatar3.jpg" alt="img">
                                                    </div>
                                                    <p class="ms-2"><a [routerLink]="routes.instructorDetails">Andrew Pirtle</a></p>
                                                </div>
                                                <span class="tag-btn">Design</span>
                                            </div>
                                            <h5 class="mt-3 mb-2 text-truncate line-clamb-2"><a [routerLink]="routes.courseDetails">Sketch from A to Z (2024): Become an app designer</a></h5>
                                ...
                                <div ngxSlickItem>
                                    <div>
                                        <div class="course-item course-item-three mx-2 mb-0">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm rounded-circle">
                                                    <img class="img-fluid rounded-circle object-fit-cover" src="./assets/img/avatar/avatar4.jpg" alt="img">
                                                </div>
                                                <p class="ms-2"><a [routerLink]="routes.instructorDetails">Christy</a></p>
                                            </div>
                                            <span class="tag-btn">Programming</span>
                                            </div>
                                            <h5 class="mt-3 mb-2"><a [routerLink]="routes.courseDetails" class=" text-truncate line-clamb-2">Build Responsive Real World Websites with Crash Course</a></h5>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorDetailsComponent, { className: "InstructorDetailsComponent", filePath: "src/app/features/pages/instructor-details/instructor-details.component.ts", lineNumber: 13 });
})();
export {
  InstructorDetailsComponent
};
//# sourceMappingURL=chunk-SZORFGKR.js.map
