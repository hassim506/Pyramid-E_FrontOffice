...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorSettingsComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-settings", imports: [RouterLink, BsDatepickerModule], template: `\r
\r
        <form>\r
        <div class="card">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorSettingsComponent, { className: "InstructorSettingsComponent", filePath: "app/features/instructor/settings/instructor-settings/instructor-settings.component.ts", lineNumber: 11 });
})();
export {
  InstructorSettingsComponent
};
//# sourceMappingURL=chunk-4CY4SVRT.js.map
