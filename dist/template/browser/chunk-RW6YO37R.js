...
function AdminrhPermissionComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminrhPermissionComponent_div_16_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r1);
...
function AdminrhPermissionComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementStart(3, "button", 58);
    \u0275\u0275listener("click", function AdminrhPermissionComponent_div_17_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function AdminrhPermissionComponent_option_32_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhPermissionComponent_tr_54_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhPermissionComponent_tr_55_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhPermissionComponent_tr_56_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(14, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "td", 31)(16, "div", 68)(17, "button", 69);
    \u0275\u0275text(18, " Actions ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "ul", 70)(20, "li")(21, "a", 71);
    \u0275\u0275listener("click", function AdminrhPermissionComponent_tr_56_Template_a_click_21_listener() {
    ...
    \u0275\u0275element(25, "hr", 73);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "li")(27, "a", 74);
    \u0275\u0275listener("click", function AdminrhPermissionComponent_tr_56_Template_a_click_27_listener() {
      const permission_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(permission_r6.guard_name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(11, 5, permission_r6.created_at, "dd/MM/yyyy HH:mm"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(14, 8, permission_r6.updated_at, "dd/MM/yyyy HH:mm"));
  }
}
function AdminrhPermissionComponent_div_57_li_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 79)(1, "a", 80);
    \u0275\u0275listener("click", function AdminrhPermissionComponent_div_57_li_8_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r8);
...
function AdminrhPermissionComponent_div_57_li_9_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhPermissionComponent_div_57_li_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 79)(1, "a", 80);
    \u0275\u0275listener("click", function AdminrhPermissionComponent_div_57_li_10_Template_a_click_1_listener() {
...
function AdminrhPermissionComponent_div_57_li_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 86)(1, "span", 87);
    \u0275\u0275text(2, "...");
    \u0275\u0275elementEnd()();
...
function AdminrhPermissionComponent_div_57_li_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 79)(1, "a", 80);
    \u0275\u0275listener("click", function AdminrhPermissionComponent_div_57_li_12_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function AdminrhPermissionComponent_div_57_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 76)(1, "div", 27);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "nav", 77)(4, "ul", 78)(5, "li", 79)(6, "a", 80);
    \u0275\u0275listener("click", function AdminrhPermissionComponent_div_57_Template_a_click_6_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(7, "i", 81);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, AdminrhPermissionComponent_div_57_li_8_Template, 3, 0, "li", 82)(9, AdminrhPermissionComponent_div_57_li_9_Template, 3, 0, "li", 83)(10, AdminrhPermissionComponent_div_57_li_10_Template, 3, 3, "li", 84)(11, AdminrhPermissionComponent_div_57_li_11_Template, 3, 0, "li", 83)(12, AdminrhPermissionComponent_div_57_li_12_Template, 3, 1, "li", 82);
    \u0275\u0275elementStart(13, "li", 79)(14, "a", 80);
    \u0275\u0275listener("click", function AdminrhPermissionComponent_div_57_Template_a_click_14_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage + 1));
    });
...
function AdminrhPermissionComponent_div_73_small_1_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhPermissionComponent_div_73_small_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small");
...
function AdminrhPermissionComponent_div_73_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 88);
    \u0275\u0275template(1, AdminrhPermissionComponent_div_73_small_1_Template, 2, 0, "small", 32)(2, AdminrhPermissionComponent_div_73_small_2_Template, 2, 0, "small", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function AdminrhPermissionComponent_div_86_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 88);
...
function AdminrhPermissionComponent_span_91_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 89);
  }
}
function AdminrhPermissionComponent_div_93_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 90);
  }
  if (rf & 2) {
...
Cette action est irr\xE9versible et peut affecter les r\xF4les utilisant cette permission.`;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminrhPermissionComponent, selectors: [["app-adminrh-permission"]], decls: 94, vars: 30, consts: [[1, "page-content"], [1, "d-md-flex", "d-block", "align-items-center", "justify-content-between", "mb-4"], [1, "my-auto", "mb-2"], [1, "mb-1"], [1, "breadcrumb", "mb-0"], [1, "breadcrumb-item"], [3, "routerLink"], ["aria-current", "page", 1, "breadcrumb-item", "active"], [1, "d-flex", "my-xl-auto", "right-content", "align-items-center", "flex-wrap"], ["type", "button", 1, "btn", "btn-primary", 3, "click"], [1, "isax", "isax-add", "me-2"], ["class", "alert alert-success alert-dismissible fade show", "role", "alert", 4, "ngIf"], ["class", "alert alert-danger alert-dismissible fade show", "role", "alert", 4, "ngIf"], [1, "card", "mb-4"], [1, "card-body"], [1, "row", "align-items-center"], [1, "col-md-6"], [1, "input-group"], [1, "input-group-text"], [1, "isax", "isax-search-normal-1"], ["type", "text", "placeholder", "Rechercher une permission...", 1, "form-control", 3, "ngModelChange", "keyup", "ngModel"], [1, "col-md-6", "text-md-end", "mt-3", "mt-md-0"], [1, "d-flex", "align-items-center", "justify-content-md-end", "gap-3"], [1, "d-flex", "align-items-center"], [1, "form-label", "mb-0", "me-2"], [1, "form-select", "form-select-sm", 2, "width", "auto", 3, "ngModelChange", "change", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], [1, "text-muted"], [1, "card"], [1, "table-responsive"], [1, "table", "table-hover"], [1, "text-end"], [4, "ngIf"], [4, "ngFor", "ngForOf"], ["class", "d-flex justify-content-between align-items-center mt-4", 4, "ngIf"], ["tabindex", "-1", 1, "modal", "fade"], [1, "modal-dialog", "modal-dialog-centered"], [1, "modal-content"], [1, "modal-header"], [1, "modal-title"], ["type", "button", 1, "btn-close", 3, "click"], [3, "ngSubmit", "formGroup"], [1, "modal-body"], [1, "mb-3"], [1, "form-label"], [1, "text-danger"], ["type", "text", "formControlName", "name", "placeholder", "Ex: cr\xE9er-utilisateur, modifier-cours...", 1, "form-control"], ["class", "invalid-feedback", 4, "ngIf"], ["formControlName", "guard_name", 1, "form-select"], ["value", "web"], ["value", "api"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-secondary", 3, "click", "disabled"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "spinner-border spinner-border-sm me-2", 4, "ngIf"], ["class", "modal-backdrop fade", 3, "show", 4, "ngIf"], ["role", "alert", 1, "alert", "alert-success", "alert-dismissible", "fade", "show"], [1, "isax", "isax-tick-circle", "me-2"], ["type", "button", "aria-label", "Close", 1, "btn-close", 3, "click"], ["role", "alert", 1, "alert", "alert-danger", "alert-dismissible", "fade", "show"], [1, "isax", "isax-close-circle", "me-2"], [3, "value"], ["colspan", "6", 1, "text-center", "py-5"], ["role", "status", 1, "spinner-border", "text-primary"], [1, "visually-hidden"], [1, "mt-2", "text-muted"], [1, "isax", "isax-box", "fs-48", "text-muted", "mb-3", "d-block"], [1, "badge", "bg-info"], [1, "dropdown"], ["type", "button", "data-bs-toggle", "dropdown", "aria-expanded", "false", 1, "btn", "btn-sm", "btn-light", "dropdown-toggle"], [1, "dropdown-menu"], ["href", "javascript:void(0);", 1, "dropdown-item", 3, "click"], [1, "isax", "isax-edit", "me-2"], [1, "dropdown-divider"], ["href", "javascript:void(0);", 1, "dropdown-item", "text-danger", 3, "click"], [1, "isax", "isax-trash", "me-2"], [1, "d-flex", "justify-content-between", "align-items-center", "mt-4"], ["aria-label", "Pagination des permissions"], [1, "pagination", "pagination-sm", "mb-0"], [1, "page-item"], ["href", "javascript:void(0);", 1, "page-link", 3, "click"], [1, "isax", "isax-arrow-left-2"], ["class", "page-item", 4, "ngIf"], ["class", "page-item disabled", 4, "ngIf"], ["class", "page-item", 3, "active", 4, "ngFor", "ngForOf"], [1, "isax", "isax-arrow-right-2"], [1, "page-item", "disabled"], [1, "page-link"], [1, "invalid-feedback"], [1, "spinner-border", "spinner-border-sm", "me-2"], [1, "modal-backdrop", "fade"]], template: function AdminrhPermissionComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function AdminrhPermissionComponent_Template_button_click_13_listener() {
        return ctx.openModal();
      });
      \u0275\u0275element(14, "i", 10);
      \u0275\u0275text(15, " Nouvelle Permission ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(16, AdminrhPermissionComponent_div_16_Template, 4, 1, "div", 11)(17, AdminrhPermissionComponent_div_17_Template, 4, 1, "div", 12);
      \u0275\u0275elementStart(18, "div", 13)(19, "div", 14)(20, "div", 15)(21, "div", 16)(22, "div", 17)(23, "span", 18);
      \u0275\u0275element(24, "i", 19);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "input", 20);
      \u0275\u0275twoWayListener("ngModelChange", function AdminrhPermissionComponent_Template_input_ngModelChange_25_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.searchText, $event) || (ctx.searchText = $event);
        return $event;
      });
      \u0275\u0275listener("keyup", function AdminrhPermissionComponent_Template_input_keyup_25_listener() {
      ...
      \u0275\u0275twoWayListener("ngModelChange", function AdminrhPermissionComponent_Template_select_ngModelChange_31_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.itemsPerPage, $event) || (ctx.itemsPerPage = $event);
        return $event;
      });
      \u0275\u0275listener("change", function AdminrhPermissionComponent_Template_select_change_31_listener() {
        return ctx.onItemsPerPageChange();
      });
      \u0275\u0275template(32, AdminrhPermissionComponent_option_32_Template, 2, 2, "option", 26);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(48, "Date de Cr\xE9ation");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(49, "th");
      \u0275\u0275text(50, "Date de Modification");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(51, "th", 31);
      \u0275\u0275text(52, "Actions");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(53, "tbody");
      \u0275\u0275template(54, AdminrhPermissionComponent_tr_54_Template, 7, 0, "tr", 32)(55, AdminrhPermissionComponent_tr_55_Template, 5, 0, "tr", 32)(56, AdminrhPermissionComponent_tr_56_Template, 30, 11, "tr", 33);
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(57, AdminrhPermissionComponent_div_57_Template, 16, 14, "div", 34);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(58, "div", 35)(59, "div", 36)(60, "div", 37)(61, "div", 38)(62, "h5", 39);
      \u0275\u0275text(63);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(64, "button", 40);
      \u0275\u0275listener("click", function AdminrhPermissionComponent_Template_button_click_64_listener() {
        return ctx.closeModal();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(65, "form", 41);
      \u0275\u0275listener("ngSubmit", function AdminrhPermissionComponent_Template_form_ngSubmit_65_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275elementStart(66, "div", 42)(67, "div", 43)(68, "label", 44);
      \u0275\u0275text(69, " Nom de la Permission ");
      \u0275\u0275elementStart(70, "span", 45);
      \u0275\u0275text(71, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(72, "input", 46);
      \u0275\u0275template(73, AdminrhPermissionComponent_div_73_Template, 3, 2, "div", 47);
      \u0275\u0275elementStart(74, "small", 27);
      \u0275\u0275text(75, " Utilisez des tirets pour s\xE9parer les mots (ex: cr\xE9er-utilisateur) ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(76, "div", 43)(77, "label", 44);
      \u0275\u0275text(78, " Guard ");
      \u0275\u0275elementStart(79, "span", 45);
      \u0275\u0275text(80, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(81, "select", 48)(82, "option", 49);
      \u0275\u0275text(83, "Web");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(84, "option", 50);
      \u0275\u0275text(85, "API");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(86, AdminrhPermissionComponent_div_86_Template, 2, 0, "div", 47);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(87, "div", 51)(88, "button", 52);
      \u0275\u0275listener("click", function AdminrhPermissionComponent_Template_button_click_88_listener() {
        return ctx.closeModal();
      });
      \u0275\u0275text(89, " Annuler ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(90, "button", 53);
      \u0275\u0275template(91, AdminrhPermissionComponent_span_91_Template, 1, 0, "span", 54);
      \u0275\u0275text(92);
      \u0275\u0275elementEnd()()()()()();
      \u0275\u0275template(93, AdminrhPermissionComponent_div_93_Template, 1, 2, "div", 55);
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
...
\r
            <tr *ngFor="let permission of paginatedPermissions">\r
              ...
              <td>\r
                <span class="badge bg-info">{{ permission.guard_name }}</span>\r
              </td>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhPermissionComponent, { className: "AdminrhPermissionComponent", filePath: "src/app/features/adminrh/adminrh-permission/adminrh-permission.component.ts", lineNumber: 16 });
})();
export {
  AdminrhPermissionComponent
};
//# sourceMappingURL=chunk-RW6YO37R.js.map
