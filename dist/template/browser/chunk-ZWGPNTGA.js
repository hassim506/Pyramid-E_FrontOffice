...
function AdminrhDemandeParcoursComponent_div_77_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(27, AdminrhDemandeParcoursComponent_div_77_div_1_button_27_Template, 4, 3, "button", 64)(28, AdminrhDemandeParcoursComponent_div_77_div_1_button_28_Template, 4, 3, "button", 65)(29, AdminrhDemandeParcoursComponent_div_77_div_1_button_29_Template, 2, 0, "button", 66);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhDemandeParcoursComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-demande-parcours", standalone: true, imports: [RouterLink, FormsModule, CommonModule, MatSortModule, CustomPaginationComponent], template: `<div class="page">

  <!-- Page Header -->
  <div class="page-header">
    <div class="page-header__left">
      <h1>Demandes de parcours</h1>
      <p>G\xE9rez et traitez les demandes de parcours de formation</p>
    </div>
  ...
  <div class="kpi-row">
    ...
    <div class="kpi">
      <div class="kpi__icon ki-purple"><i class="isax isax-route-square"></i></div>
      <div class="kpi__body">
        <div class="kpi__label">Total</div>
        <div class="kpi__val">{{ totalDemandes }}</div>
        <div class="kpi__delta">parcours</div>
      </div>
    </div>
  </div>
  ...
  <div class="main-card">
    ...
    <div class="toolbar">
      <div class="search-box">
        ...
        <input type="search" placeholder="Rechercher parcours, employ\xE9..."
    ...
    <div *ngIf="!loading && !hasData" class="empty-state">
      ...
      <p>Aucune demande de parcours</p>
    </div>
    ...
    <div *ngIf="!loading && hasData" class="demande-list">
      <div *ngFor="let d of tableData; trackBy: trackByDemandeId" class="demande-item">
        ...
        <div class="d-left">
          ...
          <div class="d-type-line tl-parc"></div>
        </div>
        ...
        <div class="d-body">
          ...
          <div class="d-title">{{ d.parcours?.titre || d.parcours?.nom || 'Parcours non d\xE9fini' }}</div>

          <div class="d-meta">
            <span *ngIf="d.date_souhaitee_debut"><i class="isax isax-calendar-1"></i> {{ formatDate(d.date_souhaitee_debut) }}</span>
            <span *ngIf="d.parcours?.description">{{ d.parcours?.description }}</span>
        ...
        <div class="d-right">
          <div class="d-badges">
            ...
            <span class="tb tb-parc">Parcours</span>
          </div>
...
//# sourceMappingURL=chunk-ZWGPNTGA.js.map
