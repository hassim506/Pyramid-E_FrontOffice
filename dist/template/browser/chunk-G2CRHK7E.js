...
<!-- Breadcrumb -->
<div [hidden]="page==='course-details-2'" class="breadcrumb-bar text-center">
    <div class="container">
        <div class="row">
                    ...
                    <div class="row row-gap-4">
                        <div class="col-lg-3">
                            <div class="footer-widget footer-menu">
                                <h5 class="footer-title">Pour Formateur</h5>
                                <ul>
                        ...
                        <div class="col-lg-3">
                            <div class="footer-widget footer-menu">
                                <h5 class="footer-title">Pour employ\xE9</h5>
                                <ul>
...
//# sourceMappingURL=chunk-G2CRHK7E.js.map
