...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SuperadminSettingsComponent, [{
    type: Component,
    args: [{ selector: "app-superadmin-settings", imports: [RouterLink, BsDatepickerModule], template: `\r
\r
        <form>\r
        <div class="card">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminSettingsComponent, { className: "SuperadminSettingsComponent", filePath: "app/features/superadmin/settings/superadmin-settings/superadmin-settings.component.ts", lineNumber: 11 });
})();
export {
  SuperadminSettingsComponent
};
//# sourceMappingURL=chunk-2RY5XIRG.js.map
