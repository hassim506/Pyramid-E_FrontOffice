...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ForgotPasswordComponent, [{
    type: Component,
    args: [{ standalone: true, selector: "app-forgot-password", imports: [CommonModule, FormsModule, RouterLink, SlickCarouselModule], template: `<div class="main-wrapper">
          ...
          <div class="loginbox">
            <div class="w-100">
              ...
              <div class="d-flex align-items-center justify-content-between login-header">
                <img src="assets/img/logo.png" class="img-fluid fp-logo" alt="Logo Pyramide">
              ...
              <ng-container *ngIf="!sent">
                ...
                <h1 class="fs-32 fw-bold topic">Mot de passe oubli\xE9 ?</h1>
                <p class="text-muted mb-4">
                  Entrez votre adresse e-mail et nous vous enverrons un lien pour r\xE9initialiser votre mot de passe.
                </p>
                ...
                <form (ngSubmit)="submit()" class="mb-3 pb-3">
                  ...
                  <div class="d-grid mb-3">
                    <button class="btn btn-secondary btn-lg" type="submit" [disabled]="isLoading">
                      ...
                      <i *ngIf="!isLoading" class="isax isax-send-2 me-2"></i>
                      {{ isLoading ? 'Envoi en cours\u2026' : 'Envoyer le lien de r\xE9initialisation' }}
                    </button>
                  </div>
                </form>
              ...
              <!-- \u2500\u2500 \xC9tat : e-mail envoy\xE9 \u2500\u2500 -->
              <ng-container *ngIf="sent">

                <div class="fp-sent-box mb-4">
                  <div class="fps-icon"><i class="isax isax-sms-star"></i></div>
                  <h5 class="fps-title">E-mail envoy\xE9 !</h5>
                  <p class="fps-sub">
                    Si un compte est associ\xE9 \xE0 <strong>{{ email }}</strong>,<br>
                    vous recevrez un lien de r\xE9initialisation sous peu.<br>
                ...
                <div class="d-grid mb-3">
                  <button type="button" class="btn btn-outline-secondary btn-lg"
                    ...
                    <i class="isax isax-refresh me-2"></i>Utiliser une autre adresse
                  </button>
                </div>
              ...
              <p class="fs-14 fw-normal d-flex align-items-center justify-content-center">
                <a [routerLink]="routes.login" class="link-2 ms-1">
...
//# sourceMappingURL=chunk-GI6GFVAR.js.map
