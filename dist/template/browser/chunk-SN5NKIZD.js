...
function StudentsSessionsComponent_div_51_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "div", 82);
    \u0275\u0275elementStart(2, "p");
    \u0275\u0275text(3, "Chargement de vos demandes de sessions...");
    \u0275\u0275elementEnd()();
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StudentsSessionsComponent, { className: "StudentsSessionsComponent", filePath: "src/app/features/student/students-session/students-session.component.ts", lineNumber: 24 });
})();
export {
  StudentsSessionsComponent
};
//# sourceMappingURL=chunk-SN5NKIZD.js.map
