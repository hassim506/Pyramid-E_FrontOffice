...
function InstructorCourseGridComponent_div_2_div_75_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(43, "i", 71);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "button", 72);
    \u0275\u0275listener("click", function InstructorCourseGridComponent_div_2_div_75_Template_button_click_44_listener() {
      const formation_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(25, _c1, ctx_r0.isFormationGratuite(formation_r4), !ctx_r0.isFormationGratuite(formation_r4)));
    \u0275\u0275advance();
...
function InstructorCourseGridComponent_div_2_div_77_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(5, "i", 84);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, InstructorCourseGridComponent_div_2_div_77_button_6_Template, 2, 3, "button", 85);
...
function InstructorCourseGridComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(75, InstructorCourseGridComponent_div_2_div_75_Template, 48, 28, "div", 40)(76, InstructorCourseGridComponent_div_2_div_76_Template, 6, 0, "div", 41);
    \u0275\u0275elementEnd();
...
//# sourceMappingURL=chunk-X7RKCNMN.js.map
