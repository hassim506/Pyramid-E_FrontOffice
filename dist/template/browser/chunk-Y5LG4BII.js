...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SuperadminMessageComponent, [{
    type: Component,
    args: [{ selector: "app-superadmin-message", imports: [CommonModule, RouterLink], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminMessageComponent, { className: "SuperadminMessageComponent", filePath: "src/app/features/superadmin/superadmin-message/superadmin-message.component.ts", lineNumber: 12 });
})();
export {
  SuperadminMessageComponent
};
//# sourceMappingURL=chunk-Y5LG4BII.js.map
