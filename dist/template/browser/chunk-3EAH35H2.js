...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorCourseComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-course", imports: [CommonModule, MatTableModule, MatSortModule, MatPaginatorModule, MatSelectModule, CustomPaginationComponent, FormsModule, RouterLink], template: `<!-- Loading -->\r
...
\r
  ...
  <div class="ip-kpi-row">\r
    ...
    <div class="ip-kpi">\r
      ...
      <div><div class="ip-kpi__val">{{ getTotalParticipants() }}</div><div class="ip-kpi__lbl">Apprenants</div></div>\r
    </div>\r
  </div>\r
\r
  <!-- Toolbar -->\r
      ...
      <div class="modal-body text-center custom-modal-body">\r
        ...
        <p class="mb-3">\r
          {{ selectedFormation?.est_publie ?\r
              ...
              'Cette formation sera visible par tous les apprenants.' }}\r
        </p>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorCourseComponent, { className: "InstructorCourseComponent", filePath: "app/features/instructor/instructor-course/instructor-course.component.ts", lineNumber: 24 });
})();
export {
...
bootstrap/dist/js/bootstrap.esm.js:
  (*!
    ...
    *)
*/
//# sourceMappingURL=chunk-3EAH35H2.js.map
