...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SuperadminTicketsComponent, [{
    type: Component,
    args: [{ selector: "app-superadmin-tickets", imports: [CommonModule, FormsModule], template: `<div class="tk-page">

  <!-- HEADER -->
  <div class="tk-header">
    <div>
      <div class="tk-header__title">Gestion des tickets</div>
      <div class="tk-header__sub">Tous les tickets \u2014 toutes entreprises</div>
    </div>
  </div>
  ...
  <div class="kpi-row">
    ...
    <div class="kpi">
      ...
      <div><div class="kpi__val">{{ stats.ouvert }}</div><div class="kpi__lbl">Ouverts</div></div>
    </div>
    <div class="kpi">
      <div class="kpi__icon ki-ongoing"><i class="isax isax-activity"></i></div>
      <div><div class="kpi__val">{{ stats.en_cours }}</div><div class="kpi__lbl">En cours</div></div>
    </div>
    <div class="kpi">
  ...
  <div class="tk-split">
    ...
    <!-- LIST PANEL -->
    <div class="tk-split__list">
      <!-- toolbar -->
      <div class="tk-toolbar">
        <input class="tk-search" placeholder="Rechercher\u2026"
        ...
        <select class="tk-select" [(ngModel)]="filterPriorite" (change)="applyFilter()">
      ...
      <div class="tk-list">
        ...
        <div *ngIf="!loading && tickets.length === 0" class="tk-empty">Aucun ticket trouv\xE9.</div>
        <div *ngFor="let t of tickets"
          ...
          <div class="tk-info">
            <div class="tk-ref">{{ t.reference }} \xB7 {{ t.entreprise?.nom }}</div>
            ...
            <div class="tk-badges">
              ...
              <span *ngIf="t.est_escalade" class="escalade-badge">Escalad\xE9</span>
            </div>
            <div class="tk-meta">
              <span>{{ t.categorie }}</span>
              <span *ngIf="t.agent_assigne">\xB7 {{ t.agent_assigne.name }}</span>
    ...
    <!-- DETAIL PANEL -->
    <div class="tk-split__detail">
      <ng-container *ngIf="!selectedTicket">
        <div class="tk-no-select">
          <i class="isax isax-message-question"></i>
          <span>S\xE9lectionnez un ticket pour voir le d\xE9tail</span>
        </div>
      </ng-container>
        ...
        <div class="tk-detail">
          ...
          <div class="tk-detail__head">
            <div class="detail-info">
              ...
              <div class="detail-ref">{{ selectedTicket.reference }} \xB7 {{ selectedTicket.entreprise?.nom }}</div>
              <div class="detail-badges">
                ...
                <span *ngIf="selectedTicket.est_escalade" class="escalade-badge">Escalad\xE9</span>
              </div>
            </div>
          ...
          <!-- actions -->
          <div class="tk-detail__actions">
            <button type="button" class="act-btn primary" (click)="changerStatut('en_cours')">
              <i class="isax isax-activity"></i> Prendre en charge
            </button>
            <button type="button" class="act-btn success" (click)="changerStatut('resolu')">
              <i class="isax isax-tick-circle"></i> R\xE9soudre
            </button>
            <button type="button" class="act-btn danger" (click)="changerStatut('ferme')">
              <i class="isax isax-close-circle"></i> Fermer
            </button>
          </div>

          <!-- body -->
          <div class="tk-detail__body" *ngIf="!loadingDetail">
            <!-- meta -->
            <div class="detail-meta">
              <span><b>Cr\xE9\xE9 par:</b> {{ selectedTicket.createur?.name || '\u2014' }}</span>
            ...
            <!-- thread -->
            <div class="tk-detail__thread-title">Conversation ({{ selectedTicket.nombre_reponses || 0 }} r\xE9ponses)</div>
          ...
          <div class="tk-loader" *ngIf="loadingDetail">Chargement\u2026</div>

          <!-- reply -->
          <div class="tk-detail__reply">
            <textarea class="tk-detail__reply-input" rows="2"
                      placeholder="R\xE9pondre au ticket\u2026"
                      [(ngModel)]="newMessage"></textarea>
            <button type="button" class="send-btn" [disabled]="sendingMessage || !newMessage.trim()"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminTicketsComponent, { className: "SuperadminTicketsComponent", filePath: "src/app/features/superadmin/superadmin-tickets/superadmin-tickets.component.ts", lineNumber: 13 });
})();
export {
  SuperadminTicketsComponent
};
//# sourceMappingURL=chunk-NS5QQR37.js.map
