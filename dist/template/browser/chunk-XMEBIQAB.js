...
function UserAddComponent_div_0_option_55_Template(rf, ctx) {
  if (rf & 1) {
...
function UserAddComponent_div_0_div_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39)(1, "small");
...
function UserAddComponent_div_0_option_73_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 40);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function UserAddComponent_div_0_div_74_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 41)(1, "button", 42);
    \u0275\u0275listener("click", function UserAddComponent_div_0_div_74_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r5);
...
function UserAddComponent_div_0_div_75_span_3_Template(rf, ctx) {
  if (rf & 1) {
...
function UserAddComponent_div_0_div_75_div_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39)(1, "small");
...
function UserAddComponent_div_0_div_75_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, UserAddComponent_div_0_div_75_span_3_Template, 2, 0, "span", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "input", 45);
    \u0275\u0275template(5, UserAddComponent_div_0_div_75_div_5_Template, 3, 0, "div", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275property("placeholder", \u0275\u0275interpolate(ctx_r1.isEditMode ? "Nouveau mot de passe" : ""));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ((tmp_4_0 = ctx_r1.userForm.get("password")) == null ? null : tmp_4_0.invalid) && ((tmp_4_0 = ctx_r1.userForm.get("password")) == null ? null : tmp_4_0.touched));
  }
}
function UserAddComponent_div_0_div_76_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 13);
    \u0275\u0275text(1, "*");
    \u0275\u0275elementEnd();
...
function UserAddComponent_div_0_div_76_div_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39)(1, "small");
...
function UserAddComponent_div_0_div_76_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, UserAddComponent_div_0_div_76_span_3_Template, 2, 0, "span", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "input", 46);
    \u0275\u0275template(5, UserAddComponent_div_0_div_76_div_5_Template, 3, 0, "div", 15)(6, UserAddComponent_div_0_div_76_div_6_Template, 3, 0, "div", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_3_0;
    ...
    \u0275\u0275property("placeholder", \u0275\u0275interpolate(ctx_r1.isEditMode ? "Confirmer le nouveau mot de passe" : ""));
    \u0275\u0275advance();
...
function UserAddComponent_div_0_div_77_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function UserAddComponent_div_0_div_77_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function UserAddComponent_div_0_span_83_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 50);
  }
}
function UserAddComponent_div_0_i_84_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 51);
  }
}
function UserAddComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(51, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(52, "select", 22)(53, "option", 23);
    \u0275\u0275text(54, "S\xE9lectionner un r\xF4le");
    \u0275\u0275elementEnd();
    \u0275\u0275template(55, UserAddComponent_div_0_option_55_Template, 2, 2, "option", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275template(56, UserAddComponent_div_0_div_56_Template, 3, 0, "div", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "div", 11)(58, "label", 12);
    \u0275\u0275text(59, "Statut ");
    \u0275\u0275elementStart(60, "span", 13);
    \u0275\u0275text(61, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(62, "select", 25)(63, "option", 26);
    \u0275\u0275text(64, "Actif");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "option", 27);
    \u0275\u0275text(66, "Inactif");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(67, "div", 28)(68, "label", 12);
    \u0275\u0275text(69, "Entreprise");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "select", 29)(71, "option", 23);
    \u0275\u0275text(72, "Aucune");
    \u0275\u0275elementEnd();
    \u0275\u0275template(73, UserAddComponent_div_0_option_73_Template, 2, 2, "option", 24);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(74, UserAddComponent_div_0_div_74_Template, 4, 5, "div", 30)(75, UserAddComponent_div_0_div_75_Template, 6, 4, "div", 31)(76, UserAddComponent_div_0_div_76_Template, 7, 7, "div", 31);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(77, UserAddComponent_div_0_div_77_Template, 4, 1, "div", 32);
    \u0275\u0275elementStart(78, "div", 33)(79, "button", 34);
    \u0275\u0275listener("click", function UserAddComponent_div_0_Template_button_click_79_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.hideDialog());
    });
    ...
    \u0275\u0275listener("click", function UserAddComponent_div_0_Template_button_click_82_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.saveUser());
    });
    \u0275\u0275template(83, UserAddComponent_div_0_span_83_Template, 1, 0, "span", 37)(84, UserAddComponent_div_0_i_84_Template, 1, 0, "i", 38);
    \u0275\u0275text(85);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
var UserAddComponent = class _UserAddComponent {
  ...
  saveUser() {
    ...
    if (this.isEditMode && this.userData) {
      ...
      this.userService.updateUser(this.userData.id, formData).subscribe({
        ...
        error: (error) => {
          this.errorMessage = error.error?.errors ? Object.values(error.error.errors).flat().join(" \xB7 ") : error.error?.message || "Erreur lors de la mise \xE0 jour.";
          this.loading = false;
        }
      });
    } else {
      this.userService.createUser(formData).subscribe({
        ...
        error: (error) => {
          this.errorMessage = error.error?.errors ? Object.values(error.error.errors).flat().join(" \xB7 ") : error.error?.message || "Erreur lors de la cr\xE9ation.";
          this.loading = false;
        }
      });
    }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserAddComponent, selectors: [["app-user-add"]], inputs: { visible: "visible", isEditMode: "isEditMode", userData: "userData" }, outputs: { onClose: "onClose", onSave: "onSave" }, features: [\u0275\u0275NgOnChangesFeature], decls: 2, vars: 2, consts: [["class", "modal fade show d-block", "tabindex", "-1", "role", "dialog", 3, "show", 4, "ngIf"], ["class", "modal-backdrop fade show", 4, "ngIf"], ["tabindex", "-1", "role", "dialog", 1, "modal", "fade", "show", "d-block"], ["role", "document", 1, "modal-dialog", "modal-dialog-centered", "modal-lg"], [1, "modal-content"], [1, "modal-header"], [1, "modal-title"], ["type", "button", 1, "btn-close", 3, "click"], [1, "modal-body"], [3, "formGroup"], [1, "row"], [1, "col-md-6", "mb-3"], [1, "form-label"], [1, "text-danger"], ["type", "text", "formControlName", "nom", 1, "form-control"], ["class", "text-danger mt-1", 4, "ngIf"], ["type", "text", "formControlName", "prenom", 1, "form-control"], ["type", "email", "formControlName", "email", 1, "form-control"], ["type", "text", "formControlName", "numero", 1, "form-control"], ["type", "text", "formControlName", "matricule", 1, "form-control"], ["type", "text", "formControlName", "direction", 1, "form-control"], ["type", "text", "formControlName", "fonction", 1, "form-control"], ["formControlName", "role_id", 1, "form-select"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "statut", 1, "form-select"], ["value", "1"], ["value", "0"], [1, "col-md-12", "mb-3"], ["formControlName", "entreprise_id", 1, "form-select"], ["class", "col-md-12 mb-2", 4, "ngIf"], ["class", "col-md-6 mb-3", 4, "ngIf"], ["class", "mx-3 mb-2 alert alert-danger alert-dismissible py-2 mb-0", "role", "alert", 4, "ngIf"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], [1, "isax", "isax-close-circle", "me-1"], ["type", "button", 1, "btn", "btn-primary", 3, "click", "disabled"], ["class", "spinner-border spinner-border-sm me-2", 4, "ngIf"], ["class", "isax isax-tick-circle me-1", 4, "ngIf"], [1, "text-danger", "mt-1"], [3, "value"], [1, "col-md-12", "mb-2"], ["type", "button", 1, "btn", "btn-outline-secondary", "btn-sm", 3, "click"], [1, "isax", "me-1"], ["class", "text-danger", 4, "ngIf"], ["type", "password", "formControlName", "password", 1, "form-control", 3, "placeholder"], ["type", "password", "formControlName", "password_confirmation", 1, "form-control", 3, "placeholder"], ["role", "alert", 1, "mx-3", "mb-2", "alert", "alert-danger", "alert-dismissible", "py-2", "mb-0"], [1, "isax", "isax-warning-2", "me-2"], ["type", "button", 1, "btn-close", "btn-close-sm", 3, "click"], [1, "spinner-border", "spinner-border-sm", "me-2"], [1, "isax", "isax-tick-circle", "me-1"], [1, "modal-backdrop", "fade", "show"]], template: function UserAddComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, UserAddComponent_div_0_Template, 86, 18, "div", 0)(1, UserAddComponent_div_1_Template, 1, 0, "div", 1);
    }
    if (rf & 2) {
...
\r
                        <div class="col-md-6 mb-3">\r
                            <label class="form-label">Matricule</label>\r
                            <input type="text" class="form-control" formControlName="matricule">\r
                        </div>\r
\r
                        <div class="col-md-6 mb-3">\r
                            <label class="form-label">Direction</label>\r
                            <input type="text" class="form-control" formControlName="direction">\r
                        </div>\r
\r
                        <div class="col-md-6 mb-3">\r
...
\r
            ...
            <!-- Erreur API ou validation -->\r
            <div *ngIf="errorMessage" class="mx-3 mb-2 alert alert-danger alert-dismissible py-2 mb-0" role="alert">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserAddComponent, { className: "UserAddComponent", filePath: "app/features/adminrh/user-add/user-add.component.ts", lineNumber: 16 });
})();

export {
  UserAddComponent
};
//# sourceMappingURL=chunk-XMEBIQAB.js.map
