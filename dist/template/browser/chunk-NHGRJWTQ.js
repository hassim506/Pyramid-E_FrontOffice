...
// src/app/features/adminrh/settings/adminrh-setting-notifications/adminrh-setting-notifications.component.ts
var AdminrhSettingNotificationsComponent = class _AdminrhSettingNotificationsComponent {
  routes = routes;
  static \u0275fac = function AdminrhSettingNotificationsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminrhSettingNotificationsComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminrhSettingNotificationsComponent, selectors: [["app-adminrh-setting-notifications"]], decls: 85, vars: 0, consts: [[1, "d-flex", "justify-content-between", "align-items-center", "border-bottom", "pb-4", "mb-4"], [1, "fs-18", "mb-0"], ["type", "button", 1, "btn", "btn-sm", "btn-dark"], [1, "d-flex", "justify-content-between", "align-items-center", "mb-4"], [1, "form-check", "form-switch", "form-check-md", "mb-0", "ms-3"], ["type", "checkbox", "id", "checkPrivacy1", "checked", "", 1, "form-check-input"], ["type", "checkbox", "id", "7", "checked", "", 1, "form-check-input"], ["type", "checkbox", "id", "4", 1, "form-check-input"], ["type", "checkbox", "id", "5", 1, "form-check-input"], [1, "text-center", "my-5"], ["type", "checkbox", "id", "checkPrivacy6", "checked", "", 1, "form-check-input"], ["type", "checkbox", "id", "checkPrivacy7", "checked", "", 1, "form-check-input"], ["type", "checkbox", "id", "8", 1, "form-check-input"], ["type", "checkbox", "id", "9", 1, "form-check-input"], ["type", "checkbox", "id", "17", 1, "form-check-input"]], template: function AdminrhSettingNotificationsComponent_Template(rf, ctx) {
    if (rf & 1) {
