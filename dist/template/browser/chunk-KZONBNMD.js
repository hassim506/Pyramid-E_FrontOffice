...
var _c1 = () => [1, 2, 3, 4, 5];
function AdminrhDemandeSessionComponent_div_73_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_div_73_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r1);
...
function AdminrhDemandeSessionComponent_div_74_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementStart(3, "button", 37);
    \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_div_74_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.clearMessages());
    });
...
function AdminrhDemandeSessionComponent_div_75_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 42);
  }
}
function AdminrhDemandeSessionComponent_div_75_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 40);
    \u0275\u0275template(1, AdminrhDemandeSessionComponent_div_75_div_1_Template, 1, 0, "div", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function AdminrhDemandeSessionComponent_div_76_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 43);
    \u0275\u0275element(1, "i", 20);
    \u0275\u0275elementStart(2, "p");
    \u0275\u0275text(3, "Aucune demande de session");
    \u0275\u0275elementEnd()();
  }
}
function AdminrhDemandeSessionComponent_div_77_div_1_span_15_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.formatDate(d_r4.session_formation == null ? null : d_r4.session_formation.date_debut), " ");
  }
}
function AdminrhDemandeSessionComponent_div_77_div_1_span_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275element(1, "i", 66);
    \u0275\u0275text(2);
  ...
  if (rf & 2) {
    const d_r4 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", d_r4.session_formation == null ? null : d_r4.session_formation.lieu, " ");
  }
}
function AdminrhDemandeSessionComponent_div_77_div_1_div_19_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeSessionComponent_div_77_div_1_button_27_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 71);
  }
}
function AdminrhDemandeSessionComponent_div_77_div_1_button_27_i_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 17);
  }
}
function AdminrhDemandeSessionComponent_div_77_div_1_button_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 68);
    \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_div_77_div_1_button_27_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const d_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.validerDemande(d_r4));
    });
    \u0275\u0275template(1, AdminrhDemandeSessionComponent_div_77_div_1_button_27_span_1_Template, 1, 0, "span", 69)(2, AdminrhDemandeSessionComponent_div_77_div_1_button_27_i_2_Template, 1, 0, "i", 70);
    \u0275\u0275text(3, " Approuver ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminrhDemandeSessionComponent_div_77_div_1_button_28_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 71);
  }
}
function AdminrhDemandeSessionComponent_div_77_div_1_button_28_i_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 19);
  }
}
function AdminrhDemandeSessionComponent_div_77_div_1_button_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 72);
    \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_div_77_div_1_button_28_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const d_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.refuserDemande(d_r4));
    });
    \u0275\u0275template(1, AdminrhDemandeSessionComponent_div_77_div_1_button_28_span_1_Template, 1, 0, "span", 69)(2, AdminrhDemandeSessionComponent_div_77_div_1_button_28_i_2_Template, 1, 0, "i", 73);
    \u0275\u0275text(3, " Refuser ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminrhDemandeSessionComponent_div_77_div_1_button_29_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 74);
    \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_div_77_div_1_button_29_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const d_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function AdminrhDemandeSessionComponent_div_77_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(4, "div", 49);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 50)(6, "div", 51);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(15, AdminrhDemandeSessionComponent_div_77_div_1_span_15_Template, 3, 1, "span", 56)(16, AdminrhDemandeSessionComponent_div_77_div_1_span_16_Template, 3, 1, "span", 56);
    \u0275\u0275elementStart(17, "span");
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(19, AdminrhDemandeSessionComponent_div_77_div_1_div_19_Template, 2, 2, "div", 57);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 58)(21, "div", 59)(22, "span", 60);
    \u0275\u0275text(23);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(27, AdminrhDemandeSessionComponent_div_77_div_1_button_27_Template, 4, 3, "button", 63)(28, AdminrhDemandeSessionComponent_div_77_div_1_button_28_Template, 4, 3, "button", 64)(29, AdminrhDemandeSessionComponent_div_77_div_1_button_29_Template, 3, 0, "button", 65);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((d_r4.session_formation == null ? null : d_r4.session_formation.titre) || "Session #" + d_r4.session_formation_id);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", d_r4.session_formation == null ? null : d_r4.session_formation.date_debut);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", d_r4.session_formation == null ? null : d_r4.session_formation.lieu);
    \u0275\u0275advance();
...
function AdminrhDemandeSessionComponent_div_77_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 43);
    \u0275\u0275element(1, "i", 24);
    \u0275\u0275elementStart(2, "p");
...
function AdminrhDemandeSessionComponent_div_77_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 44);
    \u0275\u0275template(1, AdminrhDemandeSessionComponent_div_77_div_1_Template, 30, 24, "div", 45)(2, AdminrhDemandeSessionComponent_div_77_div_2_Template, 4, 0, "div", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function AdminrhDemandeSessionComponent_div_78_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 82);
    \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_div_78_button_6_Template_button_click_0_listener() {
...
function AdminrhDemandeSessionComponent_div_78_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_div_78_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(5, "i", 79);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, AdminrhDemandeSessionComponent_div_78_button_6_Template, 2, 3, "button", 80);
    \u0275\u0275elementStart(7, "button", 78);
    \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_div_78_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage + 1));
    });
...
Veuillez saisir un motif :`);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminrhDemandeSessionComponent, selectors: [["app-adminrh-demande-session"]], decls: 79, vars: 20, consts: [[1, "page"], [1, "page-header"], [1, "page-header__left"], [1, "page-header__actions"], ["type", "button", 1, "btn-outline"], [1, "isax", "isax-export"], ["type", "button", 1, "btn-primary", 3, "click", "disabled"], [1, "isax", "isax-refresh"], [1, "kpi-row"], [1, "kpi"], [1, "kpi__icon", "ki-amber"], [1, "isax", "isax-clock"], [1, "kpi__body"], [1, "kpi__label"], [1, "kpi__val"], [1, "kpi__delta"], [1, "kpi__icon", "ki-green"], [1, "isax", "isax-tick-circle"], [1, "kpi__icon", "ki-red"], [1, "isax", "isax-close-circle"], [1, "isax", "isax-calendar-1"], [1, "main-card"], [1, "toolbar"], [1, "search-box"], [1, "isax", "isax-search-normal-1"], ["type", "search", "placeholder", "Rechercher session, employ\xE9...", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["type", "button", 1, "filter-chip", 3, "click"], [1, "toolbar-spacer"], ["type", "button", 1, "sort-btn"], [1, "isax", "isax-arrow-3"], ["class", "alert alert--ok", 4, "ngIf"], ["class", "alert alert--err", 4, "ngIf"], ["class", "skeletons", 4, "ngIf"], ["class", "empty-state", 4, "ngIf"], ["class", "demande-list", 4, "ngIf"], ["class", "pagination", 4, "ngIf"], [1, "alert", "alert--ok"], ["type", "button", 1, "alert__close", 3, "click"], [1, "alert", "alert--err"], [1, "isax", "isax-warning-2"], [1, "skeletons"], ["class", "sk-item", 4, "ngFor", "ngForOf"], [1, "sk-item"], [1, "empty-state"], [1, "demande-list"], ["class", "demande-item", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "demande-item"], [1, "d-left"], [1, "d-av"], [1, "d-type-line", "tl-sess"], [1, "d-body"], [1, "d-name"], [1, "d-company"], [1, "d-time"], [1, "d-title"], [1, "d-meta"], [4, "ngIf"], ["class", "d-msg", 3, "title", 4, "ngIf"], [1, "d-right"], [1, "d-badges"], [1, "sb"], [1, "tb", "tb-sess"], [1, "action-row"], ["type", "button", "class", "act-btn act-approve", "title", "Approuver", 3, "disabled", "click", 4, "ngIf"], ["type", "button", "class", "act-btn act-reject", "title", "Refuser", 3, "disabled", "click", 4, "ngIf"], ["type", "button", "class", "act-btn act-cancel", "title", "Annuler", 3, "click", 4, "ngIf"], [1, "isax", "isax-location"], [1, "d-msg", 3, "title"], ["type", "button", "title", "Approuver", 1, "act-btn", "act-approve", 3, "click", "disabled"], ["class", "act-spin", 4, "ngIf"], ["class", "isax isax-tick-circle", 4, "ngIf"], [1, "act-spin"], ["type", "button", "title", "Refuser", 1, "act-btn", "act-reject", 3, "click", "disabled"], ["class", "isax isax-close-circle", 4, "ngIf"], ["type", "button", "title", "Annuler", 1, "act-btn", "act-cancel", 3, "click"], [1, "isax", "isax-minus-circle"], [1, "pagination"], [1, "pagination__pages"], ["type", "button", 1, "pag-btn", 3, "click", "disabled"], [1, "isax", "isax-arrow-left-2"], ["type", "button", "class", "pag-btn", 3, "active", "click", 4, "ngFor", "ngForOf"], [1, "isax", "isax-arrow-right-3"], ["type", "button", 1, "pag-btn", 3, "click"]], template: function AdminrhDemandeSessionComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "h1");
      \u0275\u0275text(4, "Demandes de session");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "p");
      \u0275\u0275text(6, "G\xE9rez et traitez les demandes d'inscription aux sessions de formation");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_Template_button_click_11_listener() {
      ...
      \u0275\u0275text(54, "sessions");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(55, "div", 21)(56, "div", 22)(57, "div", 23);
      \u0275\u0275element(58, "i", 24);
      \u0275\u0275elementStart(59, "input", 25);
      \u0275\u0275twoWayListener("ngModelChange", function AdminrhDemandeSessionComponent_Template_input_ngModelChange_59_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.searchDataValue, $event) || (ctx.searchDataValue = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function AdminrhDemandeSessionComponent_Template_input_ngModelChange_59_listener($event) {
        return ctx.searchData($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(60, "button", 26);
      \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_Template_button_click_60_listener() {
      ...
      \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_Template_button_click_63_listener() {
      ...
      \u0275\u0275listener("click", function AdminrhDemandeSessionComponent_Template_button_click_66_listener() {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(73, AdminrhDemandeSessionComponent_div_73_Template, 5, 1, "div", 30)(74, AdminrhDemandeSessionComponent_div_74_Template, 5, 1, "div", 31)(75, AdminrhDemandeSessionComponent_div_75_Template, 2, 2, "div", 32)(76, AdminrhDemandeSessionComponent_div_76_Template, 4, 0, "div", 33)(77, AdminrhDemandeSessionComponent_div_77_Template, 3, 3, "div", 34)(78, AdminrhDemandeSessionComponent_div_78_Template, 9, 6, "div", 35);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(11);
...
(() => {
  ...
  <div class="kpi-row">
    ...
    <div class="kpi">
      <div class="kpi__icon ki-amber"><i class="isax isax-calendar-1"></i></div>
      <div class="kpi__body">
        <div class="kpi__label">Total</div>
        <div class="kpi__val">{{ totalDemandes }}</div>
        <div class="kpi__delta">sessions</div>
      </div>
    </div>
  </div>
  ...
  <div class="main-card">
    ...
    <div class="toolbar">
      <div class="search-box">
        ...
        <input type="search" placeholder="Rechercher session, employ\xE9..."
    ...
    <div *ngIf="!loading && hasData" class="demande-list">
      <div *ngFor="let d of tableData; trackBy: trackByDemandeId" class="demande-item">
        ...
        <div class="d-left">
          ...
          <div class="d-type-line tl-sess"></div>
        </div>
        ...
        <div class="d-body">
          ...
          <div class="d-title">{{ d.session_formation?.titre || ('Session #' + d.session_formation_id) }}</div>

          <div class="d-meta">
            <span *ngIf="d.session_formation?.date_debut">
              <i class="isax isax-calendar-1"></i> {{ formatDate(d.session_formation?.date_debut) }}
            </span>
            <span *ngIf="d.session_formation?.lieu">
              <i class="isax isax-location"></i> {{ d.session_formation?.lieu }}
            </span>
        ...
        <div class="d-right">
          <div class="d-badges">
            ...
            <span class="tb tb-sess">Session</span>
          </div>
