...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SuperadminAssignmentComponent, [{
    type: Component,
    args: [{ selector: "app-superadmin-assignment", imports: [CommonModule, MatTableModule, MatSortModule, MatPaginatorModule, MatSelectModule, BsDatepickerModule, FormsModule], template: `\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminAssignmentComponent, { className: "SuperadminAssignmentComponent", filePath: "app/features/superadmin/superadmin-assignment/superadmin-assignment.component.ts", lineNumber: 21 });
})();
export {
  SuperadminAssignmentComponent
};
//# sourceMappingURL=chunk-WFKKCILU.js.map
