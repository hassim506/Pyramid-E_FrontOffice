...
function SuperadminRoleComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function SuperadminRoleComponent_div_16_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r1);
...
function SuperadminRoleComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementStart(3, "button", 97);
    \u0275\u0275listener("click", function SuperadminRoleComponent_div_17_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function SuperadminRoleComponent_option_32_Template(rf, ctx) {
  if (rf & 1) {
...
function SuperadminRoleComponent_tr_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 100)(2, "div", 101)(3, "span", 102);
    \u0275\u0275text(4, "Chargement...");
    \u0275\u0275elementEnd()();
...
function SuperadminRoleComponent_tr_57_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 107);
    \u0275\u0275listener("click", function SuperadminRoleComponent_tr_57_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
...
function SuperadminRoleComponent_tr_57_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, SuperadminRoleComponent_tr_57_button_5_Template, 3, 0, "button", 106);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SuperadminRoleComponent_tr_58_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "span", 109);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td")(5, "div", 23)(6, "div", 110)(7, "div", 111);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div")(10, "h6", 60);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "td")(18, "button", 113);
    \u0275\u0275listener("click", function SuperadminRoleComponent_tr_58_Template_button_click_18_listener() {
    ...
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "td")(23, "span", 115);
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "td")(26, "small", 27);
    \u0275\u0275text(27);
    \u0275\u0275pipe(28, "date");
    \u0275\u0275element(29, "br");
    \u0275\u0275text(30);
    \u0275\u0275pipe(31, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "td", 116)(33, "div", 68)(34, "button", 117);
    \u0275\u0275listener("click", function SuperadminRoleComponent_tr_58_Template_button_click_34_listener() {
      const role_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.viewRolePermissions(role_r7));
    });
    \u0275\u0275element(35, "i", 118);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "button", 119);
    \u0275\u0275listener("click", function SuperadminRoleComponent_tr_58_Template_button_click_36_listener() {
      const role_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(37, "i", 120);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "button", 121);
    \u0275\u0275listener("click", function SuperadminRoleComponent_tr_58_Template_button_click_38_listener() {
      const role_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.deleteRole(role_r7));
    });
    \u0275\u0275element(39, "i", 122);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(28, 12, role_r7.created_at, "dd/MM/yyyy"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(31, 15, role_r7.created_at, "HH:mm"), " ");
  }
}
function SuperadminRoleComponent_div_59_li_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 127)(1, "a", 135);
    \u0275\u0275listener("click", function SuperadminRoleComponent_div_59_li_8_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function SuperadminRoleComponent_div_59_li_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 136)(1, "span", 137);
    \u0275\u0275text(2, "...");
    \u0275\u0275elementEnd()();
  }
}
function SuperadminRoleComponent_div_59_li_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 127)(1, "a", 135);
    \u0275\u0275listener("click", function SuperadminRoleComponent_div_59_li_10_Template_a_click_1_listener() {
...
function SuperadminRoleComponent_div_59_li_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 136)(1, "span", 137);
    \u0275\u0275text(2, "...");
    \u0275\u0275elementEnd()();
...
function SuperadminRoleComponent_div_59_li_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 127)(1, "a", 135);
    \u0275\u0275listener("click", function SuperadminRoleComponent_div_59_li_12_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function SuperadminRoleComponent_div_59_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 123)(1, "div", 124);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "nav", 125)(4, "ul", 126)(5, "li", 127)(6, "a", 128);
    \u0275\u0275listener("click", function SuperadminRoleComponent_div_59_Template_a_click_6_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(7, "i", 129);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, SuperadminRoleComponent_div_59_li_8_Template, 3, 0, "li", 130)(9, SuperadminRoleComponent_div_59_li_9_Template, 3, 0, "li", 131)(10, SuperadminRoleComponent_div_59_li_10_Template, 3, 3, "li", 132)(11, SuperadminRoleComponent_div_59_li_11_Template, 3, 0, "li", 131)(12, SuperadminRoleComponent_div_59_li_12_Template, 3, 1, "li", 130);
    \u0275\u0275elementStart(13, "li", 127)(14, "a", 133);
    \u0275\u0275listener("click", function SuperadminRoleComponent_div_59_Template_a_click_14_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage + 1));
    });
...
function SuperadminRoleComponent_div_78_small_1_Template(rf, ctx) {
  if (rf & 1) {
...
function SuperadminRoleComponent_div_78_small_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small");
...
function SuperadminRoleComponent_div_78_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 138);
    \u0275\u0275template(1, SuperadminRoleComponent_div_78_small_1_Template, 2, 0, "small", 34)(2, SuperadminRoleComponent_div_78_small_2_Template, 2, 0, "small", 34);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SuperadminRoleComponent_div_91_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 138);
...
function SuperadminRoleComponent_div_134_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 139);
    \u0275\u0275element(1, "i", 140);
    \u0275\u0275elementStart(2, "p", 141);
...
function SuperadminRoleComponent_div_135_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 145)(1, "div", 146);
    \u0275\u0275element(2, "input", 147);
    \u0275\u0275elementStart(3, "label", 148)(4, "strong");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "small", 149);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
function SuperadminRoleComponent_div_135_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 142)(1, "div", 143);
    \u0275\u0275template(2, SuperadminRoleComponent_div_135_div_2_Template, 8, 5, "div", 144);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 75)(4, "small", 27);
    \u0275\u0275element(5, "i", 77);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()()();
  }
...
function SuperadminRoleComponent_span_141_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 150);
  }
}
function SuperadminRoleComponent_i_142_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 151);
  }
  if (rf & 2) {
...
function SuperadminRoleComponent_div_155_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 154);
    \u0275\u0275text(5, "Ce r\xF4le n'a aucune permission assign\xE9e pour le moment.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 155);
    \u0275\u0275listener("click", function SuperadminRoleComponent_div_155_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r15);
      const ctx_r1 = \u0275\u0275nextContext();
...
function SuperadminRoleComponent_div_156_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 164)(1, "div", 165)(2, "div", 166)(3, "div", 167)(4, "div", 168);
    \u0275\u0275element(5, "i", 169);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 170)(7, "h6", 171);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
...
function SuperadminRoleComponent_div_156_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "div", 156);
    \u0275\u0275template(2, SuperadminRoleComponent_div_156_div_2_Template, 12, 2, "div", 157);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 158)(4, "div", 159)(5, "div", 160)(6, "div", 161);
    \u0275\u0275element(7, "i", 162);
    \u0275\u0275elementStart(8, "div")(9, "h4", 163);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
...
function SuperadminRoleComponent_div_164_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 173);
  }
  if (rf & 2) {
...
Cette action est irr\xE9versible et peut affecter les utilisateurs ayant ce r\xF4le.`;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SuperadminRoleComponent, selectors: [["app-superadmin-role"]], decls: 165, vars: 52, consts: [[1, "page-content"], [1, "d-md-flex", "d-block", "align-items-center", "justify-content-between", "mb-4"], [1, "my-auto", "mb-2"], [1, "mb-1"], [1, "breadcrumb", "mb-0"], [1, "breadcrumb-item"], [3, "routerLink"], ["aria-current", "page", 1, "breadcrumb-item", "active"], [1, "d-flex", "my-xl-auto", "right-content", "align-items-center", "flex-wrap"], ["type", "button", 1, "btn", "btn-primary", 3, "click"], [1, "isax", "isax-add", "me-2"], ["class", "alert alert-success alert-dismissible fade show", "role", "alert", 4, "ngIf"], ["class", "alert alert-danger alert-dismissible fade show", "role", "alert", 4, "ngIf"], [1, "card", "mb-4"], [1, "card-body"], [1, "row", "align-items-center"], [1, "col-md-6"], [1, "input-group"], [1, "input-group-text"], [1, "isax", "isax-search-normal-1"], ["type", "text", "placeholder", "Rechercher un r\xF4le...", 1, "form-control", 3, "ngModelChange", "keyup", "ngModel"], [1, "col-md-6", "text-md-end", "mt-3", "mt-md-0"], [1, "d-flex", "align-items-center", "justify-content-md-end", "gap-3"], [1, "d-flex", "align-items-center"], [1, "form-label", "mb-0", "me-2"], [1, "form-select", "form-select-sm", 2, "width", "auto", 3, "ngModelChange", "change", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], [1, "text-muted"], [1, "card"], [1, "table-responsive"], [1, "table", "table-hover", "align-middle"], [1, "table-light"], ["scope", "col"], ["scope", "col", 1, "text-end"], [4, "ngIf"], [4, "ngFor", "ngForOf", "ngForTrackBy"], ["class", "d-flex justify-content-between align-items-center mt-4", 4, "ngIf"], ["tabindex", "-1", "role", "dialog", "aria-labelledby", "roleModalLabel", 1, "modal", "fade"], [1, "modal-dialog", "modal-lg", "modal-dialog-centered", "modal-dialog-scrollable"], [1, "modal-content"], [1, "modal-header"], ["id", "roleModalLabel", 1, "modal-title"], [1, "isax", "isax-user-tag", "me-2"], ["type", "button", "aria-label", "Fermer", 1, "btn-close", 3, "click"], ["novalidate", "", 3, "ngSubmit", "formGroup"], [1, "modal-body"], [1, "row"], [1, "mb-3"], ["for", "roleName", 1, "form-label"], [1, "text-danger"], ["type", "text", "id", "roleName", "formControlName", "name", "placeholder", "Ex: Administrateur, Formateur, Apprenant...", 1, "form-control"], ["class", "invalid-feedback", 4, "ngIf"], ["for", "roleGuard", 1, "form-label"], ["id", "roleGuard", "formControlName", "guard_name", 1, "form-select"], ["value", ""], ["value", "web"], ["value", "api"], [1, "form-text", "text-muted"], [1, "mt-4"], [1, "d-flex", "justify-content-between", "align-items-center", "mb-3"], [1, "mb-0"], [1, "isax", "isax-key", "me-2"], [1, "badge", "bg-primary", "ms-2"], ["role", "group", 1, "btn-group", "btn-group-sm"], ["type", "button", 1, "btn", "btn-outline-success", "btn-sm", 3, "click", "disabled"], [1, "isax", "isax-tick-square", "me-1"], ["type", "button", 1, "btn", "btn-outline-warning", "btn-sm", 3, "click", "disabled"], [1, "isax", "isax-close-square", "me-1"], ["role", "group", 1, "btn-group"], ["type", "button", "data-bs-toggle", "dropdown", 1, "btn", "btn-outline-info", "btn-sm", "dropdown-toggle"], [1, "isax", "isax-filter", "me-1"], [1, "dropdown-menu"], ["href", "javascript:void(0);", 1, "dropdown-item", 3, "click"], [1, "isax", "isax-global", "me-2"], [1, "isax", "isax-code", "me-2"], [1, "mt-3", "p-3", "bg-light", "rounded"], [1, "col-md-8"], [1, "isax", "isax-info-circle", "me-1"], [1, "col-md-4", "text-end"], [1, "progress", 2, "height", "8px"], [1, "progress-bar"], ["class", "text-center py-4", 4, "ngIf"], ["class", "permissions-container", 4, "ngIf"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-light", 3, "click", "disabled"], [1, "isax", "isax-close-circle", "me-2"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "spinner-border spinner-border-sm me-2", 4, "ngIf"], ["class", "isax", 3, "isax-edit", "isax-add", 4, "ngIf"], ["tabindex", "-1", "role", "dialog", "aria-labelledby", "permissionsModalLabel", 1, "modal", "fade", "permissions-modal"], ["id", "permissionsModalLabel", 1, "modal-title"], ["class", "text-center py-5", 4, "ngIf"], ["type", "button", 1, "btn", "btn-light", 3, "click"], [1, "isax", "isax-edit", "me-2"], ["class", "modal-backdrop fade", 3, "show", 4, "ngIf"], ["role", "alert", 1, "alert", "alert-success", "alert-dismissible", "fade", "show"], [1, "isax", "isax-tick-circle", "me-2"], ["type", "button", "aria-label", "Close", 1, "btn-close", 3, "click"], ["role", "alert", 1, "alert", "alert-danger", "alert-dismissible", "fade", "show"], [3, "value"], ["colspan", "8", 1, "text-center", "py-5"], ["role", "status", 1, "spinner-border", "text-primary"], [1, "visually-hidden"], [1, "mt-3", "text-muted", "mb-0"], [1, "isax", "isax-box", "fs-48", "text-muted", "mb-3", "d-block"], [1, "text-muted", "mb-0"], ["class", "btn btn-primary btn-sm mt-3", 3, "click", 4, "ngIf"], [1, "btn", "btn-primary", "btn-sm", "mt-3", 3, "click"], [1, "isax", "isax-add", "me-1"], [1, "badge", "bg-light", "text-dark"], [1, "avatar-sm", "me-3"], [1, "avatar-title", "rounded-circle", "bg-primary-subtle", "text-primary"], [1, "badge"], [1, "btn", "btn-sm", "btn-outline-primary", "d-flex", "align-items-center", 3, "click", "title"], [1, "isax", "isax-key", "me-1"], [1, "badge", "bg-secondary"], [1, "text-end"], ["title", "Voir les permissions", 1, "btn", "btn-sm", "btn-outline-info", 3, "click"], [1, "isax", "isax-eye"], ["title", "Modifier le r\xF4le", 1, "btn", "btn-sm", "btn-outline-primary", 3, "click"], [1, "isax", "isax-edit"], ["title", "Supprimer le r\xF4le", 1, "btn", "btn-sm", "btn-outline-danger", 3, "click"], [1, "isax", "isax-trash"], [1, "d-flex", "justify-content-between", "align-items-center", "mt-4"], [1, "text-muted", "small"], ["aria-label", "Pagination des r\xF4les"], [1, "pagination", "pagination-sm", "mb-0"], [1, "page-item"], ["href", "javascript:void(0);", "title", "Page pr\xE9c\xE9dente", 1, "page-link", 3, "click"], [1, "isax", "isax-arrow-left-2"], ["class", "page-item", 4, "ngIf"], ["class", "page-item disabled", 4, "ngIf"], ["class", "page-item", 3, "active", 4, "ngFor", "ngForOf"], ["href", "javascript:void(0);", "title", "Page suivante", 1, "page-link", 3, "click"], [1, "isax", "isax-arrow-right-2"], ["href", "javascript:void(0);", 1, "page-link", 3, "click"], [1, "page-item", "disabled"], [1, "page-link"], [1, "invalid-feedback"], [1, "text-center", "py-4"], [1, "isax", "isax-info-circle", "fs-48", "text-muted", "mb-3", "d-block"], [1, "text-muted", "mb-2"], [1, "permissions-container"], ["formArrayName", "permissions", 1, "row"], ["class", "col-md-6 col-lg-4 mb-2", 4, "ngFor", "ngForOf"], [1, "col-md-6", "col-lg-4", "mb-2"], [1, "form-check"], ["type", "checkbox", 1, "form-check-input", 3, "formControlName", "id"], [1, "form-check-label", "d-block", 3, "for"], [1, "d-block", "text-muted"], [1, "spinner-border", "spinner-border-sm", "me-2"], [1, "isax"], [1, "text-center", "py-5"], [1, "isax", "isax-lock", "fs-48", "text-muted", "mb-3", "d-block"], [1, "text-muted", "mb-3"], [1, "btn", "btn-primary", "btn-sm", 3, "click"], [1, "row", "g-3"], ["class", "col-md-6 col-lg-4", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "mt-4", "p-3", "bg-primary", "bg-opacity-10", "rounded"], [1, "row", "text-center"], [1, "col"], [1, "d-flex", "align-items-center", "justify-content-center"], [1, "isax", "isax-chart-success", "text-primary", "me-2", "fs-5"], [1, "mb-0", "text-primary", "fw-bold"], [1, "col-md-6", "col-lg-4"], [1, "card", "border-0", "bg-light", "h-100"], [1, "card-body", "p-3"], [1, "d-flex", "align-items-start"], [1, "me-3"], [1, "isax", "isax-tick-circle", "text-success", "fs-5"], [1, "flex-grow-1"], [1, "mb-1", "fw-semibold"], [1, "isax", "isax-shield-security", "me-1"], [1, "modal-backdrop", "fade"]], template: function SuperadminRoleComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(16, SuperadminRoleComponent_div_16_Template, 4, 1, "div", 11)(17, SuperadminRoleComponent_div_17_Template, 4, 1, "div", 12);
      \u0275\u0275elementStart(18, "div", 13)(19, "div", 14)(20, "div", 15)(21, "div", 16)(22, "div", 17)(23, "span", 18);
      \u0275\u0275element(24, "i", 19);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "input", 20);
      \u0275\u0275twoWayListener("ngModelChange", function SuperadminRoleComponent_Template_input_ngModelChange_25_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.searchText, $event) || (ctx.searchText = $event);
        return $event;
      });
      \u0275\u0275listener("keyup", function SuperadminRoleComponent_Template_input_keyup_25_listener() {
      ...
      \u0275\u0275twoWayListener("ngModelChange", function SuperadminRoleComponent_Template_select_ngModelChange_31_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.itemsPerPage, $event) || (ctx.itemsPerPage = $event);
        return $event;
      });
      \u0275\u0275listener("change", function SuperadminRoleComponent_Template_select_change_31_listener() {
        return ctx.onItemsPerPageChange();
      });
      \u0275\u0275template(32, SuperadminRoleComponent_option_32_Template, 2, 2, "option", 26);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(50, "Utilisateurs");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(51, "th", 32);
      \u0275\u0275text(52, "Date de Cr\xE9ation");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(53, "th", 33);
      \u0275\u0275text(54, "Actions");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(55, "tbody");
      \u0275\u0275template(56, SuperadminRoleComponent_tr_56_Template, 7, 0, "tr", 34)(57, SuperadminRoleComponent_tr_57_Template, 6, 2, "tr", 34)(58, SuperadminRoleComponent_tr_58_Template, 40, 18, "tr", 35);
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(59, SuperadminRoleComponent_div_59_Template, 16, 12, "div", 36);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(60, "div", 37)(61, "div", 38)(62, "div", 39)(63, "div", 40)(64, "h5", 41);
      \u0275\u0275element(65, "i", 42);
      \u0275\u0275text(66);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(67, "button", 43);
      \u0275\u0275listener("click", function SuperadminRoleComponent_Template_button_click_67_listener() {
        return ctx.closeModal();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(68, "form", 44);
      \u0275\u0275listener("ngSubmit", function SuperadminRoleComponent_Template_form_ngSubmit_68_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275elementStart(69, "div", 45)(70, "div", 46)(71, "div", 16)(72, "div", 47)(73, "label", 48);
      \u0275\u0275text(74, " Nom du R\xF4le ");
      \u0275\u0275elementStart(75, "span", 49);
      \u0275\u0275text(76, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(77, "input", 50);
      \u0275\u0275template(78, SuperadminRoleComponent_div_78_Template, 3, 2, "div", 51);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(79, "div", 47)(80, "label", 52);
      \u0275\u0275text(81, " Guard ");
      \u0275\u0275elementStart(82, "span", 49);
      \u0275\u0275text(83, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(84, "select", 53)(85, "option", 54);
      \u0275\u0275text(86, "S\xE9lectionner un guard");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(87, "option", 55);
      \u0275\u0275text(88, "Web");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(89, "option", 56);
      \u0275\u0275text(90, "API");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(91, SuperadminRoleComponent_div_91_Template, 2, 0, "div", 51);
      \u0275\u0275elementStart(92, "small", 57);
      \u0275\u0275text(93, " Le guard d\xE9termine o\xF9 le r\xF4le sera utilis\xE9 ");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(94, "div", 58)(95, "div", 59)(96, "h6", 60);
      \u0275\u0275element(97, "i", 61);
      \u0275\u0275text(98, " Permissions Assign\xE9es ");
      \u0275\u0275elementStart(99, "span", 62);
      \u0275\u0275text(100);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(101, "div", 63)(102, "button", 64);
      \u0275\u0275listener("click", function SuperadminRoleComponent_Template_button_click_102_listener() {
        return ctx.selectAllPermissions();
      });
      \u0275\u0275element(103, "i", 65);
      \u0275\u0275text(104, " Tout s\xE9lectionner ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(105, "button", 66);
      \u0275\u0275listener("click", function SuperadminRoleComponent_Template_button_click_105_listener() {
        return ctx.deselectAllPermissions();
      });
      \u0275\u0275element(106, "i", 67);
      \u0275\u0275text(107, " Tout d\xE9s\xE9lectionner ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(108, "div", 68)(109, "button", 69);
      \u0275\u0275element(110, "i", 70);
      \u0275\u0275text(111, " Par Guard ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(112, "ul", 71)(113, "li")(114, "a", 72);
      \u0275\u0275listener("click", function SuperadminRoleComponent_Template_a_click_114_listener() {
        return ctx.selectPermissionsByGuard("web");
      });
      \u0275\u0275element(115, "i", 73);
      \u0275\u0275text(116, "Web ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(117, "li")(118, "a", 72);
      \u0275\u0275listener("click", function SuperadminRoleComponent_Template_a_click_118_listener() {
        return ctx.selectPermissionsByGuard("api");
      });
      \u0275\u0275element(119, "i", 74);
      \u0275\u0275text(120, "API ");
      \u0275\u0275elementEnd()()()()()();
      \u0275\u0275elementStart(121, "div", 75)(122, "div", 15)(123, "div", 76)(124, "small", 27);
      \u0275\u0275element(125, "i", 77);
      ...
      \u0275\u0275text(128);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(129, "div", 78)(130, "div", 79);
      \u0275\u0275element(131, "div", 80);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(132, "small", 27);
      \u0275\u0275text(133);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(134, SuperadminRoleComponent_div_134_Template, 6, 0, "div", 81)(135, SuperadminRoleComponent_div_135_Template, 7, 3, "div", 82);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(136, "div", 83)(137, "button", 84);
      \u0275\u0275listener("click", function SuperadminRoleComponent_Template_button_click_137_listener() {
        return ctx.closeModal();
      });
      \u0275\u0275element(138, "i", 85);
      \u0275\u0275text(139, " Annuler ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(140, "button", 86);
      \u0275\u0275template(141, SuperadminRoleComponent_span_141_Template, 1, 0, "span", 87)(142, SuperadminRoleComponent_i_142_Template, 1, 4, "i", 88);
      \u0275\u0275text(143);
      \u0275\u0275elementEnd()()()()()();
      \u0275\u0275elementStart(144, "div", 89)(145, "div", 38)(146, "div", 39)(147, "div", 40)(148, "h5", 90);
      \u0275\u0275element(149, "i", 61);
      \u0275\u0275text(150, " Permissions du r\xF4le ");
      \u0275\u0275elementStart(151, "strong");
      \u0275\u0275text(152);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(153, "button", 43);
      \u0275\u0275listener("click", function SuperadminRoleComponent_Template_button_click_153_listener() {
        return ctx.closePermissionsModal();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(154, "div", 45);
      \u0275\u0275template(155, SuperadminRoleComponent_div_155_Template, 9, 0, "div", 91)(156, SuperadminRoleComponent_div_156_Template, 13, 3, "div", 34);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(157, "div", 83)(158, "button", 92);
      \u0275\u0275listener("click", function SuperadminRoleComponent_Template_button_click_158_listener() {
        return ctx.closePermissionsModal();
      });
      \u0275\u0275element(159, "i", 85);
      \u0275\u0275text(160, " Fermer ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(161, "button", 9);
      \u0275\u0275listener("click", function SuperadminRoleComponent_Template_button_click_161_listener() {
        return ctx.editRoleFromPermissionsView();
      });
      \u0275\u0275element(162, "i", 93);
      \u0275\u0275text(163, " Modifier le r\xF4le ");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275template(164, SuperadminRoleComponent_div_164_Template, 1, 2, "div", 94);
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminRoleComponent, { className: "SuperadminRoleComponent", filePath: "src/app/features/superadmin/superadmin-role/superadmin-role.component.ts", lineNumber: 18 });
})();

export {
  SuperadminRoleComponent
};
//# sourceMappingURL=chunk-KMZBECY6.js.map
