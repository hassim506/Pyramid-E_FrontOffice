...
// src/app/features/student/mes-catalogues-details/mes-catalogues-details.component.ts
var _c0 = (a0, a1, a2) => ({ "pad-badge--prog-done": a0, "pad-badge--prog-ongoing": a1, "pad-badge--prog-todo": a2 });
function MesCataloguesDetailsComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 3)(1, "div", 4);
    \u0275\u0275element(2, "div")(3, "div")(4, "div")(5, "div");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p");
    \u0275\u0275text(7, "Chargement des formations du catalogue...");
    \u0275\u0275elementEnd()();
  }
}
function MesCataloguesDetailsComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MesCataloguesDetailsComponent_div_1_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r1);
...
function MesCataloguesDetailsComponent_ng_container_2_span_16_Template(rf, ctx) {
  if (rf & 1) {
...
function MesCataloguesDetailsComponent_ng_container_2_span_17_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.source === "demande" ? "Demande accept\xE9e" : "Assign\xE9", " ");
  }
}
function MesCataloguesDetailsComponent_ng_container_2_span_18_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", ctx_r1.catalogue.type_display || ctx_r1.catalogue.type, " ");
  }
}
function MesCataloguesDetailsComponent_ng_container_2_span_22_Template(rf, ctx) {
  if (rf & 1) {
...
function MesCataloguesDetailsComponent_ng_container_2_p_25_Template(rf, ctx) {
  if (rf & 1) {
...
function MesCataloguesDetailsComponent_ng_container_2_span_27_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275classProp("isax-calendar-add", ctx_r1.source !== "demande")("isax-tick-circle", ctx_r1.source === "demande");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", ctx_r1.source === "demande" ? "Valid\xE9e le" : "Assign\xE9 le", " ", \u0275\u0275pipeBind2(3, 6, ctx_r1.catalogue.date_assignation, "dd/MM/yyyy"), " ");
  }
}
function MesCataloguesDetailsComponent_ng_container_2_span_28_Template(rf, ctx) {
  if (rf & 1) {
...
function MesCataloguesDetailsComponent_ng_container_2_span_29_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" Expir\xE9 le ", \u0275\u0275pipeBind2(3, 1, ctx_r1.catalogue.date_expiration, "dd/MM/yyyy"), " ");
  }
}
function MesCataloguesDetailsComponent_ng_container_2_span_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275element(1, "i", 47);
    \u0275\u0275text(2);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" Expire le ", \u0275\u0275pipeBind2(3, 1, ctx_r1.catalogue.date_expiration, "dd/MM/yyyy"), " ");
  }
}
function MesCataloguesDetailsComponent_ng_container_2_span_31_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" Expire dans ", ctx_r1.getJoursRestants(ctx_r1.catalogue.date_expiration), " jour(s) ! ");
  }
}
function MesCataloguesDetailsComponent_ng_container_2_div_32_span_13_Template(rf, ctx) {
  if (rf & 1) {
...
function MesCataloguesDetailsComponent_ng_container_2_div_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(9, "div", 66);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "p", 67)(11, "span");
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, MesCataloguesDetailsComponent_ng_container_2_div_32_span_13_Template, 3, 0, "span", 68);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MesCataloguesDetailsComponent_ng_container_2_div_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 71)(1, "div", 37)(2, "div", 72)(3, "div", 73);
    \u0275\u0275element(4, "i", 74);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MesCataloguesDetailsComponent_ng_container_2_div_34_Template_button_click_14_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.goBack());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(12, 1, ctx_r1.catalogue.date_expiration, "dd/MM/yyyy"));
  }
}
function MesCataloguesDetailsComponent_ng_container_2_div_44_Template(rf, ctx) {
  if (rf & 1) {
...
function MesCataloguesDetailsComponent_ng_container_2_div_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 77)(1, "span", 82);
    \u0275\u0275element(2, "i", 83);
    \u0275\u0275text(3, " Contenu verrouill\xE9 \u2014 acc\xE8s expir\xE9 ");
    \u0275\u0275elementEnd()();
  }
}
function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_i_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 111);
  }
}
function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_i_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 112);
  }
}
function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_span_16_Template(rf, ctx) {
  if (rf & 1) {
...
function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_span_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 113);
    \u0275\u0275element(1, "i", 115);
    \u0275\u0275text(2);
...
function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_span_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 116);
    \u0275\u0275element(1, "i", 117);
    \u0275\u0275text(2, "Obligatoire ");
    \u0275\u0275elementEnd();
  }
}
function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_button_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 118);
    \u0275\u0275listener("click", function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_button_32_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r8);
      const f_r6 = \u0275\u0275nextContext().$implicit;
...
function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_button_33_Template(rf, ctx) {
  if (rf & 1) {
...
function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 86)(1, "div", 87);
    \u0275\u0275listener("click", function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_Template_div_click_1_listener() {
    ...
    \u0275\u0275template(3, MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_i_3_Template, 1, 0, "i", 89)(4, MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_i_4_Template, 1, 0, "i", 90)(5, MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_span_5_Template, 2, 1, "span", 2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 96)(13, "h5", 97);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 98);
    \u0275\u0275template(16, MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_span_16_Template, 3, 1, "span", 99)(17, MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_span_17_Template, 3, 1, "span", 99)(18, MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_span_18_Template, 3, 0, "span", 100);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div", 101)(20, "div", 102)(21, "span", 103);
    \u0275\u0275text(22, "Progression");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "span", 104);
    \u0275\u0275text(24);
    \u0275\u0275pipe(25, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div", 105);
    \u0275\u0275element(27, "div", 106);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(28, "div", 107)(29, "button", 108);
    \u0275\u0275listener("click", function MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_Template_button_click_29_listener($event) {
      const f_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275text(31);
    \u0275\u0275elementEnd();
    \u0275\u0275template(32, MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_button_32_Template, 3, 11, "button", 109)(33, MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_button_33_Template, 3, 1, "button", 110);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", f_r6.est_obligatoire);
    \u0275\u0275advance(5);
    \u0275\u0275styleProp("color", ctx_r1.estExpire ? "#9ca3af" : ctx_r1.getProgressionColor(f_r6.statut_formation));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(25, 46, +f_r6.progression, "1.0-0"), "% ");
    \u0275\u0275advance(3);
...
function MesCataloguesDetailsComponent_ng_container_2_div_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 84);
    \u0275\u0275template(1, MesCataloguesDetailsComponent_ng_container_2_div_46_div_1_Template, 34, 49, "div", 85);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MesCataloguesDetailsComponent_ng_container_2_div_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 121);
    \u0275\u0275element(1, "i", 122);
    \u0275\u0275elementStart(2, "h6", 123);
    \u0275\u0275text(3, "Aucune formation disponible");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p");
    \u0275\u0275text(5, "Ce catalogue ne contient pas encore de formations publi\xE9es.");
    \u0275\u0275elementEnd()();
  }
}
function MesCataloguesDetailsComponent_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MesCataloguesDetailsComponent_ng_container_2_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.goBack());
    });
    ...
    \u0275\u0275template(16, MesCataloguesDetailsComponent_ng_container_2_span_16_Template, 3, 0, "span", 21)(17, MesCataloguesDetailsComponent_ng_container_2_span_17_Template, 3, 9, "span", 22)(18, MesCataloguesDetailsComponent_ng_container_2_span_18_Template, 3, 1, "span", 23);
    \u0275\u0275elementStart(19, "span", 24);
    \u0275\u0275element(20, "i", 25);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd();
    \u0275\u0275template(22, MesCataloguesDetailsComponent_ng_container_2_span_22_Template, 4, 9, "span", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "h1", 27);
    \u0275\u0275text(24);
    \u0275\u0275elementEnd();
    \u0275\u0275template(25, MesCataloguesDetailsComponent_ng_container_2_p_25_Template, 2, 1, "p", 28);
    \u0275\u0275elementStart(26, "div", 29);
    \u0275\u0275template(27, MesCataloguesDetailsComponent_ng_container_2_span_27_Template, 4, 9, "span", 2)(28, MesCataloguesDetailsComponent_ng_container_2_span_28_Template, 3, 0, "span", 30)(29, MesCataloguesDetailsComponent_ng_container_2_span_29_Template, 4, 4, "span", 31)(30, MesCataloguesDetailsComponent_ng_container_2_span_30_Template, 4, 4, "span", 2)(31, MesCataloguesDetailsComponent_ng_container_2_span_31_Template, 3, 1, "span", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275template(32, MesCataloguesDetailsComponent_ng_container_2_div_32_Template, 14, 15, "div", 33);
    \u0275\u0275element(33, "div", 34);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(34, MesCataloguesDetailsComponent_ng_container_2_div_34_Template, 17, 4, "div", 35);
    ...
    \u0275\u0275text(43);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(44, MesCataloguesDetailsComponent_ng_container_2_div_44_Template, 10, 0, "div", 43)(45, MesCataloguesDetailsComponent_ng_container_2_div_45_Template, 4, 0, "div", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275template(46, MesCataloguesDetailsComponent_ng_container_2_div_46_Template, 2, 1, "div", 44)(47, MesCataloguesDetailsComponent_ng_container_2_div_47_Template, 6, 0, "div", 45);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275styleProp("background-image", (ctx_r1.catalogue == null ? null : ctx_r1.catalogue.image_couverture) ? "url(" + ctx_r1.catalogue.image_couverture + ")" : "none");
    \u0275\u0275advance(12);
    \u0275\u0275textInterpolate((ctx_r1.catalogue == null ? null : ctx_r1.catalogue.titre) || "Catalogue");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.estExpire);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.estExpire);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.catalogue == null ? null : ctx_r1.catalogue.type);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r1.totalFormations, " formation(s) ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.estExpire);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((ctx_r1.catalogue == null ? null : ctx_r1.catalogue.titre) || "Catalogue");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.catalogue == null ? null : ctx_r1.catalogue.description);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.catalogue == null ? null : ctx_r1.catalogue.date_assignation);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !(ctx_r1.catalogue == null ? null : ctx_r1.catalogue.date_expiration));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.estExpire);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.estExpire && (ctx_r1.catalogue == null ? null : ctx_r1.catalogue.date_expiration) && !ctx_r1.isExpiringSoon(ctx_r1.catalogue.date_expiration));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.estExpire && ctx_r1.isExpiringSoon(ctx_r1.catalogue == null ? null : ctx_r1.catalogue.date_expiration));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.estExpire);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.estExpire);
...
var MesCataloguesDetailsComponent = class _MesCataloguesDetailsComponent {
  route;
  router;
  formationsService;
  progressionService;
  ...
  loadDetail() {
    ...
    this.formationsService.getCatalogueProgression(this.catalogueId).subscribe({
      ...
      error: () => {
        this.error = "Impossible de charger le catalogue. V\xE9rifiez que vous y avez acc\xE8s.";
        this.loading = false;
      }
    });
  }
  ...
  get estExpire() {
    if (this.estTermine)
      return false;
    if (!this.catalogue?.date_expiration)
      return false;
    return new Date(this.catalogue.date_expiration) < /* @__PURE__ */ new Date();
  }
  ...
  static \u0275fac = function MesCataloguesDetailsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MesCataloguesDetailsComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(FormationService), \u0275\u0275directiveInject(ProgressionService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MesCataloguesDetailsComponent, selectors: [["app-mes-catalogues-details"]], decls: 3, vars: 3, consts: [["class", "qq-loading", 4, "ngIf"], ["class", "sc-error", 4, "ngIf"], [4, "ngIf"], [1, "qq-loading"], [1, "qq-loading__ring"], [1, "sc-error"], [1, "isax", "isax-warning-2", "sc-error__icon"], [1, "sc-error__retry", 3, "click"], [1, "isax", "isax-arrow-left", "me-1"], [1, "pad-hero"], [1, "pad-hero__bg"], [1, "pad-hero__overlay"], [1, "container", "position-relative", 2, "z-index", "2"], [1, "row"], [1, "col-lg-8"], [1, "pad-breadcrumb", "mb-3"], [1, "pad-breadcrumb__back", 3, "click"], [1, "isax", "isax-arrow-left-2", "me-1"], [1, "pad-breadcrumb__sep"], [1, "pad-breadcrumb__current"], [1, "pad-hero__badges", "mb-3"], ["class", "pad-badge pad-badge--expired", 4, "ngIf"], ["class", "pad-badge", 3, "pad-badge--assigned", "pad-badge--demande", 4, "ngIf"], ["class", "pad-badge pad-badge--cat", 4, "ngIf"], [1, "pad-badge", "pad-badge--count"], [1, "isax", "isax-book-1", "me-1"], ["class", "pad-badge", 3, "ngClass", 4, "ngIf"], [1, "pad-hero__title"], ["class", "pad-hero__subtitle", 4, "ngIf"], [1, "pad-hero__assignation", "mt-3"], ["class", "pad-permanent", 4, "ngIf"], ["class", "pad-expired", 4, "ngIf"], ["class", "pad-warning", 4, "ngIf"], ["class", "pad-progression-globale mt-4", 4, "ngIf"], [1, "pad-hero__divider", "mt-4"], ["class", "pad-expire-banner", 4, "ngIf"], [1, "pad-section"], [1, "container"], [1, "pad-section__header"], [1, "pad-section__header-left"], [1, "pad-section__title"], [1, "isax", "isax-book-1", "me-2", 2, "color", "#7c3aed"], [1, "pad-count-chip"], ["class", "pad-legende", 4, "ngIf"], ["class", "row g-4", 4, "ngIf"], ["class", "sc-empty", 4, "ngIf"], [1, "pad-badge", "pad-badge--expired"], [1, "isax", "isax-calendar-remove", "me-1"], [1, "pad-badge"], [1, "isax", "me-1"], [1, "pad-badge", "pad-badge--cat"], [1, "isax", "isax-category", "me-1"], [1, "pad-badge", 3, "ngClass"], [1, "isax", "isax-chart-2", "me-1"], [1, "pad-hero__subtitle"], [1, "pad-permanent"], [1, "isax", "isax-infinity", "me-1"], [1, "pad-expired"], [1, "pad-warning"], [1, "isax", "isax-warning-2", "me-1"], [1, "pad-progression-globale", "mt-4"], [1, "pad-progression-globale__header"], [1, "pad-progression-globale__label"], [1, "isax", "isax-chart-2", "me-2"], [1, "pad-progression-globale__pct"], [1, "pad-progression-globale__bar"], [1, "pad-progression-globale__fill"], [1, "pad-progression-globale__detail"], ["class", "pad-progression-globale__complete", 4, "ngIf"], [1, "pad-progression-globale__complete"], [1, "isax", "isax-tick-circle", "me-1"], [1, "pad-expire-banner"], [1, "pad-expire-banner__inner"], [1, "pad-expire-banner__icon"], [1, "isax", "isax-calendar-remove"], [1, "pad-expire-banner__text"], [1, "pad-expire-banner__btn", 3, "click"], [1, "pad-legende"], [1, "pad-legende__item", "pad-legende__item--done"], [1, "pad-legende__dot"], [1, "pad-legende__item", "pad-legende__item--ongoing"], [1, "pad-legende__item", "pad-legende__item--todo"], [1, "pad-legende__item", "pad-legende__item--expire"], [1, "isax", "isax-lock", "me-1", 2, "font-size", "13px"], [1, "row", "g-4"], ["class", "col-xl-4 col-md-6", 4, "ngFor", "ngForOf"], [1, "col-xl-4", "col-md-6"], [1, "pad-formation-card", 3, "click"], [1, "pad-formation-card__order"], ["class", "isax isax-lock", 4, "ngIf"], ["class", "isax isax-tick-circle", 4, "ngIf"], [1, "pad-formation-card__img-wrap"], ["alt", "", 1, "pad-formation-card__img", 3, "src"], [1, "pad-formation-card__img-overlay"], [1, "isax"], [1, "pad-formation-card__statut-badge", 3, "ngClass"], [1, "pad-formation-card__body"], [1, "pad-formation-card__title"], [1, "pad-formation-card__meta"], ["class", "pad-meta-chip", 4, "ngIf"], ["class", "pad-meta-chip pad-meta-chip--cert", 4, "ngIf"], [1, "pad-formation-progress", "mt-3"], [1, "pad-formation-progress__header"], [1, "pad-formation-progress__label"], [1, "pad-formation-progress__pct"], [1, "pad-formation-progress__bar"], [1, "pad-formation-progress__fill"], [1, "pad-formation-card__footer"], [1, "pad-formation-card__detail-btn", 3, "click", "disabled", "title"], ["class", "pad-formation-card__start-btn", 3, "pad-formation-card__start-btn--resume", "pad-formation-card__start-btn--done", "click", 4, "ngIf"], ["class", "pad-formation-card__start-btn pad-formation-card__start-btn--expire", "title", "Acc\xE8s expir\xE9 \u2014 contactez votre RH", 3, "disabled", 4, "ngIf"], [1, "isax", "isax-lock"], [1, "isax", "isax-tick-circle"], [1, "pad-meta-chip"], [1, "isax", "isax-chart", "me-1"], [1, "isax", "isax-clock", "me-1"], [1, "pad-meta-chip", "pad-meta-chip--cert"], [1, "isax", "isax-star", "me-1"], [1, "pad-formation-card__start-btn", 3, "click"], ["title", "Acc\xE8s expir\xE9 \u2014 contactez votre RH", 1, "pad-formation-card__start-btn", "pad-formation-card__start-btn--expire", 3, "disabled"], [1, "isax", "isax-lock", "me-1"], [1, "sc-empty"], [1, "isax", "isax-book-1", "sc-empty__icon"], [1, "sc-empty__title"]], template: function MesCataloguesDetailsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, MesCataloguesDetailsComponent_div_0_Template, 8, 0, "div", 0)(1, MesCataloguesDetailsComponent_div_1_Template, 7, 1, "div", 1)(2, MesCataloguesDetailsComponent_ng_container_2_Template, 48, 26, "ng-container", 2);
    }
    if (rf & 2) {
      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="pad-hero__badges mb-3">
            <!-- Badge expir\xE9 prioritaire -->
            <span class="pad-badge pad-badge--expired" *ngIf="estExpire">
              <i class="isax isax-calendar-remove me-1"></i>Catalogue expir\xE9
            </span>
            <span class="pad-badge"
              ...
              {{ source === 'demande' ? 'Demande accept\xE9e' : 'Assign\xE9' }}
            </span>
            ...
            <span class="pad-badge" *ngIf="!estExpire" [ngClass]="{
              ...
              <i class="isax isax-chart-2 me-1"></i>{{ progressionGlobale | number:'1.0-0' }}% compl\xE9t\xE9
            </span>
          </div>
          ...
          <div class="pad-progression-globale mt-4" *ngIf="!estExpire">
            ...
            <p class="pad-progression-globale__detail">
              <span>{{ formationsTerminees }} / {{ totalFormations }} formations termin\xE9es</span>
              <span *ngIf="progressionGlobale >= 100" class="pad-progression-globale__complete">
                <i class="isax isax-tick-circle me-1"></i>Catalogue compl\xE9t\xE9 !
              </span>
            </p>
          </div>
    ...
    <div class="container">
      <div class="pad-expire-banner__inner">
        ...
        <div class="pad-expire-banner__text">
          <strong>Acc\xE8s expir\xE9</strong>
          <span>
            Votre acc\xE8s \xE0 ce catalogue a expir\xE9 le
            <strong>{{ catalogue.date_expiration | date:'dd/MM/yyyy' }}</strong>.
            Le contenu des formations est en lecture seule. Contactez votre responsable RH pour renouveler votre acc\xE8s.
          </span>
        </div>
  ...
  <section class="pad-section" [class.pad-section--expire]="estExpire">
    <div class="container">
      ...
      <div class="pad-section__header">
        ...
        <div class="pad-legende" *ngIf="!estExpire">
          <span class="pad-legende__item pad-legende__item--done">
            <span class="pad-legende__dot"></span>Termin\xE9e
          </span>
          ...
          <span class="pad-legende__item pad-legende__item--todo">
            <span class="pad-legende__dot"></span>\xC0 commencer
          </span>
        </div>
        <!-- L\xE9gende expir\xE9e -->
        <div class="pad-legende" *ngIf="estExpire">
          <span class="pad-legende__item pad-legende__item--expire">
            <i class="isax isax-lock me-1" style="font-size:13px"></i>
            Contenu verrouill\xE9 \u2014 acc\xE8s expir\xE9
          </span>
        </div>
      </div>
          ...
          <div class="pad-formation-card"
            ...
            <div class="pad-formation-card__img-wrap">
              ...
              <div class="pad-formation-card__statut-badge"
                ...
                {{ estExpire ? 'Expir\xE9' : getStatutLabel(f.statut_formation) }}
              </div>
            </div>
      ...
      <div class="sc-empty" *ngIf="!loading && formations.length === 0">
        ...
        <p>Ce catalogue ne contient pas encore de formations publi\xE9es.</p>
      </div>
