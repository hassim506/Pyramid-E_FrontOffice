...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SuperadminSettingsComponent, [{
    type: Component,
    args: [{ selector: "app-superadmin-settings", imports: [RouterLink, BsDatepickerModule], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminSettingsComponent, { className: "SuperadminSettingsComponent", filePath: "src/app/features/superadmin/settings/superadmin-settings/superadmin-settings.component.ts", lineNumber: 11 });
})();
export {
  SuperadminSettingsComponent
};
//# sourceMappingURL=chunk-Z3AKYTTK.js.map
