...
// src/app/features/adminrh/adminrh-mes-sondages/adminrh-mes-sondages.component.ts
function AdminrhMesSondagesComponent_ng_container_0_div_26_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_0_div_27_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_span_5_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_9_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_10_div_1_p_11_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_10_div_1_p_12_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_10_div_1_span_17_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_10_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 36);
    \u0275\u0275listener("click", function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_10_div_1_Template_div_click_0_listener() {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_10_div_1_p_11_Template, 2, 1, "p", 44)(12, AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_10_div_1_p_12_Template, 3, 0, "p", 45);
    \u0275\u0275elementStart(13, "div", 46)(14, "span");
    \u0275\u0275element(15, "i", 47);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275template(17, AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_10_div_1_span_17_Template, 3, 1, "span", 0);
...
function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 34);
    \u0275\u0275template(1, AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_10_div_1_Template, 33, 13, "div", 35);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_17_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_18_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 34);
    \u0275\u0275template(1, AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_18_div_1_Template, 16, 10, "div", 61);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, AdminrhMesSondagesComponent_ng_container_0_ng_container_28_span_5_Template, 2, 1, "span", 20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 21);
    \u0275\u0275listener("click", function AdminrhMesSondagesComponent_ng_container_0_ng_container_28_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(9, AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_9_Template, 7, 0, "div", 23)(10, AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_10_Template, 2, 1, "div", 24);
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(17, AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_17_Template, 7, 0, "div", 27)(18, AdminrhMesSondagesComponent_ng_container_0_ng_container_28_div_18_Template, 2, 1, "div", 24);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminrhMesSondagesComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    ...
    \u0275\u0275text(9, "Enqu\xEAtes libres publi\xE9es par votre organisation");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(26, AdminrhMesSondagesComponent_ng_container_0_div_26_Template, 4, 0, "div", 11)(27, AdminrhMesSondagesComponent_ng_container_0_div_27_Template, 3, 1, "div", 12)(28, AdminrhMesSondagesComponent_ng_container_0_ng_container_28_Template, 19, 7, "ng-container", 0);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AdminrhMesSondagesComponent_ng_container_1_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminrhMesSondagesComponent_ng_container_1_div_1_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_p_7_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_span_5_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_p_6_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "input", 94);
    \u0275\u0275twoWayListener("ngModelChange", function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_7_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r0 = \u0275\u0275nextContext(4);
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "textarea", 95);
    \u0275\u0275twoWayListener("ngModelChange", function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_8_Template_textarea_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r0 = \u0275\u0275nextContext(4);
      \u0275\u0275twoWayBindingSet(ctx_r0.reponses[ctx_r0.currentQuestion.id], $event) || (ctx_r0.reponses[ctx_r0.currentQuestion.id] = $event);
      return \u0275\u0275resetView($event);
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "input", 96);
    \u0275\u0275twoWayListener("ngModelChange", function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_9_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(4);
      \u0275\u0275twoWayBindingSet(ctx_r0.reponses[ctx_r0.currentQuestion.id], $event) || (ctx_r0.reponses[ctx_r0.currentQuestion.id] = $event);
      return \u0275\u0275resetView($event);
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_10_label_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label", 99)(1, "input", 100);
    \u0275\u0275twoWayListener("ngModelChange", function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_10_label_2_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r11);
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 97);
    \u0275\u0275template(2, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_10_label_2_Template, 5, 6, "label", 98);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_11_option_4_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "select", 102);
    \u0275\u0275twoWayListener("ngModelChange", function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_11_Template_select_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r0 = \u0275\u0275nextContext(4);
      \u0275\u0275twoWayBindingSet(ctx_r0.reponses[ctx_r0.currentQuestion.id], $event) || (ctx_r0.reponses[ctx_r0.currentQuestion.id] = $event);
      return \u0275\u0275resetView($event);
    ...
    \u0275\u0275text(3, "\u2014 Choisir \u2014");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_11_option_4_Template, 2, 2, "option", 104);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_12_label_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label", 99)(1, "input", 106);
    \u0275\u0275listener("change", function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_12_label_2_Template_input_change_1_listener() {
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 97);
    \u0275\u0275template(2, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_12_label_2_Template, 5, 4, "label", 98);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_13_button_2_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "i", 112);
    \u0275\u0275elementContainerEnd();
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_13_button_2_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_13_button_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 111);
    \u0275\u0275listener("click", function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_13_button_2_Template_button_click_0_listener() {
      const v_r18 = \u0275\u0275restoreView(_r17).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r0.reponses[ctx_r0.currentQuestion.id] = v_r18);
    });
    \u0275\u0275template(1, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_13_button_2_ng_container_1_Template, 2, 4, "ng-container", 0)(2, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_13_button_2_ng_container_2_Template, 2, 1, "ng-container", 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_13_div_3_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 108);
    \u0275\u0275template(2, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_13_button_2_Template, 3, 4, "button", 109);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_13_div_3_Template, 5, 2, "div", 110);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(4);
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275template(5, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_span_5_Template, 2, 0, "span", 89);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_p_6_Template, 3, 1, "p", 90)(7, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_7_Template, 2, 3, "ng-container", 0)(8, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_8_Template, 2, 2, "ng-container", 0)(9, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_9_Template, 2, 2, "ng-container", 0)(10, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_10_Template, 3, 1, "ng-container", 0)(11, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_11_Template, 5, 2, "ng-container", 0)(12, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_12_Template, 3, 1, "ng-container", 0)(13, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_ng_container_13_Template, 4, 2, "ng-container", 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275element(1, "i", 16);
    \u0275\u0275text(2);
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_button_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 114);
    \u0275\u0275listener("click", function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_button_19_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r0 = \u0275\u0275nextContext(3);
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_button_20_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275element(1, "i", 64);
    \u0275\u0275text(2, " Soumettre");
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_button_20_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_button_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 116);
    \u0275\u0275listener("click", function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_button_20_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r20);
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.soumettre());
    });
    \u0275\u0275template(1, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_button_20_span_1_Template, 3, 0, "span", 0)(2, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_button_20_span_2_Template, 3, 0, "span", 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 72)(2, "button", 73);
    \u0275\u0275listener("click", function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.retour());
    });
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_p_7_Template, 2, 1, "p", 75);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(13, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_13_Template, 14, 11, "div", 80)(14, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_div_14_Template, 3, 1, "div", 12);
    \u0275\u0275elementStart(15, "div", 81)(16, "button", 82);
    \u0275\u0275listener("click", function AdminrhMesSondagesComponent_ng_container_1_ng_container_2_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(19, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_button_19_Template, 3, 0, "button", 83)(20, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_button_20_Template, 3, 3, "button", 84);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AdminrhMesSondagesComponent_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, AdminrhMesSondagesComponent_ng_container_1_div_1_Template, 10, 1, "div", 65)(2, AdminrhMesSondagesComponent_ng_container_1_ng_container_2_Template, 21, 11, "ng-container", 0);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var AdminrhMesSondagesComponent = class _AdminrhMesSondagesComponent {
  sondageService;
  vue = "liste";
  sondages = [];
  sondagesRepondus = [];
...
<ng-container *ngIf="vue === 'liste'">
  ...
  <div class="ms-hero">
    <div class="ms-hero__left">
      ...
      <div>
        <h4 class="ms-hero__title">Enqu\xEAtes & Sondages</h4>
        <p class="ms-hero__sub">Enqu\xEAtes libres publi\xE9es par votre organisation</p>
      </div>
    </div>
    <div class="ms-hero__stats">
      <div class="ms-stat">
        <span class="ms-stat__value">{{ aCompleter }}</span>
        <span class="ms-stat__label">\xC0 compl\xE9ter</span>
      </div>
      <div class="ms-stat">
        <span class="ms-stat__value">{{ repondus }}</span>
        <span class="ms-stat__label">R\xE9pondus</span>
      </div>
      <div class="ms-stat">
        <span class="ms-stat__value">{{ clotures }}</span>
        <span class="ms-stat__label">Cl\xF4tur\xE9s</span>
      </div>
    </div>
  </div>
  ...
  <ng-container *ngIf="!loading && !error">
    ...
    <!-- Section \xC0 compl\xE9ter -->
    <div class="ms-section-header">
      <div class="ms-section-header__left">
        <h5 class="ms-section-title">\xC0 compl\xE9ter</h5>
      ...
      <div *ngFor="let s of sondages" class="ms-card" (click)="ouvrir(s)">
        ...
        <div class="ms-card__body">
          ...
          <div class="ms-card__meta">
            ...
            <span><i class="isax isax-calendar-1"></i> Re\xE7u aujourd'hui</span>
          </div>
    ...
    <!-- Section D\xE9j\xE0 r\xE9pondus -->
    <div class="ms-section-header ms-section-header--secondary">
      <div class="ms-section-header__left">
        <h5 class="ms-section-title">D\xE9j\xE0 r\xE9pondus</h5>
        <span class="ms-count-badge ms-count-badge--muted">{{ repondus }} cl\xF4tur\xE9</span>
      </div>
    </div>

    <div *ngIf="sondagesRepondus.length === 0" class="ms-empty ms-empty--small">
      <div class="ms-empty__icon"><i class="isax isax-clipboard-tick"></i></div>
      <h6 class="ms-empty__title">Aucun sondage r\xE9pondu pour l'instant</h6>
      <p class="ms-empty__sub">Vos r\xE9ponses pass\xE9es s'afficheront ici</p>
    </div>
      ...
      <div *ngFor="let s of sondagesRepondus" class="ms-card ms-card--done">
        ...
        <div class="ms-card__body">
          <div class="ms-card__header">
            ...
            <span class="ms-badge ms-badge--done"><i class="isax isax-tick-circle"></i> R\xE9pondu</span>
          </div>
          <h6 class="ms-card__title">{{ s.titre }}</h6>
          <div class="ms-card__meta">
            <span><i class="isax isax-note-21"></i> {{ s.nombre_questions }} question{{ s.nombre_questions !== 1 ? 's' : '' }}</span>
...
<ng-container *ngIf="vue === 'repondre' && selected">
  ...
  <div *ngIf="submitSuccess" class="ms-success-screen">
    ...
    <button type="button" class="ms-btn-back" (click)="retour()"><i class="isax isax-arrow-left-2"></i> Retour aux enqu\xEAtes</button>
  </div>
