...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SuperadminAnnouncementsComponent, [{
    type: Component,
    args: [{ selector: "app-superadmin-announcements", imports: [CommonModule, MatTableModule, MatSortModule, MatPaginatorModule, MatSelectModule, FormsModule], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminAnnouncementsComponent, { className: "SuperadminAnnouncementsComponent", filePath: "src/app/features/superadmin/superadmin-announcements/superadmin-announcements.component.ts", lineNumber: 20 });
})();
export {
  SuperadminAnnouncementsComponent
};
//# sourceMappingURL=chunk-Z7J7C3FL.js.map
