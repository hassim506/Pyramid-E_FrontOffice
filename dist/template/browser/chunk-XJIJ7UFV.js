...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorAnnouncementsComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-announcements", imports: [CommonModule, MatTableModule, MatSortModule, MatPaginatorModule, MatSelectModule, FormsModule], template: `\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorAnnouncementsComponent, { className: "InstructorAnnouncementsComponent", filePath: "app/features/instructor/instructor-announcements/instructor-announcements.component.ts", lineNumber: 20 });
})();
export {
  InstructorAnnouncementsComponent
};
//# sourceMappingURL=chunk-XJIJ7UFV.js.map
