...
function AdminrhDemandeParcoursComponent_div_8_div_16_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeParcoursComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(16, AdminrhDemandeParcoursComponent_div_8_div_16_Template, 5, 1, "div", 38);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminrhDemandeParcoursComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminrhDemandeParcoursComponent_div_13_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
...
function AdminrhDemandeParcoursComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementStart(3, "button", 42);
    \u0275\u0275listener("click", function AdminrhDemandeParcoursComponent_div_14_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.clearMessages());
    });
...
function AdminrhDemandeParcoursComponent_option_25_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeParcoursComponent_small_39_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeParcoursComponent_div_40_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeParcoursComponent_div_41_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeParcoursComponent_div_42_tr_52_div_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 94)(1, "small", 35);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function AdminrhDemandeParcoursComponent_div_42_tr_52_div_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 94)(1, "small", 106);
    \u0275\u0275text(2, "RH:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "small", 107);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function AdminrhDemandeParcoursComponent_div_42_tr_52_button_47_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 111);
  }
}
function AdminrhDemandeParcoursComponent_div_42_tr_52_button_47_i_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 112);
  }
}
function AdminrhDemandeParcoursComponent_div_42_tr_52_button_47_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 108);
    \u0275\u0275listener("click", function AdminrhDemandeParcoursComponent_div_42_tr_52_button_47_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const demande_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.validerDemande(demande_r6));
    });
    \u0275\u0275template(1, AdminrhDemandeParcoursComponent_div_42_tr_52_button_47_span_1_Template, 1, 0, "span", 109)(2, AdminrhDemandeParcoursComponent_div_42_tr_52_button_47_i_2_Template, 1, 0, "i", 110);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const demande_r6 = \u0275\u0275nextContext().$implicit;
...
function AdminrhDemandeParcoursComponent_div_42_tr_52_button_48_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 111);
  }
}
function AdminrhDemandeParcoursComponent_div_42_tr_52_button_48_i_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 115);
  }
}
function AdminrhDemandeParcoursComponent_div_42_tr_52_button_48_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 113);
    \u0275\u0275listener("click", function AdminrhDemandeParcoursComponent_div_42_tr_52_button_48_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const demande_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.refuserDemande(demande_r6));
    });
    \u0275\u0275template(1, AdminrhDemandeParcoursComponent_div_42_tr_52_button_48_span_1_Template, 1, 0, "span", 109)(2, AdminrhDemandeParcoursComponent_div_42_tr_52_button_48_i_2_Template, 1, 0, "i", 114);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const demande_r6 = \u0275\u0275nextContext().$implicit;
...
function AdminrhDemandeParcoursComponent_div_42_tr_52_button_49_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 116);
    \u0275\u0275listener("click", function AdminrhDemandeParcoursComponent_div_42_tr_52_button_49_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const demande_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminrhDemandeParcoursComponent_div_42_tr_52_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(10, "slice");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(11, "td")(12, "div", 90)(13, "div", 91)(14, "span", 92);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div")(17, "div", 93);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "small", 35);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 94)(22, "small", 35);
    \u0275\u0275text(23);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(24, "td")(25, "span");
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "td")(28, "div", 90);
    \u0275\u0275element(29, "i", 95);
    \u0275\u0275elementStart(30, "span");
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "td")(33, "div", 90);
    \u0275\u0275element(34, "i", 96);
    ...
    \u0275\u0275text(39);
    \u0275\u0275elementEnd();
    \u0275\u0275template(40, AdminrhDemandeParcoursComponent_div_42_tr_52_div_40_Template, 3, 1, "div", 97);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "td")(42, "div", 98);
    \u0275\u0275text(43);
    \u0275\u0275elementEnd();
    \u0275\u0275template(44, AdminrhDemandeParcoursComponent_div_42_tr_52_div_44_Template, 5, 2, "div", 97);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "td", 99)(46, "div", 100);
    \u0275\u0275template(47, AdminrhDemandeParcoursComponent_div_42_tr_52_button_47_Template, 3, 3, "button", 101)(48, AdminrhDemandeParcoursComponent_div_42_tr_52_button_48_Template, 3, 3, "button", 102)(49, AdminrhDemandeParcoursComponent_div_42_tr_52_button_49_Template, 2, 1, "button", 103);
    \u0275\u0275elementStart(50, "button", 104);
    \u0275\u0275element(51, "i", 105);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", (demande_r6.parcours == null ? null : demande_r6.parcours.titre) || (demande_r6.parcours == null ? null : demande_r6.parcours.nom) || "Parcours non d\xE9fini", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind3(10, 23, (demande_r6.parcours == null ? null : demande_r6.parcours.description) || "", 0, 60), "", ((demande_r6.parcours == null ? null : demande_r6.parcours.description == null ? null : demande_r6.parcours.description.length) ?? 0) > 60 ? "\u2026" : "", " ");
    \u0275\u0275advance(6);
...
function AdminrhDemandeParcoursComponent_div_42_tr_53_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td", 117)(2, "div", 35);
    \u0275\u0275element(3, "i", 118);
    \u0275\u0275elementStart(4, "h6", 92);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function AdminrhDemandeParcoursComponent_div_42_tr_53_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminrhDemandeParcoursComponent_div_42_div_54_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeParcoursComponent_div_42_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 55)(1, "div", 56)(2, "div", 57)(3, "h6", 58);
    \u0275\u0275element(4, "i", 59);
    \u0275\u0275text(5, " Demandes de Parcours ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function AdminrhDemandeParcoursComponent_div_42_Template_a_click_14_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminrhDemandeParcoursComponent_div_42_Template_a_click_17_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminrhDemandeParcoursComponent_div_42_Template_a_click_20_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminrhDemandeParcoursComponent_div_42_Template_a_click_23_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("matSortChange", function AdminrhDemandeParcoursComponent_div_42_Template_table_matSortChange_26_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(52, AdminrhDemandeParcoursComponent_div_42_tr_52_Template, 52, 27, "tr", 82)(53, AdminrhDemandeParcoursComponent_div_42_tr_53_Template, 11, 1, "tr", 83);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(54, AdminrhDemandeParcoursComponent_div_42_div_54_Template, 2, 0, "div", 84);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
Veuillez saisir un motif :`);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminrhDemandeParcoursComponent, selectors: [["app-adminrh-demande-parcours"]], decls: 43, vars: 19, consts: [[1, "page-content"], [1, "page-title", "d-flex", "align-items-center", "justify-content-between", "mb-4"], [1, "fw-bold", "mb-1"], [1, "text-muted", "mb-0"], [1, "d-flex", "align-items-center", "gap-2"], ["class", "d-flex align-items-center gap-3 me-3", 4, "ngIf"], [1, "btn", "btn-outline-primary", 3, "click", "disabled"], [1, "isax", "isax-refresh"], [1, "ms-1", "d-none", "d-sm-inline"], ["class", "alert alert-success alert-dismissible fade show", "role", "alert", 4, "ngIf"], ["class", "alert alert-danger alert-dismissible fade show", "role", "alert", 4, "ngIf"], [1, "card", "mb-4"], [1, "card-body"], [1, "row", "g-3"], [1, "col-lg-4"], [1, "input-group"], [1, "input-group-text"], [1, "isax", "isax-search-normal-1"], ["type", "search", "placeholder", "Rechercher formation, employ\xE9...", 1, "form-control", 3, "ngModelChange", "ngModel", "ngModelOptions", "disabled"], [1, "col-lg-3"], [1, "form-select", 3, "ngModelChange", "ngModel", "disabled"], [3, "value", 4, "ngFor", "ngForOf"], ["value", "tous"], ["value", "basse"], ["value", "normale"], ["value", "haute"], ["value", "urgente"], [1, "col-lg-2", "text-end"], ["class", "text-muted", 4, "ngIf"], ["class", "d-flex justify-content-center p-5", 4, "ngIf"], ["class", "card text-center py-5", 4, "ngIf"], ["class", "card", 4, "ngIf"], [1, "d-flex", "align-items-center", "gap-3", "me-3"], [1, "text-center"], [1, "fw-bold", "text-primary", "fs-5"], [1, "text-muted"], [1, "fw-bold", "text-warning", "fs-5"], [1, "fw-bold", "text-success", "fs-5"], ["class", "text-center", 4, "ngIf"], [1, "fw-bold", "text-danger", "fs-5"], ["role", "alert", 1, "alert", "alert-success", "alert-dismissible", "fade", "show"], [1, "isax", "isax-tick-circle", "me-2"], ["type", "button", 1, "btn-close", 3, "click"], ["role", "alert", 1, "alert", "alert-danger", "alert-dismissible", "fade", "show"], [1, "isax", "isax-warning-2", "me-2"], [3, "value"], [1, "d-flex", "justify-content-center", "p-5"], ["role", "status", 1, "spinner-border", "text-primary", "mb-3", 2, "width", "3rem", "height", "3rem"], [1, "visually-hidden"], [1, "text-muted", "fs-6"], [1, "card", "text-center", "py-5"], [1, "mb-4"], [1, "isax", "isax-document", "display-1", "text-muted"], [1, "fw-bold", "mb-3"], [1, "text-muted", "mb-4"], [1, "card"], [1, "card-header", "bg-white", "border-bottom"], [1, "d-flex", "align-items-center", "justify-content-between"], [1, "mb-0", "fw-bold"], [1, "isax", "isax-routing", "me-2", "text-primary"], [1, "badge", "bg-light", "text-dark"], [1, "dropdown"], ["type", "button", "data-bs-toggle", "dropdown", "aria-expanded", "false", 1, "btn", "btn-sm", "btn-outline-secondary", "dropdown-toggle"], [1, "dropdown-menu"], ["href", "javascript:void(0)", 1, "dropdown-item", 3, "click"], [1, "table-responsive"], ["matSort", "", 1, "table", "table-hover", "mb-0", 3, "matSortChange"], [1, "table-light"], ["mat-sort-header", "parcours", 1, "fw-semibold"], [1, "isax", "isax-routing", "me-1"], ["mat-sort-header", "employe", 1, "fw-semibold"], [1, "isax", "isax-profile-2user", "me-1"], ["mat-sort-header", "priorite", 1, "fw-semibold"], [1, "isax", "isax-flag", "me-1"], ["mat-sort-header", "created_at", 1, "fw-semibold"], [1, "isax", "isax-calendar", "me-1"], ["mat-sort-header", "date_souhaitee_debut", 1, "fw-semibold"], [1, "isax", "isax-clock", "me-1"], ["mat-sort-header", "statut", 1, "fw-semibold"], [1, "isax", "isax-status", "me-1"], [1, "fw-semibold"], [1, "text-end", "fw-semibold"], ["class", "align-middle", 4, "ngFor", "ngForOf", "ngForTrackBy"], [4, "ngIf"], ["class", "card-footer bg-white border-top", 4, "ngIf"], [1, "align-middle"], [1, "d-flex", "align-items-start"], [1, "avatar", "avatar-md", "bg-primary", "text-white", "rounded", "me-3", "d-flex", "align-items-center", "justify-content-center"], [1, "isax", "isax-routing"], [1, "fw-semibold", "text-dark", "mb-1"], [1, "d-flex", "align-items-center"], [1, "avatar", "avatar-md", "bg-info", "text-white", "rounded", "me-3", "d-flex", "align-items-center", "justify-content-center"], [1, "fw-bold"], [1, "fw-medium", "text-dark"], [1, "mt-1"], [1, "isax", "isax-calendar", "text-muted", "me-2"], [1, "isax", "isax-clock", "text-muted", "me-2"], ["class", "mt-1", 4, "ngIf"], [1, "text-truncate", 2, "max-width", "200px", 3, "title"], [1, "text-end"], ["role", "group", 1, "btn-group", "btn-group-sm"], ["class", "btn btn-outline-success", "title", "Valider la demande", 3, "disabled", "click", 4, "ngIf"], ["class", "btn btn-outline-danger", "title", "Refuser la demande", 3, "disabled", "click", 4, "ngIf"], ["class", "btn btn-outline-warning", "title", "Annuler la demande", 3, "disabled", "click", 4, "ngIf"], ["title", "Voir les d\xE9tails", 1, "btn", "btn-outline-info"], [1, "isax", "isax-eye"], [1, "text-muted", "fw-medium"], [1, "text-muted", "d-block", "text-truncate", 2, "max-width", "200px", 3, "title"], ["title", "Valider la demande", 1, "btn", "btn-outline-success", 3, "click", "disabled"], ["class", "spinner-border spinner-border-sm me-1", 4, "ngIf"], ["class", "isax isax-tick-circle", 4, "ngIf"], [1, "spinner-border", "spinner-border-sm", "me-1"], [1, "isax", "isax-tick-circle"], ["title", "Refuser la demande", 1, "btn", "btn-outline-danger", 3, "click", "disabled"], ["class", "isax isax-close-circle", 4, "ngIf"], [1, "isax", "isax-close-circle"], ["title", "Annuler la demande", 1, "btn", "btn-outline-warning", 3, "click", "disabled"], ["colspan", "8", 1, "text-center", "py-5"], [1, "isax", "isax-search-normal-1", "display-6", "mb-3", "d-block", "text-muted", "opacity-50"], [1, "mb-0", "small"], [1, "btn", "btn-sm", "btn-outline-primary", "mt-2", 3, "click"], [1, "isax", "isax-refresh", "me-1"], [1, "card-footer", "bg-white", "border-top"]], template: function AdminrhDemandeParcoursComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(8, AdminrhDemandeParcoursComponent_div_8_Template, 17, 4, "div", 5);
      \u0275\u0275elementStart(9, "button", 6);
      \u0275\u0275listener("click", function AdminrhDemandeParcoursComponent_Template_button_click_9_listener() {
      ...
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(13, AdminrhDemandeParcoursComponent_div_13_Template, 4, 1, "div", 9)(14, AdminrhDemandeParcoursComponent_div_14_Template, 4, 1, "div", 10);
      \u0275\u0275elementStart(15, "div", 11)(16, "div", 12)(17, "div", 13)(18, "div", 14)(19, "div", 15)(20, "span", 16);
      \u0275\u0275element(21, "i", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "input", 18);
      \u0275\u0275twoWayListener("ngModelChange", function AdminrhDemandeParcoursComponent_Template_input_ngModelChange_22_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.searchDataValue, $event) || (ctx.searchDataValue = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function AdminrhDemandeParcoursComponent_Template_input_ngModelChange_22_listener() {
        return ctx.searchData(ctx.searchDataValue);
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(23, "div", 19)(24, "select", 20);
      \u0275\u0275twoWayListener("ngModelChange", function AdminrhDemandeParcoursComponent_Template_select_ngModelChange_24_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.selectedStatutFilter, $event) || (ctx.selectedStatutFilter = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function AdminrhDemandeParcoursComponent_Template_select_ngModelChange_24_listener($event) {
        return ctx.onStatutFilterChange($event);
      });
      \u0275\u0275template(25, AdminrhDemandeParcoursComponent_option_25_Template, 2, 3, "option", 21);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(26, "div", 19)(27, "select", 20);
      \u0275\u0275twoWayListener("ngModelChange", function AdminrhDemandeParcoursComponent_Template_select_ngModelChange_27_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.selectedPrioriteFilter, $event) || (ctx.selectedPrioriteFilter = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function AdminrhDemandeParcoursComponent_Template_select_ngModelChange_27_listener($event) {
      ...
      \u0275\u0275template(39, AdminrhDemandeParcoursComponent_small_39_Template, 2, 1, "small", 28);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(40, AdminrhDemandeParcoursComponent_div_40_Template, 7, 0, "div", 29)(41, AdminrhDemandeParcoursComponent_div_41_Template, 8, 0, "div", 30)(42, AdminrhDemandeParcoursComponent_div_42_Template, 55, 6, "div", 31);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
  ...
  }, dependencies: [FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgModel, CommonModule, NgForOf, NgIf, MatSortModule, MatSort, MatSortHeader, CustomPaginationComponent, SlicePipe], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhDemandeParcoursComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-demande-parcours", standalone: true, imports: [RouterLink, FormsModule, CommonModule, MatSortModule, CustomPaginationComponent], template: `<div class="page-content">\r
    ...
    <div class="card-header bg-white border-bottom">\r
      <div class="d-flex align-items-center justify-content-between">\r
        <h6 class="mb-0 fw-bold">\r
          <i class="isax isax-routing me-2 text-primary"></i>\r
          Demandes de Parcours\r
        </h6>\r
        <div class="d-flex align-items-center gap-2">\r
    ...
    <div class="table-responsive">\r
      <table matSort (matSortChange)="sortData($event)" class="table table-hover mb-0">\r
        <thead class="table-light">\r
          <tr>\r
            <th mat-sort-header="parcours" class="fw-semibold">\r
              <i class="isax isax-routing me-1"></i>Parcours\r
            </th>\r
              ...
              <div class="d-flex align-items-start">\r
                ...
                <div>\r
                  <div class="fw-semibold text-dark mb-1">\r
                    {{ demande.parcours?.titre || demande.parcours?.nom || 'Parcours non d\xE9fini' }}\r
                  </div>\r
                  <small class="text-muted">\r
                    {{ demande.parcours?.description || '' | slice:0:60 }}{{ (demande.parcours?.description?.length ?? 0) > 60 ? '\u2026' : '' }}\r
                  </small>\r
                </div>\r
              </div>\r
            </td>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhDemandeParcoursComponent, { className: "AdminrhDemandeParcoursComponent", filePath: "src/app/features/adminrh/adminrh-demande-parcours/adminrh-demande-parcours.component.ts", lineNumber: 43 });
})();
export {
  AdminrhDemandeParcoursComponent
};
//# sourceMappingURL=chunk-65A35JKY.js.map
