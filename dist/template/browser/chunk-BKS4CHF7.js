...
function InstructorCourseAddComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 54)(1, "div", 55)(2, "div", 56)(3, "span", 57);
    \u0275\u0275text(4, "Chargement...");
    \u0275\u0275elementEnd()();
...
function InstructorCourseAddComponent_div_3_div_68_option_24_Template(rf, ctx) {
  if (rf & 1) {
...
function InstructorCourseAddComponent_div_3_div_68_span_90_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 129);
    \u0275\u0275text(1);
    \u0275\u0275elementStart(2, "button", 130);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_68_span_90_Template_button_click_2_listener() {
...
function InstructorCourseAddComponent_div_3_div_68_span_91_Template(rf, ctx) {
  if (rf & 1) {
...
function InstructorCourseAddComponent_div_3_div_68_span_101_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 132);
    \u0275\u0275text(1);
    \u0275\u0275elementStart(2, "button", 130);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_68_span_101_Template_button_click_2_listener() {
      const i_r11 = \u0275\u0275restoreView(_r10).index;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.removePrerequis(i_r11));
    });
    \u0275\u0275text(3, "\xD7");
    \u0275\u0275elementEnd()();
  }
...
function InstructorCourseAddComponent_div_3_div_68_span_102_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 131);
...
function InstructorCourseAddComponent_div_3_div_68_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 85)(1, "div", 86)(2, "div", 87)(3, "h4", 88);
    \u0275\u0275element(4, "i", 89);
    \u0275\u0275text(5, " Informations de base ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "form", 90)(7, "div", 28)(8, "div", 29)(9, "label", 91);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 94)(17, "label", 91);
    \u0275\u0275text(18, "Cat\xE9gorie");
    \u0275\u0275elementStart(19, "span", 19);
    \u0275\u0275text(20, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "select", 95)(22, "option", 96);
    \u0275\u0275text(23, "S\xE9lectionner une cat\xE9gorie");
    \u0275\u0275elementEnd();
    \u0275\u0275template(24, InstructorCourseAddComponent_div_3_div_68_option_24_Template, 2, 2, "option", 97);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 93);
    \u0275\u0275text(26, "La cat\xE9gorie est requise");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 94)(28, "label", 91);
    \u0275\u0275text(29, "Niveau");
    \u0275\u0275elementStart(30, "span", 19);
    \u0275\u0275text(31, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "select", 98)(33, "option", 99);
    \u0275\u0275text(34, "D\xE9butant");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "option", 100);
    \u0275\u0275text(36, "Interm\xE9diaire");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "option", 101);
    \u0275\u0275text(38, "Avanc\xE9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "option", 102);
    \u0275\u0275text(40, "Expert");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(41, "div", 94)(42, "label", 91);
    \u0275\u0275text(43, "Langue");
    \u0275\u0275elementStart(44, "span", 19);
    \u0275\u0275text(45, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "select", 103)(47, "option", 104);
    \u0275\u0275text(48, "Fran\xE7ais");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "option", 105);
    \u0275\u0275text(50, "Anglais");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "option", 106);
    \u0275\u0275text(52, "Espagnol");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(53, "div", 30)(54, "label", 91);
    \u0275\u0275text(55, "Type de formation");
    \u0275\u0275elementStart(56, "span", 19);
    \u0275\u0275text(57, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(58, "select", 107)(59, "option", 108);
    \u0275\u0275text(60, "En ligne");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "option", 109);
    \u0275\u0275text(62, "Pr\xE9sentiel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "option", 110);
    \u0275\u0275text(64, "Hybride");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(65, "div", 30)(66, "label", 91);
    \u0275\u0275text(67, "Nombre max de participants");
    \u0275\u0275elementEnd();
    \u0275\u0275element(68, "input", 111);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "div", 29)(70, "label", 91);
    \u0275\u0275text(71, "Description courte");
    \u0275\u0275elementStart(72, "span", 19);
    \u0275\u0275text(73, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(74, "input", 112);
    \u0275\u0275elementStart(75, "div", 93);
    \u0275\u0275text(76, "La description courte est requise");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(77, "div", 29)(78, "label", 91);
    \u0275\u0275text(79, "Description compl\xE8te");
    \u0275\u0275elementStart(80, "span", 19);
    \u0275\u0275text(81, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(82, "textarea", 113);
    \u0275\u0275elementStart(83, "div", 93);
    \u0275\u0275text(84, "La description est requise");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(85, "div", 30)(86, "label", 18);
    \u0275\u0275element(87, "i", 114);
    \u0275\u0275text(88, " Objectifs p\xE9dagogiques ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(89, "div", 115);
    \u0275\u0275template(90, InstructorCourseAddComponent_div_3_div_68_span_90_Template, 4, 1, "span", 116)(91, InstructorCourseAddComponent_div_3_div_68_span_91_Template, 2, 0, "span", 117);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(92, "div", 118)(93, "input", 119);
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_68_Template_input_ngModelChange_93_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r2.newObjectif, $event) || (ctx_r2.newObjectif = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("keyup.enter", function InstructorCourseAddComponent_div_3_div_68_Template_input_keyup_enter_93_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.addObjectif());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(94, "button", 120);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_68_Template_button_click_94_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.addObjectif());
    });
    \u0275\u0275text(95, "+ Ajouter");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(96, "div", 30)(97, "label", 18);
    \u0275\u0275element(98, "i", 121);
    \u0275\u0275text(99, " Pr\xE9requis ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(100, "div", 115);
    \u0275\u0275template(101, InstructorCourseAddComponent_div_3_div_68_span_101_Template, 4, 1, "span", 122)(102, InstructorCourseAddComponent_div_3_div_68_span_102_Template, 2, 0, "span", 117);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(103, "div", 118)(104, "input", 123);
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_68_Template_input_ngModelChange_104_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r2.newPrerequis, $event) || (ctx_r2.newPrerequis = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("keyup.enter", function InstructorCourseAddComponent_div_3_div_68_Template_input_keyup_enter_104_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.addPrerequis());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(105, "button", 120);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_68_Template_button_click_105_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.addPrerequis());
    });
    \u0275\u0275text(106, "+ Ajouter");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(107, "div", 124)(108, "div", 41);
    \u0275\u0275element(109, "input", 125);
    \u0275\u0275elementStart(110, "label", 126);
    \u0275\u0275element(111, "i", 127);
...
function InstructorCourseAddComponent_div_3_div_69_div_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 164);
    \u0275\u0275element(1, "img", 165);
    \u0275\u0275elementStart(2, "div", 166)(3, "button", 167);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_69_div_20_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275element(4, "i", 168);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 169)(6, "button", 170);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_69_div_20_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r14);
      \u0275\u0275nextContext();
...
function InstructorCourseAddComponent_div_3_div_69_ng_template_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 172);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_69_ng_template_21_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r16);
      \u0275\u0275nextContext();
      const imageInput_r15 = \u0275\u0275reference(19);
      return \u0275\u0275resetView(imageInput_r15.click());
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 176);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_69_ng_template_21_Template_button_click_7_listener($event) {
      \u0275\u0275restoreView(_r16);
      \u0275\u0275nextContext();
      const imageInput_r15 = \u0275\u0275reference(19);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 169)(11, "small", 143);
    \u0275\u0275element(12, "i", 178);
    \u0275\u0275text(13, " Formats accept\xE9s : JPEG, PNG, WebP \u2022 Taille max : 5MB \u2022 R\xE9solution recommand\xE9e : 1200x600px ");
    \u0275\u0275elementEnd()()();
  }
}
function InstructorCourseAddComponent_div_3_div_69_div_23_Template(rf, ctx) {
  if (rf & 1) {
...
function InstructorCourseAddComponent_div_3_div_69_button_35_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 180);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_69_button_35_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext(3);
...
function InstructorCourseAddComponent_div_3_div_69_div_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 181)(1, "small");
    \u0275\u0275element(2, "i", 182);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
  }
...
function InstructorCourseAddComponent_div_3_div_69_div_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 183)(1, "small");
    \u0275\u0275element(2, "i", 184);
    \u0275\u0275text(3, "URL vid\xE9o valide");
    \u0275\u0275elementEnd()();
  }
}
function InstructorCourseAddComponent_div_3_div_69_div_42_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 194);
    \u0275\u0275element(1, "iframe", 195);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_8_0;
...
function InstructorCourseAddComponent_div_3_div_69_div_42_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 194);
...
function InstructorCourseAddComponent_div_3_div_69_div_42_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 197)(1, "video", 198);
...
function InstructorCourseAddComponent_div_3_div_69_div_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 185)(1, "div", 186)(2, "div", 187)(3, "h6", 188);
    \u0275\u0275element(4, "i", 189);
    \u0275\u0275text(5, " Aper\xE7u de la vid\xE9o ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "span", 190);
    \u0275\u0275text(7, "Vid\xE9o d\xE9tect\xE9e");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 191);
    \u0275\u0275template(9, InstructorCourseAddComponent_div_3_div_69_div_42_div_9_Template, 2, 1, "div", 192)(10, InstructorCourseAddComponent_div_3_div_69_div_42_div_10_Template, 2, 1, "div", 192)(11, InstructorCourseAddComponent_div_3_div_69_div_42_div_11_Template, 3, 1, "div", 193);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    let tmp_7_0;
...
function InstructorCourseAddComponent_div_3_div_69_div_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 199)(1, "div", 200)(2, "div", 201);
    \u0275\u0275element(3, "i", 202);
    \u0275\u0275elementStart(4, "h6", 143);
    \u0275\u0275text(5, "Aucune vid\xE9o de pr\xE9sentation");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 203);
    \u0275\u0275text(7, " Ajoutez une vid\xE9o pour pr\xE9senter votre formation aux apprenants ");
    \u0275\u0275elementEnd()()()();
  }
}
function InstructorCourseAddComponent_div_3_div_69_div_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 124)(1, "div", 204)(2, "div", 205)(3, "h6", 206);
    \u0275\u0275element(4, "i", 207);
    \u0275\u0275text(5, " Param\xE8tres de la vid\xE9o ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 28)(7, "div", 40)(8, "div", 41);
    \u0275\u0275element(9, "input", 208);
    \u0275\u0275elementStart(10, "label", 209);
    \u0275\u0275text(11, " Lecture automatique ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "small", 150);
    \u0275\u0275text(13, " La vid\xE9o d\xE9marre automatiquement (non recommand\xE9) ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(14, "div", 40)(15, "div", 41);
    \u0275\u0275element(16, "input", 210);
    \u0275\u0275elementStart(17, "label", 211);
    \u0275\u0275text(18, " Afficher les contr\xF4les ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "small", 150);
    \u0275\u0275text(20, " Permet aux utilisateurs de contr\xF4ler la lecture ");
    \u0275\u0275elementEnd()()()()()()();
  }
}
function InstructorCourseAddComponent_div_3_div_69_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "form", 90)(12, "div", 28)(13, "div", 136)(14, "label", 91);
    \u0275\u0275element(15, "i", 137);
    \u0275\u0275text(16, " Image de couverture ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 138);
    \u0275\u0275listener("dragover", function InstructorCourseAddComponent_div_3_div_69_Template_div_dragover_17_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onDragOver($event));
    })("dragleave", function InstructorCourseAddComponent_div_3_div_69_Template_div_dragleave_17_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onDragLeave($event));
    })("drop", function InstructorCourseAddComponent_div_3_div_69_Template_div_drop_17_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onDrop($event));
    });
    \u0275\u0275elementStart(18, "input", 139, 2);
    \u0275\u0275listener("change", function InstructorCourseAddComponent_div_3_div_69_Template_input_change_18_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onImageSelected($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(20, InstructorCourseAddComponent_div_3_div_69_div_20_Template, 9, 1, "div", 140)(21, InstructorCourseAddComponent_div_3_div_69_ng_template_21_Template, 14, 0, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    \u0275\u0275template(23, InstructorCourseAddComponent_div_3_div_69_div_23_Template, 3, 1, "div", 141);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 136)(25, "label", 91);
    \u0275\u0275element(26, "i", 142);
    \u0275\u0275text(27, " Vid\xE9o de pr\xE9sentation ");
    \u0275\u0275elementStart(28, "span", 143);
    \u0275\u0275text(29, "(optionnel)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div", 17)(31, "div", 144)(32, "span", 145);
    \u0275\u0275element(33, "i", 146);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "input", 147);
    \u0275\u0275listener("blur", function InstructorCourseAddComponent_div_3_div_69_Template_input_blur_34_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.validateVideoUrl());
    })("input", function InstructorCourseAddComponent_div_3_div_69_Template_input_input_34_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onVideoUrlChange($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(35, InstructorCourseAddComponent_div_3_div_69_button_35_Template, 2, 0, "button", 148);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "div", 149)(37, "small", 150);
    \u0275\u0275element(38, "i", 151);
    \u0275\u0275text(39, " Plateformes support\xE9es : YouTube, Vimeo, ou lien direct vers une vid\xE9o ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(40, InstructorCourseAddComponent_div_3_div_69_div_40_Template, 4, 1, "div", 152)(41, InstructorCourseAddComponent_div_3_div_69_div_41_Template, 4, 0, "div", 153);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(42, InstructorCourseAddComponent_div_3_div_69_div_42_Template, 12, 3, "div", 154)(43, InstructorCourseAddComponent_div_3_div_69_div_43_Template, 8, 0, "div", 155);
    \u0275\u0275elementEnd();
    \u0275\u0275template(44, InstructorCourseAddComponent_div_3_div_69_div_44_Template, 21, 0, "div", 156);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "div", 157)(46, "h6", 158);
    \u0275\u0275element(47, "i", 159);
    \u0275\u0275text(48, " R\xE9sum\xE9 de cette section ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "div", 28)(50, "div", 40)(51, "p", 160);
    \u0275\u0275element(52, "i", 161);
    \u0275\u0275text(53, " Image de couverture : ");
    \u0275\u0275elementStart(54, "span", 162);
    \u0275\u0275text(55);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(56, "div", 40)(57, "p", 160);
    \u0275\u0275element(58, "i", 163);
    \u0275\u0275text(59, " Vid\xE9o de pr\xE9sentation : ");
    \u0275\u0275elementStart(60, "span", 162);
    \u0275\u0275text(61);
    \u0275\u0275elementEnd()()()()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r2.imagePreview)("ngIfElse", noImageTemplate_r18);
    \u0275\u0275advance(3);
...
function InstructorCourseAddComponent_div_3_div_70_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 219)(1, "div", 220)(2, "div", 221)(3, "div", 222)(4, "h3", 188);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "small");
    \u0275\u0275text(7, "Modules");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(8, "div", 220)(9, "div", 223)(10, "div", 222)(11, "h3", 188);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "small");
    \u0275\u0275text(14, "Sections");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(15, "div", 220)(16, "div", 224)(17, "div", 222)(18, "h3", 188);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
...
function InstructorCourseAddComponent_div_3_div_70_div_11_div_1_p_18_Template(rf, ctx) {
  if (rf & 1) {
...
function InstructorCourseAddComponent_div_3_div_70_div_11_div_1_div_20_span_9_Template(rf, ctx) {
  if (rf & 1) {
...
function InstructorCourseAddComponent_div_3_div_70_div_11_div_1_div_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r23 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 245)(1, "div", 246);
    \u0275\u0275element(2, "i", 247);
    \u0275\u0275elementStart(3, "div")(4, "strong");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "br");
    \u0275\u0275elementStart(7, "small", 143);
    \u0275\u0275text(8);
    \u0275\u0275template(9, InstructorCourseAddComponent_div_3_div_70_div_11_div_1_div_20_span_9_Template, 2, 0, "span", 248);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "div", 249)(11, "button", 234);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_70_div_11_div_1_div_20_Template_button_click_11_listener() {
      const sectionIndex_r24 = \u0275\u0275restoreView(_r23).index;
      const moduleIndex_r21 = \u0275\u0275nextContext().index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.editSection(moduleIndex_r21, sectionIndex_r24));
    });
    \u0275\u0275element(12, "i", 235);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "button", 236);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_70_div_11_div_1_div_20_Template_button_click_13_listener() {
      const sectionIndex_r24 = \u0275\u0275restoreView(_r23).index;
      const moduleIndex_r21 = \u0275\u0275nextContext().index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.removeSection(moduleIndex_r21, sectionIndex_r24));
    });
    \u0275\u0275element(14, "i", 237);
    \u0275\u0275elementEnd()()();
  }
...
function InstructorCourseAddComponent_div_3_div_70_div_11_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 227)(1, "h2", 228)(2, "button", 229)(3, "div", 230);
    \u0275\u0275element(4, "i", 231);
    \u0275\u0275elementStart(5, "div", 232)(6, "strong");
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275element(8, "br");
    \u0275\u0275elementStart(9, "small", 143);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 233);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_70_div_11_div_1_Template_div_click_11_listener($event) {
      \u0275\u0275restoreView(_r20);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(12, "button", 234);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_70_div_11_div_1_Template_button_click_12_listener() {
      const moduleIndex_r21 = \u0275\u0275restoreView(_r20).index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.editModule(moduleIndex_r21));
    });
    \u0275\u0275element(13, "i", 235);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "button", 236);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_70_div_11_div_1_Template_button_click_14_listener() {
      const moduleIndex_r21 = \u0275\u0275restoreView(_r20).index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.removeModule(moduleIndex_r21));
    });
    \u0275\u0275element(15, "i", 237);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(16, "div", 238)(17, "div", 239);
    \u0275\u0275template(18, InstructorCourseAddComponent_div_3_div_70_div_11_div_1_p_18_Template, 2, 1, "p", 240);
    \u0275\u0275elementStart(19, "div", 241);
    \u0275\u0275template(20, InstructorCourseAddComponent_div_3_div_70_div_11_div_1_div_20_Template, 15, 5, "div", 242);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "button", 243);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_70_div_11_div_1_Template_button_click_21_listener() {
      const moduleIndex_r21 = \u0275\u0275restoreView(_r20).index;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.openSectionModal(moduleIndex_r21));
    });
    \u0275\u0275element(22, "i", 244);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", (module_r22.sections == null ? null : module_r22.sections.length) || 0, " sections \xB7 ", ctx_r2.getModuleDuration(module_r22), " min ");
    \u0275\u0275advance(6);
...
function InstructorCourseAddComponent_div_3_div_70_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 225);
    \u0275\u0275template(1, InstructorCourseAddComponent_div_3_div_70_div_11_div_1_Template, 24, 14, "div", 226);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function InstructorCourseAddComponent_div_3_div_70_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r26 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 251);
    \u0275\u0275element(1, "i", 252);
    \u0275\u0275elementStart(2, "h5", 143);
    ...
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_70_div_12_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r26);
      const ctx_r2 = \u0275\u0275nextContext(3);
...
function InstructorCourseAddComponent_div_3_div_70_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 85)(1, "div", 86)(2, "div", 87)(3, "div", 212)(4, "h4", 213);
    \u0275\u0275element(5, "i", 214);
    \u0275\u0275text(6, " Modules et Sections ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 52);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_70_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.openModuleModal());
    });
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(10, InstructorCourseAddComponent_div_3_div_70_div_10_Template, 22, 3, "div", 216)(11, InstructorCourseAddComponent_div_3_div_70_div_11_Template, 2, 1, "div", 217)(12, InstructorCourseAddComponent_div_3_div_70_div_12_Template, 9, 0, "div", 218);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function InstructorCourseAddComponent_div_3_div_71_div_6_Template(rf, ctx) {
  if (rf & 1) {
...
function InstructorCourseAddComponent_div_3_div_71_div_7_div_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r27 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 262);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_71_div_7_div_4_Template_div_click_0_listener() {
      const qs_r28 = \u0275\u0275restoreView(_r27).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.selectQuiz(qs_r28.moduleIndex, qs_r28.sectionIndex));
    });
    \u0275\u0275element(1, "i", 263);
    \u0275\u0275elementStart(2, "strong");
    \u0275\u0275text(3);
  ...
  if (rf & 2) {
    const qs_r28 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(4);
    \u0275\u0275styleProp("background", ctx_r2.activeQuizKey === ctx_r2.getQuizKey(qs_r28.moduleIndex, qs_r28.sectionIndex) ? "#ede9fe" : "#f9fafb");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(qs_r28.sectionTitle);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(qs_r28.moduleTitle);
  }
}
function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_div_3_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r35 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 295)(1, "input", 296);
    \u0275\u0275listener("change", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_div_3_div_2_Template_input_change_1_listener() {
      \u0275\u0275restoreView(_r35);
      const opt_r34 = \u0275\u0275nextContext().$implicit;
      const q_r31 = \u0275\u0275nextContext(3).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r2.toggleQuizCorrect(q_r31, opt_r34));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "label", 297);
    \u0275\u0275text(3, "Correcte");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const opt_r34 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("checked", opt_r34.is_correct);
  }
}
function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_div_3_button_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r36 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 298);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_div_3_button_3_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r36);
      const oi_r37 = \u0275\u0275nextContext().index;
      const q_r31 = \u0275\u0275nextContext(3).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r2.removeQuizOption(q_r31, oi_r37));
    });
    \u0275\u0275element(1, "i", 168);
    \u0275\u0275elementEnd();
  }
}
function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_div_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r33 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 291)(1, "input", 292);
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_div_3_Template_input_ngModelChange_1_listener($event) {
      const opt_r34 = \u0275\u0275restoreView(_r33).$implicit;
      \u0275\u0275twoWayBindingSet(opt_r34.reponse_text, $event) || (opt_r34.reponse_text = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(2, InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_div_3_div_2_Template, 4, 1, "div", 293)(3, InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_div_3_button_3_Template, 2, 0, "button", 294);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const q_r31 = \u0275\u0275nextContext(3).$implicit;
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", opt_r34.reponse_text);
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(4, _c1));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", q_r31.type !== "true_false");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", q_r31.type !== "true_false");
  }
}
function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r38 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 299);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_button_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r38);
      const q_r31 = \u0275\u0275nextContext(3).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r2.addQuizOption(q_r31));
    });
    \u0275\u0275element(1, "i", 244);
    \u0275\u0275text(2, " R\xE9ponse ");
    \u0275\u0275elementEnd();
...
function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "label", 18);
    \u0275\u0275text(2, "R\xE9ponses");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_div_3_Template, 4, 5, "div", 289)(4, InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_button_4_Template, 3, 0, "button", 290);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const q_r31 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", q_r31.reponses);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", q_r31.type !== "true_false");
  }
}
function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r32 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 284)(1, "div", 158)(2, "label", 18);
    \u0275\u0275text(3, "Question");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "input", 285);
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r32);
      const q_r31 = \u0275\u0275nextContext().$implicit;
      \u0275\u0275twoWayBindingSet(q_r31.question_text, $event) || (q_r31.question_text = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 286)(6, "div", 40)(7, "label", 18);
    \u0275\u0275text(8, "Points");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "input", 270);
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_Template_input_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r32);
      const q_r31 = \u0275\u0275nextContext().$implicit;
      \u0275\u0275twoWayBindingSet(q_r31.points, $event) || (q_r31.points = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_Template_input_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r32);
      const q_r31 = \u0275\u0275nextContext().$implicit;
      \u0275\u0275twoWayBindingSet(q_r31.explication, $event) || (q_r31.explication = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(14, InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_div_14_Template, 5, 2, "div", 288);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const q_r31 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", q_r31.question_text);
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(7, _c1));
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", q_r31.points);
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(8, _c1));
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", q_r31.explication);
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(9, _c1));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", q_r31.type !== "text");
  }
}
function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r30 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 278)(1, "div", 279);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_Template_div_click_1_listener() {
      const q_r31 = \u0275\u0275restoreView(_r30).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r2.toggleQuizQuestion(q_r31.id));
    });
    \u0275\u0275elementStart(2, "span", 280);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 81)(5, "span", 281);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 282);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_Template_button_click_7_listener($event) {
      const q_r31 = \u0275\u0275restoreView(_r30).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(5);
      $event.stopPropagation();
      return \u0275\u0275resetView(ctx_r2.removeQuizQuestion(q_r31));
    });
    \u0275\u0275element(8, "i", 237);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(9, InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_div_9_Template, 15, 10, "div", 283);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const q_r31 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(5);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(q_r31.question_text || "(sans titre)");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.getTypeLabel(q_r31.type));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r2.expandedQuestion === q_r31.id);
  }
}
function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r29 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 264)(1, "div", 265)(2, "div", 266)(3, "label", 91);
    \u0275\u0275text(4, "Titre du quiz");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "input", 267);
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 220)(7, "label", 91);
    \u0275\u0275text(8, "Dur\xE9e (min)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "input", 268);
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_Template_input_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 40)(11, "label", 91);
    \u0275\u0275text(12, "Score minimum (%)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "input", 269);
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_Template_input_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 40)(15, "label", 91);
    \u0275\u0275text(16, "Tentatives max");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "input", 270);
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_Template_input_ngModelChange_17_listener($event) {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(18, InstructorCourseAddComponent_div_3_div_71_div_7_div_5_div_18_Template, 10, 3, "div", 271);
    \u0275\u0275elementStart(19, "div", 272)(20, "button", 273);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_Template_button_click_20_listener() {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "button", 273);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "button", 273);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_Template_button_click_26_listener() {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275text(28, " Vrai / Faux");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "button", 273);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_71_div_7_div_5_Template_button_click_29_listener() {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(4);
...
function InstructorCourseAddComponent_div_3_div_71_div_7_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 300)(1, "span");
    \u0275\u0275text(2, "S\xE9lectionnez une section quiz \xE0 gauche pour l'\xE9diter.");
    \u0275\u0275elementEnd()();
  }
}
function InstructorCourseAddComponent_div_3_div_71_div_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 257)(1, "div", 258)(2, "p", 259);
    \u0275\u0275text(3, "Sections quiz");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, InstructorCourseAddComponent_div_3_div_71_div_7_div_4_Template, 7, 4, "div", 260);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, InstructorCourseAddComponent_div_3_div_71_div_7_div_5_Template, 32, 13, "div", 261)(6, InstructorCourseAddComponent_div_3_div_71_div_7_ng_template_6_Template, 3, 0, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const noQuizSelected_r39 = \u0275\u0275reference(7);
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngForOf", ctx_r2.getQuizSections());
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.activeLocalQuiz)("ngIfElse", noQuizSelected_r39);
  }
}
function InstructorCourseAddComponent_div_3_div_71_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, InstructorCourseAddComponent_div_3_div_71_div_6_Template, 6, 0, "div", 254)(7, InstructorCourseAddComponent_div_3_div_71_div_7_Template, 8, 3, "div", 255);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function InstructorCourseAddComponent_div_3_div_72_span_55_Template(rf, ctx) {
  if (rf & 1) {
    const _r41 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 331);
    \u0275\u0275text(1);
    \u0275\u0275elementStart(2, "button", 130);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_72_span_55_Template_button_click_2_listener() {
      const i_r42 = \u0275\u0275restoreView(_r41).index;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.removeCompetence(i_r42));
    });
    \u0275\u0275text(3, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const comp_r43 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", comp_r43, " ");
  }
}
function InstructorCourseAddComponent_div_3_div_72_span_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 131);
...
function InstructorCourseAddComponent_div_3_div_72_span_66_Template(rf, ctx) {
  if (rf & 1) {
    const _r44 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 332);
    \u0275\u0275text(1);
    \u0275\u0275elementStart(2, "button", 130);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_72_span_66_Template_button_click_2_listener() {
      const i_r45 = \u0275\u0275restoreView(_r44).index;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.removeOutil(i_r45));
    });
    \u0275\u0275text(3, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const outil_r46 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", outil_r46, " ");
  }
}
function InstructorCourseAddComponent_div_3_div_72_span_67_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 131);
...
function InstructorCourseAddComponent_div_3_div_72_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "form", 90)(7, "div", 28)(8, "div", 301)(9, "h5", 302);
    \u0275\u0275element(10, "i", 303);
    \u0275\u0275text(11, "D\xE9tails de la formation");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 94)(13, "label", 91);
    \u0275\u0275text(14, "Difficult\xE9");
    \u0275\u0275elementStart(15, "span", 19);
    \u0275\u0275text(16, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "select", 304)(18, "option", 305);
    \u0275\u0275text(19, "Facile");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "option", 306);
    \u0275\u0275text(21, "Moyen");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "option", 307);
    \u0275\u0275text(23, "Difficile");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 94)(29, "label", 91);
    \u0275\u0275text(30, "Prix (\u20AC)");
    \u0275\u0275elementStart(31, "span", 19);
    \u0275\u0275text(32, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(33, "input", 308);
    \u0275\u0275elementStart(34, "small", 143);
    \u0275\u0275text(35, "0 pour une formation gratuite");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "div", 93);
    \u0275\u0275text(37, "Le prix est requis (0 minimum)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "div", 94)(39, "label", 91);
    \u0275\u0275text(40, "Dur\xE9e totale (heures)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(41, "input", 309);
    \u0275\u0275elementStart(42, "small", 143);
    \u0275\u0275text(43, "Estimation du temps total n\xE9cessaire");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "div", 93);
    \u0275\u0275text(45, "La dur\xE9e doit \xEAtre d'au moins 1 heure");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 310)(47, "h5", 302);
    \u0275\u0275element(48, "i", 311);
    \u0275\u0275text(49, "Contenu et comp\xE9tences");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(50, "div", 30)(51, "label", 18);
    \u0275\u0275element(52, "i", 312);
    \u0275\u0275text(53, " Comp\xE9tences acquises ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "div", 115);
    \u0275\u0275template(55, InstructorCourseAddComponent_div_3_div_72_span_55_Template, 4, 1, "span", 313)(56, InstructorCourseAddComponent_div_3_div_72_span_56_Template, 2, 0, "span", 117);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "div", 118)(58, "input", 314);
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_72_Template_input_ngModelChange_58_listener($event) {
      \u0275\u0275restoreView(_r40);
      const ctx_r2 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r2.newCompetence, $event) || (ctx_r2.newCompetence = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("keyup.enter", function InstructorCourseAddComponent_div_3_div_72_Template_input_keyup_enter_58_listener() {
      \u0275\u0275restoreView(_r40);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.addCompetence());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "button", 120);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_72_Template_button_click_59_listener() {
      \u0275\u0275restoreView(_r40);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.addCompetence());
    });
    \u0275\u0275text(60, "+ Ajouter");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(61, "div", 30)(62, "label", 18);
    \u0275\u0275element(63, "i", 315);
    \u0275\u0275text(64, " Outils requis ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "div", 115);
    \u0275\u0275template(66, InstructorCourseAddComponent_div_3_div_72_span_66_Template, 4, 1, "span", 316)(67, InstructorCourseAddComponent_div_3_div_72_span_67_Template, 2, 0, "span", 117);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "div", 118)(69, "input", 317);
    \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_div_3_div_72_Template_input_ngModelChange_69_listener($event) {
      \u0275\u0275restoreView(_r40);
      const ctx_r2 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r2.newOutil, $event) || (ctx_r2.newOutil = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("keyup.enter", function InstructorCourseAddComponent_div_3_div_72_Template_input_keyup_enter_69_listener() {
      \u0275\u0275restoreView(_r40);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.addOutil());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "button", 120);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_div_72_Template_button_click_70_listener() {
      \u0275\u0275restoreView(_r40);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.addOutil());
    });
    \u0275\u0275text(71, "+ Ajouter");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(72, "div", 310)(73, "h5", 302);
    \u0275\u0275element(74, "i", 318);
    \u0275\u0275text(75, "Public cible et marketing");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(76, "div", 29)(77, "label", 91);
    \u0275\u0275text(78, "Public cible");
    \u0275\u0275elementEnd();
    \u0275\u0275element(79, "textarea", 319);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "div", 29)(81, "label", 91);
    \u0275\u0275text(82, "Tags");
    \u0275\u0275elementEnd();
    \u0275\u0275element(83, "input", 320);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(84, "div", 310)(85, "h5", 302);
    \u0275\u0275element(86, "i", 207);
    \u0275\u0275text(87, "Param\xE8tres avanc\xE9s");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(88, "div", 30)(89, "label", 91);
    \u0275\u0275text(90, "Date de d\xE9but");
    \u0275\u0275elementEnd();
    \u0275\u0275element(91, "input", 321);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(92, "div", 30)(93, "label", 91);
    \u0275\u0275text(94, "Date de fin");
    \u0275\u0275elementEnd();
    \u0275\u0275element(95, "input", 322);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(96, "div", 94)(97, "div", 41);
    \u0275\u0275element(98, "input", 323);
    \u0275\u0275elementStart(99, "label", 324);
    \u0275\u0275element(100, "i", 325);
    \u0275\u0275text(101, "Inscriptions ouvertes");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(102, "div", 94)(103, "div", 41);
    \u0275\u0275element(104, "input", 326);
    \u0275\u0275elementStart(105, "label", 327);
    \u0275\u0275element(106, "i", 328);
    \u0275\u0275text(107, "Formation publi\xE9e");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(108, "div", 94)(109, "div", 41);
    \u0275\u0275element(110, "input", 329);
    \u0275\u0275elementStart(111, "label", 330);
    \u0275\u0275element(112, "i", 127);
    \u0275\u0275text(113, "Formation certifiante");
    \u0275\u0275elementEnd()()()()()()()();
  }
  if (rf & 2) {
    let tmp_5_0;
...
function InstructorCourseAddComponent_div_3_div_73_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "form", 90)(12, "div", 28)(13, "div", 136)(14, "h5", 334);
    \u0275\u0275element(15, "i", 335);
    \u0275\u0275text(16, " Co\xFBts de d\xE9veloppement ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 30)(18, "label", 91);
    \u0275\u0275text(19, "Co\xFBt de conception (\u20AC)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(20, "input", 336);
    \u0275\u0275elementStart(21, "small", 143);
    \u0275\u0275text(22, "Analyse des besoins, conception p\xE9dagogique");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 30)(24, "label", 91);
    \u0275\u0275text(25, "Co\xFBt de production (\u20AC)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(26, "input", 337);
    \u0275\u0275elementStart(27, "small", 143);
    \u0275\u0275text(28, "Cr\xE9ation du contenu, vid\xE9os, exercices");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div", 338)(30, "h5", 334);
    \u0275\u0275element(31, "i", 339);
    \u0275\u0275text(32, " Co\xFBts de livraison ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div", 30)(34, "label", 91);
    \u0275\u0275text(35, "Co\xFBt formateur par jour (\u20AC)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(36, "input", 340);
    \u0275\u0275elementStart(37, "small", 143);
    \u0275\u0275text(38, "Tarif journalier du formateur");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "div", 30)(40, "label", 91);
    \u0275\u0275text(41, "Frais logistiques par participant (\u20AC)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(42, "input", 341);
    \u0275\u0275elementStart(43, "small", 143);
    \u0275\u0275text(44, "Mat\xE9riel, documentation, pauses");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "div", 342)(46, "div", 204)(47, "div", 205)(48, "h5", 206);
    \u0275\u0275element(49, "i", 343);
    \u0275\u0275text(50, " Estimation totale ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "div", 28)(52, "div", 40)(53, "div", 344)(54, "span");
    \u0275\u0275text(55, "Co\xFBts de d\xE9veloppement :");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "strong");
    \u0275\u0275text(57);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(58, "div", 344)(59, "span");
    \u0275\u0275text(60);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "strong");
    \u0275\u0275text(62);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(63, "div", 344)(64, "span");
    \u0275\u0275text(65);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275element(68, "hr");
    \u0275\u0275elementStart(69, "div", 344)(70, "span")(71, "strong");
    \u0275\u0275text(72, "Co\xFBt total estim\xE9 :");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(73, "strong", 345);
    \u0275\u0275text(74);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(75, "div", 40)(76, "div", 344)(77, "span");
    \u0275\u0275text(78, "Co\xFBt par participant :");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(79, "strong", 346);
    \u0275\u0275text(80);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(81, "div", 344)(82, "span");
    \u0275\u0275text(83, "Co\xFBt par heure :");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(84, "strong", 347);
    \u0275\u0275text(85);
    \u0275\u0275elementEnd()()()()()()();
    \u0275\u0275elementStart(86, "div", 348)(87, "label", 91);
    \u0275\u0275text(88, "Notes sur l'estimation");
    \u0275\u0275elementEnd();
    \u0275\u0275element(89, "textarea", 349);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function InstructorCourseAddComponent_div_3_button_78_Template(rf, ctx) {
  if (rf & 1) {
    const _r47 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 53);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_button_78_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r47);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function InstructorCourseAddComponent_div_3_button_79_Template(rf, ctx) {
  if (rf & 1) {
    const _r48 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 52);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_button_79_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r48);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function InstructorCourseAddComponent_div_3_button_80_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 355);
  }
}
function InstructorCourseAddComponent_div_3_button_80_i_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 356);
  }
}
function InstructorCourseAddComponent_div_3_button_80_Template(rf, ctx) {
  if (rf & 1) {
    const _r49 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 352);
    \u0275\u0275listener("click", function InstructorCourseAddComponent_div_3_button_80_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r49);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.submitCourse());
    });
    \u0275\u0275template(1, InstructorCourseAddComponent_div_3_button_80_span_1_Template, 1, 0, "span", 353)(2, InstructorCourseAddComponent_div_3_button_80_i_2_Template, 1, 0, "i", 354);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function InstructorCourseAddComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 64)(1, "div", 65)(2, "div", 28)(3, "div", 66)(4, "div", 67)(5, "div", 68)(6, "ul", 69)(7, "li", 70)(8, "div", 71)(9, "span", 72)(10, "span", 73);
    \u0275\u0275text(11, "01");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "span", 74);
    \u0275\u0275element(13, "i", 75);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 76)(15, "p");
    \u0275\u0275text(16, "Informations de base");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(17, "li", 70)(18, "div", 71)(19, "span", 72)(20, "span", 73);
    \u0275\u0275text(21, "02");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "span", 74);
    \u0275\u0275element(23, "i", 75);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "div", 76)(25, "p");
    \u0275\u0275text(26, "M\xE9dia");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(27, "li", 70)(28, "div", 71)(29, "span", 72)(30, "span", 73);
    \u0275\u0275text(31, "03");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "span", 74);
    \u0275\u0275element(33, "i", 75);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(34, "div", 76)(35, "p");
    \u0275\u0275text(36, "Modules & Sections");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(37, "li", 70)(38, "div", 71)(39, "span", 72)(40, "span", 73);
    \u0275\u0275text(41, "04");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "span", 74);
    \u0275\u0275element(43, "i", 75);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(44, "div", 76)(45, "p");
    \u0275\u0275text(46, "Quiz");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(47, "li", 70)(48, "div", 71)(49, "span", 72)(50, "span", 73);
    \u0275\u0275text(51, "05");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "span", 74);
    \u0275\u0275element(53, "i", 75);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(54, "div", 76)(55, "p");
    \u0275\u0275text(56, "Informations");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(57, "li", 70)(58, "div", 71)(59, "span", 72)(60, "span", 73);
    \u0275\u0275text(61, "06");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "span", 74);
    \u0275\u0275element(63, "i", 75);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(64, "div", 76)(65, "p");
    \u0275\u0275text(66, "Co\xFBt estimatif");
    \u0275\u0275elementEnd()()()()()();
    \u0275\u0275elementStart(67, "div", 77);
    \u0275\u0275template(68, InstructorCourseAddComponent_div_3_div_68_Template, 113, 20, "div", 78)(69, InstructorCourseAddComponent_div_3_div_69_Template, 62, 20, "div", 78)(70, InstructorCourseAddComponent_div_3_div_70_Template, 13, 3, "div", 78)(71, InstructorCourseAddComponent_div_3_div_71_Template, 8, 2, "div", 78)(72, InstructorCourseAddComponent_div_3_div_72_Template, 114, 17, "div", 78)(73, InstructorCourseAddComponent_div_3_div_73_Template, 90, 11, "div", 78);
    \u0275\u0275elementStart(74, "div", 79)(75, "span", 80);
    \u0275\u0275text(76);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "div", 81);
    \u0275\u0275template(78, InstructorCourseAddComponent_div_3_button_78_Template, 3, 0, "button", 82)(79, InstructorCourseAddComponent_div_3_button_79_Template, 3, 0, "button", 83)(80, InstructorCourseAddComponent_div_3_button_80_Template, 4, 4, "button", 84);
    \u0275\u0275elementEnd()()()()()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var InstructorCourseAddComponent = class _InstructorCourseAddComponent {
  ...
  constructor(fb, formationService, categorieService, router, sanitizer, authService, quizService, questionService) {
    this.fb = fb;
...
`;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InstructorCourseAddComponent, selectors: [["app-instructor-course-add"]], decls: 110, vars: 20, consts: [["moduleForm", "ngForm"], ["sectionForm", "ngForm"], ["imageInput", ""], ["noImageTemplate", ""], ["noQuizSelected", ""], ["class", "d-flex justify-content-center align-items-center py-5", 4, "ngIf"], ["class", "alert alert-danger alert-dismissible fade show mx-3", "role", "alert", 4, "ngIf"], ["class", "alert alert-success alert-dismissible fade show mx-3", "role", "alert", 4, "ngIf"], ["class", "content", 4, "ngIf"], ["id", "moduleModal", "tabindex", "-1", 1, "modal", "fade"], [1, "modal-dialog", "modal-dialog-centered"], [1, "modal-content"], [1, "modal-header"], [1, "modal-title"], ["type", "button", "data-bs-dismiss", "modal", 1, "btn-close"], [3, "ngSubmit"], [1, "modal-body"], [1, "mb-3"], [1, "form-label"], [1, "text-danger"], ["type", "text", "name", "titre", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], ["name", "description", "rows", "3", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "number", "name", "duree", "min", "0", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "modal-footer"], ["type", "button", "data-bs-dismiss", "modal", 1, "btn", "btn-secondary"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["id", "sectionModal", "tabindex", "-1", 1, "modal", "fade"], [1, "modal-dialog", "modal-dialog-centered", "modal-lg"], [1, "row"], [1, "col-md-12", "mb-3"], [1, "col-md-6", "mb-3"], ["name", "type", "required", "", 1, "form-select", 3, "ngModelChange", "ngModel"], ["value", "video"], ["value", "text"], ["value", "pdf"], ["value", "exercice"], ["value", "ressource"], ["value", "quiz"], ["name", "contenu", "rows", "3", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "url", "name", "ressources", "placeholder", "https://...", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "col-md-6"], [1, "form-check", "form-switch"], ["type", "checkbox", "name", "obligatoire", "id", "obligatoire", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "obligatoire", 1, "form-check-label"], ["type", "checkbox", "name", "visible", "id", "visible", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "visible", 1, "form-check-label"], ["id", "successModal", "tabindex", "-1", "data-bs-backdrop", "static", 1, "modal", "fade"], [1, "modal-body", "text-center", "p-5"], [1, "text-success", "mb-4"], [1, "fas", "fa-check-circle", "fa-5x"], [1, "text-muted", "mb-4"], [1, "d-flex", "gap-2", "justify-content-center"], [1, "btn", "btn-primary", 3, "click"], [1, "btn", "btn-outline-secondary", 3, "click"], [1, "d-flex", "justify-content-center", "align-items-center", "py-5"], [1, "text-center"], ["role", "status", 1, "spinner-border", "text-primary", 2, "width", "3rem", "height", "3rem"], [1, "visually-hidden"], [1, "mt-3", "text-muted"], ["role", "alert", 1, "alert", "alert-danger", "alert-dismissible", "fade", "show", "mx-3"], [1, "fas", "fa-exclamation-triangle", "me-2"], ["type", "button", "aria-label", "Close", 1, "btn-close", 3, "click"], ["role", "alert", 1, "alert", "alert-success", "alert-dismissible", "fade", "show", "mx-3"], [1, "fas", "fa-check-circle", "me-2"], [1, "content"], [1, "container"], [1, "col-lg-10", "mx-auto"], [1, "add-course-item"], [1, "wizard", "mb-4"], ["id", "progressbar2", 1, "form-wizard-steps"], [3, "ngClass"], [1, "profile-step"], [1, "dot-active", "mb-2"], [1, "number"], [1, "tickmark"], [1, "fa-solid", "fa-check"], [1, "step-section"], [1, "form-container"], ["class", "form-step", 4, "ngIf"], [1, "d-flex", "justify-content-between", "align-items-center", "pf-nav-footer"], [1, "pf-step-lbl"], [1, "d-flex", "gap-2", "align-items-center"], ["class", "btn btn-outline-secondary", 3, "click", 4, "ngIf"], ["class", "btn btn-primary", 3, "click", 4, "ngIf"], ["class", "btn btn-success", 3, "disabled", "click", 4, "ngIf"], [1, "form-step"], [1, "card", "border-0", "shadow-sm"], [1, "card-body", "p-4"], [1, "card-title", "mb-4"], [1, "fas", "fa-info-circle", "text-primary", "me-2"], [3, "formGroup"], [1, "form-label", "fw-semibold"], ["type", "text", "formControlName", "titre", "placeholder", "Ex: D\xE9veloppement Web avec Angular", 1, "form-control"], [1, "invalid-feedback"], [1, "col-md-4", "mb-3"], ["formControlName", "categorie_formation_id", 1, "form-select"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "niveau", 1, "form-select"], ["value", "debutant"], ["value", "intermediaire"], ["value", "avance"], ["value", "expert"], ["formControlName", "langue", 1, "form-select"], ["value", "fr"], ["value", "en"], ["value", "es"], ["formControlName", "type", 1, "form-select"], ["value", "en_ligne"], ["value", "presentiel"], ["value", "hybride"], ["type", "number", "formControlName", "nb_max_participants", "placeholder", "25", "min", "1", 1, "form-control"], ["type", "text", "formControlName", "short_description", "placeholder", "R\xE9sum\xE9 en une phrase", 1, "form-control"], ["formControlName", "description", "rows", "5", "placeholder", "Description d\xE9taill\xE9e de la formation...", 1, "form-control"], [1, "fas", "fa-bullseye", "me-1", 2, "color", "#C4900A"], [1, "pf-tags-wrap"], ["class", "pf-tag", 4, "ngFor", "ngForOf"], ["class", "pf-empty-tags", 4, "ngIf"], [1, "pf-tag-input"], ["type", "text", "placeholder", "Ajouter un objectif\u2026", 3, "ngModelChange", "keyup.enter", "ngModel", "ngModelOptions"], ["type", "button", 3, "click"], [1, "fas", "fa-list-check", "me-1", 2, "color", "#1565C0"], ["class", "pf-tag pf-tag-blue", 4, "ngFor", "ngForOf"], ["type", "text", "placeholder", "Ajouter un pr\xE9requis\u2026", 3, "ngModelChange", "keyup.enter", "ngModel", "ngModelOptions"], [1, "col-md-12"], ["type", "checkbox", "formControlName", "est_certifiante", "id", "certifiante", 1, "form-check-input"], ["for", "certifiante", 1, "form-check-label"], [1, "fas", "fa-certificate", "text-warning", "me-2"], [3, "value"], [1, "pf-tag"], ["type", "button", 1, "pf-tag-del", 3, "click"], [1, "pf-empty-tags"], [1, "pf-tag", "pf-tag-blue"], [1, "fas", "fa-photo-video", "text-primary", "me-2"], [1, "alert", "alert-info", "mb-4"], [1, "fas", "fa-info-circle", "me-2"], [1, "col-md-12", "mb-4"], [1, "fas", "fa-image", "me-2"], [1, "upload-area", "border-2", "border-dashed", "rounded-3", "p-4", "text-center", "position-relative", 3, "dragover", "dragleave", "drop"], ["type", "file", "accept", "image/*", "id", "imageUpload", 1, "d-none", 3, "change"], ["class", "position-relative", 4, "ngIf", "ngIfElse"], ["class", "alert alert-danger mt-2 mb-0 py-2", 4, "ngIf"], [1, "fas", "fa-play-circle", "me-2"], [1, "text-muted"], [1, "input-group"], [1, "input-group-text"], [1, "fab", "fa-youtube", "text-danger"], ["type", "url", "formControlName", "media_url", "placeholder", "https://www.youtube.com/watch?v=... ou https://youtu.be/...", 1, "form-control", 3, "blur", "input"], ["type", "button", "class", "btn btn-outline-secondary", "title", "Effacer l'URL", 3, "click", 4, "ngIf"], [1, "mt-2"], [1, "text-muted", "d-block"], [1, "fas", "fa-lightbulb", "me-1"], ["class", "text-danger mt-1", 4, "ngIf"], ["class", "text-success mt-1", 4, "ngIf"], ["class", "video-preview", 4, "ngIf"], ["class", "video-placeholder", 4, "ngIf"], ["class", "col-md-12", 4, "ngIf"], [1, "mt-4", "p-3", "bg-light", "rounded"], [1, "mb-2"], [1, "fas", "fa-clipboard-check", "me-2"], [1, "mb-1"], [1, "fas", "fa-image", "me-2", "text-primary"], [1, "fw-semibold"], [1, "fas", "fa-play-circle", "me-2", "text-primary"], [1, "position-relative"], ["alt", "Aper\xE7u de l'image", 1, "img-fluid", "rounded", "shadow-sm", 2, "max-height", "300px", "max-width", "100%", 3, "src"], [1, "position-absolute", "top-0", "end-0", "m-2"], ["type", "button", "title", "Supprimer l'image", 1, "btn", "btn-sm", "btn-danger", "rounded-circle", 3, "click"], [1, "fas", "fa-times"], [1, "mt-3"], ["type", "button", 1, "btn", "btn-outline-primary", "btn-sm", 3, "click"], [1, "fas", "fa-sync-alt", "me-2"], [1, "upload-placeholder", 2, "cursor", "pointer", 3, "click"], [1, "upload-icon", "mb-3"], [1, "fas", "fa-cloud-upload-alt", "fa-3x", "text-primary"], [1, "text-muted", "mb-3"], ["type", "button", 1, "btn", "btn-primary", 3, "click"], [1, "fas", "fa-folder-open", "me-2"], [1, "fas", "fa-info-circle", "me-1"], [1, "alert", "alert-danger", "mt-2", "mb-0", "py-2"], ["type", "button", "title", "Effacer l'URL", 1, "btn", "btn-outline-secondary", 3, "click"], [1, "text-danger", "mt-1"], [1, "fas", "fa-exclamation-circle", "me-1"], [1, "text-success", "mt-1"], [1, "fas", "fa-check-circle", "me-1"], [1, "video-preview"], [1, "card"], [1, "card-header", "d-flex", "justify-content-between", "align-items-center"], [1, "mb-0"], [1, "fas", "fa-eye", "me-2"], [1, "badge", "bg-success"], [1, "card-body", "p-0"], ["class", "ratio ratio-16x9", 4, "ngIf"], ["class", "p-3", 4, "ngIf"], [1, "ratio", "ratio-16x9"], ["title", "Aper\xE7u YouTube", "frameborder", "0", "allow", "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", "allowfullscreen", "", "loading", "lazy", 3, "src"], ["title", "Aper\xE7u Vimeo", "frameborder", "0", "allow", "autoplay; fullscreen; picture-in-picture", "allowfullscreen", "", "loading", "lazy", 3, "src"], [1, "p-3"], ["controls", "", "preload", "metadata", 1, "w-100", "rounded", 2, "max-height", "400px", 3, "src"], [1, "video-placeholder"], [1, "card", "border-dashed"], [1, "card-body", "text-center", "py-4"], [1, "fas", "fa-video", "fa-3x", "text-muted", "mb-3"], [1, "text-muted", "small", "mb-0"], [1, "card", "bg-light"], [1, "card-body"], [1, "card-title"], [1, "fas", "fa-cog", "me-2"], ["type", "checkbox", "formControlName", "video_autoplay", "id", "videoAutoplay", 1, "form-check-input"], ["for", "videoAutoplay", 1, "form-check-label"], ["type", "checkbox", "formControlName", "video_show_controls", "id", "videoControls", 1, "form-check-input"], ["for", "videoControls", 1, "form-check-label"], [1, "d-flex", "justify-content-between", "align-items-center", "mb-4"], [1, "card-title", "mb-0"], [1, "fas", "fa-book", "text-primary", "me-2"], [1, "fas", "fa-plus", "me-2"], ["class", "row mb-4", 4, "ngIf"], ["class", "accordion", "id", "modulesAccordion", 4, "ngIf"], ["class", "text-center py-5", 4, "ngIf"], [1, "row", "mb-4"], [1, "col-md-4"], [1, "card", "bg-primary", "text-white"], [1, "card-body", "text-center"], [1, "card", "bg-success", "text-white"], [1, "card", "bg-info", "text-white"], ["id", "modulesAccordion", 1, "accordion"], ["class", "accordion-item mb-3 border rounded", 4, "ngFor", "ngForOf"], [1, "accordion-item", "mb-3", "border", "rounded"], [1, "accordion-header"], ["type", "button", 1, "accordion-button"], [1, "d-flex", "align-items-center", "w-100"], [1, "fas", "fa-grip-vertical", "me-3", "text-muted"], [1, "flex-grow-1"], [1, "btn-group", "me-2", 3, "click"], [1, "btn", "btn-sm", "btn-outline-primary", 3, "click"], [1, "fas", "fa-edit"], [1, "btn", "btn-sm", "btn-outline-danger", 3, "click"], [1, "fas", "fa-trash"], [1, "accordion-collapse", "collapse", 3, "id"], [1, "accordion-body"], ["class", "text-muted mb-3", 4, "ngIf"], [1, "sections-list", "mb-3"], ["class", "d-flex align-items-center justify-content-between p-3 mb-2 border rounded bg-light", 4, "ngFor", "ngForOf"], [1, "btn", "btn-sm", "btn-outline-success", 3, "click"], [1, "fas", "fa-plus", "me-1"], [1, "d-flex", "align-items-center", "justify-content-between", "p-3", "mb-2", "border", "rounded", "bg-light"], [1, "d-flex", "align-items-center"], [1, "fas", "fa-play-circle", "text-success", "me-3"], ["class", "badge bg-success ms-2", 4, "ngIf"], [1, "btn-group"], [1, "badge", "bg-success", "ms-2"], [1, "text-center", "py-5"], [1, "fas", "fa-folder-open", "fa-4x", "text-muted", "mb-3"], [1, "fas", "fa-question-circle", "text-primary", "me-2"], ["class", "alert alert-info", 4, "ngIf"], ["style", "display:flex;gap:1rem;min-height:400px", 4, "ngIf"], [1, "alert", "alert-info"], [2, "display", "flex", "gap", "1rem", "min-height", "400px"], [2, "width", "220px", "flex-shrink", "0", "border-right", "1px solid #e5e7eb", "padding-right", "1rem"], [1, "fw-semibold", "text-muted", "mb-2", 2, "font-size", "0.8rem", "text-transform", "uppercase", "letter-spacing", ".05em"], ["style", "cursor:pointer;padding:.4rem .6rem;border-radius:.375rem;margin-bottom:.25rem;font-size:.85rem", 3, "background", "click", 4, "ngFor", "ngForOf"], ["style", "flex:1", 4, "ngIf", "ngIfElse"], [2, "cursor", "pointer", "padding", ".4rem .6rem", "border-radius", ".375rem", "margin-bottom", ".25rem", "font-size", ".85rem", 3, "click"], [1, "fas", "fa-question-circle", "me-1", 2, "color", "#7c3aed"], [2, "flex", "1"], [1, "row", "g-2", "mb-3"], [1, "col-md-8"], ["type", "text", 1, "form-control", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["type", "number", "min", "0", 1, "form-control", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["type", "number", "min", "0", "max", "100", 1, "form-control", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["type", "number", "min", "1", 1, "form-control", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["class", "card mb-2 border", 4, "ngFor", "ngForOf"], [1, "d-flex", "gap-2", "mt-3", "flex-wrap"], ["type", "button", 1, "btn", "btn-sm", "btn-outline-primary", 3, "click"], [1, "fas", "fa-dot-circle", "me-1"], [1, "fas", "fa-check-square", "me-1"], [1, "fas", "fa-toggle-on", "me-1"], [1, "fas", "fa-font", "me-1"], [1, "card", "mb-2", "border"], [1, "card-header", "d-flex", "align-items-center", "justify-content-between", "py-2", "px-3", 2, "cursor", "pointer", "background", "#f8f9fa", 3, "click"], [1, "fw-semibold", 2, "font-size", ".875rem"], [1, "badge", "bg-secondary", 2, "font-size", ".7rem"], ["type", "button", 1, "btn", "btn-sm", "btn-outline-danger", 3, "click"], ["class", "card-body p-3", 4, "ngIf"], [1, "card-body", "p-3"], ["type", "text", "placeholder", "Texte de la question", 1, "form-control", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "row", "g-2", "mb-2"], ["type", "text", "placeholder", "Optionnel", 1, "form-control", 3, "ngModelChange", "ngModel", "ngModelOptions"], [4, "ngIf"], ["class", "d-flex align-items-center gap-2 mb-1", 4, "ngFor", "ngForOf"], ["type", "button", "class", "btn btn-sm btn-outline-primary mt-1", 3, "click", 4, "ngIf"], [1, "d-flex", "align-items-center", "gap-2", "mb-1"], ["type", "text", "placeholder", "R\xE9ponse", 1, "form-control", "form-control-sm", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["class", "form-check mb-0 ms-1", 4, "ngIf"], ["type", "button", "class", "btn btn-sm btn-outline-secondary", 3, "click", 4, "ngIf"], [1, "form-check", "mb-0", "ms-1"], ["type", "checkbox", 1, "form-check-input", 3, "change", "checked"], [1, "form-check-label", 2, "font-size", ".75rem"], ["type", "button", 1, "btn", "btn-sm", "btn-outline-secondary", 3, "click"], ["type", "button", 1, "btn", "btn-sm", "btn-outline-primary", "mt-1", 3, "click"], [1, "d-flex", "align-items-center", "justify-content-center", "text-muted", 2, "flex", "1"], [1, "col-12", "mb-4"], [1, "text-secondary", "border-bottom", "pb-2"], [1, "fas", "fa-cogs", "me-2"], ["formControlName", "difficulte", 1, "form-select"], ["value", "facile"], ["value", "moyen"], ["value", "difficile"], ["type", "number", "formControlName", "prix", "placeholder", "0", "min", "0", "step", "0.01", 1, "form-control"], ["type", "number", "formControlName", "duree_totale", "placeholder", "40", "min", "1", "step", "0.5", 1, "form-control"], [1, "col-12", "mb-4", "mt-4"], [1, "fas", "fa-graduation-cap", "me-2"], [1, "fas", "fa-graduation-cap", "me-1", 2, "color", "#3D7A5F"], ["class", "pf-tag pf-tag-green", 4, "ngFor", "ngForOf"], ["type", "text", "placeholder", "Ajouter une comp\xE9tence\u2026", 3, "ngModelChange", "keyup.enter", "ngModel", "ngModelOptions"], [1, "fas", "fa-tools", "me-1", 2, "color", "#6B3FA0"], ["class", "pf-tag pf-tag-purple", 4, "ngFor", "ngForOf"], ["type", "text", "placeholder", "Ajouter un outil\u2026", 3, "ngModelChange", "keyup.enter", "ngModel", "ngModelOptions"], [1, "fas", "fa-users", "me-2"], ["formControlName", "public_cible", "rows", "3", "placeholder", "\xC0 qui s'adresse cette formation ?", 1, "form-control"], ["type", "text", "formControlName", "tags", "placeholder", "javascript, angular, web (s\xE9par\xE9s par virgules)", 1, "form-control"], ["type", "date", "formControlName", "date_debut", 1, "form-control"], ["type", "date", "formControlName", "date_fin", 1, "form-control"], ["type", "checkbox", "formControlName", "inscription_ouverte", "id", "inscriptionOuverte2", 1, "form-check-input"], ["for", "inscriptionOuverte2", 1, "form-check-label"], [1, "fas", "fa-door-open", "text-success", "me-2"], ["type", "checkbox", "formControlName", "est_publie", "id", "estPublie2", 1, "form-check-input"], ["for", "estPublie2", 1, "form-check-label"], [1, "fas", "fa-eye", "text-info", "me-2"], ["type", "checkbox", "formControlName", "est_certifiante", "id", "estCertifiante2", 1, "form-check-input"], ["for", "estCertifiante2", 1, "form-check-label"], [1, "pf-tag", "pf-tag-green"], [1, "pf-tag", "pf-tag-purple"], [1, "fas", "fa-calculator", "text-primary", "me-2"], [1, "text-secondary"], [1, "fas", "fa-code", "me-2"], ["type", "number", "formControlName", "cout_conception", "placeholder", "2000", "step", "100", "min", "0", 1, "form-control"], ["type", "number", "formControlName", "cout_production", "placeholder", "5000", "step", "100", "min", "0", 1, "form-control"], [1, "col-md-12", "mb-4", "mt-4"], [1, "fas", "fa-chalkboard-teacher", "me-2"], ["type", "number", "formControlName", "cout_formateur_jour", "placeholder", "600", "step", "50", "min", "0", 1, "form-control"], ["type", "number", "formControlName", "frais_logistique", "placeholder", "50", "step", "10", "min", "0", 1, "form-control"], [1, "col-md-12", "mt-4"], [1, "fas", "fa-chart-line", "text-success", "me-2"], [1, "d-flex", "justify-content-between"], [1, "text-success"], [1, "text-primary"], [1, "text-info"], [1, "col-md-12", "mt-3"], ["formControlName", "notes_estimation", "rows", "3", "placeholder", "Pr\xE9cisions sur l'estimation, conditions particuli\xE8res, options suppl\xE9mentaires...", 1, "form-control"], [1, "fas", "fa-arrow-left", "me-2"], [1, "fas", "fa-arrow-right", "ms-2"], [1, "btn", "btn-success", 3, "click", "disabled"], ["class", "spinner-border spinner-border-sm me-2", 4, "ngIf"], ["class", "fas fa-check me-2", 4, "ngIf"], [1, "spinner-border", "spinner-border-sm", "me-2"], [1, "fas", "fa-check", "me-2"]], template: function InstructorCourseAddComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(59, "Texte / Lecture");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(60, "option", 34);
      \u0275\u0275text(61, "Document PDF");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(62, "option", 35);
      \u0275\u0275text(63, "Exercice pratique");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(64, "option", 36);
      \u0275\u0275text(65, "Ressource externe");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(66, "option", 37);
      \u0275\u0275text(67, "Quiz");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(68, "div", 30)(69, "label", 18);
      \u0275\u0275text(70, "Dur\xE9e (minutes)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(71, "input", 22);
      \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_Template_input_ngModelChange_71_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.currentSection.duree_estimee, $event) || (ctx.currentSection.duree_estimee = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(72, "div", 29)(73, "label", 18);
      \u0275\u0275text(74, "Description");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(75, "textarea", 38);
      \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_Template_textarea_ngModelChange_75_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.currentSection.contenu, $event) || (ctx.currentSection.contenu = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(76, "div", 29)(77, "label", 18);
      \u0275\u0275text(78, "URL de la ressource");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(79, "input", 39);
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(80, "div", 40)(81, "div", 41)(82, "input", 42);
      \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_Template_input_ngModelChange_82_listener($event) {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275text(84, "Section obligatoire");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(85, "div", 40)(86, "div", 41)(87, "input", 44);
      \u0275\u0275twoWayListener("ngModelChange", function InstructorCourseAddComponent_Template_input_ngModelChange_87_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.currentSection.visible, $event) || (ctx.currentSection.visible = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(88, "label", 45);
      \u0275\u0275text(89, "Section visible");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(90, "div", 23)(91, "button", 24);
      \u0275\u0275text(92, "Annuler");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(93, "button", 25);
      \u0275\u0275text(94);
      \u0275\u0275elementEnd()()()()()();
      \u0275\u0275elementStart(95, "div", 46)(96, "div", 10)(97, "div", 11)(98, "div", 47)(99, "div", 48);
      \u0275\u0275element(100, "i", 49);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(101, "h4", 17);
      \u0275\u0275text(102, "Formation enregistr\xE9e avec succ\xE8s !");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(103, "p", 50);
      \u0275\u0275text(104, "Votre formation a \xE9t\xE9 enregistr\xE9e et l'estimation des co\xFBts est disponible.");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(105, "div", 51)(106, "button", 52);
      ...
      \u0275\u0275text(107, " Voir mes formations ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(108, "button", 53);
      \u0275\u0275listener("click", function InstructorCourseAddComponent_Template_button_click_108_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.createNewCourse());
      });
      \u0275\u0275text(109, " Cr\xE9er une nouvelle formation ");
      \u0275\u0275elementEnd()()()()()();
    }
    if (rf & 2) {
      const moduleForm_r50 = \u0275\u0275reference(12);
      const sectionForm_r51 = \u0275\u0275reference(41);
      ...
      \u0275\u0275advance(4);
      \u0275\u0275property("disabled", !moduleForm_r50.valid);
      \u0275\u0275advance();
      ...
      \u0275\u0275advance(6);
      \u0275\u0275property("disabled", !sectionForm_r51.valid);
      \u0275\u0275advance();
                    ...
                    <div class="row">\r
                        ...
                        <div class="col-md-6 mb-3">\r
                            ...
                            <select class="form-select" [(ngModel)]="currentSection.type" name="type" required>\r
                                ...
                                <option value="pdf">Document PDF</option>\r
                                <option value="exercice">Exercice pratique</option>\r
                                <option value="ressource">Ressource externe</option>\r
...
`, styles: ['/* src/app/features/courses/instructor-course-add/instructor-course-add.component.scss */\n.content {\n  padding: 2rem 0;\n  background: #F8F5F0;\n  min-height: 100vh;\n}\n.add-course-item {\n  background: #FFFFFF;\n  border-radius: 16px;\n  box-shadow: 0 2px 24px rgba(44, 36, 22, 0.09);\n  overflow: hidden;\n  margin-bottom: 2rem;\n}\n.pf-header {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  padding: 1.4rem 2rem;\n  border-bottom: 1px solid #E4DDD3;\n}\n.pf-header .pf-header-icon {\n  width: 50px;\n  height: 50px;\n  background: #FDF3DC;\n  border-radius: 12px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 1.35rem;\n  color: #C4900A;\n  flex-shrink: 0;\n}\n.pf-header h3 {\n  font-size: 1.1rem;\n  font-weight: 700;\n  color: #2C2416;\n  margin: 0;\n}\n.pf-header p {\n  font-size: 0.8rem;\n  color: #7A6A55;\n  margin: 0;\n}\n.wizard {\n  padding: 1.25rem 2rem;\n  border-bottom: 1px solid #E4DDD3;\n}\n.wizard .form-wizard-steps {\n  display: flex;\n  list-style: none;\n  margin: 0;\n  padding: 0;\n  position: relative;\n}\n.wizard .form-wizard-steps::before {\n  content: "";\n  position: absolute;\n  top: 17px;\n  left: 30px;\n  right: 30px;\n  height: 1px;\n  background: #E4DDD3;\n  z-index: 0;\n}\n.wizard .form-wizard-steps li {\n  flex: 1;\n  text-align: center;\n  position: relative;\n  z-index: 1;\n}\n.wizard .profile-step {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 0.3rem;\n}\n.wizard .dot-active {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 34px;\n  height: 34px;\n  border-radius: 50%;\n  background: #E4DDD3;\n  color: #7A6A55;\n  font-weight: 700;\n  font-size: 0.78rem;\n  transition: all 0.2s;\n}\n.wizard .dot-active .tickmark {\n  display: none;\n}\n.wizard .dot-active .number {\n  display: block;\n}\n.wizard .step-section p {\n  font-size: 0.7rem;\n  color: #7A6A55;\n  margin: 0;\n  font-weight: 500;\n}\n.wizard li.progress-active .dot-active {\n  background: #C4900A;\n  color: #FFFFFF;\n  box-shadow: 0 0 0 4px rgba(196, 144, 10, 0.15);\n}\n.wizard li.progress-active .step-section p {\n  color: #C4900A;\n  font-weight: 700;\n}\n.wizard li.progress-activated .dot-active {\n  background: #5BA87A;\n  color: #FFFFFF;\n}\n.wizard li.progress-activated .dot-active .tickmark {\n  display: block;\n}\n.wizard li.progress-activated .dot-active .number {\n  display: none;\n}\n.wizard li.progress-activated .step-section p {\n  color: #5BA87A;\n}\n.form-container {\n  padding: 1.75rem 2rem;\n}\n.form-step {\n  min-height: 320px;\n}\n.text-secondary.border-bottom {\n  font-size: 0.72rem !important;\n  font-weight: 700 !important;\n  text-transform: uppercase;\n  letter-spacing: 0.07em;\n  color: #7A6A55 !important;\n  border-color: #E4DDD3 !important;\n}\n.form-label {\n  font-size: 0.78rem;\n  font-weight: 600;\n  color: #7A6A55;\n  text-transform: uppercase;\n  letter-spacing: 0.04em;\n  margin-bottom: 0.4rem;\n}\n.form-control,\n.form-select {\n  border-radius: 10px;\n  border: 1.5px solid #E4DDD3;\n  padding: 9px 13px;\n  font-size: 0.9rem;\n  color: #2C2416;\n  background: #FFFFFF;\n  transition: border-color 0.2s;\n}\n.form-control:focus,\n.form-select:focus {\n  border-color: #C4900A;\n  box-shadow: 0 0 0 3px rgba(196, 144, 10, 0.12);\n  background: #FFFFFF;\n}\n.form-control.is-invalid,\n.form-select.is-invalid {\n  border-color: #dc3545;\n}\ntextarea.form-control {\n  resize: vertical;\n}\n.pf-tags-wrap {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.45rem;\n  padding: 0.65rem 0.75rem;\n  background: #F8F5F0;\n  border-radius: 10px;\n  border: 1.5px solid #E4DDD3;\n  min-height: 48px;\n  align-items: flex-start;\n}\n.pf-tag {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.3rem;\n  padding: 0.28rem 0.6rem;\n  background: #FDF3DC;\n  color: rgb(157.1805825243, 115.4796116505, 8.0194174757);\n  border-radius: 20px;\n  font-size: 0.78rem;\n  font-weight: 500;\n  border: 1px solid rgba(196, 144, 10, 0.22);\n}\n.pf-tag .pf-tag-del {\n  background: none;\n  border: none;\n  padding: 0 0 0 2px;\n  line-height: 1;\n  cursor: pointer;\n  color: inherit;\n  opacity: 0.55;\n  font-size: 0.75rem;\n}\n.pf-tag .pf-tag-del:hover {\n  opacity: 1;\n}\n.pf-tag.pf-tag-blue {\n  background: #EBF4FD;\n  color: #1565C0;\n  border-color: rgba(21, 101, 192, 0.2);\n}\n.pf-tag.pf-tag-green {\n  background: #EAF5F0;\n  color: #3D7A5F;\n  border-color: rgba(61, 122, 95, 0.2);\n}\n.pf-tag.pf-tag-purple {\n  background: #F3EFF9;\n  color: #6B3FA0;\n  border-color: rgba(107, 63, 160, 0.2);\n}\n.pf-tag-input {\n  display: flex;\n  align-items: center;\n  gap: 0.45rem;\n  margin-top: 0.55rem;\n}\n.pf-tag-input input {\n  flex: 1;\n  border: 1.5px solid #E4DDD3;\n  border-radius: 8px;\n  padding: 0.38rem 0.75rem;\n  font-size: 0.85rem;\n  color: #2C2416;\n  outline: none;\n  background: #FFFFFF;\n}\n.pf-tag-input input:focus {\n  border-color: #C4900A;\n}\n.pf-tag-input input::placeholder {\n  color: rgb(172.4637681159, 156.9275362319, 136.5362318841);\n}\n.pf-tag-input button {\n  background: #C4900A;\n  color: #FFFFFF;\n  border: none;\n  border-radius: 8px;\n  padding: 0.38rem 0.75rem;\n  font-size: 0.8rem;\n  font-weight: 600;\n  cursor: pointer;\n  white-space: nowrap;\n}\n.pf-tag-input button:hover {\n  background: rgb(162.0330097087, 119.0446601942, 8.2669902913);\n}\n.pf-empty-tags {\n  font-size: 0.8rem;\n  color: rgb(161.9927536232, 144.4855072464, 121.5072463768);\n  font-style: italic;\n  padding: 0.2rem 0.3rem;\n}\n.module-item {\n  border: 1.5px solid #E4DDD3;\n  border-radius: 12px;\n  overflow: hidden;\n}\n.module-item .card-header {\n  background: #F8F5F0;\n  border-bottom: 1px solid #E4DDD3;\n  padding: 11px 15px;\n}\n.module-item .section-item {\n  border: 1px solid #E4DDD3;\n  border-radius: 8px;\n  transition: background 0.15s;\n}\n.module-item .section-item:hover {\n  background: #F8F5F0;\n}\n.upload-zone,\n.upload-area {\n  border: 2px dashed #E4DDD3;\n  border-radius: 12px;\n  padding: 2.5rem;\n  text-align: center;\n  transition: all 0.2s;\n  cursor: pointer;\n  background: #F8F5F0;\n}\n.upload-zone:hover,\n.upload-zone.drag-over,\n.upload-area:hover,\n.upload-area.drag-over {\n  border-color: #C4900A;\n  background: #FDF3DC;\n}\n.pf-nav-footer {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1.1rem 2rem;\n  border-top: 1px solid #E4DDD3;\n  background: #F8F5F0;\n  margin: 1.5rem -2rem -1.75rem;\n}\n.pf-nav-footer .pf-step-lbl {\n  font-size: 0.82rem;\n  color: #7A6A55;\n  font-weight: 500;\n}\n.btn {\n  border-radius: 10px;\n  padding: 9px 20px;\n  font-weight: 600;\n  font-size: 0.87rem;\n  transition: all 0.2s;\n}\n.btn.btn-primary {\n  background: #2C2416;\n  border-color: #2C2416;\n  color: #FFFFFF;\n}\n.btn.btn-primary:hover {\n  background: rgb(84.8, 69.3818181818, 42.4);\n  border-color: rgb(84.8, 69.3818181818, 42.4);\n}\n.btn.btn-success {\n  background: #C4900A;\n  border-color: #C4900A;\n  color: #FFFFFF;\n}\n.btn.btn-success:hover {\n  background: rgb(166.8854368932, 122.6097087379, 8.5145631068);\n}\n.btn.btn-outline-secondary {\n  border-color: #E4DDD3;\n  color: #7A6A55;\n  background: #FFFFFF;\n}\n.btn.btn-outline-secondary:hover {\n  background: #F8F5F0;\n  color: #2C2416;\n}\n.btn.btn-outline-primary {\n  border-color: #C4900A;\n  color: #C4900A;\n  background: #FFFFFF;\n}\n.btn.btn-outline-primary:hover {\n  background: #FDF3DC;\n}\n.btn.btn-outline-danger:hover {\n  transform: none;\n}\n.btn.btn-sm {\n  padding: 5px 13px;\n  font-size: 0.8rem;\n  border-radius: 8px;\n}\n.alert {\n  border-radius: 10px;\n  border: none;\n  font-size: 0.88rem;\n}\n.alert.alert-info {\n  background: #EBF4FD;\n  color: #1565C0;\n}\n.alert.alert-success {\n  background: #EAF5F0;\n  color: #3D7A5F;\n}\n.alert.alert-danger {\n  background: #FEF0F0;\n  color: #C62828;\n}\n.alert.alert-warning {\n  background: #FDF3DC;\n  color: rgb(147.4757281553, 108.3495145631, 7.5242718447);\n}\n.form-check-input:checked {\n  background-color: #C4900A;\n  border-color: #C4900A;\n}\n.card.bg-light {\n  background: #F8F5F0 !important;\n  border: 1.5px solid #E4DDD3 !important;\n  border-radius: 10px !important;\n}\n@media (max-width: 768px) {\n  .form-container,\n  .pf-nav-footer,\n  .pf-header {\n    padding-left: 1rem;\n    padding-right: 1rem;\n  }\n  .wizard {\n    padding: 1rem;\n  }\n  .pf-nav-footer {\n    margin: 1rem -1rem -1rem;\n  }\n  .step-section p {\n    font-size: 0.62rem;\n  }\n}\n/*# sourceMappingURL=instructor-course-add.component.css.map */\n'] }]
  }], () => [{ type: FormBuilder }, { type: FormationService }, { type: CategorieService }, { type: Router }, { type: DomSanitizer }, { type: AuthService }, { type: QuizService }, { type: QuestionQuizService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorCourseAddComponent, { className: "InstructorCourseAddComponent", filePath: "src/app/features/courses/instructor-course-add/instructor-course-add.component.ts", lineNumber: 78 });
})();
export {
  InstructorCourseAddComponent
};
//# sourceMappingURL=chunk-BKS4CHF7.js.map
