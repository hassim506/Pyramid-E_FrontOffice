...
var _c0 = () => [1, 2, 3, 4, 5, 6];
function AdminrhParcoursComponent_button_48_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 20);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_button_48_Template_button_click_0_listener() {
      const n_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.selectedNiveau = n_r2.value);
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("ac-chip--on", ctx_r2.selectedNiveau === n_r2.value);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(n_r2.label);
  }
}
function AdminrhParcoursComponent_button_56_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 20);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_button_56_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
...
function AdminrhParcoursComponent_div_58_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminrhParcoursComponent_div_58_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
...
function AdminrhParcoursComponent_div_59_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementStart(3, "button", 93);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_div_59_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
...
function AdminrhParcoursComponent_div_60_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 98);
  }
}
function AdminrhParcoursComponent_div_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 96);
    \u0275\u0275template(1, AdminrhParcoursComponent_div_60_div_1_Template, 1, 0, "div", 97);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function AdminrhParcoursComponent_ng_container_61_div_1_div_1_img_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 123);
  }
  if (rf & 2) {
    const p_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("src", p_r8.image_url, \u0275\u0275sanitizeUrl)("alt", p_r8.nom);
  }
}
function AdminrhParcoursComponent_ng_container_61_div_1_div_1_i_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 3);
  }
}
function AdminrhParcoursComponent_ng_container_61_div_1_div_1_div_19_span_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r2.getFormationsObligatoires(p_r8.formations).length, " oblig. ");
  }
}
function AdminrhParcoursComponent_ng_container_61_div_1_div_1_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 124)(1, "span");
    \u0275\u0275element(2, "i", 125);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AdminrhParcoursComponent_ng_container_61_div_1_div_1_div_19_span_4_Template, 3, 1, "span", 28);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const p_r8 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", p_r8.prix, " XOF");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.getFormationsObligatoires(p_r8.formations).length > 0);
  }
}
function AdminrhParcoursComponent_ng_container_61_div_1_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 104)(1, "div", 105);
    \u0275\u0275template(2, AdminrhParcoursComponent_ng_container_61_div_1_div_1_img_2_Template, 1, 2, "img", 106)(3, AdminrhParcoursComponent_ng_container_61_div_1_div_1_i_3_Template, 1, 0, "i", 107);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 111)(10, "span");
    \u0275\u0275element(11, "i", 112);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(19, AdminrhParcoursComponent_ng_container_61_div_1_div_1_div_19_Template, 5, 2, "div", 114);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 115)(21, "span", 116);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "div", 117)(24, "button", 118);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_ng_container_61_div_1_div_1_Template_button_click_24_listener() {
      const p_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.viewParcours(p_r8));
    });
    \u0275\u0275element(25, "i", 119);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "button", 120);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_ng_container_61_div_1_div_1_Template_button_click_26_listener() {
      const p_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.editParcours(p_r8));
    });
    \u0275\u0275element(27, "i", 121);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "button", 122);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_ng_container_61_div_1_div_1_Template_button_click_28_listener() {
      const p_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.archiveParcours(p_r8));
    });
    \u0275\u0275element(29, "i", 87);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275attribute("data-th", p_r8.actif ? "blue" : "amber");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", p_r8.image_url);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !p_r8.image_url);
    \u0275\u0275advance(2);
    \u0275\u0275attribute("data-cat", p_r8.niveau === "expert" ? "purple" : p_r8.niveau === "avance" ? "blue" : p_r8.niveau === "intermediaire" ? "teal" : "default");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getNiveauLabel(p_r8.niveau), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(p_r8.nom);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", p_r8.duree_estimee, "h");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", p_r8.formations.length, " formations");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", p_r8.users.length, " inscrits");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", p_r8.prix && p_r8.prix !== "0");
    \u0275\u0275advance(2);
    \u0275\u0275attribute("data-s", p_r8.actif ? "pub" : "draft");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", p_r8.actif ? "Actif" : "Inactif", " ");
  }
}
function AdminrhParcoursComponent_ng_container_61_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 102);
    \u0275\u0275template(1, AdminrhParcoursComponent_ng_container_61_div_1_div_1_Template, 30, 12, "div", 103);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r2.filteredParcours)("ngForTrackBy", ctx_r2.trackByParcoursId);
  }
}
function AdminrhParcoursComponent_ng_container_61_div_2_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 129);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_ng_container_61_div_2_button_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.openParcoursModal());
    });
    \u0275\u0275element(1, "i", 6);
...
function AdminrhParcoursComponent_ng_container_61_div_2_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 130);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_ng_container_61_div_2_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.clearFilters());
    });
...
function AdminrhParcoursComponent_ng_container_61_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AdminrhParcoursComponent_ng_container_61_div_2_button_4_Template, 3, 0, "button", 127)(5, AdminrhParcoursComponent_ng_container_61_div_2_button_5_Template, 3, 0, "button", 128);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.parcours.length === 0 ? "Aucun parcours cr\xE9\xE9" : "Aucun r\xE9sultat pour ces filtres");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.parcours.length === 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.parcours.length > 0);
  }
}
function AdminrhParcoursComponent_ng_container_61_div_3_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 139);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_ng_container_61_div_3_button_6_Template_button_click_0_listener() {
      const pg_r13 = \u0275\u0275restoreView(_r12).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.onPageChange(pg_r13));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const pg_r13 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("active", pg_r13 === ctx_r2.currentPage);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(pg_r13);
  }
}
function AdminrhParcoursComponent_ng_container_61_div_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 132)(1, "span", 133);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 134)(4, "button", 135);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_ng_container_61_div_3_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275element(5, "i", 136);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, AdminrhParcoursComponent_ng_container_61_div_3_button_6_Template, 2, 3, "button", 137);
    \u0275\u0275elementStart(7, "button", 135);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_ng_container_61_div_3_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onPageChange(ctx_r2.currentPage + 1));
    });
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate3("", ctx_r2.getPaginationStart(), "\u2013", ctx_r2.getPaginationEnd(), " sur ", ctx_r2.totalItems, " parcours");
    \u0275\u0275advance(2);
...
function AdminrhParcoursComponent_ng_container_61_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, AdminrhParcoursComponent_ng_container_61_div_1_Template, 2, 2, "div", 99)(2, AdminrhParcoursComponent_ng_container_61_div_2_Template, 6, 3, "div", 100)(3, AdminrhParcoursComponent_ng_container_61_div_3_Template, 9, 6, "div", 101);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredParcours.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredParcours.length === 0);
    \u0275\u0275advance();
...
function AdminrhParcoursComponent_span_83_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhParcoursComponent_span_90_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 140);
    \u0275\u0275text(1, " Description requise (min. 10 caract\xE8res) ");
    \u0275\u0275elementEnd();
  }
}
function AdminrhParcoursComponent_option_98_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", n_r14.value);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(n_r14.label);
  }
}
function AdminrhParcoursComponent_div_131_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 142)(1, "span", 143);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "input", 144);
    \u0275\u0275elementStart(4, "button", 145);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_div_131_Template_button_click_4_listener() {
      const i_r16 = \u0275\u0275restoreView(_r15).index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.removeObjectif(i_r16));
    });
    \u0275\u0275element(5, "i", 146);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("formGroupName", i_r16);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", i_r16 + 1, ".");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.objectifsLength === 1);
  }
}
function AdminrhParcoursComponent_div_140_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 142)(1, "span", 143);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "input", 147);
    \u0275\u0275elementStart(4, "button", 145);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_div_140_Template_button_click_4_listener() {
      const i_r18 = \u0275\u0275restoreView(_r17).index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.removePrerequis(i_r18));
    });
    \u0275\u0275element(5, "i", 146);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.prerequisLength === 1);
  }
}
function AdminrhParcoursComponent_span_144_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("(", ctx_r2.selectedFormations.length, " s\xE9lectionn\xE9e", ctx_r2.selectedFormations.length > 1 ? "s" : "", ")");
  }
}
function AdminrhParcoursComponent_div_145_span_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 151);
    \u0275\u0275text(1);
    \u0275\u0275elementStart(2, "button", 152);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_div_145_span_1_Template_button_click_2_listener() {
      const f_r20 = \u0275\u0275restoreView(_r19).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.removeSelectedFormation(f_r20.id));
    });
    \u0275\u0275element(3, "i", 14);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", f_r20.titre, " ");
  }
}
function AdminrhParcoursComponent_div_145_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 149);
    \u0275\u0275template(1, AdminrhParcoursComponent_div_145_span_1_Template, 4, 1, "span", 150);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r2.selectedFormations);
  }
}
function AdminrhParcoursComponent_div_151_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhParcoursComponent_div_152_i_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 160);
  }
}
function AdminrhParcoursComponent_div_152_span_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" \xB7 ", f_r22.niveau);
  }
}
function AdminrhParcoursComponent_div_152_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 154);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_div_152_Template_div_click_0_listener() {
      const f_r22 = \u0275\u0275restoreView(_r21).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleFormation(f_r22.id));
    });
    \u0275\u0275elementStart(1, "div", 155);
    \u0275\u0275template(2, AdminrhParcoursComponent_div_152_i_2_Template, 1, 0, "i", 156);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 157)(4, "div", 158);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 159);
    \u0275\u0275text(7);
    \u0275\u0275template(8, AdminrhParcoursComponent_div_152_span_8_Template, 2, 1, "span", 28);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const f_r22 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("checked", ctx_r2.isFormationSelected(f_r22.id));
    \u0275\u0275advance();
    \u0275\u0275classProp("on", ctx_r2.isFormationSelected(f_r22.id));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.isFormationSelected(f_r22.id));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(f_r22.titre);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", (f_r22.categorie == null ? null : f_r22.categorie.nom) || f_r22.type || "\u2014", "", f_r22.duree_totale ? " \xB7 " + f_r22.duree_totale + "h" : "", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", f_r22.niveau);
  }
}
function AdminrhParcoursComponent_div_153_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 153);
...
function AdminrhParcoursComponent_div_156_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhParcoursComponent_span_163_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 162);
  }
}
function AdminrhParcoursComponent_ng_container_168_div_61_div_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", obj_r24, " ");
  }
}
function AdminrhParcoursComponent_ng_container_168_div_61_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 40)(1, "label", 41);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 172);
    \u0275\u0275template(4, AdminrhParcoursComponent_ng_container_168_div_61_div_4_Template, 3, 1, "div", 173);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Objectifs (", ctx_r2.selectedParcours.objectifs.length, ")");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r2.selectedParcours.objectifs);
  }
}
function AdminrhParcoursComponent_ng_container_168_div_62_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 174);
    \u0275\u0275element(1, "i", 176);
    \u0275\u0275text(2);
  ...
  if (rf & 2) {
    const pre_r25 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", pre_r25, " ");
  }
}
function AdminrhParcoursComponent_ng_container_168_div_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 40)(1, "label", 41);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 172);
    \u0275\u0275template(4, AdminrhParcoursComponent_ng_container_168_div_62_div_4_Template, 3, 1, "div", 173);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Pr\xE9requis (", ctx_r2.selectedParcours.prerequis.length, ")");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r2.selectedParcours.prerequis);
  }
}
function AdminrhParcoursComponent_ng_container_168_div_63_div_4_span_4_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhParcoursComponent_ng_container_168_div_63_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 180)(1, "div", 181)(2, "div", 182);
    \u0275\u0275text(3);
    \u0275\u0275template(4, AdminrhParcoursComponent_ng_container_168_div_63_div_4_span_4_Template, 2, 0, "span", 183);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 184);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 111)(8, "span");
    \u0275\u0275element(9, "i", 112);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "span", 185);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", (f_r26.pivot == null ? null : f_r26.pivot.ordre) ? "\xC9tape " + (f_r26.pivot == null ? null : f_r26.pivot.ordre) : "\u2014", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", f_r26.pivot == null ? null : f_r26.pivot.obligatoire);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(f_r26.titre);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", f_r26.duree_totale, "h");
    \u0275\u0275advance();
    \u0275\u0275attribute("data-s", f_r26.est_publie ? "pub" : "draft");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", f_r26.est_publie ? "Publi\xE9" : "Brouillon", " ");
  }
}
function AdminrhParcoursComponent_ng_container_168_div_63_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "div", 177);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 178);
    \u0275\u0275template(4, AdminrhParcoursComponent_ng_container_168_div_63_div_4_Template, 13, 6, "div", 179);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Formations du parcours (", ctx_r2.selectedParcours.formations.length, ")");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r2.selectedParcours.formations)("ngForTrackBy", ctx_r2.trackByFormationId);
  }
}
function AdminrhParcoursComponent_ng_container_168_Template(rf, ctx) {
  if (rf & 1) {
    const _r23 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 32)(2, "div", 163);
    \u0275\u0275element(3, "i", 119);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(10, "i", 14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 39)(12, "div", 164)(13, "div", 165);
    \u0275\u0275text(14, "Informations");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 166)(16, "span", 167);
    \u0275\u0275text(17, "Niveau");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "span", 168);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 166)(21, "span", 167);
    \u0275\u0275text(22, "Dur\xE9e estim\xE9e");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "span", 168);
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 166)(26, "span", 167);
    \u0275\u0275text(27, "Dur\xE9e totale formations");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "span", 168);
    \u0275\u0275text(29);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div", 166)(31, "span", 167);
    \u0275\u0275text(32, "Co\xFBt");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "span", 168);
    \u0275\u0275text(34);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "div", 166)(36, "span", 167);
    \u0275\u0275text(37, "Formations incluses");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "span", 168);
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(40, "div", 166)(41, "span", 167);
    \u0275\u0275text(42, "Inscrits");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "span", 168);
    \u0275\u0275text(44);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "div", 166)(46, "span", 167);
    \u0275\u0275text(47, "Statut");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "span", 168)(49, "span", 116);
    \u0275\u0275text(50);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(51, "div", 166)(52, "span", 167);
    \u0275\u0275text(53, "Cr\xE9\xE9 le");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "span", 168);
    \u0275\u0275text(55);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(56, "div", 40)(57, "label", 41);
    \u0275\u0275text(58, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "div", 169);
    \u0275\u0275text(60);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(61, AdminrhParcoursComponent_ng_container_168_div_61_Template, 5, 2, "div", 170)(62, AdminrhParcoursComponent_ng_container_168_div_62_Template, 5, 2, "div", 170)(63, AdminrhParcoursComponent_ng_container_168_div_63_Template, 5, 3, "div", 28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "div", 77)(65, "button", 79);
    \u0275\u0275text(66, "Fermer");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(67, "button", 171);
    \u0275\u0275listener("click", function AdminrhParcoursComponent_ng_container_168_Template_button_click_67_listener() {
      \u0275\u0275restoreView(_r23);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.editParcours(ctx_r2.selectedParcours));
    });
    \u0275\u0275element(68, "i", 121);
    \u0275\u0275text(69, "Modifier ");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r2.selectedParcours.nom);
    \u0275\u0275advance(13);
    \u0275\u0275textInterpolate(ctx_r2.getNiveauLabel(ctx_r2.selectedParcours.niveau));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r2.selectedParcours.duree_estimee, "h");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r2.getTotalDuration(ctx_r2.selectedParcours.formations), "h");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r2.selectedParcours.prix, " XOF");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2("", ctx_r2.selectedParcours.formations.length, " (", ctx_r2.getFormationsObligatoires(ctx_r2.selectedParcours.formations).length, " oblig.)");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r2.selectedParcours.users.length);
    \u0275\u0275advance(5);
    \u0275\u0275attribute("data-s", ctx_r2.selectedParcours.actif ? "pub" : "draft");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.selectedParcours.actif ? "Actif" : "Inactif", " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r2.formatDate(ctx_r2.selectedParcours.created_at));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r2.selectedParcours.description);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.selectedParcours.objectifs.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.selectedParcours.prerequis.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.selectedParcours.formations.length > 0);
  }
}
function AdminrhParcoursComponent_div_178_Template(rf, ctx) {
  if (rf & 1) {
...
${errorMessages}`;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminrhParcoursComponent, selectors: [["app-adminrh-parcours"]], decls: 193, vars: 43, consts: [[1, "ac-shell"], [1, "ac-topbar"], [1, "ac-tab", "active"], [1, "isax", "isax-route-square"], [1, "ac-spacer"], ["type", "button", 1, "ac-add-btn", 3, "click"], [1, "isax", "isax-add"], [1, "ac-kpi-row"], [1, "ac-kpi"], [1, "ac-kpi__label"], [1, "ac-kpi__val"], [1, "ac-kpi__delta", "neutral"], [1, "isax", "isax-tick-circle"], [1, "ac-kpi__delta", "up"], [1, "isax", "isax-close-circle"], [1, "isax", "isax-book-1"], [1, "ac-toolbar"], [1, "ac-search"], [1, "isax", "isax-search-normal-1", "ac-search__icon"], ["type", "search", "placeholder", "Rechercher un parcours\u2026", 1, "ac-search__input", 3, "ngModelChange", "ngModel"], ["type", "button", 1, "ac-chip", 3, "click"], ["type", "button", "class", "ac-chip", 3, "ac-chip--on", "click", 4, "ngFor", "ngForOf"], [1, "ac-view-group", 2, "margin-left", "8px"], ["type", "button", 1, "ac-view-toggle", 3, "click"], ["type", "button", "class", "ac-chip", 3, "click", 4, "ngIf"], ["class", "ac-alert", "style", "color:#27500a;background:#eaf3de;border-color:#97c459;", 4, "ngIf"], ["class", "ac-alert", 4, "ngIf"], ["class", "ac-skeletons", 4, "ngIf"], [4, "ngIf"], ["id", "parcoursModal", "tabindex", "-1", 1, "modal", "fade"], [1, "modal-dialog", "modal-lg", 2, "max-width", "640px"], [1, "wz-modal", "modal-content"], [1, "wz-head"], [1, "wz-head__icon"], [1, "wz-head__text"], [1, "wz-head__title"], [1, "wz-head__sub"], ["type", "button", "data-bs-dismiss", "modal", 1, "wz-close"], [2, "display", "flex", "flex-direction", "column", "flex", "1", "min-height", "0", "overflow", "hidden", 3, "ngSubmit", "formGroup"], [1, "wz-body"], [1, "wz-field"], [1, "wz-label"], [1, "wz-req"], ["type", "text", "formControlName", "nom", "placeholder", "Ex: D\xE9veloppement Web Full Stack", 1, "wz-input"], ["class", "wz-hint", 4, "ngIf"], ["formControlName", "description", "placeholder", "Description d\xE9taill\xE9e du parcours", 1, "wz-input", "wz-textarea"], [1, "wz-row"], [1, "wz-field", 2, "margin-bottom", "0"], ["title", "Niveau du parcours", "formControlName", "niveau", 1, "wz-input"], [3, "value", 4, "ngFor", "ngForOf"], ["type", "number", "formControlName", "duree_estimee", "min", "1", 1, "wz-input"], [1, "wz-row", 2, "margin-top", "12px"], ["type", "number", "formControlName", "prix", "min", "0", "step", "0.01", 1, "wz-input"], ["type", "url", "formControlName", "image_url", "placeholder", "https://\u2026", 1, "wz-input"], [1, "wz-toggle-row", 2, "margin-top", "12px"], [1, "wz-toggle-title"], [1, "wz-toggle-sub"], [1, "wz-toggle", 3, "click"], [2, "margin-top", "18px"], [2, "display", "flex", "align-items", "center", "justify-content", "space-between", "margin-bottom", "8px"], ["type", "button", 1, "ac-add-btn", 2, "padding", "4px 10px", "font-size", "11px", 3, "click"], ["formArrayName", "objectifs"], ["style", "display:flex;align-items:center;gap:6px;margin-bottom:6px;", 3, "formGroupName", 4, "ngFor", "ngForOf"], [2, "margin-top", "12px"], ["formArrayName", "prerequis"], [1, "wz-label", 2, "margin-bottom", "8px"], ["style", "font-weight:400;color:#185fa5;margin-left:4px;", 4, "ngIf"], ["class", "cw-pool-chips", 4, "ngIf"], [1, "cw-pool"], [1, "cw-pool__search"], [1, "isax", "isax-search-normal-1"], ["type", "search", "placeholder", "Rechercher une formation\u2026", 3, "ngModelChange", "ngModel"], [1, "cw-pool__list", 2, "max-height", "200px"], ["class", "cw-pool__empty", 4, "ngIf"], ["class", "cw-pool__item", 3, "checked", "click", 4, "ngFor", "ngForOf"], [2, "font-size", "11px", "color", "#9ca3af"], ["class", "wz-error", 4, "ngIf"], [1, "wz-foot"], [1, "wz-foot__info"], ["type", "button", "data-bs-dismiss", "modal", 1, "wz-btn-ghost"], ["type", "submit", 1, "wz-btn-primary", 3, "disabled"], ["class", "wz-spinner", 4, "ngIf"], ["id", "viewModal", "tabindex", "-1", 1, "modal", "fade"], [1, "modal-dialog", "modal-lg", "modal-dialog-scrollable", 2, "max-width", "680px"], ["id", "deleteModal", "tabindex", "-1", 1, "modal", "fade"], [1, "modal-dialog", 2, "max-width", "420px"], [1, "wz-head__icon", 2, "background", "#FAEEDA", "color", "#BA7517"], [1, "isax", "isax-archive"], ["class", "wz-head__sub", 4, "ngIf"], [1, "wz-info-banner", 2, "background", "#fef2f2", "border-color", "#fca5a5", "color", "#7f1d1d"], [1, "isax", "isax-warning-2", 2, "color", "#dc2626"], ["type", "button", 1, "wz-btn-arch", 3, "click"], [1, "ac-alert", 2, "color", "#27500a", "background", "#eaf3de", "border-color", "#97c459"], ["type", "button", 1, "ac-alert-close", 3, "click"], [1, "ac-alert"], [1, "isax", "isax-warning-2"], [1, "ac-skeletons"], ["class", "ac-skeleton-card", 4, "ngFor", "ngForOf"], [1, "ac-skeleton-card"], ["class", "ac-card-grid", 4, "ngIf"], ["class", "ac-empty ac-empty--span", 4, "ngIf"], ["class", "ac-pager", 4, "ngIf"], [1, "ac-card-grid"], ["class", "ac-fcard", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "ac-fcard"], [1, "ac-fcard__thumb"], ["class", "ac-fcard__img", 3, "src", "alt", 4, "ngIf"], ["class", "isax isax-route-square", 4, "ngIf"], [1, "ac-fcard__body"], [1, "ac-fcard__cat"], [1, "ac-fcard__title"], [1, "ac-fcard__meta"], [1, "isax", "isax-clock"], [1, "isax", "isax-people"], ["class", "ac-fcard__meta", "style", "margin-top:3px;", 4, "ngIf"], [1, "ac-fcard__footer"], [1, "ac-status"], [1, "ac-fcard__actions", 2, "margin-left", "auto"], ["type", "button", "title", "Voir", 1, "ac-act", 3, "click"], [1, "isax", "isax-eye"], ["type", "button", "title", "Modifier", 1, "ac-act", 3, "click"], [1, "isax", "isax-edit-2"], ["type", "button", "title", "Archiver", 1, "ac-act", "ac-act--arch", 3, "click"], [1, "ac-fcard__img", 3, "src", "alt"], [1, "ac-fcard__meta", 2, "margin-top", "3px"], [1, "isax", "isax-wallet"], [1, "ac-empty", "ac-empty--span"], ["type", "button", "class", "ac-add-btn", "style", "margin-top:10px;", 3, "click", 4, "ngIf"], ["type", "button", "class", "ac-chip", "style", "margin-top:10px;", 3, "click", 4, "ngIf"], ["type", "button", 1, "ac-add-btn", 2, "margin-top", "10px", 3, "click"], ["type", "button", 1, "ac-chip", 2, "margin-top", "10px", 3, "click"], [1, "isax", "isax-refresh"], [1, "ac-pager"], [1, "ac-pager__info"], [1, "ac-pager__btns"], ["type", "button", 1, "ac-pager__btn", 3, "click", "disabled"], [1, "isax", "isax-arrow-left-3"], ["type", "button", "class", "ac-pager__btn", 3, "active", "click", 4, "ngFor", "ngForOf"], [1, "isax", "isax-arrow-right-3"], ["type", "button", 1, "ac-pager__btn", 3, "click"], [1, "wz-hint"], [3, "value"], [2, "display", "flex", "align-items", "center", "gap", "6px", "margin-bottom", "6px", 3, "formGroupName"], [2, "font-size", "12px", "color", "#9ca3af", "min-width", "20px", "text-align", "right"], ["type", "text", "formControlName", "value", "placeholder", "D\xE9crivez un objectif\u2026", 1, "wz-input", 2, "flex", "1"], ["type", "button", 1, "ac-act", "ac-act--del", 3, "click", "disabled"], [1, "isax", "isax-trash"], ["type", "text", "formControlName", "value", "placeholder", "D\xE9crivez un pr\xE9requis\u2026", 1, "wz-input", 2, "flex", "1"], [2, "font-weight", "400", "color", "#185fa5", "margin-left", "4px"], [1, "cw-pool-chips"], ["class", "cw-pool-chip", 4, "ngFor", "ngForOf"], [1, "cw-pool-chip"], ["type", "button", 3, "click"], [1, "cw-pool__empty"], [1, "cw-pool__item", 3, "click"], [1, "cw-pool__check"], ["class", "isax isax-tick", 4, "ngIf"], [1, "cw-pool__info"], [1, "cw-pool__name"], [1, "cw-pool__meta"], [1, "isax", "isax-tick"], [1, "wz-error"], [1, "wz-spinner"], [1, "wz-head__icon", 2, "background", "#e1f5ee", "color", "#0f6e56"], [1, "wz-recap-card"], [1, "wz-recap-title"], [1, "wz-recap-row"], [1, "wz-rl"], [1, "wz-rv"], [1, "wz-desc-box"], ["class", "wz-field", 4, "ngIf"], ["type", "button", "data-bs-dismiss", "modal", 1, "wz-btn-primary", 3, "click"], [1, "wz-list"], ["class", "wz-list-item", 4, "ngFor", "ngForOf"], [1, "wz-list-item"], [1, "isax", "isax-tick-circle", 2, "color", "#0f6e56"], [1, "isax", "isax-info-circle", 2, "color", "#185fa5"], [1, "wz-section-label"], [1, "ac-card-grid", 2, "grid-template-columns", "repeat(auto-fill,minmax(200px,1fr))", "gap", "8px"], ["class", "ac-fcard", "style", "min-height:auto;", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "ac-fcard", 2, "min-height", "auto"], [1, "ac-fcard__body", 2, "padding", "10px 12px"], ["data-cat", "default", 1, "ac-fcard__cat"], ["style", "margin-left:4px;color:#e78a0e;", 4, "ngIf"], [1, "ac-fcard__title", 2, "font-size", "12px"], [1, "ac-status", 2, "font-size", "9px"], [2, "margin-left", "4px", "color", "#e78a0e"]], template: function AdminrhParcoursComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function AdminrhParcoursComponent_Template_button_click_6_listener() {
        return ctx.openParcoursModal();
      });
      \u0275\u0275element(7, "i", 6);
      \u0275\u0275text(8, "Nouveau parcours ");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(33, "d\xE9sactiv\xE9s");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(34, "div", 8)(35, "div", 9);
      \u0275\u0275element(36, "i", 15);
      \u0275\u0275text(37, "Formations dispo");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(38, "div", 10);
      \u0275\u0275text(39);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(40, "div", 11);
      \u0275\u0275text(41, "catalogu\xE9es");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(42, "div", 16)(43, "div", 17);
      \u0275\u0275element(44, "i", 18);
      \u0275\u0275elementStart(45, "input", 19);
      \u0275\u0275twoWayListener("ngModelChange", function AdminrhParcoursComponent_Template_input_ngModelChange_45_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.searchTerm, $event) || (ctx.searchTerm = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(46, "button", 20);
      \u0275\u0275listener("click", function AdminrhParcoursComponent_Template_button_click_46_listener() {
        return ctx.selectedNiveau = "";
      });
      \u0275\u0275text(47, "Tous niveaux");
      \u0275\u0275elementEnd();
      \u0275\u0275template(48, AdminrhParcoursComponent_button_48_Template, 2, 3, "button", 21);
      ...
      \u0275\u0275listener("click", function AdminrhParcoursComponent_Template_button_click_54_listener() {
        return ctx.selectedStatut = "inactif";
      });
      \u0275\u0275text(55, "Inactifs");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(56, AdminrhParcoursComponent_button_56_Template, 3, 0, "button", 24);
      \u0275\u0275element(57, "span", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275template(58, AdminrhParcoursComponent_div_58_Template, 5, 1, "div", 25)(59, AdminrhParcoursComponent_div_59_Template, 5, 1, "div", 26)(60, AdminrhParcoursComponent_div_60_Template, 2, 2, "div", 27)(61, AdminrhParcoursComponent_ng_container_61_Template, 4, 3, "ng-container", 28);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275element(74, "i", 14);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(75, "form", 38);
      \u0275\u0275listener("ngSubmit", function AdminrhParcoursComponent_Template_form_ngSubmit_75_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275elementStart(76, "div", 39)(77, "div", 40)(78, "label", 41);
      \u0275\u0275text(79, "Nom du parcours ");
      \u0275\u0275elementStart(80, "span", 42);
      \u0275\u0275text(81, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(82, "input", 43);
      \u0275\u0275template(83, AdminrhParcoursComponent_span_83_Template, 2, 0, "span", 44);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(84, "div", 40)(85, "label", 41);
      \u0275\u0275text(86, "Description ");
      \u0275\u0275elementStart(87, "span", 42);
      \u0275\u0275text(88, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(89, "textarea", 45);
      \u0275\u0275template(90, AdminrhParcoursComponent_span_90_Template, 2, 0, "span", 44);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(91, "div", 46)(92, "div", 47)(93, "label", 41);
      \u0275\u0275text(94, "Niveau ");
      \u0275\u0275elementStart(95, "span", 42);
      \u0275\u0275text(96, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(97, "select", 48);
      \u0275\u0275template(98, AdminrhParcoursComponent_option_98_Template, 2, 2, "option", 49);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(99, "div", 47)(100, "label", 41);
      \u0275\u0275text(101, "Dur\xE9e estim\xE9e (heures) ");
      \u0275\u0275elementStart(102, "span", 42);
      \u0275\u0275text(103, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(104, "input", 50);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(105, "div", 51)(106, "div", 47)(107, "label", 41);
      \u0275\u0275text(108, "Co\xFBt (XOF) ");
      \u0275\u0275elementStart(109, "span", 42);
      \u0275\u0275text(110, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(111, "input", 52);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(112, "div", 47)(113, "label", 41);
      \u0275\u0275text(114, "Image URL");
      \u0275\u0275elementEnd();
      \u0275\u0275element(115, "input", 53);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(116, "div", 54)(117, "div")(118, "div", 55);
      \u0275\u0275text(119, "Parcours actif");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(120, "div", 56);
      \u0275\u0275text(121, "Rendre ce parcours disponible aux employ\xE9s");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(122, "div", 57);
      \u0275\u0275listener("click", function AdminrhParcoursComponent_Template_div_click_122_listener() {
        let tmp_0_0;
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(123, "div", 58)(124, "div", 59)(125, "span", 41);
      \u0275\u0275text(126, "Objectifs du parcours");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(127, "button", 60);
      \u0275\u0275listener("click", function AdminrhParcoursComponent_Template_button_click_127_listener() {
      ...
      \u0275\u0275template(131, AdminrhParcoursComponent_div_131_Template, 6, 3, "div", 62);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(132, "div", 63)(133, "div", 59)(134, "span", 41);
      \u0275\u0275text(135, "Pr\xE9requis");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(136, "button", 60);
      \u0275\u0275listener("click", function AdminrhParcoursComponent_Template_button_click_136_listener() {
        return ctx.addPrerequis();
      });
      \u0275\u0275element(137, "i", 6);
      \u0275\u0275text(138, "Ajouter ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(139, "div", 64);
      \u0275\u0275template(140, AdminrhParcoursComponent_div_140_Template, 6, 3, "div", 62);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(141, "div", 58)(142, "div", 65);
      \u0275\u0275text(143, " Formations du parcours ");
      \u0275\u0275template(144, AdminrhParcoursComponent_span_144_Template, 2, 2, "span", 66);
      \u0275\u0275elementEnd();
      \u0275\u0275template(145, AdminrhParcoursComponent_div_145_Template, 2, 1, "div", 67);
      \u0275\u0275elementStart(146, "div", 68)(147, "div", 69);
      \u0275\u0275element(148, "i", 70);
      \u0275\u0275elementStart(149, "input", 71);
      \u0275\u0275twoWayListener("ngModelChange", function AdminrhParcoursComponent_Template_input_ngModelChange_149_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.formationsSearchTerm, $event) || (ctx.formationsSearchTerm = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(150, "div", 72);
      \u0275\u0275template(151, AdminrhParcoursComponent_div_151_Template, 2, 0, "div", 73)(152, AdminrhParcoursComponent_div_152_Template, 9, 9, "div", 74)(153, AdminrhParcoursComponent_div_153_Template, 2, 0, "div", 73);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(154, "div", 75);
      \u0275\u0275text(155, " L'ordre des formations d\xE9finit la s\xE9quence du parcours. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(156, AdminrhParcoursComponent_div_156_Template, 3, 1, "div", 76);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(157, "div", 77)(158, "span", 78);
      \u0275\u0275text(159);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(160, "button", 79);
      \u0275\u0275text(161, "Annuler");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(162, "button", 80);
      \u0275\u0275template(163, AdminrhParcoursComponent_span_163_Template, 1, 0, "span", 81);
      \u0275\u0275text(164);
      \u0275\u0275elementEnd()()()()()();
      \u0275\u0275elementStart(165, "div", 82)(166, "div", 83)(167, "div", 31);
      \u0275\u0275template(168, AdminrhParcoursComponent_ng_container_168_Template, 70, 15, "ng-container", 28);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(169, "div", 84)(170, "div", 85)(171, "div", 31)(172, "div", 32)(173, "div", 86);
      \u0275\u0275element(174, "i", 87);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(175, "div", 34)(176, "div", 35);
      \u0275\u0275text(177, "Archiver le parcours");
      \u0275\u0275elementEnd();
      \u0275\u0275template(178, AdminrhParcoursComponent_div_178_Template, 2, 1, "div", 88);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(179, "button", 37);
      \u0275\u0275element(180, "i", 14);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(181, "div", 39)(182, "div", 89);
      \u0275\u0275element(183, "i", 90);
      \u0275\u0275elementStart(184, "span");
      \u0275\u0275text(185, "Le parcours sera archiv\xE9 et masqu\xE9. Les inscriptions associ\xE9es seront conserv\xE9es.");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(186, "div", 77);
      \u0275\u0275element(187, "span", 78);
      \u0275\u0275elementStart(188, "button", 79);
      \u0275\u0275text(189, "Annuler");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(190, "button", 91);
      \u0275\u0275listener("click", function AdminrhParcoursComponent_Template_button_click_190_listener() {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(8);
      \u0275\u0275property("ngIf", ((tmp_19_0 = ctx.parcoursForm.get("nom")) == null ? null : tmp_19_0.invalid) && ((tmp_19_0 = ctx.parcoursForm.get("nom")) == null ? null : tmp_19_0.touched));
      \u0275\u0275advance(7);
      \u0275\u0275property("ngIf", ((tmp_20_0 = ctx.parcoursForm.get("description")) == null ? null : tmp_20_0.invalid) && ((tmp_20_0 = ctx.parcoursForm.get("description")) == null ? null : tmp_20_0.touched));
      \u0275\u0275advance(8);
      \u0275\u0275property("ngForOf", ctx.niveaux);
      \u0275\u0275advance(24);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhParcoursComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-parcours", standalone: true, imports: [CommonModule, ReactiveFormsModule, FormsModule], template: `<div class="ac-shell">

  <!-- \u2500\u2500 Topbar \u2500\u2500 -->
  <div class="ac-topbar">
    <span class="ac-tab active">
      <i class="isax isax-route-square"></i>Parcours ({{ totalItems }})
    </span>
    <span class="ac-spacer"></span>
    <button type="button" class="ac-add-btn" (click)="openParcoursModal()">
  ...
  <div class="ac-kpi-row">
    <div class="ac-kpi">
      <div class="ac-kpi__label"><i class="isax isax-route-square"></i>Total</div>
      <div class="ac-kpi__val">{{ totalItems }}</div>
      <div class="ac-kpi__delta neutral">parcours</div>
    </div>
    <div class="ac-kpi">
      <div class="ac-kpi__label"><i class="isax isax-tick-circle"></i>Actifs</div>
      <div class="ac-kpi__val">{{ getParcoursActifs() }}</div>
      <div class="ac-kpi__delta up">en cours</div>
    </div>
    <div class="ac-kpi">
      <div class="ac-kpi__label"><i class="isax isax-close-circle"></i>Inactifs</div>
      <div class="ac-kpi__val">{{ getParcoursInactifs() }}</div>
      <div class="ac-kpi__delta neutral">d\xE9sactiv\xE9s</div>
    </div>
    <div class="ac-kpi">
      <div class="ac-kpi__label"><i class="isax isax-book-1"></i>Formations dispo</div>
      <div class="ac-kpi__val">{{ formations.length }}</div>
      <div class="ac-kpi__delta neutral">catalogu\xE9es</div>
    </div>
  </div>
  ...
  <div class="ac-toolbar">
    <div class="ac-search">
      ...
      <input class="ac-search__input" type="search" [(ngModel)]="searchTerm" placeholder="Rechercher un parcours\u2026">
    </div>
    <button type="button" class="ac-chip" [class.ac-chip--on]="selectedNiveau === ''"
            (click)="selectedNiveau = ''">Tous niveaux</button>
    <button type="button" class="ac-chip" *ngFor="let n of niveaux"
            [class.ac-chip--on]="selectedNiveau === n.value"
            (click)="selectedNiveau = n.value">{{ n.label }}</button>
    <div class="ac-view-group" style="margin-left:8px;">
      <button type="button" class="ac-view-toggle" [class.active]="selectedStatut === ''"
              (click)="selectedStatut = ''">Tous</button>
      <button type="button" class="ac-view-toggle" [class.active]="selectedStatut === 'actif'"
              (click)="selectedStatut = 'actif'">Actifs</button>
      <button type="button" class="ac-view-toggle" [class.active]="selectedStatut === 'inactif'"
              (click)="selectedStatut = 'inactif'">Inactifs</button>
    </div>
    <button type="button" class="ac-chip" (click)="clearFilters()"
            *ngIf="searchTerm || selectedNiveau || selectedStatut">
  ...
  <ng-container *ngIf="!loading">
    <div class="ac-card-grid" *ngIf="filteredParcours.length > 0">
      <div *ngFor="let p of filteredParcours; trackBy: trackByParcoursId" class="ac-fcard">
        ...
        <div class="ac-fcard__body">
          <div class="ac-fcard__cat"
               [attr.data-cat]="p.niveau === 'expert' ? 'purple' : p.niveau === 'avance' ? 'blue' : p.niveau === 'intermediaire' ? 'teal' : 'default'">
            {{ getNiveauLabel(p.niveau) }}
          </div>
          <div class="ac-fcard__title">{{ p.nom }}</div>
          <div class="ac-fcard__meta">
            <span><i class="isax isax-clock"></i> {{ p.duree_estimee }}h</span>
            <span><i class="isax isax-book-1"></i> {{ p.formations.length }} formations</span>
            <span><i class="isax isax-people"></i> {{ p.users.length }} inscrits</span>
          </div>
          <div class="ac-fcard__meta" style="margin-top:3px;" *ngIf="p.prix && p.prix !== '0'">
            <span><i class="isax isax-wallet"></i> {{ p.prix }} XOF</span>
            <span *ngIf="getFormationsObligatoires(p.formations).length > 0">
              <i class="isax isax-warning-2"></i> {{ getFormationsObligatoires(p.formations).length }} oblig.
            </span>
          </div>
        </div>
        ...
        <div class="ac-fcard__footer">
          <span class="ac-status" [attr.data-s]="p.actif ? 'pub' : 'draft'">
            {{ p.actif ? 'Actif' : 'Inactif' }}
          </span>
          <div class="ac-fcard__actions" style="margin-left:auto;">
            <button type="button" class="ac-act" title="Voir" (click)="viewParcours(p)">
              <i class="isax isax-eye"></i>
            </button>
            <button type="button" class="ac-act" title="Modifier" (click)="editParcours(p)">
              <i class="isax isax-edit-2"></i>
            </button>
            <button type="button" class="ac-act ac-act--arch" title="Archiver" (click)="archiveParcours(p)">
    ...
    <!-- Empty -->
    <div class="ac-empty ac-empty--span" *ngIf="filteredParcours.length === 0">
      <i class="isax isax-route-square"></i>
      <p>{{ parcours.length === 0 ? 'Aucun parcours cr\xE9\xE9' : 'Aucun r\xE9sultat pour ces filtres' }}</p>
      <button type="button" class="ac-add-btn" style="margin-top:10px;"
              (click)="openParcoursModal()" *ngIf="parcours.length === 0">
        <i class="isax isax-add"></i>Cr\xE9er un parcours
      </button>
      <button type="button" class="ac-chip" style="margin-top:10px;"
              (click)="clearFilters()" *ngIf="parcours.length > 0">
        <i class="isax isax-refresh"></i>Effacer les filtres
      </button>
    </div>

    <!-- Pagination -->
    <div class="ac-pager" *ngIf="totalPages > 1">
      <span class="ac-pager__info">{{ getPaginationStart() }}\u2013{{ getPaginationEnd() }} sur {{ totalItems }} parcours</span>
      <div class="ac-pager__btns">
        ...
        <button type="button" class="ac-pager__btn" *ngFor="let pg of pages"
                [class.active]="pg === currentPage" (click)="onPageChange(pg)">{{ pg }}</button>
        <button type="button" class="ac-pager__btn" [disabled]="currentPage === totalPages"
                (click)="onPageChange(currentPage + 1)">
...
<!-- \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550
     MODAL CR\xC9ATION / MODIFICATION
\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 -->
<div class="modal fade" id="parcoursModal" tabindex="-1">
  <div class="modal-dialog modal-lg" style="max-width:640px;">
    <div class="wz-modal modal-content">

      <div class="wz-head">
        <div class="wz-head__icon"><i class="isax isax-route-square"></i></div>
        <div class="wz-head__text">
          <div class="wz-head__title">{{ editMode ? 'Modifier le parcours' : 'Nouveau parcours' }}</div>
          <div class="wz-head__sub">{{ editMode ? 'Mettez \xE0 jour les informations' : 'Renseignez les informations du parcours' }}</div>
        </div>
        <button type="button" class="wz-close" data-bs-dismiss="modal"><i class="isax isax-close-circle"></i></button>
      </div>

      <form [formGroup]="parcoursForm" (ngSubmit)="onSubmit()" style="display:flex;flex-direction:column;flex:1;min-height:0;overflow:hidden;">
        <div class="wz-body">

          <div class="wz-field">
            <label class="wz-label">Nom du parcours <span class="wz-req">*</span></label>
            <input type="text" class="wz-input" formControlName="nom" placeholder="Ex: D\xE9veloppement Web Full Stack">
            <span class="wz-hint" *ngIf="parcoursForm.get('nom')?.invalid && parcoursForm.get('nom')?.touched">
              Nom requis (min. 3 caract\xE8res)
            </span>
          </div>

          <div class="wz-field">
            <label class="wz-label">Description <span class="wz-req">*</span></label>
            <textarea class="wz-input wz-textarea" formControlName="description" placeholder="Description d\xE9taill\xE9e du parcours"></textarea>
            <span class="wz-hint" *ngIf="parcoursForm.get('description')?.invalid && parcoursForm.get('description')?.touched">
              Description requise (min. 10 caract\xE8res)
            </span>
          </div>

          <div class="wz-row">
            <div class="wz-field" style="margin-bottom:0;">
              <label class="wz-label">Niveau <span class="wz-req">*</span></label>
              <select class="wz-input" title="Niveau du parcours" formControlName="niveau">
                <option *ngFor="let n of niveaux" [value]="n.value">{{ n.label }}</option>
              </select>
            </div>
            <div class="wz-field" style="margin-bottom:0;">
              <label class="wz-label">Dur\xE9e estim\xE9e (heures) <span class="wz-req">*</span></label>
              <input type="number" class="wz-input" formControlName="duree_estimee" min="1">
            </div>
          </div>

          <div class="wz-row" style="margin-top:12px;">
            <div class="wz-field" style="margin-bottom:0;">
              <label class="wz-label">Co\xFBt (XOF) <span class="wz-req">*</span></label>
              <input type="number" class="wz-input" formControlName="prix" min="0" step="0.01">
            </div>
            <div class="wz-field" style="margin-bottom:0;">
              <label class="wz-label">Image URL</label>
              <input type="url" class="wz-input" formControlName="image_url" placeholder="https://\u2026">
            </div>
          </div>

          <div class="wz-toggle-row" style="margin-top:12px;">
            <div>
              <div class="wz-toggle-title">Parcours actif</div>
              <div class="wz-toggle-sub">Rendre ce parcours disponible aux employ\xE9s</div>
            </div>
            <div class="wz-toggle" [class.on]="parcoursForm.get('actif')?.value"
                 (click)="parcoursForm.get('actif')?.setValue(!parcoursForm.get('actif')?.value)"></div>
          </div>

          <!-- Objectifs -->
          <div style="margin-top:18px;">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
              <span class="wz-label">Objectifs du parcours</span>
              <button type="button" class="ac-add-btn" style="padding:4px 10px;font-size:11px;" (click)="addObjectif()">
                <i class="isax isax-add"></i>Ajouter
              </button>
            </div>
            <div formArrayName="objectifs">
              <div *ngFor="let obj of objectifs.controls; let i = index" [formGroupName]="i"
                   style="display:flex;align-items:center;gap:6px;margin-bottom:6px;">
                <span style="font-size:12px;color:#9ca3af;min-width:20px;text-align:right;">{{ i+1 }}.</span>
                <input type="text" class="wz-input" formControlName="value" style="flex:1;"
                       placeholder="D\xE9crivez un objectif\u2026">
                <button type="button" class="ac-act ac-act--del" (click)="removeObjectif(i)"
                        [disabled]="objectifsLength === 1">
          ...
          <div style="margin-top:12px;">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
              <span class="wz-label">Pr\xE9requis</span>
              <button type="button" class="ac-add-btn" style="padding:4px 10px;font-size:11px;" (click)="addPrerequis()">
                <i class="isax isax-add"></i>Ajouter
              </button>
            </div>
            <div formArrayName="prerequis">
              <div *ngFor="let pre of prerequis.controls; let i = index" [formGroupName]="i"
                   style="display:flex;align-items:center;gap:6px;margin-bottom:6px;">
                <span style="font-size:12px;color:#9ca3af;min-width:20px;text-align:right;">{{ i+1 }}.</span>
                <input type="text" class="wz-input" formControlName="value" style="flex:1;"
                       placeholder="D\xE9crivez un pr\xE9requis\u2026">
                <button type="button" class="ac-act ac-act--del" (click)="removePrerequis(i)"
                        [disabled]="prerequisLength === 1">
                  <i class="isax isax-trash"></i>
                </button>
              </div>
            </div>
          ...
          <div style="margin-top:18px;">
            <div class="wz-label" style="margin-bottom:8px;">
              Formations du parcours
              <span *ngIf="selectedFormations.length > 0" style="font-weight:400;color:#185fa5;margin-left:4px;">({{ selectedFormations.length }} s\xE9lectionn\xE9e{{ selectedFormations.length > 1 ? 's' : '' }})</span>
            </div>

            <!-- Chips s\xE9lectionn\xE9es -->
            <div class="cw-pool-chips" *ngIf="selectedFormations.length > 0">
              <span class="cw-pool-chip" *ngFor="let f of selectedFormations">
                {{ f.titre }}
            ...
            <div class="cw-pool">
              <div class="cw-pool__search">
                ...
                <input type="search" [(ngModel)]="formationsSearchTerm" placeholder="Rechercher une formation\u2026">
              </div>
              <div class="cw-pool__list" style="max-height:200px;">
                <div *ngIf="loadingFormations" class="cw-pool__empty">Chargement\u2026</div>
                ...
                <div class="cw-pool__empty" *ngIf="!loadingFormations && filteredFormationsPool.length === 0">
                  Aucune formation disponible
                </div>
              </div>
            </div>
            <div style="font-size:11px;color:#9ca3af;">
              L'ordre des formations d\xE9finit la s\xE9quence du parcours.
            </div>
          </div>

          <div class="wz-error" *ngIf="error && saving">
            <i class="isax isax-warning-2"></i>{{ error }}
          </div>
        ...
        <div class="wz-foot">
          <span class="wz-foot__info">{{ editMode ? 'Modification' : 'Cr\xE9ation' }} en cours</span>
          <button type="button" class="wz-btn-ghost" data-bs-dismiss="modal">Annuler</button>
          <button type="submit" class="wz-btn-primary" [disabled]="parcoursForm.invalid || saving">
            <span *ngIf="saving" class="wz-spinner"></span>
...
<div class="modal fade" id="viewModal" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-scrollable" style="max-width:680px;">
    <div class="wz-modal modal-content">
      <ng-container *ngIf="selectedParcours">
        <div class="wz-head">
          <div class="wz-head__icon" style="background:#e1f5ee;color:#0f6e56;"><i class="isax isax-eye"></i></div>
          <div class="wz-head__text">
            <div class="wz-head__title">{{ selectedParcours.nom }}</div>
            <div class="wz-head__sub">D\xE9tails du parcours</div>
          </div>
          <button type="button" class="wz-close" data-bs-dismiss="modal"><i class="isax isax-close-circle"></i></button>
        </div>
        ...
        <div class="wz-body">
          <div class="wz-recap-card">
            <div class="wz-recap-title">Informations</div>
            <div class="wz-recap-row"><span class="wz-rl">Niveau</span><span class="wz-rv">{{ getNiveauLabel(selectedParcours.niveau) }}</span></div>
            <div class="wz-recap-row"><span class="wz-rl">Dur\xE9e estim\xE9e</span><span class="wz-rv">{{ selectedParcours.duree_estimee }}h</span></div>
            <div class="wz-recap-row"><span class="wz-rl">Dur\xE9e totale formations</span><span class="wz-rv">{{ getTotalDuration(selectedParcours.formations) }}h</span></div>
            <div class="wz-recap-row"><span class="wz-rl">Co\xFBt</span><span class="wz-rv">{{ selectedParcours.prix }} XOF</span></div>
            <div class="wz-recap-row"><span class="wz-rl">Formations incluses</span><span class="wz-rv">{{ selectedParcours.formations.length }} ({{ getFormationsObligatoires(selectedParcours.formations).length }} oblig.)</span></div>
            <div class="wz-recap-row"><span class="wz-rl">Inscrits</span><span class="wz-rv">{{ selectedParcours.users.length }}</span></div>
            <div class="wz-recap-row"><span class="wz-rl">Statut</span>
              <span class="wz-rv">
                <span class="ac-status" [attr.data-s]="selectedParcours.actif ? 'pub' : 'draft'">
                  {{ selectedParcours.actif ? 'Actif' : 'Inactif' }}
                </span>
              </span>
            </div>
            <div class="wz-recap-row"><span class="wz-rl">Cr\xE9\xE9 le</span><span class="wz-rv">{{ formatDate(selectedParcours.created_at) }}</span></div>
          </div>

          <div class="wz-field">
            <label class="wz-label">Description</label>
            <div class="wz-desc-box">{{ selectedParcours.description }}</div>
          </div>

          <div class="wz-field" *ngIf="selectedParcours.objectifs.length > 0">
            <label class="wz-label">Objectifs ({{ selectedParcours.objectifs.length }})</label>
            <div class="wz-list">
              <div class="wz-list-item" *ngFor="let obj of selectedParcours.objectifs">
                <i class="isax isax-tick-circle" style="color:#0f6e56;"></i>{{ obj }}
              </div>
            </div>
          </div>

          <div class="wz-field" *ngIf="selectedParcours.prerequis.length > 0">
            <label class="wz-label">Pr\xE9requis ({{ selectedParcours.prerequis.length }})</label>
            <div class="wz-list">
              <div class="wz-list-item" *ngFor="let pre of selectedParcours.prerequis">
                <i class="isax isax-info-circle" style="color:#185fa5;"></i>{{ pre }}
              </div>
            </div>
          </div>

          <div *ngIf="selectedParcours.formations.length > 0">
            <div class="wz-section-label">Formations du parcours ({{ selectedParcours.formations.length }})</div>
            <div class="ac-card-grid" style="grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:8px;">
              <div *ngFor="let f of selectedParcours.formations; trackBy: trackByFormationId"
                   class="ac-fcard" style="min-height:auto;">
                <div class="ac-fcard__body" style="padding:10px 12px;">
                  <div class="ac-fcard__cat" data-cat="default">
                    {{ f.pivot?.ordre ? '\xC9tape ' + f.pivot?.ordre : '\u2014' }}
                    <span *ngIf="f.pivot?.obligatoire" style="margin-left:4px;color:#e78a0e;">\u2605</span>
                  </div>
                  <div class="ac-fcard__title" style="font-size:12px;">{{ f.titre }}</div>
                  <div class="ac-fcard__meta">
                    <span><i class="isax isax-clock"></i> {{ f.duree_totale }}h</span>
                    <span class="ac-status" style="font-size:9px;" [attr.data-s]="f.est_publie ? 'pub' : 'draft'">
        ...
        <div class="wz-foot">
          <button type="button" class="wz-btn-ghost" data-bs-dismiss="modal">Fermer</button>
          <button type="button" class="wz-btn-primary" (click)="editParcours(selectedParcours!)" data-bs-dismiss="modal">
...
<div class="modal fade" id="deleteModal" tabindex="-1">
  <div class="modal-dialog" style="max-width:420px;">
    <div class="wz-modal modal-content">
      <div class="wz-head">
        <div class="wz-head__icon" style="background:#FAEEDA;color:#BA7517;"><i class="isax isax-archive"></i></div>
        <div class="wz-head__text">
          <div class="wz-head__title">Archiver le parcours</div>
          <div class="wz-head__sub" *ngIf="selectedParcours">{{ selectedParcours.nom }}</div>
        </div>
        <button type="button" class="wz-close" data-bs-dismiss="modal"><i class="isax isax-close-circle"></i></button>
      </div>
      <div class="wz-body">
        <div class="wz-info-banner" style="background:#fef2f2;border-color:#fca5a5;color:#7f1d1d;">
          <i class="isax isax-warning-2" style="color:#dc2626;"></i>
          <span>Le parcours sera archiv\xE9 et masqu\xE9. Les inscriptions associ\xE9es seront conserv\xE9es.</span>
        </div>
      </div>
      <div class="wz-foot">
        <span class="wz-foot__info"></span>
        <button type="button" class="wz-btn-ghost" data-bs-dismiss="modal">Annuler</button>
        <button type="button" class="wz-btn-arch" (click)="archiveParcours(selectedParcours)">
...
//# sourceMappingURL=chunk-NQP7HUKE.js.map
