...
// src/app/features/adminrh/adminrh-quiz-details/adminrh-quiz-details.component.ts
var AdminrhQuizDetailsComponent = class _AdminrhQuizDetailsComponent {
  routes = routes;
  static \u0275fac = function AdminrhQuizDetailsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminrhQuizDetailsComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminrhQuizDetailsComponent, selectors: [["app-adminrh-quiz-details"]], decls: 134, vars: 1, consts: [[1, "page-content"], [1, "container"], [1, "row"], [1, "col-xl-9", "col-lg-9"], [1, "quiz-details"], [1, "back-link", 3, "routerLink"], [1, "bx", "bx-left-arrow-alt"], [1, "table-quiz"], [1, "table-responsive", "custom-table"], [1, "table", "table-nowrap", "mb-0"], [1, "quiz-table"], [1, "bx", "bx-info-circle"], [1, "resut-badge", "badge-light-danger"], [1, "quiz-overview"], [1, "bx", "bxs-adjust"], ["href", "javascript:void(0);", "data-bs-toggle", "tooltip", "data-bs-placement", "top", "data-bs-original-title", "True / False"], [1, "bx", "bxs-info-circle"], [1, "resut-badge", "badge-light-success"]], template: function AdminrhQuizDetailsComponent_Template(rf, ctx) {
    if (rf & 1) {
