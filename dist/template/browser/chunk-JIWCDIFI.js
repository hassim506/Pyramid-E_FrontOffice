...
function UserAddComponent_div_0_div_67_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, UserAddComponent_div_0_div_67_span_3_Template, 2, 0, "span", 41);
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "input", 42);
    \u0275\u0275template(5, UserAddComponent_div_0_div_67_div_5_Template, 3, 0, "div", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
...
function UserAddComponent_div_0_div_68_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, UserAddComponent_div_0_div_68_span_3_Template, 2, 0, "span", 41);
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "input", 43);
    \u0275\u0275template(5, UserAddComponent_div_0_div_68_div_5_Template, 3, 0, "div", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ((tmp_4_0 = ctx_r1.userForm.get("password_confirmation")) == null ? null : tmp_4_0.invalid) && ((tmp_4_0 = ctx_r1.userForm.get("password_confirmation")) == null ? null : tmp_4_0.touched));
  }
}
...
function UserAddComponent_div_0_i_75_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 45);
  }
}
function UserAddComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(66, UserAddComponent_div_0_div_66_Template, 4, 5, "div", 28)(67, UserAddComponent_div_0_div_67_Template, 6, 3, "div", 29)(68, UserAddComponent_div_0_div_68_Template, 6, 3, "div", 29);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(69, "div", 30)(70, "button", 31);
    \u0275\u0275listener("click", function UserAddComponent_div_0_Template_button_click_70_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.hideDialog());
    });
    ...
    \u0275\u0275template(74, UserAddComponent_div_0_span_74_Template, 1, 0, "span", 34)(75, UserAddComponent_div_0_i_75_Template, 1, 0, "i", 35);
    \u0275\u0275text(76);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
  ...
  saveUser() {
    ...
    if (this.isEditMode && this.userData) {
      ...
      this.userService.updateUser(this.userData.id, formData).subscribe({
        ...
        error: (error) => {
          const msg = error.error?.errors ? Object.values(error.error.errors).flat().join("\n") : error.error?.message || "Erreur lors de la mise \xE0 jour";
          alert(msg);
          this.loading = false;
        }
      });
      ...
      this.userService.createUser(formData).subscribe({
        ...
        error: (error) => {
          const msg = error.error?.errors ? Object.values(error.error.errors).flat().join("\n") : error.error?.message || "Erreur lors de la cr\xE9ation";
          alert(msg);
          this.loading = false;
        }
      });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserAddComponent, { className: "UserAddComponent", filePath: "app/features/superadmin/user-add/user-add.component.ts", lineNumber: 16 });
})();

export {
  UserAddComponent
};
//# sourceMappingURL=chunk-JIWCDIFI.js.map
