...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SuperadminPlansComponent, [{
    type: Component,
    args: [{ selector: "app-superadmin-plans", imports: [CommonModule, MatTableModule, MatSortModule, MatPaginatorModule, MatSelectModule, CustomPaginationComponent, BsDatepickerModule], template: `<div class="row">
    <div class="col-xl-5">
      <div class="card mb-3">
      <div class="card-body">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminPlansComponent, { className: "SuperadminPlansComponent", filePath: "src/app/features/superadmin/settings/superadmin-plans/superadmin-plans.component.ts", lineNumber: 21 });
})();
export {
  SuperadminPlansComponent
};
//# sourceMappingURL=chunk-OIS4SJO4.js.map
