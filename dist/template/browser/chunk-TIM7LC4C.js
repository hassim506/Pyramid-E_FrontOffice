...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(StudentMessageComponent, [{
    type: Component,
    args: [{ selector: "app-student-message", imports: [CommonModule, RouterLink], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StudentMessageComponent, { className: "StudentMessageComponent", filePath: "src/app/features/student/student-message/student-message.component.ts", lineNumber: 12 });
})();
export {
  StudentMessageComponent
};
//# sourceMappingURL=chunk-TIM7LC4C.js.map
