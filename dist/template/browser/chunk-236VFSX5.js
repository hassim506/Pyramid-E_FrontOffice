...
} from "./chunk-2F5I5O6R.js";
import {
  UserAddComponent
} from "./chunk-ARTMY6WJ.js";
...
function UserListComponent_ng_container_14_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, UserListComponent_ng_container_14_div_10_div_3_Template, 2, 3, "div", 37);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function UserListComponent_ng_container_14_div_29_Template(rf, ctx) {
  if (rf & 1) {
...
function UserListComponent_ng_container_14_div_30_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 42);
  }
}
function UserListComponent_ng_container_14_div_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UserListComponent_ng_container_14_div_30_div_1_Template, 1, 0, "div", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function UserListComponent_ng_container_14_table_31_tr_18_button_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 65);
    \u0275\u0275listener("click", function UserListComponent_ng_container_14_table_31_tr_18_button_30_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
...
function UserListComponent_ng_container_14_table_31_tr_18_button_31_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 67);
    \u0275\u0275listener("click", function UserListComponent_ng_container_14_table_31_tr_18_button_31_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const u_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function UserListComponent_ng_container_14_table_31_tr_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "div", 51)(3, "div", 52);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "td")(14, "span", 56);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "td")(17, "span", 57);
    \u0275\u0275element(18, "i");
    \u0275\u0275text(19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "td")(21, "span", 58);
    \u0275\u0275element(22, "i");
    \u0275\u0275text(23);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(25);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "td")(27, "div", 60)(28, "button", 61);
    \u0275\u0275listener("click", function UserListComponent_ng_container_14_table_31_tr_18_Template_button_click_28_listener() {
    ...
    \u0275\u0275element(29, "i", 62);
    \u0275\u0275elementEnd();
    \u0275\u0275template(30, UserListComponent_ng_container_14_table_31_tr_18_button_30_Template, 2, 0, "button", 63)(31, UserListComponent_ng_container_14_table_31_tr_18_button_31_Template, 2, 0, "button", 64);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(u_r8.matricule || "\u2014");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(u_r8.direction || "\u2014");
    \u0275\u0275advance(2);
    \u0275\u0275attribute("data-role", ctx_r1.getRoleKey(ctx_r1.getRoleName(u_r8)));
    \u0275\u0275advance();
...
function UserListComponent_ng_container_14_table_31_tr_19_Template(rf, ctx) {
  if (rf & 1) {
...
function UserListComponent_ng_container_14_table_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "table", 43)(1, "thead")(2, "tr")(3, "th", 44);
    \u0275\u0275text(4, "Utilisateur");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "th", 45);
    \u0275\u0275text(6, "Matricule");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "th", 46);
    \u0275\u0275text(8, "Direction");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "th", 46);
    \u0275\u0275text(10, "R\xF4le");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "th", 47);
    \u0275\u0275text(12, "Statut");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "th", 48);
    ...
    \u0275\u0275template(18, UserListComponent_ng_container_14_table_31_tr_18_Template, 32, 17, "tr", 50)(19, UserListComponent_ng_container_14_table_31_tr_19_Template, 4, 0, "tr", 7);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function UserListComponent_ng_container_14_div_32_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 78);
    \u0275\u0275listener("click", function UserListComponent_ng_container_14_div_32_button_6_Template_button_click_0_listener() {
...
function UserListComponent_ng_container_14_div_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 71)(1, "span", 72);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 73)(4, "button", 74);
    \u0275\u0275listener("click", function UserListComponent_ng_container_14_div_32_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275element(5, "i", 75);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, UserListComponent_ng_container_14_div_32_button_6_Template, 2, 3, "button", 76);
    \u0275\u0275elementStart(7, "button", 74);
    \u0275\u0275listener("click", function UserListComponent_ng_container_14_div_32_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage + 1));
    });
...
function UserListComponent_ng_container_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(27, "i", 29);
    \u0275\u0275text(28, " Nouvel utilisateur ");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(29, UserListComponent_ng_container_14_div_29_Template, 3, 1, "div", 30)(30, UserListComponent_ng_container_14_div_30_Template, 2, 2, "div", 31)(31, UserListComponent_ng_container_14_table_31_Template, 20, 3, "table", 32)(32, UserListComponent_ng_container_14_div_32_Template, 9, 6, "div", 33);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserListComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 80)(1, "table", 81)(2, "thead")(3, "tr")(4, "th", 82);
    \u0275\u0275text(5, "Permission");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    \u0275\u0275text(7, "Admin RH");
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "tbody")(13, "tr")(14, "td", 83);
    \u0275\u0275text(15, "Gestion des utilisateurs");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "tr")(17, "td");
    \u0275\u0275text(18, "Cr\xE9er / modifier un utilisateur");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "td")(20, "span", 84);
    \u0275\u0275text(21, "\u25D0");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "td")(23, "span", 85);
    \u0275\u0275text(24, "\u2014");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "td")(26, "span", 85);
    \u0275\u0275text(27, "\u2014");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(28, "tr")(29, "td");
    \u0275\u0275text(30, "D\xE9sactiver un compte");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "td")(32, "span", 84);
    \u0275\u0275text(33, "\u25D0");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(34, "td")(35, "span", 85);
    \u0275\u0275text(36, "\u2014");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "td")(38, "span", 85);
    \u0275\u0275text(39, "\u2014");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(40, "tr")(41, "td", 83);
    \u0275\u0275text(42, "Formations & contenus");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(43, "tr")(44, "td");
    \u0275\u0275text(45, "Cr\xE9er une formation");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "td")(47, "span", 85);
    \u0275\u0275text(48, "\u2014");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(49, "td")(50, "span", 86);
    \u0275\u0275text(51, "\u2713");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(52, "td")(53, "span", 85);
    \u0275\u0275text(54, "\u2014");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(55, "tr")(56, "td");
    \u0275\u0275text(57, "Valider une demande de formation");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "td")(59, "span", 86);
    \u0275\u0275text(60, "\u2713");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(61, "td")(62, "span", 85);
    \u0275\u0275text(63, "\u2014");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(64, "td")(65, "span", 85);
    \u0275\u0275text(66, "\u2014");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(67, "tr")(68, "td");
    \u0275\u0275text(69, "Acc\xE9der \xE0 ses formations");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "td")(71, "span", 86);
    \u0275\u0275text(72, "\u2713");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(73, "td")(74, "span", 86);
    \u0275\u0275text(75, "\u2713");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(76, "td")(77, "span", 86);
    \u0275\u0275text(78, "\u2713");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(79, "tr")(80, "td");
    \u0275\u0275text(81, "G\xE9rer les quiz");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(82, "td")(83, "span", 85);
    \u0275\u0275text(84, "\u2014");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(85, "td")(86, "span", 86);
    \u0275\u0275text(87, "\u2713");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(88, "td")(89, "span", 85);
    \u0275\u0275text(90, "\u2014");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(91, "tr")(92, "td", 83);
    \u0275\u0275text(93, "Suivi & statistiques");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(94, "tr")(95, "td");
    \u0275\u0275text(96, "Statistiques de son entreprise");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(97, "td")(98, "span", 86);
    \u0275\u0275text(99, "\u2713");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(100, "td")(101, "span", 85);
    \u0275\u0275text(102, "\u2014");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(103, "td")(104, "span", 85);
    \u0275\u0275text(105, "\u2014");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(106, "tr")(107, "td");
    \u0275\u0275text(108, "Voir sa propre progression");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(109, "td")(110, "span", 86);
    \u0275\u0275text(111, "\u2713");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(112, "td")(113, "span", 86);
    \u0275\u0275text(114, "\u2713");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(115, "td")(116, "span", 86);
    \u0275\u0275text(117, "\u2713");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(118, "tr")(119, "td");
    \u0275\u0275text(120, "T\xE9l\xE9charger un certificat");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(121, "td")(122, "span", 86);
    \u0275\u0275text(123, "\u2713");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(124, "td")(125, "span", 86);
    \u0275\u0275text(126, "\u2713");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(127, "td")(128, "span", 86);
    \u0275\u0275text(129, "\u2713");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(130, "div", 87)(131, "span")(132, "span", 86);
    \u0275\u0275text(133, "\u2713");
    \u0275\u0275elementEnd();
    \u0275\u0275text(134, " Acc\xE8s complet");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(135, "span")(136, "span", 84);
    \u0275\u0275text(137, "\u25D0");
    \u0275\u0275elementEnd();
    \u0275\u0275text(138, " Acc\xE8s limit\xE9 (son p\xE9rim\xE8tre)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(139, "span")(140, "span", 85);
    \u0275\u0275text(141, "\u2014");
    \u0275\u0275elementEnd();
...
function UserListComponent_div_17_span_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 107)(1, "strong");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function UserListComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(10, "i", 96);
    \u0275\u0275template(11, UserListComponent_div_17_span_11_Template, 4, 0, "span", 97)(12, UserListComponent_div_17_span_12_Template, 5, 2, "span", 97);
    \u0275\u0275elementStart(13, "input", 98);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(14, UserListComponent_div_17_div_14_Template, 2, 2, "div", 99);
    ...
    \u0275\u0275template(33, UserListComponent_div_17_span_33_Template, 1, 0, "span", 105)(34, UserListComponent_div_17_i_34_Template, 1, 0, "i", 106);
    \u0275\u0275text(35);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
${res.updated} mis \xE0 jour`;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserListComponent, selectors: [["app-user-list"]], hostBindings: function UserListComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(14, UserListComponent_ng_container_14_Template, 33, 15, "ng-container", 7)(15, UserListComponent_div_15_Template, 2, 0, "div", 8)(16, UserListComponent_div_16_Template, 143, 0, "div", 9);
      \u0275\u0275elementEnd();
    ...
    <table class="ul-table" *ngIf="!loading">
      <thead>
        <tr>
          ...
          <th style="width:13%">R\xF4le</th>
          <th style="width:10%">Statut</th>
          <th style="width:11%">Derni\xE8re activit\xE9</th>
      ...
      <tbody>
        <tr *ngFor="let u of tableData; trackBy: trackById">
          ...
          <td>
            <span class="ul-meta">{{ u.direction || '\u2014' }}</span>
          </td>
          <td>
    ...
    <div class="ul-import-modal__body">
      ...
      <label class="ul-dropzone" for="rh-file-input" [class.ul-dropzone--active]="!!selectedFile">
        ...
        <span class="ul-dropzone__label" *ngIf="!selectedFile">
          ...
          <small>.xlsx \xB7 .xls \xB7 .csv</small>
        </span>
        <span class="ul-dropzone__label" *ngIf="selectedFile">
        ...
        <input id="rh-file-input" type="file" accept=".xlsx,.xls,.csv"
               (change)="onFileSelected($event)" [disabled]="isImporting" style="display:none">
      </label>
      ...
      <div class="ul-import-info">
        ...
        <ul>
          <li>T\xE9l\xE9chargez d'abord le <strong>template</strong> pour voir la structure requise</li>
          <li>Colonnes obligatoires : <strong>nom, prenom, email, role_id</strong></li>
          <li>Les utilisateurs avec le m\xEAme email seront mis \xE0 jour automatiquement</li>
        </ul>
      </div>
    </div>

    <div class="ul-import-modal__foot">
      <button type="button" class="ul-import-modal__cancel" (click)="closeImportDialog()" [disabled]="isImporting">
        Annuler
      </button>
      <button type="button" class="ul-import-modal__submit"
...
//# sourceMappingURL=chunk-236VFSX5.js.map
