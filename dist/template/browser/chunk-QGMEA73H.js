...
var InstructorStatementsComponent = class _InstructorStatementsComponent {
  ...
  types = [
    ...
    { key: "difficulte", icon: "isax-danger", color: "red", label: "En difficult\xE9", sub: "Apprenants \xE0 risque" },
  ...
  destinataire = "";
  schedules = [
    { label: "R\xE9sum\xE9 hebdomadaire apprenants", sub: "Chaque vendredi \xB7 progression + alertes difficult\xE9", on: true },
    { label: "Rapport apr\xE8s chaque session", sub: "Pr\xE9sences, dur\xE9es, questions pos\xE9es", on: true },
    { label: "Alerte quiz en \xE9chec", sub: "Si un apprenant \xE9choue 2x au m\xEAme quiz", on: false }
  ];
  // Preview
  completion = 0;
  certifies = 0;
  ...
  insights = [
    ...
    { color: "#854F0B", text: "Certains apprenants n'ont pas eu d'activit\xE9 depuis plus de 7 jours. Un email de relance peut \xEAtre d\xE9clench\xE9." }
  ];
  recents = [
    { nom: "Rapport apprenants T1 2025", meta: "Toutes formations \xB7 PDF", format: "pdf", date: "15 jan." },
    { nom: "Scores quiz d\xE9c. 2024", meta: "Excel \xB7 d\xE9tail par question", format: "excel", date: "1 jan." },
    { nom: "Pr\xE9sences sessions nov. 2024", meta: "CSV \xB7 183 apprenants", format: "csv", date: "1 d\xE9c." }
  ];
  rawFormations = [];
  rawCerts = [];
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InstructorStatementsComponent, selectors: [["app-instructor-statements"]], decls: 138, vars: 12, consts: [[1, "rp-header"], [1, "rp-header__icon", "rp-header__icon--blue"], [1, "isax", "isax-receipt-item"], [1, "rp-header__info"], [1, "rp-header__title"], [1, "rp-header__sub"], [1, "rp-header__acts"], ["type", "button", 1, "rp-btn", "rp-btn--ghost"], [1, "isax", "isax-clock"], ["type", "button", 1, "rp-btn", "rp-btn--blue", 3, "click", "disabled"], [1, "spinner-border", "spinner-border-sm", "me-1"], [1, "isax", "isax-document-upload"], [1, "rp-toast", "rp-toast--blue"], [1, "rp-layout"], [1, "rp-layout__left"], [1, "rp-card"], [1, "rp-card__head"], [1, "isax", "isax-grid-2"], [1, "rp-card__title"], [1, "rp-type-grid"], [1, "rp-type-card", 3, "selected-blue"], [1, "isax", "isax-filter"], [1, "rp-filters"], [1, "rp-flt-row", "rp-flt-row--3"], [1, "rp-field"], [1, "rp-label"], [1, "rp-select", 3, "ngModelChange", "ngModel"], ["value", "mois"], ["value", "trimestre"], ["value", "duree"], ["value", "custom"], ["value", "toutes"], [3, "value"], ["value", "pdf"], ["value", "excel"], ["value", "csv"], [1, "rp-flt-row", "rp-flt-row--2"], ["value", "tous"], ["value", "actifs"], ["value", "difficulte"], ["type", "text", "placeholder", "Email(s) s\xE9par\xE9s par virgule", 1, "rp-input", 3, "ngModelChange", "ngModel"], [1, "rp-schedules"], [1, "rp-sched-row"], [1, "rp-layout__right"], [1, "isax", "isax-eye"], [1, "rp-badge", "rp-badge--blue"], [1, "rp-preview"], [1, "rp-preview__loading"], [1, "isax", "isax-lamp-on"], [1, "rp-insights"], [1, "rp-insight"], [1, "isax", "isax-clock-1"], [1, "rp-hist-list"], [1, "rp-hist-item"], [1, "isax", "isax-document-download"], [1, "rp-export-grid"], ["type", "button", 1, "rp-exp-btn", 3, "click"], [1, "isax", "isax-document", "rp-exp-icon", "rp-exp-icon--pdf"], [1, "rp-exp-label"], [1, "rp-exp-sub"], [1, "isax", "isax-document-text", "rp-exp-icon", "rp-exp-icon--excel"], [1, "isax", "isax-clipboard-text", "rp-exp-icon", "rp-exp-icon--csv"], [1, "isax", "isax-tick-circle"], [1, "rp-type-card", 3, "click"], [1, "rp-type-body"], [1, "rp-type-name"], [1, "rp-type-sub"], [1, "rp-sched-info"], [1, "rp-sched-label"], [1, "rp-sched-sub"], ["type", "button", 1, "rp-toggle", "rp-toggle--blue", 3, "click"], [1, "rp-toggle__thumb"], [1, "spinner-border", "spinner-border-sm", "text-secondary"], [1, "rp-preview__title"], [1, "rp-kpi-row"], [1, "rp-kpi"], [1, "rp-kpi__val"], [1, "rp-kpi__lbl"], [1, "rp-preview__section"], [1, "rp-preview__section-title"], [1, "isax", "isax-award"], [1, "rp-bar-row"], [1, "rp-bar-label", 3, "title"], [1, "rp-bar-track"], [1, "rp-bar-fill"], [1, "rp-bar-pct"], [1, "rp-insight__dot"], [1, "rp-insight__text"], [1, "rp-hist-info"], [1, "rp-hist-name"], [1, "rp-hist-meta"], [1, "rp-hist-date"], ["type", "button", "title", "T\xE9l\xE9charger", 1, "rp-hist-dl", 3, "click"]], template: function InstructorStatementsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(7, "Suivi apprenants, scores quiz et compl\xE9tion \xB7 donn\xE9es en temps r\xE9el");
      \u0275\u0275elementEnd()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorStatementsComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-statements", imports: [CommonModule, FormsModule], template: `<!-- \u2500\u2500 PAGE HEADER \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
<div class="rp-header">
  <div class="rp-header__icon rp-header__icon--blue">
    <i class="isax isax-receipt-item"></i>
  </div>
  <div class="rp-header__info">
    <div class="rp-header__title">Rapports p\xE9dagogiques \u2014 {{ getDisplayName() }}</div>
    <div class="rp-header__sub">Suivi apprenants, scores quiz et compl\xE9tion \xB7 donn\xE9es en temps r\xE9el</div>
  </div>
  <div class="rp-header__acts">
    <button type="button" class="rp-btn rp-btn--ghost">
      <i class="isax isax-clock"></i> Historique
    </button>
    <button type="button" class="rp-btn rp-btn--blue" (click)="generate()" [disabled]="generating">
...
@if (successMsg) {
  <div class="rp-toast rp-toast--blue">
  ...
  <div class="rp-layout__left">
      ...
      <div class="rp-type-grid">
        @for (t of types; track t.key) {
          <div class="rp-type-card"
               [class.selected-blue]="selectedType === t.key"
    ...
    <div class="rp-card">
      ...
      <div class="rp-filters">
        <div class="rp-flt-row rp-flt-row--3">
          <div class="rp-field">
            ...
            <select class="rp-select" [(ngModel)]="periode">
              ...
              <option value="duree">Toute la dur\xE9e</option>
              <option value="custom">Personnalis\xE9e</option>
            </select>
          </div>
          <div class="rp-field">
            <label class="rp-label">Formation</label>
            <select class="rp-select" [(ngModel)]="formation">
              <option value="toutes">Toutes</option>
              @for (f of formations; track f.id) {
                <option [value]="f.id">{{ f.titre || f.title }}</option>
              }
            </select>
          </div>
          <div class="rp-field">
        ...
        <div class="rp-flt-row rp-flt-row--2">
          <div class="rp-field">
            <label class="rp-label">Apprenants</label>
            <select class="rp-select" [(ngModel)]="apprenants">
              <option value="tous">Tous</option>
              <option value="actifs">Actifs uniquement</option>
              <option value="difficulte">En difficult\xE9</option>
            </select>
          </div>
          <div class="rp-field">
            <label class="rp-label">Destinataire(s)</label>
            <input class="rp-input" type="text" placeholder="Email(s) s\xE9par\xE9s par virgule" [(ngModel)]="destinataire">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="rp-schedules">
        @for (s of schedules; track s.label) {
          <div class="rp-sched-row">
            ...
            <button type="button" class="rp-toggle rp-toggle--blue" [class.on]="s.on" (click)="s.on = !s.on">
  ...
  <div class="rp-layout__right">
    ...
    <div class="rp-card">
      <div class="rp-card__head">
        ...
        <span class="rp-badge rp-badge--blue">{{ periodeLabel }}</span>
      </div>
      <div class="rp-preview">
        @if (loading) {
          ...
          <div class="rp-preview__title">Performance p\xE9dagogique</div>
          <!-- KPIs -->
          <div class="rp-kpi-row">
            <div class="rp-kpi">
              <div class="rp-kpi__val">{{ completion }}%</div>
              <div class="rp-kpi__lbl">Compl\xE9tion</div>
            </div>
            <div class="rp-kpi">
              <div class="rp-kpi__val">{{ certifies }}</div>
              <div class="rp-kpi__lbl">Certifi\xE9s</div>
            </div>
            <div class="rp-kpi">
              <div class="rp-kpi__val">{{ difficulte }}</div>
              <div class="rp-kpi__lbl">En difficult\xE9</div>
            </div>
          </div>
          <!-- Quiz par formation -->
          @if (quizBars.length) {
            <div class="rp-preview__section">
              <div class="rp-preview__section-title">
                <i class="isax isax-award"></i> Scores quiz par formation
              </div>
              @for (q of quizBars; track q.label) {
                <div class="rp-bar-row">
                  <span class="rp-bar-label" [title]="q.label">{{ q.label }}</span>
                  <div class="rp-bar-track">
                    <div class="rp-bar-fill"
                         [class.rp-bar-fill--blue]="q.pct >= 60"
                         [class.rp-bar-fill--ko]="q.pct < 60"
                         [style.width.%]="q.pct"></div>
                  </div>
                  <span class="rp-bar-pct">{{ q.pct }}%</span>
                </div>
              }
            </div>
          }
    ...
    <div class="rp-card">
      <div class="rp-card__head">
        ...
        <span class="rp-card__title">Insights p\xE9dagogiques</span>
      </div>
      <div class="rp-insights">
        @for (ins of insights; track ins.text) {
          <div class="rp-insight">
            <div class="rp-insight__dot" [style.background]="ins.color"></div>
            <div class="rp-insight__text">{{ ins.text }}</div>
          </div>
        }
      </div>
    </div>
...
//# sourceMappingURL=chunk-QGMEA73H.js.map
