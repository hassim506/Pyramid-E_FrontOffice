...
// src/app/features/superadmin/settings/superadmin-social-profiles/superadmin-social-profiles.component.ts
var SuperadminSocialProfilesComponent = class _SuperadminSocialProfilesComponent {
  static \u0275fac = function SuperadminSocialProfilesComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SuperadminSocialProfilesComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SuperadminSocialProfilesComponent, selectors: [["app-superadmin-social-profiles"]], decls: 41, vars: 0, consts: [[1, "card"], [1, "card-body"], [1, "mb-3"], [1, "form-label"], [1, "position-relative", "input-icon-start"], ["type", "text", "placeholder", "https://www.twitter.com/", 1, "form-control"], [1, "social-icon"], [1, "fa-brands", "fa-x-twitter", "fs-14"], ["type", "text", "placeholder", "https://www.facebook.com/", 1, "form-control"], [1, "fa-brands", "fa-square-facebook", "fs-14"], ["type", "text", "placeholder", "https://www.instagram.com/", 1, "form-control"], [1, "fa-brands", "fa-instagram", "fs-14"], ["type", "text", "placeholder", "https://www.linkedin.com/", 1, "form-control"], [1, "fa-brands", "fa-linkedin-in", "fs-14"], ["type", "text", "placeholder", "https://www.youtube.com/", 1, "form-control"], [1, "fa-brands", "fa-youtube", "fs-14"], [1, "mt-4"], ["type", "submit", 1, "btn", "btn-secondary"]], template: function SuperadminSocialProfilesComponent_Template(rf, ctx) {
    if (rf & 1) {
