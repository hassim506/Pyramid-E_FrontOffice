...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhQuizResultsComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-quiz-results", imports: [CommonModule, FormsModule], template: `<!-- Loading -->\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhQuizResultsComponent, { className: "AdminrhQuizResultsComponent", filePath: "app/features/adminrh/adminrh-quiz-results/adminrh-quiz-results.component.ts", lineNumber: 12 });
})();
export {
  AdminrhQuizResultsComponent
};
//# sourceMappingURL=chunk-3KBITXDI.js.map
