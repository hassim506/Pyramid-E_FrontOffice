...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhPayoutsComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-payouts", imports: [CommonModule, MatTableModule, MatSortModule, FormsModule, MatPaginatorModule, MatSelectModule, BsDatepickerModule, CustomPaginationComponent], template: `
    <div class="payouts">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhPayoutsComponent, { className: "AdminrhPayoutsComponent", filePath: "src/app/features/adminrh/adminrh-payouts/adminrh-payouts.component.ts", lineNumber: 23 });
})();
export {
  AdminrhPayoutsComponent
};
//# sourceMappingURL=chunk-RVK3NQOT.js.map
