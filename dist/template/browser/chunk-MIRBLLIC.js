...
// src/app/features/superadmin/settings/superadmin-integrations/superadmin-integrations.component.ts
var SuperadminIntegrationsComponent = class _SuperadminIntegrationsComponent {
  static \u0275fac = function SuperadminIntegrationsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SuperadminIntegrationsComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SuperadminIntegrationsComponent, selectors: [["app-superadmin-integrations"]], decls: 58, vars: 0, consts: [[1, "card"], [1, "card-body"], [1, "d-flex", "align-items-center", "justify-content-between", "border", "mb-3", "p-3", "rounded-3"], [1, "meet-icon", "me-3", "flex-shrink-0"], ["src", "./assets/img/icons/meet-icon-1.svg", "alt", "img"], [1, "d-flex", "align-items-center", "justify-content-between", "w-100"], [1, "mb-1"], [1, "small"], [1, "form-check", "form-switch", "form-check-md", "mb-0"], ["type", "checkbox", "id", "checkZoom", "checked", "", 1, "form-check-input"], [1, "row"], [1, "col-md-6"], [1, "mb-3"], [1, "form-label"], [1, "text-danger"], ["type", "text", "value", "", 1, "form-control"], [1, "mb-4", "mt-1"], ["src", "./assets/img/icons/meet-icon-2.svg", "alt", "img"], ["type", "checkbox", "id", "checkGoogle", "checked", "", 1, "form-check-input"], ["href", "javascript:void(0);", 1, "btn", "btn-secondary"]], template: function SuperadminIntegrationsComponent_Template(rf, ctx) {
    if (rf & 1) {
