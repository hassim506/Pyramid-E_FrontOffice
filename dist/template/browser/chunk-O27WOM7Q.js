...
// src/app/features/student/catalogue-detail/catalogue-detail.component.ts
...
function CatalogueDetailComponent_ng_container_2_div_51_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CatalogueDetailComponent_ng_container_2_div_51_div_1_Template_button_click_32_listener($event) {
      const f_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(25, 63, +f_r7.progression, "1.0-0"), "% ");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance();
    \u0275\u0275classProp("pad-formation-card__start-btn--resume", f_r7.statut_formation === "en_cours" && !ctx_r1.estExpire)("pad-formation-card__start-btn--done", f_r7.statut_formation === "termine" && !ctx_r1.estExpire)("pad-formation-card__start-btn--expire", ctx_r1.estExpire);
    \u0275\u0275property("disabled", ctx_r1.estExpire)("title", ctx_r1.estExpire ? "Acc\xE8s expir\xE9 \u2014 contactez votre RH" : "");
    \u0275\u0275advance();
    \u0275\u0275classProp("isax-lock", ctx_r1.estExpire)("isax-play", !ctx_r1.estExpire && f_r7.statut_formation === "non_commence")("isax-refresh", !ctx_r1.estExpire && f_r7.statut_formation === "en_cours")("isax-eye", !ctx_r1.estExpire && f_r7.statut_formation === "termine");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.estExpire ? "Verrouill\xE9" : f_r7.statut_formation === "termine" ? "Revoir" : f_r7.statut_formation === "en_cours" ? "Reprendre" : "Commencer", " ");
  }
}
function CatalogueDetailComponent_ng_container_2_div_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 90);
    \u0275\u0275template(1, CatalogueDetailComponent_ng_container_2_div_51_div_1_Template, 35, 66, "div", 91);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function CatalogueDetailComponent_ng_container_2_div_53_button_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CatalogueDetailComponent_ng_container_2_div_53_button_6_Template_button_click_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.changePage(p_r11));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("cd-pagination__btn--active", ctx_r1.currentPage === p_r11);
    \u0275\u0275advance();
...
function CatalogueDetailComponent_ng_container_2_div_53_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 129)(4, "button", 130);
    ...
    \u0275\u0275element(5, "i", 131);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, CatalogueDetailComponent_ng_container_2_div_53_button_6_Template, 2, 3, "button", 132);
...
var CatalogueDetailComponent = class _CatalogueDetailComponent {
  ...
  ngOnInit() {
    ...
    console.log(`\u{1F680} [CatalogueDetail] ngOnInit \u2192 catalogueId=${this.catalogueId}`);
    if (!this.catalogueId) {
    ...
    this.progressionSub = this.progressionService.change$.subscribe((map) => {
      console.log(`\u{1F514} [CatalogueDetail #${this.catalogueId}] ProgressionService.change$ \xE9mis | map.size=${map.size}`);
      const relevantKeys = [...map.keys()].filter((k) => k.includes(`_null_${this.catalogueId}`));
      console.log(`\u{1F50D} [CatalogueDetail #${this.catalogueId}] Cl\xE9s pertinentes dans le cache:`, relevantKeys);
    ...
    this.routerSub = this.router.events.pipe(filter((e) => e instanceof NavigationEnd)).subscribe((e) => {
      ...
      console.log(`\u{1F9ED} [CatalogueDetail #${this.catalogueId}] NavigationEnd \u2192 ${url}`);
      if (url.includes(`/catalogue-detail/${this.catalogueId}`)) {
        console.log(`\u{1F504} [CatalogueDetail #${this.catalogueId}] Retour sur la page \u2192 refreshProgressions()`);
  ...
  loadCatalogueDetail() {
    this.loading = true;
    console.log(`\u{1F4E1} [CatalogueDetail #${this.catalogueId}] loadCatalogueDetail() \u2192 getMesCataloguesAssignes()`);
    this.formationsService.getMesCataloguesAssignes().subscribe({
      next: (res) => {
        const all = res.catalogues ?? [];
        const meta = all.find((c) => c.id === this.catalogueId);
        console.log(`\u2705 [CatalogueDetail #${this.catalogueId}] Meta catalogue trouv\xE9:`, meta);
        this.source = meta?.source ?? "assigne";
        this.badgeLabel = meta?.badge_label ?? "Assign\xE9";
        this.dateExpiration = meta?.date_expiration ?? null;
        console.log(`\u{1F4CB} [CatalogueDetail #${this.catalogueId}] source=${this.source} | dateExpiration=${this.dateExpiration}`);
        this.loadFormations();
      },
      error: (err) => {
  ...
  loadFormations() {
    console.log(`\u{1F4E1} [CatalogueDetail #${this.catalogueId}] loadFormations() \u2192 getCatalogueProgression()`);
    this.formationsService.getCatalogueProgression(this.catalogueId).subscribe({
      next: (res) => {
        console.log(`\u2705 [CatalogueDetail #${this.catalogueId}] getCatalogueProgression r\xE9ponse:`, res);
        console.log(`\u{1F4CA} [CatalogueDetail #${this.catalogueId}] progression_globale=${res.progression_globale} | formations_terminees=${res.formations_terminees} | total=${res.total_formations}`);
        if (res.formations?.length) {
          console.log(`\u{1F50D} [CatalogueDetail #${this.catalogueId}] Formations re\xE7ues (${res.formations.length}):`, res.formations.map((f) => ({
            id: f.id,
            titre: f.titre,
            progression: f.progression,
            statut: f.statut_formation
          })));
        }
        ...
        this.formationsService.getCatalogueDetail(this.catalogueId).subscribe({
          next: (r) => {
            console.log(`\u2705 [CatalogueDetail #${this.catalogueId}] getCatalogueDetail r\xE9ponse:`, r?.catalogue);
      ...
      error: (err) => {
        console.warn(`\u26A0\uFE0F [CatalogueDetail #${this.catalogueId}] getCatalogueProgression \xE9chec, fallback getCatalogueDetail:`, err);
        this.formationsService.getCatalogueDetail(this.catalogueId).subscribe({
          next: (r) => {
            console.log(`\u2705 [CatalogueDetail #${this.catalogueId}] Fallback getCatalogueDetail r\xE9ponse:`, r);
            this.catalogue = r.catalogue;
  ...
  refreshProgressions() {
    console.log(`\u{1F504} [CatalogueDetail #${this.catalogueId}] refreshProgressions() \u2192 appel API...`);
    this.formationsService.getCatalogueProgression(this.catalogueId).subscribe({
      next: (res) => {
        console.log(`\u2705 [CatalogueDetail #${this.catalogueId}] refreshProgressions r\xE9ponse:`, {
          ...
          formations: res.formations?.map((f) => ({ id: f.id, progression: f.progression, statut: f.statut_formation }))
        });
        this.formations = res.formations ?? [];
        this.progressionGlobale = res.progression_globale ?? 0;
        this.totalFormations = res.total_formations ?? 0;
  ...
  _syncFormationsDepuisService() {
    ...
    console.log(`\u{1F9EE} [CatalogueDetail #${this.catalogueId}] _syncFormationsDepuisService \u2014 d\xE9but sync pour ${this.formations.length} formations`);
    let terminees = 0;
    ...
    this.formations = this.formations.map((f) => {
      ...
      console.log(`  \u{1F4E6} [Formation #${f.id} "${f.titre}"] getPercent(${f.id}, null, ${this.catalogueId})=${percentService}% | API=${f.progression}% | final=${progression}% | statut=${statut}`);
      if (statut === "termine")
        terminees++;
    ...
    console.log(`\u{1F4C8} [CatalogueDetail #${this.catalogueId}] Progression globale: somme=${sommeProgressions} / ${total} = ${progressionMoyenne}% | API=${this.progressionGlobale}% | final=${Math.max(this.progressionGlobale, progressionMoyenne)}%`);
    ...
    console.log(`\u2705 [CatalogueDetail #${this.catalogueId}] Apr\xE8s sync: progressionGlobale=${this.progressionGlobale}% | formationsTerminees=${this.formationsTerminees}/${total}`);
    this._applySearchAndPaginate();
  }
  ...
  commencerFormation(formationId, event) {
    ...
    if (this.estExpire)
      return;
    console.log(`\u{1F680} [CatalogueDetail #${this.catalogueId}] commencerFormation \u2192 formationId=${formationId} | state: { fromPage: 'catalogue', catalogueId: ${this.catalogueId} }`);
...
\r
              ...
              <button class="pad-formation-card__start-btn"\r
                ...
                {{ estExpire ? 'Verrouill\xE9' : (f.statut_formation === 'termine' ? 'Revoir' : f.statut_formation === 'en_cours' ? 'Reprendre' : 'Commencer') }}\r
              </button>\r
\r
            </div>\r
\r
