...
var InstructorChangePasswordComponent = class _InstructorChangePasswordComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InstructorChangePasswordComponent, selectors: [["app-instructor-change-password"]], decls: 65, vars: 24, consts: [[1, "card", "mb-0"], [1, "card-body"], [1, "border-bottom", "mb-4", "pb-4"], [1, "row"], [1, "col-md-8"], [1, "mb-3"], [1, "mb-1", "fs-18"], ["href", "javascript:void(0);", 1, "text-decoration-underline"], [1, "mb-3", "position-relative"], [1, "form-label"], [1, "text-danger"], [1, "position-relative"], [1, "pass-inputs", "form-control", 3, "type"], ["tabindex", "0", 1, "isax", "toggle-password", 3, "click", "keydown.enter", "ngClass"], ["id", "passwordInput", 1, "pass-group"], [1, "pass-group", "mb-3"], ["id", "password", 1, "pass-input", "form-control", "form-control-lg", 3, "input", "type"], ["tabindex", "0", 1, "isax", "toggle-password", "fs-14", 3, "click", "keydown.enter", "ngClass"], ["id", "passwordStrength", 1, "strength-meter", "password-strength", 3, "ngClass"], ["id", "poor", 3, "ngClass"], ["id", "weak", 3, "ngClass"], ["id", "strong", 3, "ngClass"], ["id", "heavy", 3, "ngClass"], ["type", "submit", 1, "btn", "btn-secondary"], ["href", "javascript:void(0);", 1, "fw-semibold"], ["type", "text", 1, "form-control"]], template: function InstructorChangePasswordComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function InstructorChangePasswordComponent_Template_span_click_20_listener() {
        return ctx.togglePassword(1);
      })("keydown.enter", function InstructorChangePasswordComponent_Template_span_keydown_enter_20_listener() {
        return ctx.togglePassword(1);
      });
      \u0275\u0275elementEnd()()();
      ...
      \u0275\u0275listener("input", function InstructorChangePasswordComponent_Template_input_input_28_listener($event) {
        return ctx.checkPasswordStrength($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(29, "span", 17);
      \u0275\u0275listener("click", function InstructorChangePasswordComponent_Template_span_click_29_listener() {
        return ctx.togglePassword(0);
      })("keydown.enter", function InstructorChangePasswordComponent_Template_span_keydown_enter_29_listener() {
        return ctx.togglePassword(0);
      });
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275listener("click", function InstructorChangePasswordComponent_Template_span_click_42_listener() {
        return ctx.togglePassword(2);
      })("keydown.enter", function InstructorChangePasswordComponent_Template_span_keydown_enter_42_listener() {
        return ctx.togglePassword(2);
      });
      \u0275\u0275elementEnd()()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorChangePasswordComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-change-password", imports: [CommonModule, FormsModule], template: `<div class="card mb-0">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorChangePasswordComponent, { className: "InstructorChangePasswordComponent", filePath: "app/features/instructor/settings/instructor-change-password/instructor-change-password.component.ts", lineNumber: 12 });
})();
export {
  InstructorChangePasswordComponent
};
//# sourceMappingURL=chunk-YF6PF4ZC.js.map
