...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhTicketsComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-tickets", imports: [CommonModule, FormsModule], template: `<div class="tk-page">

  <!-- HEADER -->
  <div class="tk-header">
    <div>
      <div class="tk-header__title">Tickets support</div>
      <div class="tk-header__sub">Incidents et demandes de votre entreprise</div>
    </div>
  ...
  <div class="kpi-row">
    ...
    <div class="kpi">
      ...
      <div><div class="kpi__val">{{ stats.ouvert }}</div><div class="kpi__lbl">En cours</div></div>
    </div>
    <div class="kpi">
  ...
  <div class="tk-form-card" *ngIf="showCreateForm">
    <div class="tk-form-card__title">Cr\xE9er un nouveau ticket</div>
    <div class="tk-form-err" *ngIf="submitError">{{ submitError }}</div>

    <div class="form-row">
      <div class="form-group full">
        <label class="form-label">Sujet <span class="req">*</span></label>
        <input type="text" class="form-input" placeholder="R\xE9sumez votre probl\xE8me\u2026"
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <select class="form-select" [(ngModel)]="newTicket.categorie">
          ...
          <option value="amelioration">Am\xE9lioration</option>
      ...
      <div class="form-group">
        ...
        <select class="form-select" [(ngModel)]="newTicket.type">
          <option value="incident">Incident</option>
          <option value="demande">Demande</option>
          <option value="question">Question</option>
          <option value="reclamation">R\xE9clamation</option>
        </select>
      </div>
    </div>
    <div class="form-row">
      <div class="form-group full">
        ...
        <textarea class="form-textarea" rows="4"
                  placeholder="D\xE9crivez le probl\xE8me en d\xE9tail\u2026"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhTicketsComponent, { className: "AdminrhTicketsComponent", filePath: "src/app/features/adminrh/adminrh-tickets/adminrh-tickets.component.ts", lineNumber: 14 });
})();
export {
  AdminrhTicketsComponent
};
//# sourceMappingURL=chunk-MP6X4DQU.js.map
