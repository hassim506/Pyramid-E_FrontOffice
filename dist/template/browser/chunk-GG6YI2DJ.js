...
var _c1 = (a0, a1) => ({ "bg-success bg-opacity-10 text-success": a0, "bg-secondary bg-opacity-10 text-secondary": a1 });
function AdminrhDemandeCatalogueComponent_div_8_div_16_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeCatalogueComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(16, AdminrhDemandeCatalogueComponent_div_8_div_16_Template, 5, 1, "div", 38);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminrhDemandeCatalogueComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminrhDemandeCatalogueComponent_div_13_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
...
function AdminrhDemandeCatalogueComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementStart(3, "button", 42);
    \u0275\u0275listener("click", function AdminrhDemandeCatalogueComponent_div_14_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.clearMessages());
    });
...
function AdminrhDemandeCatalogueComponent_option_25_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeCatalogueComponent_small_39_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeCatalogueComponent_div_40_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeCatalogueComponent_div_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 50)(1, "div", 12)(2, "div", 51);
    \u0275\u0275element(3, "i", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "h5", 53);
    \u0275\u0275text(5, "Aucune demande de catalogue");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 54);
    \u0275\u0275text(7, " Aucune demande de catalogue n'a \xE9t\xE9 soumise pour le moment. ");
    \u0275\u0275elementEnd()()();
  }
}
function AdminrhDemandeCatalogueComponent_div_42_tr_52_small_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 35);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", demande_r6.catalogue.nombre_formations || 0, " formation(s) \u2022 ", demande_r6.catalogue.type_display || demande_r6.catalogue.type || "N/A", " ");
  }
}
function AdminrhDemandeCatalogueComponent_div_42_tr_52_small_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 107);
    \u0275\u0275text(1, " Chargement... ");
    \u0275\u0275elementEnd();
  }
}
function AdminrhDemandeCatalogueComponent_div_42_tr_52_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 96)(1, "span", 108);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const demande_r6 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(2, _c1, demande_r6.catalogue == null ? null : demande_r6.catalogue.est_actif, !(demande_r6.catalogue == null ? null : demande_r6.catalogue.est_actif)));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", demande_r6.catalogue == null ? null : demande_r6.catalogue.statut, " ");
  }
}
function AdminrhDemandeCatalogueComponent_div_42_tr_52_div_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 96)(1, "small", 35);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function AdminrhDemandeCatalogueComponent_div_42_tr_52_div_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 96)(1, "small", 109);
    \u0275\u0275text(2, "RH:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "small", 110);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function AdminrhDemandeCatalogueComponent_div_42_tr_52_button_47_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 114);
  }
}
function AdminrhDemandeCatalogueComponent_div_42_tr_52_button_47_i_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 115);
  }
}
function AdminrhDemandeCatalogueComponent_div_42_tr_52_button_47_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 111);
    \u0275\u0275listener("click", function AdminrhDemandeCatalogueComponent_div_42_tr_52_button_47_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const demande_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.validerDemande(demande_r6));
    });
    \u0275\u0275template(1, AdminrhDemandeCatalogueComponent_div_42_tr_52_button_47_span_1_Template, 1, 0, "span", 112)(2, AdminrhDemandeCatalogueComponent_div_42_tr_52_button_47_i_2_Template, 1, 0, "i", 113);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const demande_r6 = \u0275\u0275nextContext().$implicit;
...
function AdminrhDemandeCatalogueComponent_div_42_tr_52_button_48_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 114);
  }
}
function AdminrhDemandeCatalogueComponent_div_42_tr_52_button_48_i_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 118);
  }
}
function AdminrhDemandeCatalogueComponent_div_42_tr_52_button_48_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 116);
    \u0275\u0275listener("click", function AdminrhDemandeCatalogueComponent_div_42_tr_52_button_48_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const demande_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.refuserDemande(demande_r6));
    });
    \u0275\u0275template(1, AdminrhDemandeCatalogueComponent_div_42_tr_52_button_48_span_1_Template, 1, 0, "span", 112)(2, AdminrhDemandeCatalogueComponent_div_42_tr_52_button_48_i_2_Template, 1, 0, "i", 117);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const demande_r6 = \u0275\u0275nextContext().$implicit;
...
function AdminrhDemandeCatalogueComponent_div_42_tr_52_button_49_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 119);
    \u0275\u0275listener("click", function AdminrhDemandeCatalogueComponent_div_42_tr_52_button_49_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const demande_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminrhDemandeCatalogueComponent_div_42_tr_52_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, AdminrhDemandeCatalogueComponent_div_42_tr_52_small_8_Template, 2, 2, "small", 28)(9, AdminrhDemandeCatalogueComponent_div_42_tr_52_small_9_Template, 2, 0, "small", 90)(10, AdminrhDemandeCatalogueComponent_div_42_tr_52_div_10_Template, 3, 5, "div", 91);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "td")(12, "div", 92)(13, "div", 93)(14, "span", 94);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div")(17, "div", 95);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "small", 35);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 96)(22, "small", 35);
    \u0275\u0275text(23);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(24, "td")(25, "span");
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "td")(28, "div", 92);
    \u0275\u0275element(29, "i", 97);
    \u0275\u0275elementStart(30, "span");
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "td")(33, "div", 92);
    \u0275\u0275element(34, "i", 98);
    \u0275\u0275elementStart(35, "span");
    \u0275\u0275text(36);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(37, "td")(38, "span");
    \u0275\u0275text(39);
    \u0275\u0275elementEnd();
    \u0275\u0275template(40, AdminrhDemandeCatalogueComponent_div_42_tr_52_div_40_Template, 3, 1, "div", 91);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "td")(42, "div", 99);
    \u0275\u0275text(43);
    \u0275\u0275elementEnd();
    \u0275\u0275template(44, AdminrhDemandeCatalogueComponent_div_42_tr_52_div_44_Template, 5, 2, "div", 91);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "td", 100)(46, "div", 101);
    \u0275\u0275template(47, AdminrhDemandeCatalogueComponent_div_42_tr_52_button_47_Template, 3, 3, "button", 102)(48, AdminrhDemandeCatalogueComponent_div_42_tr_52_button_48_Template, 3, 3, "button", 103)(49, AdminrhDemandeCatalogueComponent_div_42_tr_52_button_49_Template, 2, 1, "button", 104);
    \u0275\u0275elementStart(50, "button", 105);
    \u0275\u0275element(51, "i", 106);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275styleProp("background-color", (demande_r6.catalogue == null ? null : demande_r6.catalogue.couleur) || null);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", (demande_r6.catalogue == null ? null : demande_r6.catalogue.titre) || "Catalogue #" + demande_r6.catalogue_id, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", demande_r6.catalogue);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !demande_r6.catalogue);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", demande_r6.catalogue == null ? null : demande_r6.catalogue.statut);
    \u0275\u0275advance(5);
...
function AdminrhDemandeCatalogueComponent_div_42_tr_53_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td", 120)(2, "div", 35);
    \u0275\u0275element(3, "i", 121);
    \u0275\u0275elementStart(4, "h6", 94);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 122);
    \u0275\u0275text(7, "Essayez avec d'autres termes de recherche.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "button", 123);
    \u0275\u0275listener("click", function AdminrhDemandeCatalogueComponent_div_42_tr_53_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminrhDemandeCatalogueComponent_div_42_div_54_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminrhDemandeCatalogueComponent_div_42_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 55)(1, "div", 56)(2, "div", 57)(3, "h6", 58);
    \u0275\u0275element(4, "i", 59);
    \u0275\u0275text(5, " Demandes de Catalogue ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function AdminrhDemandeCatalogueComponent_div_42_Template_a_click_14_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminrhDemandeCatalogueComponent_div_42_Template_a_click_17_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminrhDemandeCatalogueComponent_div_42_Template_a_click_20_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminrhDemandeCatalogueComponent_div_42_Template_a_click_23_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("matSortChange", function AdminrhDemandeCatalogueComponent_div_42_Template_table_matSortChange_26_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(52, AdminrhDemandeCatalogueComponent_div_42_tr_52_Template, 52, 26, "tr", 82)(53, AdminrhDemandeCatalogueComponent_div_42_tr_53_Template, 11, 1, "tr", 83);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(54, AdminrhDemandeCatalogueComponent_div_42_div_54_Template, 2, 0, "div", 84);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var AdminrhDemandeCatalogueComponent = class _AdminrhDemandeCatalogueComponent {
  ...
  constructor(data, router, pagination, demandeFormationService, catalogueService, authService) {
    this.data = data;
    this.router = router;
...
Veuillez saisir un motif :`);
  ...
  static \u0275fac = function AdminrhDemandeCatalogueComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminrhDemandeCatalogueComponent)(\u0275\u0275directiveInject(DataService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(PaginationService), \u0275\u0275directiveInject(DemandeFormationService), \u0275\u0275directiveInject(CatalogueService), \u0275\u0275directiveInject(AuthService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminrhDemandeCatalogueComponent, selectors: [["app-adminrh-demande-catalogue"]], decls: 43, vars: 19, consts: [[1, "page-content"], [1, "page-title", "d-flex", "align-items-center", "justify-content-between", "mb-4"], [1, "fw-bold", "mb-1"], [1, "text-muted", "mb-0"], [1, "d-flex", "align-items-center", "gap-2"], ["class", "d-flex align-items-center gap-3 me-3", 4, "ngIf"], [1, "btn", "btn-outline-primary", 3, "click", "disabled"], [1, "isax", "isax-refresh"], [1, "ms-1", "d-none", "d-sm-inline"], ["class", "alert alert-success alert-dismissible fade show", "role", "alert", 4, "ngIf"], ["class", "alert alert-danger alert-dismissible fade show", "role", "alert", 4, "ngIf"], [1, "card", "mb-4"], [1, "card-body"], [1, "row", "g-3"], [1, "col-lg-4"], [1, "input-group"], [1, "input-group-text"], [1, "isax", "isax-search-normal-1"], ["type", "search", "placeholder", "Rechercher catalogue, employ\xE9...", 1, "form-control", 3, "ngModelChange", "ngModel", "ngModelOptions", "disabled"], [1, "col-lg-3"], [1, "form-select", 3, "ngModelChange", "ngModel", "disabled"], [3, "value", 4, "ngFor", "ngForOf"], ["value", "tous"], ["value", "basse"], ["value", "normale"], ["value", "haute"], ["value", "urgente"], [1, "col-lg-2", "text-end"], ["class", "text-muted", 4, "ngIf"], ["class", "d-flex justify-content-center p-5", 4, "ngIf"], ["class", "card text-center py-5", 4, "ngIf"], ["class", "card", 4, "ngIf"], [1, "d-flex", "align-items-center", "gap-3", "me-3"], [1, "text-center"], [1, "fw-bold", "text-primary", "fs-5"], [1, "text-muted"], [1, "fw-bold", "text-warning", "fs-5"], [1, "fw-bold", "text-success", "fs-5"], ["class", "text-center", 4, "ngIf"], [1, "fw-bold", "text-danger", "fs-5"], ["role", "alert", 1, "alert", "alert-success", "alert-dismissible", "fade", "show"], [1, "isax", "isax-tick-circle", "me-2"], ["type", "button", 1, "btn-close", 3, "click"], ["role", "alert", 1, "alert", "alert-danger", "alert-dismissible", "fade", "show"], [1, "isax", "isax-warning-2", "me-2"], [3, "value"], [1, "d-flex", "justify-content-center", "p-5"], ["role", "status", 1, "spinner-border", "text-primary", "mb-3", 2, "width", "3rem", "height", "3rem"], [1, "visually-hidden"], [1, "text-muted", "fs-6"], [1, "card", "text-center", "py-5"], [1, "mb-4"], [1, "isax", "isax-document", "display-1", "text-muted"], [1, "fw-bold", "mb-3"], [1, "text-muted", "mb-4"], [1, "card"], [1, "card-header", "bg-white", "border-bottom"], [1, "d-flex", "align-items-center", "justify-content-between"], [1, "mb-0", "fw-bold"], [1, "isax", "isax-document", "me-2", "text-primary"], [1, "badge", "bg-light", "text-dark"], [1, "dropdown"], ["type", "button", "data-bs-toggle", "dropdown", "aria-expanded", "false", 1, "btn", "btn-sm", "btn-outline-secondary", "dropdown-toggle"], [1, "dropdown-menu"], ["href", "javascript:void(0)", 1, "dropdown-item", 3, "click"], [1, "table-responsive"], ["matSort", "", 1, "table", "table-hover", "mb-0", 3, "matSortChange"], [1, "table-light"], ["mat-sort-header", "catalogue", 1, "fw-semibold"], [1, "isax", "isax-book", "me-1"], ["mat-sort-header", "employe", 1, "fw-semibold"], [1, "isax", "isax-profile-2user", "me-1"], ["mat-sort-header", "priorite", 1, "fw-semibold"], [1, "isax", "isax-flag", "me-1"], ["mat-sort-header", "created_at", 1, "fw-semibold"], [1, "isax", "isax-calendar", "me-1"], ["mat-sort-header", "date_souhaitee_debut", 1, "fw-semibold"], [1, "isax", "isax-clock", "me-1"], ["mat-sort-header", "statut", 1, "fw-semibold"], [1, "isax", "isax-status", "me-1"], [1, "fw-semibold"], [1, "text-end", "fw-semibold"], ["class", "align-middle", 4, "ngFor", "ngForOf", "ngForTrackBy"], [4, "ngIf"], ["class", "card-footer bg-white border-top", 4, "ngIf"], [1, "align-middle"], [1, "d-flex", "align-items-start"], [1, "avatar", "avatar-md", "bg-primary", "text-white", "rounded", "me-3", "d-flex", "align-items-center", "justify-content-center"], [1, "isax", "isax-book"], [1, "fw-semibold", "text-dark", "mb-1"], ["class", "text-muted fst-italic", 4, "ngIf"], ["class", "mt-1", 4, "ngIf"], [1, "d-flex", "align-items-center"], [1, "avatar", "avatar-md", "bg-info", "text-white", "rounded", "me-3", "d-flex", "align-items-center", "justify-content-center"], [1, "fw-bold"], [1, "fw-medium", "text-dark"], [1, "mt-1"], [1, "isax", "isax-calendar", "text-muted", "me-2"], [1, "isax", "isax-clock", "text-muted", "me-2"], [1, "text-truncate", 2, "max-width", "200px", 3, "title"], [1, "text-end"], ["role", "group", 1, "btn-group", "btn-group-sm"], ["class", "btn btn-outline-success", "title", "Valider la demande", 3, "disabled", "click", 4, "ngIf"], ["class", "btn btn-outline-danger", "title", "Refuser la demande", 3, "disabled", "click", 4, "ngIf"], ["class", "btn btn-outline-warning", "title", "Annuler la demande", 3, "disabled", "click", 4, "ngIf"], ["title", "Voir les d\xE9tails", 1, "btn", "btn-outline-info"], [1, "isax", "isax-eye"], [1, "text-muted", "fst-italic"], [1, "badge", 3, "ngClass"], [1, "text-muted", "fw-medium"], [1, "text-muted", "d-block", "text-truncate", 2, "max-width", "200px", 3, "title"], ["title", "Valider la demande", 1, "btn", "btn-outline-success", 3, "click", "disabled"], ["class", "spinner-border spinner-border-sm me-1", 4, "ngIf"], ["class", "isax isax-tick-circle", 4, "ngIf"], [1, "spinner-border", "spinner-border-sm", "me-1"], [1, "isax", "isax-tick-circle"], ["title", "Refuser la demande", 1, "btn", "btn-outline-danger", 3, "click", "disabled"], ["class", "isax isax-close-circle", 4, "ngIf"], [1, "isax", "isax-close-circle"], ["title", "Annuler la demande", 1, "btn", "btn-outline-warning", 3, "click", "disabled"], ["colspan", "8", 1, "text-center", "py-5"], [1, "isax", "isax-search-normal-1", "display-6", "mb-3", "d-block", "text-muted", "opacity-50"], [1, "mb-0", "small"], [1, "btn", "btn-sm", "btn-outline-primary", "mt-2", 3, "click"], [1, "isax", "isax-refresh", "me-1"], [1, "card-footer", "bg-white", "border-top"]], template: function AdminrhDemandeCatalogueComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div")(3, "h4", 2);
      \u0275\u0275text(4, "Gestion des Demandes de Catalogue");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "p", 3);
      \u0275\u0275text(6, " Validez ou refusez les demandes de catalogue de vos employ\xE9s ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "div", 4);
      \u0275\u0275template(8, AdminrhDemandeCatalogueComponent_div_8_Template, 17, 4, "div", 5);
      \u0275\u0275elementStart(9, "button", 6);
      \u0275\u0275listener("click", function AdminrhDemandeCatalogueComponent_Template_button_click_9_listener() {
      ...
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(13, AdminrhDemandeCatalogueComponent_div_13_Template, 4, 1, "div", 9)(14, AdminrhDemandeCatalogueComponent_div_14_Template, 4, 1, "div", 10);
      \u0275\u0275elementStart(15, "div", 11)(16, "div", 12)(17, "div", 13)(18, "div", 14)(19, "div", 15)(20, "span", 16);
      \u0275\u0275element(21, "i", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "input", 18);
      \u0275\u0275twoWayListener("ngModelChange", function AdminrhDemandeCatalogueComponent_Template_input_ngModelChange_22_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.searchDataValue, $event) || (ctx.searchDataValue = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function AdminrhDemandeCatalogueComponent_Template_input_ngModelChange_22_listener() {
        return ctx.searchData(ctx.searchDataValue);
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(23, "div", 19)(24, "select", 20);
      \u0275\u0275twoWayListener("ngModelChange", function AdminrhDemandeCatalogueComponent_Template_select_ngModelChange_24_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.selectedStatutFilter, $event) || (ctx.selectedStatutFilter = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function AdminrhDemandeCatalogueComponent_Template_select_ngModelChange_24_listener($event) {
        return ctx.onStatutFilterChange($event);
      });
      \u0275\u0275template(25, AdminrhDemandeCatalogueComponent_option_25_Template, 2, 3, "option", 21);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(26, "div", 19)(27, "select", 20);
      \u0275\u0275twoWayListener("ngModelChange", function AdminrhDemandeCatalogueComponent_Template_select_ngModelChange_27_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.selectedPrioriteFilter, $event) || (ctx.selectedPrioriteFilter = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function AdminrhDemandeCatalogueComponent_Template_select_ngModelChange_27_listener($event) {
      ...
      \u0275\u0275template(39, AdminrhDemandeCatalogueComponent_small_39_Template, 2, 1, "small", 28);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(40, AdminrhDemandeCatalogueComponent_div_40_Template, 7, 0, "div", 29)(41, AdminrhDemandeCatalogueComponent_div_41_Template, 8, 0, "div", 30)(42, AdminrhDemandeCatalogueComponent_div_42_Template, 55, 6, "div", 31);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
  ...
  }, dependencies: [FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgModel, CommonModule, NgClass, NgForOf, NgIf, MatSortModule, MatSort, MatSortHeader, CustomPaginationComponent], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhDemandeCatalogueComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-demande-catalogue", standalone: true, imports: [RouterLink, FormsModule, CommonModule, MatSortModule, CustomPaginationComponent], template: `<div class="page-content">\r
  <!-- En-t\xEAte de la page -->\r
  <div class="page-title d-flex align-items-center justify-content-between mb-4">\r
    <div>\r
      <h4 class="fw-bold mb-1">Gestion des Demandes de Catalogue</h4>\r
      <p class="text-muted mb-0">\r
        Validez ou refusez les demandes de catalogue de vos employ\xE9s\r
      </p>\r
    </div>\r
        ...
        <div class="col-lg-4">\r
          <div class="input-group">\r
            ...
            <input\r
              ...
              placeholder="Rechercher catalogue, employ\xE9..."\r
              [disabled]="loading">\r
          </div>\r
        </div>\r
\r
...
\r
  ...
  <div class="card text-center py-5" *ngIf="showEmptyState">\r
    <div class="card-body">\r
      ...
      <h5 class="fw-bold mb-3">Aucune demande de catalogue</h5>\r
      <p class="text-muted mb-4">\r
        Aucune demande de catalogue n'a \xE9t\xE9 soumise pour le moment.\r
      </p>\r
    </div>\r
  </div>\r
\r
    ...
    <div class="table-responsive">\r
      <table matSort (matSortChange)="sortData($event)" class="table table-hover mb-0">\r
        <thead class="table-light">\r
          <tr>\r
            <th mat-sort-header="catalogue" class="fw-semibold">\r
              <i class="isax isax-book me-1"></i>Catalogue\r
            </th>\r
            ...
            <td>\r
              <div class="d-flex align-items-start">\r
                <div class="avatar avatar-md bg-primary text-white rounded me-3 d-flex align-items-center justify-content-center"\r
                     [style.background-color]="demande.catalogue?.couleur || null">\r
                  <i class="isax isax-book"></i>\r
                </div>\r
                <div>\r
                  <div class="fw-semibold text-dark mb-1">\r
                    {{ demande.catalogue?.titre || ('Catalogue #' + demande.catalogue_id) }}\r
                  </div>\r
                  <small class="text-muted" *ngIf="demande.catalogue">\r
                    {{ demande.catalogue.nombre_formations || 0 }} formation(s) \u2022\r
                    {{ demande.catalogue.type_display || demande.catalogue.type || 'N/A' }}\r
                  </small>\r
                  <small class="text-muted fst-italic" *ngIf="!demande.catalogue">\r
                    Chargement...\r
                  </small>\r
                  <div class="mt-1" *ngIf="demande.catalogue?.statut">\r
                        <span class="badge"\r
                              [ngClass]="{\r
                                'bg-success bg-opacity-10 text-success': demande.catalogue?.est_actif,\r
                                'bg-secondary bg-opacity-10 text-secondary': !demande.catalogue?.est_actif\r
                              }">\r
                          {{ demande.catalogue?.statut }}\r
                        </span>\r
                  </div>\r
                </div>\r
              </div>\r
...
` }]
  }], () => [{ type: DataService }, { type: Router }, { type: PaginationService }, { type: DemandeFormationService }, { type: CatalogueService }, { type: AuthService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhDemandeCatalogueComponent, { className: "AdminrhDemandeCatalogueComponent", filePath: "src/app/features/adminrh/adminrh-demande-catalogue/adminrh-demande-catalogue.component.ts", lineNumber: 33 });
})();
export {
  AdminrhDemandeCatalogueComponent
};
//# sourceMappingURL=chunk-GG6YI2DJ.js.map
