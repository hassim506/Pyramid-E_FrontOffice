...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorPlansComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-plans", imports: [CommonModule, MatTableModule, MatSortModule, MatPaginatorModule, MatSelectModule, CustomPaginationComponent, BsDatepickerModule], template: `<div class="row">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorPlansComponent, { className: "InstructorPlansComponent", filePath: "app/features/instructor/settings/instructor-plans/instructor-plans.component.ts", lineNumber: 21 });
})();
export {
  InstructorPlansComponent
};
//# sourceMappingURL=chunk-JT7F3LT7.js.map
