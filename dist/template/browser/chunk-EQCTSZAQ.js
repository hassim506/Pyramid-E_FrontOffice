...
<ng-container *ngIf="!loading">
  ...
  <div class="ip-page-head">
    <div>
      <h5 class="ip-page-head__title">Gestion des certificats</h5>
      <p class="ip-page-head__sub">Consultez et g\xE9rez les certificats d\xE9livr\xE9s \xE0 vos employ\xE9s</p>
    </div>
  </div>
  ...
  <div class="ip-card">
    <div class="table-responsive">
      <table class="table ip-table">
        ...
        <tbody>
          <tr *ngFor="let cert of paginatedCertificats">
            <td>
  ...
  <div *ngIf="totalPages > 1" class="ip-pagination">
    <span class="ip-pagination__info">
      {{ (currentPage - 1) * itemsPerPage + 1 }}\u2013{{ pageEnd }}
      sur {{ filteredCertificats.length }} certificats
    </span>
    <div class="ip-pagination__controls">
      ...
      <ng-container *ngFor="let p of pageNumbers">
        ...
        <button *ngIf="p !== -1" class="ip-pg-btn"
    ...
    <div class="modal-content ip-modal-content" *ngIf="selectedCert">
      ...
      <div class="ip-modal-body">
        <div class="ip-cert-preview" [style.background]="config.bg_couleur">
          ...
          <div class="ip-cert-score-row" *ngIf="config.show_duree && selectedCert.formation?.duree_totale">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhCertificateComponent, { className: "AdminrhCertificateComponent", filePath: "src/app/features/adminrh/adminrh-certificate/adminrh-certificate.component.ts", lineNumber: 17 });
})();
export {
  AdminrhCertificateComponent
};
//# sourceMappingURL=chunk-EQCTSZAQ.js.map
