...
var MesCompetencesComponent = class _MesCompetencesComponent {
  ...
  loadCompetences() {
    ...
    this.formationsService.getCompetencesAcquises().subscribe({
      next: (res) => {
        this.data = __spreadProps(__spreadValues({}, res), {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MesCompetencesComponent, { className: "MesCompetencesComponent", filePath: "app/features/student/mes-competences/mes-competences.component.ts", lineNumber: 55 });
})();
export {
  MesCompetencesComponent
};
//# sourceMappingURL=chunk-YA7IRJ5O.js.map
