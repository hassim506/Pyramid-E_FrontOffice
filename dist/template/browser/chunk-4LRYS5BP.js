...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InstructorSettingsComponent, [{
    type: Component,
    args: [{ selector: "app-instructor-settings", imports: [RouterLink, BsDatepickerModule], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstructorSettingsComponent, { className: "InstructorSettingsComponent", filePath: "src/app/features/instructor/settings/instructor-settings/instructor-settings.component.ts", lineNumber: 11 });
})();
export {
  InstructorSettingsComponent
};
//# sourceMappingURL=chunk-4LRYS5BP.js.map
