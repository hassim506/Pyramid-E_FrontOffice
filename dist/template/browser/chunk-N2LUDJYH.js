...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SuperadminProfileComponent, [{
    type: Component,
    args: [{ selector: "app-superadmin-profile", imports: [CommonModule, ReactiveFormsModule, RouterModule], template: `<div class="content container-fluid">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminProfileComponent, { className: "SuperadminProfileComponent", filePath: "app/features/superadmin/superadmin-profile/superadmin-profile.component.ts", lineNumber: 19 });
})();
export {
  SuperadminProfileComponent
};
//# sourceMappingURL=chunk-N2LUDJYH.js.map
