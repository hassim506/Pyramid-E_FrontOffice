...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhCertificateModeleComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-certificate-modele", standalone: true, imports: [CommonModule, FormsModule], template: `<!-- Error -->
...
<div class="ip-page-head">
  <div>
    <h5 class="ip-page-head__title">Personnalisation du certificat</h5>
    <p class="ip-page-head__sub">Configurez le mod\xE8le de certificat appliqu\xE9 \xE0 toutes les formations de votre entreprise</p>
  </div>
</div>

<!-- \u2500\u2500 Two-column layout \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
<div class="ip-customizer-layout">

  <!-- \u2500\u2500 Left panel : configuration \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
  <div class="ip-panel">

    <!-- Section: Identit\xE9 entreprise -->
      ...
      <div class="ip-cert-card__body">
        ...
        <div class="ip-cert-card__validity">
          ...
          <ng-container *ngIf="config.show_date_expiration">
            \xB7 Valide jusqu'au 15 janvier 2026 ({{ config.duree_validite }})
          </ng-container>
        </div>
      </div>
    </div>
    ...
    <div class="ip-card">
      <div class="table-responsive">
        <table class="table ip-table">
          ...
          <tbody>
            <tr *ngFor="let cert of recentCertificats">
              <td>
            ...
            <tr *ngIf="recentCertificats.length === 0">
              <td colspan="4" class="ip-empty">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminrhCertificateModeleComponent, { className: "AdminrhCertificateModeleComponent", filePath: "src/app/features/adminrh/adminrh-certificate-modele/adminrh-certificate-modele.component.ts", lineNumber: 19 });
})();
export {
  AdminrhCertificateModeleComponent
};
//# sourceMappingURL=chunk-G4ZCSRUC.js.map
