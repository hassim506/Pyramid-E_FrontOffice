...
function D(t2, e, o = true) {
  var n, r, i2, l;
  if (t2) {
    let d = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), s4 = d.height, a2 = d.width, u = e.offsetHeight, c = e.offsetWidth, f2 = e.getBoundingClientRect(), g2 = $(), it = k(), lt = h(), L, N2, ot = "top";
    f2.top + u + s4 > lt.height ? (L = f2.top + g2 - s4, ot = "bottom", L < 0 && (L = g2)) : L = u + f2.top + g2, f2.left + a2 > lt.width ? N2 = Math.max(0, f2.left + it + c - a2) : N2 = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N2 + "px" : t2.style.insetInlineStart = N2 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l = (i2 = x(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? l : "");
  }
}
function S(t2, e) {
...
function I(t2, e, o = true, n = void 0) {
  var r;
  if (t2) {
    let i2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), l = e.offsetHeight, d = e.getBoundingClientRect(), s4 = h(), a2, u, c = n != null ? n : "top";
    if (!n && d.top + l + i2.height > s4.height ? (a2 = -1 * i2.height, c = "bottom", d.top + a2 < 0 && (a2 = -1 * d.top)) : a2 = l, i2.width > s4.width ? u = d.left * -1 : d.left + i2.width > s4.width ? u = (d.left + i2.width - s4.width) * -1 : u = 0, t2.style.top = a2 + "px", t2.style.insetInlineStart = u + "px", t2.style.transformOrigin = c, o) {
      let f2 = (r = x(/-anchor-gutter$/)) == null ? void 0 : r.value;
      t2.style.marginTop = c === "bottom" ? `calc(${f2 != null ? f2 : "2px"} * -1)` : f2 != null ? f2 : "";
    }
  }
}
function y(t2) {
...
function j(t2, e) {
  ...
  if (t2) switch (t2) {
    ...
    default: {
      ...
      let l = ((s4) => typeof s4 == "function" && "call" in s4 && "apply" in s4)(t2) ? t2() : t2, d = H(l);
...
function A(t2, e = {}) {
  if (p2(t2)) {
    let o = (n, r) => {
      var l, d;
      let i2 = (l = t2 == null ? void 0 : t2.$attrs) != null && l[n] ? [(d = t2 == null ? void 0 : t2.$attrs) == null ? void 0 : d[n]] : [];
      return [r].flat().reduce((s4, a2) => {
        if (a2 != null) {
          let u = typeof a2;
          if (u === "string" || u === "number") s4.push(a2);
          else if (u === "object") {
            let c = Array.isArray(a2) ? o(n, a2) : Object.entries(a2).map(([f2, g2]) => n === "style" && (g2 || g2 === 0) ? `${f2.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()}:${g2}` : g2 ? f2 : void 0);
            s4 = c.length ? s4.concat(c.filter((f2) => !!f2)) : s4;
          }
        }
        return s4;
      }, i2);
...
function Q(e = "", t2 = "") {
  return dt2(`${p(e, false) && p(t2, false) ? `${e}-` : e}${t2}`);
}
function ae(e = "", t2 = "") {
  return `--${Q(e, t2)}`;
}
...
function le(e, t2) {
  ...
  function r(n, l) {
    ...
    for (; c <= n.length; ) {
      let h2 = n[c];
      if ((h2 === '"' || h2 === "'" || h2 === "`") && n[c - 1] !== "\\" && (d = d === h2 ? null : h2), !d && (h2 === "(" && u++, h2 === ")" && u--, (h2 === "," || c === n.length) && u === 0)) {
        let f2 = m2.trim();
  ...
  for (let n = i2.length - 1; n >= 0; n--) {
    let [l, o] = i2[n], c = e.slice(l + 3, o), m2 = r(c, t2), d = t2(...m2);
...
var ue = (e = {}, t2, r, s4) => {
  if (t2) {
    let { variable: i2, options: a2 } = S2.defaults || {}, { prefix: n, transform: l } = (e == null ? void 0 : e.options) || a2 || {}, o = z(t2, k2) ? t2 : `{${t2}}`;
    return s4 === "value" || a(s4) && l === "strict" ? S2.getTokenValue(t2) : Y2(o, void 0, n, [i2.excludedKeyRegex], r);
  }
  return "";
};
function ar(e, ...t2) {
...
function de(e, t2 = {}) {
  let r = S2.defaults.variable, { prefix: s4 = r.prefix, selector: i2 = r.selector, excludedKeyRegex: a2 = r.excludedKeyRegex } = t2, n = [], l = [], o = [{ node: e, path: s4 }];
  for (; o.length; ) {
    let { node: m2, path: d } = o.pop();
    for (let u in m2) {
      let h2 = m2[u], f2 = ve(h2), p3 = z(u, a2) ? Q(d) : Q(d, ee(u));
  ...
  let c = l.join("");
  return { value: l, tokens: n, declarations: c, css: C2(i2, c) };
}
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  var R2, T2, j2, O2, M, z3, V2;
  let { preset: a2, options: n } = t2, l, o, c, m2, d, u, h2;
  if (s(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te, extend: re } = a2, f2 = te || {}, { colorScheme: K2 } = f2, A2 = v2(f2, ["colorScheme"]), x2 = re || {}, { colorScheme: X } = x2, G2 = v2(x2, ["colorScheme"]), p3 = K2 || {}, { dark: U } = p3, B2 = v2(p3, ["dark"]), y2 = X || {}, { dark: I2 } = y2, H2 = v2(y2, ["dark"]), W2 = s(L) ? this._toVariables({ primitive: L }, n) : {}, q = s(A2) ? this._toVariables({ semantic: A2 }, n) : {}, Z = s(B2) ? this._toVariables({ light: B2 }, n) : {}, pe = s(U) ? this._toVariables({ dark: U }, n) : {}, fe = s(G2) ? this._toVariables({ semantic: G2 }, n) : {}, ye = s(H2) ? this._toVariables({ light: H2 }, n) : {}, Se = s(I2) ? this._toVariables({ dark: I2 }, n) : {}, [Me, ze] = [(R2 = W2.declarations) != null ? R2 : "", W2.tokens], [Ke, Xe] = [(T2 = q.declarations) != null ? T2 : "", q.tokens || []], [Ge, Ue] = [(j2 = Z.declarations) != null ? j2 : "", Z.tokens || []], [Be, Ie] = [(O2 = pe.declarations) != null ? O2 : "", pe.tokens || []], [He, We] = [(M = fe.declarations) != null ? M : "", fe.tokens || []], [qe, Ze] = [(z3 = ye.declarations) != null ? z3 : "", ye.tokens || []], [Fe, Je] = [(V2 = Se.declarations) != null ? V2 : "", Se.tokens || []];
  ...
  return { primitive: { css: l, tokens: o }, semantic: { css: c, tokens: m2 }, global: { css: d, tokens: u }, style: h2 };
}, getPreset({ name: e = "", preset: t2 = {}, options: r, params: s4, set: i2, defaults: a2, selector: n }) {
  var f2, x2, p3;
  let l, o, c;
  if (s(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j2 } = m2, O2 = v2(m2, ["colorScheme", "extend", "css"]), d = T2 || {}, { colorScheme: M } = d, z3 = v2(d, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), h2 = M || {}, { dark: te } = h2, re = v2(h2, ["dark"]), K2 = s(O2) ? this._toVariables({ [y2]: g(g({}, O2), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y2]: g(g({}, L), re) }, r) : {}, X = s(V2) ? this._toVariables({ [y2]: g(g({}, V2), te) }, r) : {}, [G2, U] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B2, I2] = [(x2 = A2.declarations) != null ? x2 : "", A2.tokens || []], [H2, W2] = [(p3 = X.declarations) != null ? p3 : "", X.tokens || []], q = this.transformCSS(y2, `${G2}${B2}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H2, "dark", "variable", r, i2, a2, n);
    l = `${q}${Z}`, o = [.../* @__PURE__ */ new Set([...U, ...I2, ...W2])], c = m(j2, { dt: E2 });
  }
  return { css: l, tokens: o, style: c };
}, getPresetC({ name: e = "", theme: t2 = {}, params: r, set: s4, defaults: i2 }) {
  var o;
  let { preset: a2, options: n } = t2, l = (o = a2 == null ? void 0 : a2.components) == null ? void 0 : o[e];
  ...
  var c, m2;
  let a2 = e.replace("-directive", ""), { preset: n, options: l } = t2, o = ((c = n == null ? void 0 : n.components) == null ? void 0 : c[a2]) || ((m2 = n == null ? void 0 : n.directives) == null ? void 0 : m2[a2]);
  ...
  let n = this.getCommon({ name: e, theme: t2, params: r, set: i2, defaults: a2 }), l = Object.entries(s4).reduce((o, [c, m2]) => o.push(`${c}="${m2}"`) && o, []).join(" ");
  ...
  var c;
  let n = { name: e, theme: t2, params: r, set: i2, defaults: a2 }, l = (c = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c.css, o = Object.entries(s4).reduce((m2, [d, u]) => m2.push(`${d}="${u}"`) && m2, []).join(" ");
  ...
  let a2 = function(l, o = {}, c = []) {
    ...
    Object.entries(l).forEach(([m2, d]) => {
      let u = z(m2, t2.variable.excludedKeyRegex) ? o : o ? `${o}.${oe(m2)}` : oe(m2), h2 = c ? `${c}.${m2}` : m2;
  ...
  var l;
  let i2 = ((o) => o.split(".").filter((m2) => !z(m2.toLowerCase(), r.variable.excludedKeyRegex)).join("."))(t2), a2 = t2.includes("colorScheme.light") ? "light" : t2.includes("colorScheme.dark") ? "dark" : void 0, n = [(l = e[i2]) == null ? void 0 : l.computed(a2)].flat().filter((o) => o);
  return n.length === 1 ? n[0].value : n.reduce((o = {}, c) => {
    let u = c, { colorScheme: m2 } = u, d = v2(u, ["colorScheme"]);
    return o[m2] = d, o;
  }, void 0);
}, getSelectorRule(e, t2, r, s4) {
  return r === "class" || r === "attr" ? C2(s(t2) ? `${e}${t2},${e} ${t2}` : e, s4) : C2(e, C2(t2 != null ? t2 : ":root", s4));
}, transformCSS(e, t2, r, s4, i2 = {}, a2, n, l) {
  if (s(t2)) {
    let { cssLayer: o } = i2;
    if (s4 !== "style") {
      let c = this.getColorSchemeOption(i2, n);
      t2 = r === "dark" ? c.reduce((m2, { type: d, selector: u }) => (s(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l, d, t2)), m2), "") : C2(l != null ? l : ":root", t2);
    }
    if (o) {
      let c = { name: "primeui", order: "primeui" };
      i(o) && (c.name = m(o.name, { name: e, type: s4 })), s(c.name) && (t2 = C2(`@layer ${c.name}`, t2), a2 == null || a2.layerNames(c.name));
    }
    return t2;
  }
  return "";
...
var S2 = { defaults: { variable: { prefix: "p", selector: ":root", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t2 } = e;
  t2 && (this._theme = $2(g({}, t2), { options: g(g({}, this.defaults.options), t2.options) }), this._tokens = b3.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
  ...
  this._theme = $2(g({}, this.theme), { preset: e }), this._tokens = b3.createTokens(e, this.defaults), this.clearLoadedStyleNames(), N.emit("preset:change", e), N.emit("theme:change", this.theme);
}, getOptions() {
  return this.options;
}, setOptions(e) {
  this._theme = $2(g({}, this.theme), { options: e }), this.clearLoadedStyleNames(), N.emit("options:change", e), N.emit("theme:change", this.theme);
}, getLayerNames() {
...
var BaseStyle = class _BaseStyle {
  ...
  loadTheme = (options = {}, style4 = "") => {
    return this.load(this.theme, options, (computedStyle = "") => S2.transformCSS(options.name || this.name, `${computedStyle}${ar`${style4}`}`));
  };
...
//# sourceMappingURL=chunk-VJCKUHID.js.map
