...
var SessionFormationService = class _SessionFormationService {
  ...
  createSessionRH(sessionData) {
    return this.http.post(this.apiUrlrh, sessionData, this.httpOptions).pipe(catchError(this.handleError("createSessionRH")));
  }
  /**
  ...
  updateSessionRH(id, sessionData) {
    return this.http.put(`${this.apiUrlrh}/${id}`, sessionData, this.httpOptions).pipe(catchError(this.handleError("updateSessionRH")));
  }
  /**
  ...
  deleteSessionRH(id) {
    return this.http.delete(`${this.apiUrlrh}/${id}`, this.httpOptions).pipe(catchError(this.handleError("deleteSessionRH")));
  }
  /**
   * Annuler une session
   */
...
//# sourceMappingURL=chunk-F4LTBMOU.js.map
