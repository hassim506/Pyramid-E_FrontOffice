...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CustomPaginationComponent, [{
    type: Component,
    args: [{ selector: "app-custom-pagination", imports: [CommonModule], standalone: true, template: `<div class="row align-items-center mt-4">
  <div class="col-md-2">
      ...
      <div class="pagination_section">
        <ul class="pagination">
          ...
          <li [hidden]="
                ...
                totalItems < serialNumberArray[serialNumberArray.length - 1]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CustomPaginationComponent, { className: "CustomPaginationComponent", filePath: "src/app/shared/service/custom-pagination/custom-pagination.component.ts", lineNumber: 17 });
})();

export {
  CustomPaginationComponent
};
//# sourceMappingURL=chunk-3XTSKOGE.js.map
