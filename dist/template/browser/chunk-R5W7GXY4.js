...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminrhDemandeSessionComponent, [{
    type: Component,
    args: [{ selector: "app-adminrh-demande-session", standalone: true, imports: [RouterLink, FormsModule, CommonModule, MatSortModule, CustomPaginationComponent], template: `<div class="page">\r
\r
  <!-- Page Header -->\r
  <div class="page-header">\r
    <div class="page-header__left">\r
      <h1>Demandes de session</h1>\r
      <p>G\xE9rez et traitez les demandes d'inscription aux sessions de formation</p>\r
    </div>\r
...
\r
  ...
  <div class="kpi-row">\r
    ...
    <div class="kpi">\r
      <div class="kpi__icon ki-amber"><i class="isax isax-calendar-1"></i></div>\r
      <div class="kpi__body">\r
        <div class="kpi__label">Total</div>\r
        <div class="kpi__val">{{ totalDemandes }}</div>\r
        <div class="kpi__delta">sessions</div>\r
      </div>\r
    </div>\r
  </div>\r
\r
...
\r
    ...
    <div class="toolbar">\r
      <div class="search-box">\r
        ...
        <input type="search" placeholder="Rechercher session, employ\xE9..."\r
...
\r
    ...
    <div *ngIf="!loading && !hasData" class="empty-state">\r
      ...
      <p>Aucune demande de session</p>\r
    </div>\r
\r
    <!-- Demande list -->\r
...
\r
        ...
        <div class="d-left">\r
          ...
          <div class="d-type-line tl-sess"></div>\r
        </div>\r
\r
        <!-- Body -->\r
        <div class="d-body">\r
...
\r
          <div class="d-title">{{ d.session_formation?.titre || ('Session #' + d.session_formation_id) }}</div>\r
\r
          <div class="d-meta">\r
            <span *ngIf="d.session_formation?.date_debut">\r
              <i class="isax isax-calendar-1"></i> {{ formatDate(d.session_formation?.date_debut) }}\r
            </span>\r
            <span *ngIf="d.session_formation?.lieu">\r
              <i class="isax isax-location"></i> {{ d.session_formation?.lieu }}\r
            </span>\r
...
\r
        ...
        <div class="d-right">\r
          <div class="d-badges">\r
            ...
            <span class="tb tb-sess">Session</span>\r
          </div>\r
...
//# sourceMappingURL=chunk-R5W7GXY4.js.map
