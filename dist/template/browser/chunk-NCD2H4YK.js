...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ClientListComponent, [{
    type: Component,
    args: [{ selector: "app-client-list", imports: [RouterLink, FormsModule, CommonModule, MatSortModule, CustomPaginationComponent, ClientAddComponent], template: `<!-- \u2500\u2500 SHELL \u2500\u2500 -->
<div class="cl-shell">
  ...
  <div class="cl-body">
      ...
      <ul class="cl-list" *ngIf="!loading">
        <li *ngFor="let client of tableData"
          ...
          <div class="cl-list__info">
            ...
            <span class="cl-list__sub">{{ client.type | titlecase }} \xB7 {{ client.secteur_activite }}</span>
          </div>
        ...
        <li *ngIf="!tableData.length" class="cl-list__empty">
          ...
          <small>Aucun client trouv\xE9</small>
        </li>
      </ul>
    ...
    <main class="cl-detail">
      ...
      <div *ngIf="!selectedClient && !loading" class="cl-empty-state">
        ...
        <h3>S\xE9lectionnez un client</h3>
        ...
        <button type="button" class="cl-btn cl-btn--primary mt-3" (click)="openNew()">
          <i class="isax isax-add me-1"></i>Cr\xE9er un client
        </button>
      </div>
        ...
        <div class="cl-detail-grid">
          ...
          <div class="cl-card">
            <div class="cl-card__header">
              ...
              <h3 class="cl-card__title">Informations g\xE9n\xE9rales</h3>
            </div>
            <div class="cl-card__body">
              <div class="cl-info-list">
                ...
                <div class="cl-info-row">
                  <span class="cl-info-row__label">T\xE9l\xE9phone</span>
          ...
          <!-- Entreprises associ\xE9es -->
          <div class="cl-card">
            <div class="cl-card__header">
              <i class="isax isax-building cl-card__icon"></i>
              <h3 class="cl-card__title">Entreprises associ\xE9es</h3>
            </div>
            <div class="cl-card__body">
              ...
              <ng-template #noEntreprises>
                <div class="cl-info-empty">
                  ...
                  <small>Aucune entreprise associ\xE9e</small>
                </div>
              </ng-template>
            </div>
          </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientListComponent, { className: "ClientListComponent", filePath: "src/app/features/superadmin/client/client-list.component.ts", lineNumber: 22 });
})();
export {
  ClientListComponent
};
//# sourceMappingURL=chunk-NCD2H4YK.js.map
