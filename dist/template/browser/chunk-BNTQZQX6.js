...
var FormationsService = class _FormationsService {
  ...
  getFormationsDuParcoursParCategorie(parcoursId, categorieId) {
    return this.http.get(`${this.apiUrl}/demandes-formation/listes/parcours/${parcoursId}/categories/${categorieId}/formations`, { headers: this.getHeaders() });
  }
...
//# sourceMappingURL=chunk-BNTQZQX6.js.map
