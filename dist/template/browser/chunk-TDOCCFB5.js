...
function SuperadminQuizComponent_ng_container_2_tr_32_div_8_Template(rf, ctx) {
  if (rf & 1) {
...
function SuperadminQuizComponent_ng_container_2_tr_32_span_14_Template(rf, ctx) {
  if (rf & 1) {
...
function SuperadminQuizComponent_ng_container_2_tr_32_span_15_Template(rf, ctx) {
  if (rf & 1) {
...
function SuperadminQuizComponent_ng_container_2_tr_32_span_17_Template(rf, ctx) {
  if (rf & 1) {
...
function SuperadminQuizComponent_ng_container_2_tr_32_span_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 48);
    \u0275\u0275text(1, "\u2014");
    \u0275\u0275elementEnd();
...
function SuperadminQuizComponent_ng_container_2_tr_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, SuperadminQuizComponent_ng_container_2_tr_32_div_8_Template, 2, 1, "div", 40);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275template(14, SuperadminQuizComponent_ng_container_2_tr_32_span_14_Template, 3, 1, "span", 43)(15, SuperadminQuizComponent_ng_container_2_tr_32_span_15_Template, 2, 0, "span", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "td");
    \u0275\u0275template(17, SuperadminQuizComponent_ng_container_2_tr_32_span_17_Template, 2, 1, "span", 45)(18, SuperadminQuizComponent_ng_container_2_tr_32_span_18_Template, 2, 0, "span", 44);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SuperadminQuizComponent_ng_container_2_tr_32_Template_button_click_29_listener() {
    ...
    \u0275\u0275listener("click", function SuperadminQuizComponent_ng_container_2_tr_32_Template_button_click_31_listener() {
      const quiz_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function SuperadminQuizComponent_ng_container_2_tr_32_Template_button_click_33_listener() {
      const quiz_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function SuperadminQuizComponent_ng_container_2_tr_33_Template(rf, ctx) {
  if (rf & 1) {
...
function SuperadminQuizComponent_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(32, SuperadminQuizComponent_ng_container_2_tr_32_Template, 35, 16, "tr", 35)(33, SuperadminQuizComponent_ng_container_2_tr_33_Template, 5, 0, "tr", 2);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function SuperadminQuizComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(19);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(20, SuperadminQuizComponent_div_5_div_20_Template, 8, 1, "div", 64);
...
var SuperadminQuizComponent = class _SuperadminQuizComponent {
  ...
  static \u0275fac = function SuperadminQuizComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SuperadminQuizComponent)(\u0275\u0275directiveInject(QuizService), \u0275\u0275directiveInject(FormBuilder));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SuperadminQuizComponent, selectors: [["app-superadmin-quiz"]], decls: 28, vars: 8, consts: [["class", "ip-loader", 4, "ngIf"], ["class", "alert alert-danger alert-dismissible", 4, "ngIf"], [4, "ngIf"], ["id", "sa_quiz_details_modal", "tabindex", "-1", "aria-hidden", "true", 1, "modal", "fade"], [1, "modal-dialog", "modal-dialog-centered", "ip-modal-dialog"], ["class", "modal-content ip-modal-content", 4, "ngIf"], ["id", "sa_quiz_edit_modal", "tabindex", "-1", "aria-hidden", "true", 1, "modal", "fade"], [1, "modal-content", "ip-modal-content"], [1, "ip-modal-header"], [1, "ip-modal-icon"], [1, "isax", "isax-edit-2"], [1, "ip-modal-title"], [1, "ip-modal-sub"], ["type", "button", "data-bs-dismiss", "modal", 1, "btn-close", "ms-auto"], [1, "ip-modal-divider"], ["class", "ip-modal-body", 4, "ngIf"], [1, "ip-modal-footer"], ["type", "button", "data-bs-dismiss", "modal", 1, "ip-btn", "ip-btn--ghost"], ["type", "button", 1, "ip-btn", "ip-btn--primary", 3, "click", "disabled"], ["class", "spinner-border spinner-border-sm me-1", 4, "ngIf"], ["class", "isax isax-tick-circle me-1", 4, "ngIf"], [1, "ip-loader"], ["role", "status", 1, "spinner-border"], [1, "visually-hidden"], [1, "alert", "alert-danger", "alert-dismissible"], ["type", "button", 1, "btn-close", 3, "click"], [1, "ip-page-head"], [1, "ip-page-head__title"], [1, "ip-count"], [1, "ip-page-head__sub"], [1, "ip-btn", "ip-btn--primary", 3, "routerLink"], [1, "isax", "isax-add-circle"], [1, "ip-card"], [1, "table-responsive"], [1, "table", "ip-table"], [4, "ngFor", "ngForOf"], [1, "ip-quiz-cell"], [1, "ip-quiz-icon"], [1, "isax", "isax-award"], [1, "ip-quiz-title"], ["class", "ip-quiz-desc", 4, "ngIf"], [1, "ip-pill"], [1, "isax", "isax-book-1"], ["class", "ip-pill", 4, "ngIf"], ["class", "text-muted", 4, "ngIf"], ["class", "ip-score", 4, "ngIf"], [1, "ip-status-badge"], [1, "fa-solid", "fa-circle"], [1, "text-muted"], [1, "ip-actions"], ["type", "button", "title", "D\xE9tails", 1, "ip-action-btn", 3, "click"], [1, "isax", "isax-eye"], ["type", "button", "title", "Modifier", 1, "ip-action-btn", 3, "click"], ["type", "button", "title", "Supprimer", 1, "ip-action-btn", "text-danger", 3, "click"], [1, "isax", "isax-trash"], [1, "ip-quiz-desc"], [1, "isax", "isax-clock"], [1, "ip-score"], ["colspan", "7", 1, "ip-empty"], [1, "ip-modal-body"], [1, "ip-detail-block"], [1, "ip-detail-icon-wrap"], [1, "ip-detail-label"], [1, "ip-detail-value"], ["class", "ip-detail-block", 4, "ngIf"], [1, "ip-detail-row"], [1, "ip-detail-block", "ip-detail-block--half"], [1, "isax", "isax-medal-star"], [1, "isax", "isax-repeat"], [1, "isax", "isax-status"], [1, "isax", "isax-calendar"], [1, "isax", "isax-document-text"], [3, "formGroup"], [1, "ip-field"], [1, "ip-label"], [1, "ip-required"], ["type", "text", "formControlName", "titre", "placeholder", "Titre du quiz", 1, "ip-input"], ["formControlName", "description", "rows", "3", "placeholder", "Description du quiz (optionnel)", 1, "ip-input", "ip-textarea"], [1, "ip-field-row"], [1, "ip-field", "ip-field--half"], [1, "ip-input-icon-wrap"], [1, "isax", "isax-clock", "ip-input-icon"], ["type", "number", "formControlName", "duree_minutes", "placeholder", "Ex. : 30", "min", "1", 1, "ip-input", "ip-input--icon"], [1, "isax", "isax-medal-star", "ip-input-icon"], ["type", "number", "formControlName", "score_minimum", "placeholder", "Ex. : 60", "min", "0", "max", "100", 1, "ip-input", "ip-input--icon"], [1, "isax", "isax-repeat", "ip-input-icon"], ["type", "number", "formControlName", "tentatives_max", "placeholder", "Illimit\xE9es si vide", "min", "1", 1, "ip-input", "ip-input--icon"], [1, "ip-toggle-row"], [1, "ip-toggle-label"], [1, "ip-toggle"], ["type", "checkbox", "formControlName", "is_active"], [1, "ip-toggle-slider"], ["class", "alert alert-danger mt-2 py-2 small", 4, "ngIf"], [1, "alert", "alert-danger", "mt-2", "py-2", "small"], [1, "spinner-border", "spinner-border-sm", "me-1"], [1, "isax", "isax-tick-circle", "me-1"]], template: function SuperadminQuizComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, SuperadminQuizComponent_div_0_Template, 4, 0, "div", 0)(1, SuperadminQuizComponent_div_1_Template, 3, 1, "div", 1)(2, SuperadminQuizComponent_ng_container_2_Template, 34, 5, "ng-container", 2);
      \u0275\u0275elementStart(3, "div", 3)(4, "div", 4);
      \u0275\u0275template(5, SuperadminQuizComponent_div_5_Template, 79, 15, "div", 5);
      \u0275\u0275elementEnd()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SuperadminQuizComponent, [{
    type: Component,
    args: [{ selector: "app-superadmin-quiz", standalone: true, imports: [CommonModule, RouterLink, FormsModule, ReactiveFormsModule], template: `<!-- Loading -->
...
<!-- \u2500\u2500 MODAL D\xC9TAILS \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
<div class="modal fade" id="sa_quiz_details_modal" tabindex="-1" aria-hidden="true">
...
<!-- \u2500\u2500 MODAL MODIFICATION \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
<div class="modal fade" id="sa_quiz_edit_modal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered ip-modal-dialog">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperadminQuizComponent, { className: "SuperadminQuizComponent", filePath: "src/app/features/superadmin/superadmin-quiz/superadmin-quiz.component.ts", lineNumber: 17 });
})();
export {
  SuperadminQuizComponent
};
//# sourceMappingURL=chunk-TDOCCFB5.js.map
