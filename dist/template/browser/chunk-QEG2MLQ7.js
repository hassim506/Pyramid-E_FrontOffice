         ...
         <div class="navbar-header">
           ...
           <div class="navbar-logo">
             <a *ngIf="base==='index-two' || base==='index-three' || base==='index-four' || base==='index-five' || base==='index-six' || base==='courses' || base==='pages' || base==='blog'" class="logo-white header-logo" [routerLink]="routes.home">
               <img src="assets/img/logo.png" class="logo" alt="Logo" style="max-height:56px">
             </a>
             <a *ngIf="base==='index'" class="logo-white header-logo" [routerLink]="routes.home">
               <img src="assets/img/logo-white.png" class="logo" alt="Logo" style="max-height:106px">
             </a>
         ...
         <div class="main-menu-wrapper" [ngClass]="{ 'active': isHovered }">								
           <div class="menu-header">
             <a [routerLink]="routes.home" class="menu-logo">
               <img src="assets/img/logo.png" class="img-fluid" alt="Logo" style="max-height:106px">
             </a>
           ...
           <div class="menu-login">
             <a [routerLink]="routes.login" class="btn btn-primary w-100 mb-2"><i class="isax isax-user me-2"></i>Se Connecter</a>
             <a [routerLink]="routes.register" class="btn btn-secondary w-100"><i class="isax isax-user-edit me-2"></i>Ajouter Employ\xE9</a>
           </div>
         </div>
         ...
         @if(base==='index' || base==='index-two' || base==='index-three' || base==='index-four' || base==='index-five' || base==='index-six'){
           ...
           @if(base === 'index-two' || base==='courses' || base==='pages'|| base==='blog'){
             <a [routerLink]="routes.login" class="btn btn-light d-inline-flex align-items-center me-2">
               <i class="isax isax-lock-circle me-2"></i>Se Connecter
           </a>
           <a [routerLink]="routes.register" class="btn btn-secondary me-0">
               <i class="isax isax-user-edit me-2"></i>Ajouter Employ\xE9
           </a>
           }
           </div>
         </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeaderComponent, { className: "HeaderComponent", filePath: "src/app/features/layouts/header/header.component.ts", lineNumber: 16 });
})();
...
function AdminHeaderComponent_div_27_ng_container_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "i", 56);
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4, "Mon Profile");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "a", 42);
    \u0275\u0275element(6, "i", 53);
    \u0275\u0275elementStart(7, "span");
    \u0275\u0275text(8, "Centre d'aide");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AdminHeaderComponent_div_27_ng_container_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "i", 54);
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4, "Tableau de bords RH");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "a", 42);
    \u0275\u0275element(6, "i", 49);
    \u0275\u0275elementStart(7, "span");
    \u0275\u0275text(8, "Gestion utilisateurs");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "a", 42);
    \u0275\u0275element(10, "i", 51);
    \u0275\u0275elementStart(11, "span");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", ctx_r1.routes.adminrh_dashboard);
    \u0275\u0275advance(4);
    \u0275\u0275property("routerLink", ctx_r1.routes.adminrhSettings);
  }
}
function AdminHeaderComponent_div_27_span_33_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminHeaderComponent_div_27_div_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "a", 42);
    \u0275\u0275element(2, "i", 59);
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate((ctx_r1.currentUser == null ? null : ctx_r1.currentUser.role_id) === 1 ? "View as Student" : "Log in as Student");
  }
}
function AdminHeaderComponent_div_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(25, AdminHeaderComponent_div_27_ng_container_25_Template, 21, 5, "ng-container", 41)(26, AdminHeaderComponent_div_27_ng_container_26_Template, 13, 3, "ng-container", 41)(27, AdminHeaderComponent_div_27_ng_container_27_Template, 9, 2, "ng-container", 41)(28, AdminHeaderComponent_div_27_ng_container_28_Template, 21, 5, "ng-container", 41);
    \u0275\u0275elementStart(29, "a", 42);
    \u0275\u0275element(30, "i", 43);
    \u0275\u0275elementStart(31, "span");
    \u0275\u0275text(32, "Messages");
    \u0275\u0275elementEnd();
    \u0275\u0275template(33, AdminHeaderComponent_div_27_span_33_Template, 2, 0, "span", 44);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(34, "div", 39);
    \u0275\u0275elementStart(35, "div", 45);
    \u0275\u0275template(36, AdminHeaderComponent_div_27_div_36_Template, 5, 2, "div", 46);
    \u0275\u0275elementStart(37, "button", 47);
    \u0275\u0275listener("click", function AdminHeaderComponent_div_27_Template_button_click_37_listener() {
      \u0275\u0275restoreView(_r1);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate(ctx_r1.getRoleLabel());
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.role_id) === 1);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.role_id) === 3);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.role_id) === 2);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.role_id) === 4 || (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.role_id) === 5 || (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.role_id) === 9 || (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.role_id) === 14);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", ctx_r1.routes.instructorCourse);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.role_id) === 3);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.role_id) === 1 || (ctx_r1.currentUser == null ? null : ctx_r1.currentUser.role_id) === 2);
  }
}
function AdminHeaderComponent_div_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "div", 60)(2, "a", 61);
    \u0275\u0275element(3, "i", 62);
...
var AdminHeaderComponent = class _AdminHeaderComponent {
  ...
  isLoggedIn = false;
  currentUser = null;
  constructor(common, data, sidebarService, renderer, authService, router) {
    this.common = common;
    this.data = data;
    this.sidebarService = sidebarService;
    this.renderer = renderer;
  ...
  getRoleLabel() {
    ...
    switch (this.currentUser.role_id) {
      ...
      case 13:
        return "Consultant";
      case 14:
        return "Super Admin RH Holding Groupe";
      default:
        return "User";
    }
  }
  ...
  static \u0275fac = function AdminHeaderComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminHeaderComponent)(\u0275\u0275directiveInject(CommonService), \u0275\u0275directiveInject(DataService), \u0275\u0275directiveInject(SidebarService), \u0275\u0275directiveInject(Renderer2), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(Router));
  };
  ...
  }, inputs: { base: "base" }, decls: 29, vars: 7, consts: [[1, "header-wrapper"], [1, "container-fluid"], [1, "row", "align-items-center"], [1, "col"], [1, "header-content", "d-flex", "align-items-center", "justify-content-between"], [1, "header-brand"], [1, "brand-logo", "d-flex", "align-items-center", 3, "routerLink"], ["src", "assets/img/logo.png", "alt", "Logo", 1, "logo-img", "me-2"], [1, "header-actions", "d-flex", "align-items-center"], [1, "header-item", "me-3"], [1, "theme-switcher", "d-flex"], ["type", "button", "title", "Light Mode", 1, "theme-toggle-btn", 3, "click"], [1, "isax", "isax-sun-15"], ["type", "button", "title", "Dark Mode", 1, "theme-toggle-btn", 3, "click"], [1, "isax", "isax-moon"], [1, "dropdown"], ["type", "button", "data-bs-toggle", "dropdown", 1, "header-icon-btn"], [1, "isax", "isax-notification"], [1, "notification-badge"], [1, "dropdown-menu", "dropdown-menu-end", "notification-dropdown"], [1, "dropdown-header"], [1, "badge", "bg-primary"], ["class", "header-item", 4, "ngIf"], [1, "header-item"], [1, "dropdown", "profile-dropdown"], ["type", "button", "data-bs-toggle", "dropdown", 1, "profile-btn", "d-flex", "align-items-center"], [1, "profile-avatar", "me-2"], ["alt", "Profile", 1, "avatar-img", 3, "src"], [1, "profile-info", "d-none", "d-md-block"], [1, "profile-name"], [1, "profile-role"], [1, "isax", "isax-arrow-down-1", "ms-2"], [1, "dropdown-menu", "dropdown-menu-end", "profile-menu"], [1, "profile-menu-header"], [1, "d-flex", "align-items-center"], [1, "profile-avatar", "me-3"], [1, "profile-details"], [1, "profile-name", "mb-0"], [1, "profile-email", "mb-1"], [1, "dropdown-divider"], [1, "profile-menu-body", 2, "margin-left", "0"], [4, "ngIf"], [1, "dropdown-item", 3, "routerLink"], [1, "isax", "isax-messages-3", "me-2"], ["class", "badge bg-danger ms-auto", 4, "ngIf"], [1, "profile-menu-footer"], ["class", "mb-2", 4, "ngIf"], [1, "btn", "btn-outline-danger", "w-100", "d-flex", "align-items-center", "justify-content-center", 3, "click"], [1, "isax", "isax-logout", "me-2"], [1, "isax", "isax-user-add", "me-2"], [1, "isax", "isax-people5", "me-2"], [1, "isax", "isax-teacher5", "me-2"], [1, "isax", "isax-element-4", "me-2"], [1, "isax", "isax-setting-2", "me-2"], [1, "isax", "isax-book-1", "me-2"], [1, "isax", "isax-security-user", "me-2"], [1, "isax", "isax-security-user"], [1, "badge", "bg-danger", "ms-auto"], [1, "mb-2"], [1, "isax", "isax-arrow-2", "me-2"], [1, "auth-buttons", "d-flex", "align-items-center"], [1, "btn", "btn-outline-primary", "btn-sm", "me-2", 3, "routerLink"], [1, "isax", "isax-login", "me-1"]], template: function AdminHeaderComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(26, "3 New");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275template(27, AdminHeaderComponent_div_27_Template, 41, 16, "div", 22)(28, AdminHeaderComponent_div_28_Template, 6, 1, "div", 22);
      \u0275\u0275elementEnd()()()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(6);
...
\r
                    <!-- Admin Menu -->\r
                    <ng-container *ngIf="currentUser?.role_id === 1">\r
...
\r
                    <!-- Instructor Menu -->\r
                    <ng-container *ngIf="currentUser?.role_id === 3">\r
...
\r
                    <!-- Student Menu -->\r
                    <ng-container *ngIf="currentUser?.role_id === 2">\r
                       <!--<a class="dropdown-item" [routerLink]="routes.instructorCourse">\r
                        <i class="isax isax-element-4 me-2"></i>\r
                      ...
                      <a class="dropdown-item" [routerLink]="routes.students_profile">\r
                        <i class="isax isax-security-user"></i>\r
                        <span>Mon Profile</span>\r
                      </a>\r
                      <!--<a class="dropdown-item" [routerLink]="routes.instructorCourse">\r
                         <i class="isax isax-book-1 me-2"></i>\r
                        <span>Mes Formations</span>\r
...
\r
                          <!-- Rh Menu -->\r
                  <ng-container *ngIf="currentUser?.role_id === 4 || currentUser?.role_id === 5 || currentUser?.role_id === 9 || currentUser?.role_id === 14">\r
                      <a class="dropdown-item" [routerLink]="routes.adminrh_dashboard">\r
                        <i class="isax isax-book-1 me-2"></i>\r
                        <span>Tableau de bords RH</span>\r
                      </a>\r
                     ...
                     \r
                      ...
                      <a class="dropdown-item" [routerLink]="routes.adminrhSettings">\r
                      <i class="isax isax-setting-2 me-2"></i>\r
                      <span>Parametres</span>\r
                    </a>\r
                    </ng-container>\r
...
\r
                  ...
                  <div class="profile-menu-footer">\r
                    <!-- Switch Role -->\r
                    <div *ngIf="currentUser?.role_id === 1 || currentUser?.role_id === 2" class="mb-2">\r
                      <a class="dropdown-item" [routerLink]="routes.login">\r
                        <i class="isax isax-arrow-2 me-2"></i>\r
                        <span>{{ currentUser?.role_id === 1 ? 'View as Student' : 'Log in as Student' }}</span>\r
                      </a>\r
                    </div>\r
\r
                    <!-- Logout Button -->\r
                    <button class="btn btn-outline-danger w-100 d-flex align-items-center justify-content-center" (click)="logout()">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminHeaderComponent, { className: "AdminHeaderComponent", filePath: "src/app/features/layouts/admin-header/admin-header.component.ts", lineNumber: 17 });
})();
...
//# sourceMappingURL=chunk-QEG2MLQ7.js.map
