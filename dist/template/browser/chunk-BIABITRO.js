...
function InstructorCourseComponent_ng_container_2_tr_79_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "div", 51)(3, "a", 52);
    \u0275\u0275element(4, "img", 53);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div")(6, "a", 54);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 55)(9, "span");
    \u0275\u0275element(10, "i", 56);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(32);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "td")(34, "div", 61)(35, "a", 62);
    \u0275\u0275element(36, "i", 63);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "a", 64);
    \u0275\u0275element(38, "i", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "button", 65);
...
function InstructorCourseComponent_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(15, "i", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div")(17, "div", 27);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div", 28);
    \u0275\u0275text(20, "Publi\xE9es");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(21, "div", 24)(22, "div", 29);
    \u0275\u0275element(23, "i", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div")(25, "div", 27);
    \u0275\u0275text(26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 28);
    \u0275\u0275text(28, "En attente");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(29, "div", 24)(30, "div", 31);
    \u0275\u0275element(31, "i", 32);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(37, "div", 24)(38, "div", 33);
    \u0275\u0275element(39, "i", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "div")(41, "div", 27);
    \u0275\u0275text(42);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "div", 28);
    \u0275\u0275text(44, "Apprenants");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(45, "div", 35)(46, "input", 36);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(56, "div", 42)(57, "a", 43);
    \u0275\u0275element(58, "i", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "a", 45);
    \u0275\u0275element(60, "i", 46);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(61, "div", 47)(62, "div", 48)(63, "table", 49)(64, "thead")(65, "tr")(66, "th");
    \u0275\u0275text(67, "Formation");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(79, InstructorCourseComponent_ng_container_2_tr_79_Template, 43, 25, "tr", 50)(80, InstructorCourseComponent_ng_container_2_tr_80_Template, 5, 0, "tr", 2);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
var InstructorCourseComponent = class _InstructorCourseComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InstructorCourseComponent, selectors: [["app-instructor-course"]], decls: 18, vars: 11, consts: [["class", "ip-loader", 4, "ngIf"], ["class", "alert alert-danger", 4, "ngIf"], [4, "ngIf"], ["id", "publish_modal", 1, "modal", "fade"], [1, "modal-dialog", "modal-dialog-centered"], [1, "modal-content"], [1, "modal-body", "text-center", "custom-modal-body"], [1, "avatar", "avatar-lg", "rounded-circle", "mb-2", 3, "ngClass"], [1, "mb-2"], [1, "mb-3"], [1, "d-flex", "align-items-center", "justify-content-center", "gap-2"], ["type", "button", "data-bs-dismiss", "modal", 1, "btn", "bg-gray-100", "rounded-pill"], ["type", "button", "data-bs-dismiss", "modal", 3, "click"], [1, "ip-loader"], ["role", "status", 1, "spinner-border", "text-primary"], [1, "visually-hidden"], [1, "alert", "alert-danger"], [1, "ip-page-head"], [1, "ip-page-head__title"], [1, "ip-count"], [1, "ip-page-head__sub"], ["href", "/courses/instructor-course-add", "target", "_blank", 1, "ip-btn", "ip-btn--primary"], [1, "isax", "isax-add-circle"], [1, "ip-kpi-row"], [1, "ip-kpi"], [1, "ip-kpi__icon", "ki-green"], [1, "isax", "isax-tick-circle"], [1, "ip-kpi__val"], [1, "ip-kpi__lbl"], [1, "ip-kpi__icon", "ki-amber"], [1, "isax", "isax-clock"], [1, "ip-kpi__icon", "ki-blue"], [1, "isax", "isax-edit-2"], [1, "ip-kpi__icon", "ki-teal"], [1, "isax", "isax-people"], [1, "ip-toolbar"], ["type", "text", "placeholder", "Rechercher une formation\u2026", 1, "ip-search", 3, "ngModelChange", "ngModel"], [1, "ip-select", 3, "change"], ["value", "all"], ["value", "active"], ["value", "pending"], ["value", "draft"], [1, "ip-toolbar__right"], [1, "ip-view-btn", "active", 3, "routerLink"], [1, "isax", "isax-task"], [1, "ip-view-btn", 3, "routerLink"], [1, "isax", "isax-element-3"], [1, "ip-card"], [1, "table-responsive"], [1, "table", "ip-table"], [4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "ip-course-cell"], ["target", "_blank", 1, "ip-course-img", 3, "href"], ["onerror", "this.src='assets/img/course/course-01.jpg'", 3, "src", "alt"], ["target", "_blank", 1, "ip-course-title", 3, "href"], [1, "ip-course-meta"], [1, "isax", "isax-video-circle"], [1, "isax", "isax-flag"], [1, "ip-pill"], [1, "badge", "badge-sm", "d-inline-flex", "align-items-center", 3, "ngClass"], [1, "fa-solid", "fa-circle", "fs-5", "me-1"], [1, "ip-actions"], ["target", "_blank", "title", "Voir", 1, "ip-action-btn", 3, "href"], [1, "isax", "isax-eye"], ["target", "_blank", "title", "Modifier", 1, "ip-action-btn", 3, "href"], ["type", "button", 1, "ip-action-btn", 3, "click", "title"], ["type", "button", "title", "Archiver", 1, "ip-action-btn", "ip-action-btn--arch", 3, "click"], [1, "isax", "isax-archive"], ["colspan", "6", 1, "ip-empty"], [1, "isax", "isax-book-1"]], template: function InstructorCourseComponent_Template(rf, ctx) {
    if (rf & 1) {
          ...
          <tr *ngFor="let f of tableData; trackBy: trackByFormation">
            <td>
              <div class="ip-course-cell">
                <a [href]="routes.courseDetails + '/' + f.id" target="_blank" class="ip-course-img">
                  <img [src]="getFormationImage(f)" [alt]="f.titre" onerror="this.src='assets/img/course/course-01.jpg'">
                </a>
                <div>
                  <a [href]="routes.courseDetails + '/' + f.id" target="_blank" class="ip-course-title">{{ f.titre }}</a>
            ...
            <td>
              <div class="ip-actions">
                <a [href]="routes.courseDetails + '/' + f.id" target="_blank" class="ip-action-btn" title="Voir">
                ...
                <button type="button" class="ip-action-btn ip-action-btn--arch" title="Archiver" (click)="archiveFormation(f)">
...
bootstrap/dist/js/bootstrap.esm.js:
  (*!
    ...
    *)
*/
//# sourceMappingURL=chunk-BIABITRO.js.map
